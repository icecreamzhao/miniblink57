    ...
    namespace wasm {
            ...
            uint32_t* protected_load_pc, bool is_load_mem)
        {
            ...
            case LoadType::kI64Load32S:
                ...
                break;
            case LoadType::kI64Load: {
                MemOperand src_op = (offset_reg != no_reg)
...
#undef FP_UNOP
            ...
            LiftoffRegister src, Label* trap)
        {
            ...
            case kExprI32SConvertF32: {
                LiftoffRegister rounded = GetUnusedRegister(kFpReg, LiftoffRegList::ForRegs(src));
                LiftoffRegister converted_back = GetUnusedRegister(kFpReg, LiftoffRegList::ForRegs(src, rounded));
            ...
            case kExprF32SConvertI32: {
                LiftoffRegister scratch = GetUnusedRegister(kFpReg, LiftoffRegList::ForRegs(dst));
        ...
        {
            Register tmp = GetUnusedRegister(kGpReg, LiftoffRegList::ForRegs(src, dst)).gp();
            ...
            LiftoffRegister rhs)
        {
            ...
            if (liftoff::IsRegInRegPair(lhs, dst) || liftoff::IsRegInRegPair(rhs, dst)) {
                tmp = GetUnusedRegister(kGpReg, LiftoffRegList::ForRegs(dst, lhs, rhs)).gp();
            }
