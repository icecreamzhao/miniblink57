...
namespace internal {
    ...
    RUNTIME_FUNCTION(Runtime_GetPropertyWithReceiver)
    {
        ...
        RETURN_RESULT_OR_FAILURE(
            isolate, Object::GetProperty(&it, static_cast<OnNonExistent>(on_non_existent->value())));
    }
    ...
    RUNTIME_FUNCTION(Runtime_SetPropertyWithReceiver)
    {
        ...
        Maybe<bool> result = Object::SetSuperProperty(&it, value, StoreOrigin::kMaybeKeyed);
    ...
    RUNTIME_FUNCTION(Runtime_CheckProxyGetSetTrapResult)
    {
        ...
        RETURN_RESULT_OR_FAILURE(isolate, JSProxy::CheckGetSetTrapResult(isolate, name, target, trap_result, JSProxy::AccessKind(access_kind)));
    }
