...
#define kScratchDoubleReg xmm0
        ...
        public:
            ...
            Immediate ToImmediate(InstructionOperand* operand)
            {
                ...
                if (constant.type() == Constant::kInt32 && RelocInfo::IsWasmReference(constant.rmode())) {
    ...
    if (CpuFeatures::IsSupported(AVX)) {                                   \
        ...
        namespace {
                ...
                const Instruction* instr)
            {
                if (instr->OutputCount() > 0) {
                    if (converter->OutputRegister(0) != eax)
                        return false;
            ...
            Instruction* instr)
        {
            ...
            case kIA32AddPair: {
                ...
                bool use_temp = false;
                if ((instr->InputAt(1)->IsRegister() && i.OutputRegister(0).code() == i.InputRegister(1).code()) || i.OutputRegister(0).code() == i.InputRegister(3).code()) {
            ...
            case kSSEFloat32Round: {
                ...
                RoundingMode const mode = static_cast<RoundingMode>(MiscField::decode(instr->opcode()));
            ...
            case kSSEFloat32Max: {
                ...
                auto ool = new (zone()) OutOfLineLoadFloat32NaN(this, i.OutputDoubleRegister());
            ...
            case kSSEFloat64Max: {
                ...
                auto ool = new (zone()) OutOfLineLoadFloat64NaN(this, i.OutputDoubleRegister());
                __ j(parity_even, ool->entry());
                __ j(above, &done_compare, Label::kNear);
                __ j(below, &compare_swap, Label::kNear);
            ...
            case kIA32Lea: {
                ...
                } else if (mode == kMode_MR1 && i.InputRegister(1) == i.OutputRegister()) {
...
#undef ATOMIC_BINOP_CASE
        ...
        {
            Label::Distance flabel_distance = branch->fallthru ? Label::kNear : Label::kFar;
        ...
        void CodeGenerator::AssembleReturn(InstructionOperand* pop)
        {
            ...
            if (pop->IsImmediate()) {
                ...
                __ pop(scratch_reg);
                __ lea(esp, Operand(esp, pop_reg, times_system_pointer_size, static_cast<int>(pop_size)));
                __ jmp(scratch_reg);
            }
        }
