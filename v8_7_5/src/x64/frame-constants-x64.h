...
namespace internal {
    ...
    public:
        ...
        static constexpr int kXMMRegistersBlockSize = kXMMRegisterSize * kCalleeSaveXMMRegisters;
        ...
        // bytes on the stack.
        static constexpr int kCallerFPOffset = -3 * kSystemPointerSize + -7 * kSystemPointerSize - kXMMRegistersBlockSize;
        ...
        static constexpr int kCallerFPOffset = -3 * kSystemPointerSize + -5 * kSystemPointerSize;
#endif
    };
    ...
    public:
        ...
        static constexpr int kFixedFrameSizeFromFp = TypedFrameConstants::kFixedFrameSizeFromFp + kNumberOfSavedGpParamRegs * kSystemPointerSize + kNumberOfSavedFpParamRegs * kSimd128Size;
    };

    class JavaScriptFrameConstants : public AllStatic {
    public:
        // FP-relative.
        static constexpr int kLocal0Offset = StandardFrameConstants::kExpressionsOffset;
        static constexpr int kLastParameterOffset = kFPOnStackSize + kPCOnStackSize;
        static constexpr int kFunctionOffset = StandardFrameConstants::kFunctionOffset;
