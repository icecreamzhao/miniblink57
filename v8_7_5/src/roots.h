...
#define ROOT(...) +1
        ...
        kImmortalImmovableRootsCount = kReadOnlyRootsCount STRONG_MUTABLE_IMMOVABLE_ROOT_LIST(ROOT),
#undef ROOT
        ...
        kLastImmortalImmovableRoot = kFirstImmortalImmovableRoot + kImmortalImmovableRootsCount - 1,
    ...
    public:
        ...
        static constexpr bool IsImmortalImmovable(RootIndex root_index)
        {
            ...
            return static_cast<unsigned>(root_index) <= static_cast<unsigned>(RootIndex::kLastImmortalImmovableRoot);
        }
    ...
    private:
        ...
        {
            STATIC_ASSERT(static_cast<size_t>(RootIndex::kLastReadOnlyRoot) == static_cast<size_t>(RootIndex::kFirstStrongRoot) - 1);
            return FullObjectSlot(
