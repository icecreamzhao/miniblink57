...
namespace internal {
    ...
    namespace {
        ...
        {
            static base::LazyInstance<PatternItems>::type items = LAZY_INSTANCE_INITIALIZER;
        ...
        class Pattern {
        public:
            Pattern(const char* d1, const char* d2)
...
#undef DEFFINE_TRAIT
        ...
        const std::vector<PatternData>& GetPatternData(Intl::HourCycle hour_cycle)
        {
            ...
            case Intl::HourCycle::kH11: {
                static base::LazyInstance<Pattern, H11Trait>::type h11 = LAZY_INSTANCE_INITIALIZER;
                return h11.Pointer()->Get();
            }
            case Intl::HourCycle::kH12: {
                static base::LazyInstance<Pattern, H12Trait>::type h12 = LAZY_INSTANCE_INITIALIZER;
                return h12.Pointer()->Get();
            }
            case Intl::HourCycle::kH23: {
                static base::LazyInstance<Pattern, H23Trait>::type h23 = LAZY_INSTANCE_INITIALIZER;
                return h23.Pointer()->Get();
            }
            case Intl::HourCycle::kH24: {
                static base::LazyInstance<Pattern, H24Trait>::type h24 = LAZY_INSTANCE_INITIALIZER;
                return h24.Pointer()->Get();
            }
            case Intl::HourCycle::kUndefined: {
                static base::LazyInstance<Pattern, HDefaultTrait>::type hDefault = LAZY_INSTANCE_INITIALIZER;
        ...
        std::string GetGMTTzID(Isolate* isolate, const std::string& input)
        {
            ...
            case 8:
                ...
                break;
            case 9:
                if ((input[7] == '+' || input[7] == '-') && IsInRange(input[8], '0', '9')) {
                    return ret + input[7] + input[8];
                }
                break;
            case 10:
                if ((input[7] == '+' || input[7] == '-') && (input[8] == '1') && IsInRange(input[9], '0', '4')) {
        ...
        Isolate* isolate, Handle<JSDateTimeFormat> date_time_format)
    {
        ...
        Handle<String> locale = factory->NewStringFromAsciiChecked(locale_str.c_str());

        icu::SimpleDateFormat* icu_simple_date_format = date_time_format->icu_simple_date_format()->raw();
        // calendar
        ...
        if (U_SUCCESS(status)) {
            ...
            if (canonical_time_zone == UNICODE_STRING_SIMPLE("Etc/UTC") || canonical_time_zone == UNICODE_STRING_SIMPLE("Etc/GMT")) {
        ...
        if (date_time_format->date_style() == DateTimeStyle::kUndefined && date_time_format->time_style() == DateTimeStyle::kUndefined) {
        ...
        Handle<Object> date)
    {
        ...
        icu::SimpleDateFormat* format = date_time_format->icu_simple_date_format()->raw();
        ...
        Handle<Object> options, RequiredOption required, DefaultsOption defaults)
    {
        ...
        if (can_cache) {
            ...
            icu::SimpleDateFormat* cached_icu_simple_date_format = static_cast<icu::SimpleDateFormat*>(
        ...
        if (can_cache) {
            isolate->set_icu_object_in_cache(
                cache_type, std::static_pointer_cast<icu::UObject>(date_time_format->icu_simple_date_format()->get()));
        }
    ...
    namespace {
            ...
            const std::vector<std::string>& props)
        {
            ...
            for (const auto& prop : props) {
                //  i. Let prop be the property name.
                // ii. Let value be ? Get(options, prop)
                Maybe<bool> maybe_undefined = IsPropertyUndefined(isolate, options, prop.c_str());
    ...
    {
        Handle<Context> native_context = Handle<Context>(isolate->context()->native_context(), isolate);
        Handle<JSFunction> constructor = Handle<JSFunction>(
    ...
    namespace {
        ...
        bool IsValidTimeZoneName(const icu::TimeZone& tz)
        {
            ...
            return U_SUCCESS(status) && canonical != icu::UnicodeString("Etc/Unknown", -1, US_INV);
        }
            ...
            const char* timezone)
        {
            ...
            std::string canonicalized = JSDateTimeFormat::CanonicalizeTimeZoneID(isolate, timezone);
        ...
        public:
            icu::Calendar* CreateCalendar(const icu::Locale& locale, icu::TimeZone* tz)
            {
                ...
                if (calendar->getDynamicClassID() == icu::GregorianCalendar::getStaticClassID()) {
                    icu::GregorianCalendar* gc = static_cast<icu::GregorianCalendar*>(calendar.get());
                    UErrorCode status = U_ZERO_ERROR;
        ...
        icu::Calendar* CreateCalendar(Isolate* isolate, const icu::Locale& icu_locale,
            icu::TimeZone* tz)
        {
            static base::LazyInstance<CalendarCache>::type calendar_cache = LAZY_INSTANCE_INITIALIZER;
        ...
        std::unique_ptr<icu::SimpleDateFormat> CreateICUDateFormatFromCache(
            ...
            icu::DateTimePatternGenerator& generator)
        {
            static base::LazyInstance<DateFormatCache>::type cache = LAZY_INSTANCE_INITIALIZER;
            return std::unique_ptr<icu::SimpleDateFormat>(
        ...
        Handle<Object> locales, Handle<Object> input_options)
    {
        ...
        Maybe<std::vector<std::string>> maybe_requested_locales = Intl::CanonicalizeLocaleList(isolate, locales);
        MAYBE_RETURN(maybe_requested_locales, Handle<JSDateTimeFormat>());
        std::vector<std::string> requested_locales = maybe_requested_locales.FromJust();
        ...
        Maybe<Intl::MatcherOption> maybe_locale_matcher = Intl::GetLocaleMatcher(isolate, options, "Intl.DateTimeFormat");
        ...
        Maybe<Intl::HourCycle> maybe_hour_cycle = Intl::GetHourCycle(isolate, options, "Intl.DateTimeFormat");
        ...
        Maybe<bool> maybe_timezone = Intl::GetStringOption(isolate, options, "timeZone", empty_values,
        ...
        if (maybe_get_hour12.FromJust()) {
            ...
            if (hour12) {
                ...
                if (hc_default == Intl::HourCycle::kH11 || hc_default == Intl::HourCycle::kH23) {
                    // 1. Set hc to "h11".
        ...
        if (FLAG_harmony_intl_datetime_style) {
            ...
            if (date_style != DateTimeStyle::kUndefined || time_style != DateTimeStyle::kUndefined) {
        ...
        if (icu_date_format.get() == nullptr) {
            ...
            Maybe<FormatMatcherOption> maybe_format_matcher = Intl::GetStringOption<FormatMatcherOption>(
            ...
            icu_date_format = CreateICUDateFormatFromCache(icu_locale, skeleton_ustr, *generator);
            if (icu_date_format.get() == nullptr) {
            ...
            if (FLAG_harmony_intl_date_format_range) {
                icu_date_interval_format = CreateICUDateIntervalFormat(icu_locale, skeleton_ustr);
            }
        ...
        if (maybe_get_hour12.FromJust() || maybe_hour_cycle.FromJust() != Intl::HourCycle::kUndefined) {
            auto hc_extension_it = r.extensions.find("hc");
            if (hc_extension_it != r.extensions.end()) {
                if (date_time_format->hour_cycle() != Intl::ToHourCycle(hc_extension_it->second.c_str())) {
        ...
        Handle<Managed<icu::Locale>> managed_locale = Managed<icu::Locale>::FromRawPtr(isolate, 0, icu_locale.clone());

        date_time_format->set_icu_locale(*managed_locale);
        Handle<Managed<icu::SimpleDateFormat>> managed_format = Managed<icu::SimpleDateFormat>::FromUniquePtr(isolate, 0,
            std::move(icu_date_format));
        date_time_format->set_icu_simple_date_format(*managed_format);
        if (FLAG_harmony_intl_date_format_range) {
            Handle<Managed<icu::DateIntervalFormat>> managed_interval_format = Managed<icu::DateIntervalFormat>::FromUniquePtr(
        ...
        double y)
    {
        ...
        icu::DateIntervalFormat* date_interval_format = date_time_format->icu_date_interval_format()->raw();
