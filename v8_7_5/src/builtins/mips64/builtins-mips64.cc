...
#define __ ACCESS_MASM(masm)
    ...
    namespace {
            ...
            Builtins::Name entry_trampoline)
        {
            ...
            __ li(s1, ExternalReference::Create(IsolateAddressId::kPendingExceptionAddress, masm->isolate()));
            ...
            __ pop(a5);
            __ li(a4, ExternalReference::Create(IsolateAddressId::kCEntryFPAddress, masm->isolate()));
        ...
        Register scratch3)
    {
...

        {
            ...
            __ Ld(a5, FieldMemOperand(optimized_code_entry, Code::kCodeDataContainerOffset));
...
#undef JUMP_IF_EQUAL
    ...
    void Builtins::Generate_InterpreterEntryTrampoline(MacroAssembler* masm)
    {
        ...
        __ Lw(a4, FieldMemOperand(feedback_vector, FeedbackVector::kInvocationCountOffset));
        __ Addu(a4, a4, Operand(1));
        __ Sw(a4, FieldMemOperand(feedback_vector, FeedbackVector::kInvocationCountOffset));
        ...
        // Allocate the local and temporary register file on the stack.
        {
            ...
            __ Lw(a4, FieldMemOperand(kInterpreterBytecodeArrayRegister, BytecodeArray::kFrameSizeOffset));
        ...
        __ Lw(a5, FieldMemOperand(kInterpreterBytecodeArrayRegister, BytecodeArray::kIncomingNewTargetOrGeneratorRegisterOffset));
    ...
    void Builtins::Generate_InstantiateAsmJs(MacroAssembler* masm)
    {
        ...
        Label failed;
        {
            ...
            for (int j = 0; j < 4; ++j) {
                ...
                for (int i = j - 1; i >= 0; --i) {
                    __ Ld(t2, MemOperand(fp, StandardFrameConstants::kCallerSPOffset + i * kPointerSize));
                    __ push(t2);
                }
                for (int i = 0; i < 3 - j; ++i) {
                    __ PushRoot(RootIndex::kUndefinedValue);
    ...
    namespace {
            ...
            bool with_result)
        {
            ...
            __ Ld(fp, MemOperand(sp, BuiltinContinuationFrameConstants::kFixedFrameSizeFromFp));
            __ Pop(t0);
            __ Daddu(sp, sp,
    ...
    void Builtins::Generate_InterpreterOnStackReplacement(MacroAssembler* masm)
    {
        ...
        __ SmiUntag(a1, MemOperand(a1, FixedArray::OffsetOfElementAt(DeoptimizationData::kOsrPcOffsetIndex) - kHeapObjectTag));
        ...
        Handle<Code> code)
    {
            ...
            Operand(StackFrame::TypeToMarker(StackFrame::ARGUMENTS_ADAPTOR)));
        {
            ...
            __ Lhu(a7, FieldMemOperand(a7, SharedFunctionInfo::kFormalParameterCountOffset));
            __ mov(a6, fp);
        }
    ...
    void Builtins::Generate_WasmCompileLazy(MacroAssembler* masm)
    {
        ...
        __ SmiTag(kWasmCompileLazyFuncIndexRegister);
        {
            ...
            constexpr RegList gp_regs = Register::ListOf<a0, a1, a2, a3, a4, a5, a6, a7>();
            ...
            __ Ld(a2, FieldMemOperand(kWasmInstanceRegister, WasmInstanceObject::kCEntryStubOffset));
    ...
    void Builtins::Generate_CallApiGetter(MacroAssembler* masm)
    {
        ...
        __ Sd(scratch, MemOperand(sp, (PCA::kReturnValueDefaultValueIndex + 1) * kPointerSize));
        __ li(scratch, ExternalReference::isolate_address(masm->isolate()));
