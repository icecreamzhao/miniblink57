...
#define __ ACCESS_MASM(masm)
    ...
    void Builtins::Generate_ResumeGeneratorTrampoline(MacroAssembler* masm)
    {
        ...
        __ LoadP(r5, FieldMemOperand(r4, JSGeneratorObject::kParametersAndRegistersOffset));
        {
    ...
    namespace {
            ...
            Builtins::Name entry_trampoline)
        {
            ...
            __ Move(r3, ExternalReference::Create(IsolateAddressId::kCEntryFPAddress, masm->isolate()));
...
#undef JUMP_IF_EQUAL
    ...
    void Builtins::Generate_InterpreterEntryTrampoline(MacroAssembler* masm)
    {
        ...
        // Allocate the local and temporary register file on the stack.
        {
            ...
            __ lwz(r5, FieldMemOperand(kInterpreterBytecodeArrayRegister, BytecodeArray::kFrameSizeOffset));
        ...
        __ LoadWordArith(
            r8, FieldMemOperand(kInterpreterBytecodeArrayRegister, BytecodeArray::kIncomingNewTargetOrGeneratorRegisterOffset));
        ...
        __ lbzx(r6, MemOperand(kInterpreterBytecodeArrayRegister, kInterpreterBytecodeOffsetRegister));
        ...
        Label do_return;
        __ lbzx(r4, MemOperand(kInterpreterBytecodeArrayRegister, kInterpreterBytecodeOffsetRegister));
    ...
    static void Generate_InterpreterEnterBytecode(MacroAssembler* masm)
    {
        ...
        __ Move(r5, ExternalReference::address_of_interpreter_entry_trampoline_instruction_start(masm->isolate()));
        ...
        __ lbzx(ip, MemOperand(kInterpreterBytecodeArrayRegister, kInterpreterBytecodeOffsetRegister));
    ...
    void Builtins::Generate_InstantiateAsmJs(MacroAssembler* masm)
    {
        ...
        Label failed;
        {
            ...
            for (int j = 0; j < 4; ++j) {
                ...
                for (int i = j - 1; i >= 0; --i) {
                    __ LoadP(r7, MemOperand(fp, StandardFrameConstants::kCallerSPOffset + i * kPointerSize));
                    __ push(r7);
                }
                for (int i = 0; i < 3 - j; ++i) {
                    __ PushRoot(RootIndex::kUndefinedValue);
    ...
    namespace {
            ...
            bool with_result)
        {
            ...
            if (with_result) {
                ...
                __ StoreP(
                    r3, MemOperand(sp, config->num_allocatable_general_registers() * kPointerSize + BuiltinContinuationFrameConstants::kFixedFrameSize));
            }
    ...
    void Builtins::Generate_InterpreterOnStackReplacement(MacroAssembler* masm)
    {
...

        {
            ...
            __ LoadP(r4,
                FieldMemOperand(r4, FixedArray::OffsetOfElementAt(DeoptimizationData::kOsrPcOffsetIndex)));
            __ SmiUntag(r4);
    ...
    void Builtins::Generate_WasmCompileLazy(MacroAssembler* masm)
    {
            ...
            kWasmCompileLazyFuncIndexRegister);
        {
            ...
            constexpr RegList fp_regs = DoubleRegister::ListOf<d1, d2, d3, d4, d5, d6, d7, d8>();
            ...
            __ LoadP(r5, FieldMemOperand(kWasmInstanceRegister, WasmInstanceObject::kCEntryStubOffset));
        ...
        bool builtin_exit_frame)
    {
        ...
        bool needs_return_buffer = (result_size == 2 && !ABI_RETURNS_OBJECT_PAIRS_IN_REGS);
        ...
        ExternalReference pending_handler_constant_pool_address = ExternalReference::Create(
