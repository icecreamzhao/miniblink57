...
#define __ ACCESS_MASM(masm)
        ...
        ExitFrameType exit_frame_type)
    {
        ...
        // Thumb mode builtin.
        DCHECK_EQ(1, reinterpret_cast<uintptr_t>(ExternalReference::Create(address).address()) & 1);
#endif
    ...
    namespace {
        ...
        // JSEntryVariant.
        constexpr int kPushedStackSpace = kNumCalleeSaved * kPointerSize + kPointerSize /* LR */ + kNumDoubleCalleeSaved * kDoubleSize + 4 * kPointerSize /* r5, r6, r7, scratch */ + EntryFrameConstants::kCallerFPOffset;
            ...
            Builtins::Name entry_trampoline)
        {
            ...
            int pushed_stack_space = EntryFrameConstants::kCallerFPOffset;
            {
                ...
                pushed_stack_space += kNumCalleeSaved * kPointerSize + kPointerSize /* LR */;
            ...
            __ Move(r5, ExternalReference::Create(IsolateAddressId::kCEntryFPAddress, masm->isolate()));
            ...
            __ pop(r3);
            __ Move(scratch, ExternalReference::Create(IsolateAddressId::kCEntryFPAddress, masm->isolate()));
        ...
        Register scratch3)
    {
...

        {
            ...
            __ ldr(scratch2, FieldMemOperand(optimized_code_entry, Code::kCodeDataContainerOffset));
            __ ldr(
                scratch2,
...
#undef JUMP_IF_EQUAL
    ...
    void Builtins::Generate_InterpreterEntryTrampoline(MacroAssembler* masm)
    {
        ...
        __ ldr(r9, FieldMemOperand(feedback_vector, FeedbackVector::kInvocationCountOffset));
        __ add(r9, r9, Operand(1));
        __ str(r9, FieldMemOperand(feedback_vector, FeedbackVector::kInvocationCountOffset));
        ...
        __ mov(r9, Operand(0));
        __ strh(r9, FieldMemOperand(kInterpreterBytecodeArrayRegister, BytecodeArray::kOSRNestingLevelOffset));
        ...
        // Allocate the local and temporary register file on the stack.
        {
            ...
            __ ldr(r4, FieldMemOperand(kInterpreterBytecodeArrayRegister, BytecodeArray::kFrameSizeOffset));
        ...
        __ ldr(r9, FieldMemOperand(kInterpreterBytecodeArrayRegister, BytecodeArray::kIncomingNewTargetOrGeneratorRegisterOffset));
        ...
        __ ldrb(r4, MemOperand(kInterpreterBytecodeArrayRegister, kInterpreterBytecodeOffsetRegister));
        __ ldr(
        ...
        Label do_return;
        __ ldrb(r1, MemOperand(kInterpreterBytecodeArrayRegister, kInterpreterBytecodeOffsetRegister));
    ...
    static void Generate_InterpreterEnterBytecode(MacroAssembler* masm)
    {
        ...
        __ Move(r2, ExternalReference::address_of_interpreter_entry_trampoline_instruction_start(masm->isolate()));
        ...
        UseScratchRegisterScope temps(masm);
        Register scratch = temps.Acquire();
        __ ldrb(scratch, MemOperand(kInterpreterBytecodeArrayRegister, kInterpreterBytecodeOffsetRegister));
    ...
    void Builtins::Generate_InstantiateAsmJs(MacroAssembler* masm)
    {
        ...
        Label failed;
        {
            ...
            for (int j = 0; j < 4; ++j) {
                ...
                for (int i = j - 1; i >= 0; --i) {
                    __ ldr(r4, MemOperand(fp, StandardFrameConstants::kCallerSPOffset + i * kPointerSize));
                    __ push(r4);
                }
                for (int i = 0; i < 3 - j; ++i) {
                    __ PushRoot(RootIndex::kUndefinedValue);
    ...
    namespace {
            ...
            bool with_result)
        {
            ...
            __ ldr(fp, MemOperand(sp, BuiltinContinuationFrameConstants::kFixedFrameSizeFromFp));
    ...
    void Builtins::Generate_InterpreterOnStackReplacement(MacroAssembler* masm)
    {
...

        {
            ...
            __ ldr(r1, FieldMemOperand(r1, FixedArray::OffsetOfElementAt(DeoptimizationData::kOsrPcOffsetIndex)));
        ...
        ConvertReceiverMode mode)
    {
        ...
        Label done_convert;
        __ ldr(r3, FieldMemOperand(r2, SharedFunctionInfo::kFlagsOffset));
        __ tst(r3, Operand(SharedFunctionInfo::IsNativeBit::kMask | SharedFunctionInfo::IsStrictBit::kMask));
    ...
    void Builtins::Generate_WasmCompileLazy(MacroAssembler* masm)
    {
            ...
            kWasmCompileLazyFuncIndexRegister);
        {
            ...
            __ ldr(r2, FieldMemOperand(kWasmInstanceRegister, WasmInstanceObject::kCEntryStubOffset));
