...
namespace internal {
    ...
    BUILTIN(ErrorConstructor)
    {
        ...
        RETURN_RESULT_OR_FAILURE(
            isolate, ErrorUtils::Construct(isolate, args.target(), Handle<Object>::cast(args.new_target()), args.atOrUndefined(isolate, 1), mode, caller, false));
    }
    ...
    namespace {
            ...
            Handle<JSFunction> constructor)
        {
            ...
            RETURN_RESULT_OR_FAILURE(
                isolate, ErrorUtils::MakeGenericError(isolate, constructor, MessageTemplateFromInt(Smi::ToInt(*template_index)), arg0, arg1, arg2, SKIP_NONE));
        }
