...
namespace internal {
        ...
        int* decimal_exponent)
    {
        ...
        PowersOfTenCache::GetCachedPowerForBinaryExponentRange(
            ...
            &ten_mk, &mk);
        DCHECK((kMinimalTargetExponent <= w.e() + ten_mk.e() + DiyFp::kSignificandSize) && (kMaximalTargetExponent >= w.e() + ten_mk.e() + DiyFp::kSignificandSize));
        ...
        DCHECK(scaled_w.e() == boundary_plus.e() + ten_mk.e() + DiyFp::kSignificandSize);
