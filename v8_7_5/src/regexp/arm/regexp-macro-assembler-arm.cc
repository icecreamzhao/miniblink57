...
#define __ ACCESS_MASM(masm_)
    ...
    Handle<HeapObject> RegExpMacroAssemblerARM::GetCode(Handle<String> source)
    {
        ...
        RegList registers_to_retain = r4.bit() | r5.bit() | r6.bit() | r7.bit() | r8.bit() | r9.bit() | r10.bit() | fp.bit();
    ...
    void RegExpMacroAssemblerARM::CallCheckStackGuardState()
    {
        ...
        if (FLAG_embedded_builtins) {
            ...
            __ mov(lr, Operand(reinterpret_cast<intptr_t>(code.location()), RelocInfo::CODE_TARGET));
        }
        __ Call(lr);
