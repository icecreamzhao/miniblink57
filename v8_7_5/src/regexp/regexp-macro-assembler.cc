...
namespace internal {
        ...
        Isolate* isolate)
    {
        ...
        unibrow::Mapping<unibrow::Ecma262Canonicalize>* canonicalize = isolate->regexp_macro_assembler_canonicalize();
        ...
        const byte** input_start, const byte** input_end)
    {
        ...
        if (return_value == 0) {
            ...
            if (String::IsOneByteRepresentationUnderneath(*subject_handle) != is_one_byte) {
                ...
                *input_start = StringCharacterPosition(*subject_handle, start_index, no_gc);
        ...
        int previous_index, Isolate* isolate)
    {
        ...
        DisallowHeapAllocation no_gc;
        const byte* input_start = StringCharacterPosition(subject_ptr, start_offset + slice_offset, no_gc);
        ...
        int* output, int output_size, Isolate* isolate)
    {
        ...
        int result = fn.CallIrregexp(input.ptr(), start_offset, input_start, input_end, output,
