...
namespace internal {
    ...
    const char* const TriggerFailureExtension::kSource = "native function triggerCheckFalse();"
        ...
        v8::Local<v8::String> str)
    {
        if (strcmp(*v8::String::Utf8Value(isolate, str), "triggerCheckFalse") == 0) {
            ...
            CHECK_EQ(0, strcmp(*v8::String::Utf8Value(isolate, str), "triggerSlowAssertFalse"));
            return v8::FunctionTemplate::New(
                isolate,
