...
int APIENTRY _tWinMain(HINSTANCE hInstance, HINSTANCE hPrevInstance, LPTSTR lpCmdLine, int nCmdShow)
{
    ...
    content::RenderViewHost* renderHost = new content::RenderViewHost();
    renderHost->init(hInstance);
    renderHost->run();
    delete renderHost;
...
BOOL InitInstance(HINSTANCE hInstance, LPTSTR lpCmdLine, int nCmdShow)
{
    ...
    //         460, 250, 1008, 691, NULL, NULL, hInstance, this);
    //
    //     if (!hWnd)
    //         return FALSE;
    //
...
LRESULT CALLBACK WndProc(HWND hWnd, UINT message, WPARAM wParam, LPARAM lParam)
{
    ...
    //     case WM_MOUSEMOVE:
    //     case WM_MOUSELEAVE:
    //         webPage->fireMouseEvent(hWnd, message, wParam, lParam);
    //         break;
    //     case WM_SETCURSOR:
