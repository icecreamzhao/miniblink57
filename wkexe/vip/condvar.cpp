...
typedef NTSTATUS(NTAPI *ft_NtCreateKeyedEvent)(OUT PHANDLE handle, IN ACCESS_MASK access/*EVENT_ALL_ACCESS*/, IN POBJECT_ATTRIBUTES attr, IN ULONG flags);
typedef NTSTATUS(NTAPI *ft_NtWaitForKeyedEvent)(IN HANDLE handle, IN PVOID key, IN BOOLEAN alertable, IN PLARGE_INTEGER mstimeout);
typedef NTSTATUS(NTAPI *ft_NtReleaseKeyedEvent)(IN HANDLE handle, IN PVOID key, IN BOOLEAN alertable, IN PLARGE_INTEGER mstimeout);

NTSTATUS NTAPI NtCreateKeyedEvent(OUT PHANDLE handle, IN ACCESS_MASK access/*EVENT_ALL_ACCESS*/, IN POBJECT_ATTRIBUTES attr, IN ULONG flags)
{
...
VOID WINAPI RtlpInitializeKeyedEvent(VOID)
{
    ASSERT(CondVarKeyedEventHandle == NULL);
...
BOOL
WINAPI
MySleepConditionVariableCS(PCONDITION_VARIABLE ConditionVariable, PCRITICAL_SECTION CriticalSection, DWORD Timeout)
{
    NTSTATUS Status;
    LARGE_INTEGER Time;
...
BOOL
WINAPI
MySleepConditionVariableSRW(PCONDITION_VARIABLE ConditionVariable, PSRWLOCK Lock, DWORD Timeout, ULONG Flags)
{
    NTSTATUS Status;
    LARGE_INTEGER Time;
...
VOID
WINAPI
MyWakeAllConditionVariable(PCONDITION_VARIABLE ConditionVariable)
{
...
VOID
WINAPI
MyWakeConditionVariable(PCONDITION_VARIABLE ConditionVariable)
{
