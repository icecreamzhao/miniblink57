...
#include "e:\\mycode\\swiftshader-master\\third_party\\PowerVR_SDK\\Builds\\Include\\EGL\\egl.h"
#include "e:\\mycode\\swiftshader-master\\third_party\\PowerVR_SDK\\Builds\\Include\\GLES2\\gl2.h"
...
******************************************************************************/
int WINAPI WinMainOGL(HINSTANCE hInstance, HINSTANCE hPrevInstance, WCHAR* lpCmdLine, int nCmdShow)
{
    // Windows variables
    HWND				hWnd = 0;
    HDC					hDC = 0;
    ...
    */
    ...
    if (!bShaderCompiled) {
        ...
        MessageBoxA(hWnd, i32InfoLogLength ? pszInfoLog : "", "Failed to compile fragment shader", MB_OK | MB_ICONEXCLAMATION);
        delete[] pszInfoLog;
    ...
    if (!bShaderCompiled) {
        ...
        MessageBoxA(hWnd, i32InfoLogLength ? pszInfoLog : "", "Failed to compile vertex shader", MB_OK | MB_ICONEXCLAMATION);
    ...
    if (!bLinked) {
        ...
        MessageBoxA(hWnd, i32InfoLogLength ? pszInfoLog : "", "Failed to link program", MB_OK | MB_ICONEXCLAMATION);
