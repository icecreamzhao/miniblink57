...
public:
    ...
    private:
        ...
        NODEJS_DISALLOW_COPY_AND_ASSIGN(ScopedLock);
    };
    ...
    private:
        ...
        const MutexBase& mutex_;
        NODEJS_DISALLOW_COPY_AND_ASSIGN(ScopedUnlock);
    };
...
private:
    ...
    NODEJS_DISALLOW_COPY_AND_ASSIGN(MutexBase);
};
...
private:
    ...
    NODEJS_DISALLOW_COPY_AND_ASSIGN(ConditionVariableBase);
};
...
{
    NODE_CHECK_EQ(0, Traits::cond_init(&cond_));
}
...
{
    NODE_CHECK_EQ(0, Traits::mutex_init(&mutex_));
}
