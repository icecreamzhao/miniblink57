...
public:
    ...
    int PerformInputSequence(BrowserHandle browser_wrapper, const Json::Value& sequence, std::string* error_info);
    ...
    {
        return this->use_native_events_;
    }

    bool require_window_focus(void) const
    {
        return this->require_window_focus_;
    }

    bool use_persistent_hover(void) const
    {
        return this->use_persistent_hover_;
    }
    ...
    {
        return this->current_input_state_.is_shift_pressed;
    }
    bool is_control_pressed(void) const
    {
        return this->current_input_state_.is_control_pressed;
    }
    bool is_alt_pressed(void) const
    {
        return this->current_input_state_.is_alt_pressed;
    }
    clock_t last_click_time(void) const
    {
        return this->current_input_state_.last_click_time;
    }

private:
    int PointerMoveTo(BrowserHandle browser_wrapper, const Json::Value& move_to_action, InputState* input_state);
    int PointerDown(BrowserHandle browser_wrapper, const Json::Value& down_action, InputState* input_state);
    int PointerUp(BrowserHandle browser_wrapper, const Json::Value& up_action, InputState* input_state);
    int KeyDown(BrowserHandle browser_wrapper, const Json::Value& down_action, InputState* input_state);
    int KeyUp(BrowserHandle browser_wrapper, const Json::Value& up_action, InputState* input_state);
    int Pause(BrowserHandle browser_wrapper, const Json::Value& pause_action);
