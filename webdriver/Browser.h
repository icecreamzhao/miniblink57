...
public:
    ...
    static inline _ATL_FUNC_INFO* BeforeNavigate2Info()
    {
        static _ATL_FUNC_INFO kBeforeNavigate2 = { CC_STDCALL, VT_EMPTY, 7,
            { VT_DISPATCH, VT_VARIANT | VT_BYREF, VT_VARIANT | VT_BYREF, VT_VARIANT | VT_BYREF, VT_VARIANT | VT_BYREF, VT_VARIANT | VT_BYREF,
                VT_BOOL | VT_BYREF } };
    ...
    {
        static _ATL_FUNC_INFO kNewWindow3 = { CC_STDCALL, VT_EMPTY, 5, { VT_DISPATCH | VT_BYREF, VT_BOOL | VT_BYREF, VT_I4, VT_BSTR, VT_BSTR } };
        return &kNewWindow3;
    }

    static inline _ATL_FUNC_INFO* NewProcessInfo()
    {
        static _ATL_FUNC_INFO kNewProcess = { CC_STDCALL, VT_EMPTY, 3, { VT_I4, VT_DISPATCH, VT_BOOL | VT_BYREF } };
        return &kNewProcess;
    }
    ...
    void Close(void);
    bool IsBusy(void);
    void GetDocument(const bool force_top_level_document, IHTMLDocument2** doc);
...
private:
    ...
    bool IsDocumentNavigating(const std::string& page_load_strategy, IHTMLDocument2* doc);
