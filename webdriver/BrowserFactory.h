...
//     bool AttachToBrowser(ProcessWindowInfo* procWinInfo, std::string* error_message);
...
//     }
//     bool clear_cache(void) const
//     {
//         return this->clear_cache_;
//     }
//     bool force_createprocess_api(void) const
//     {
//         return this->force_createprocess_api_;
//     }
//     bool force_shell_windows_api(void) const
//     {
//         return this->force_shell_windows_api_;
//     }
//     int browser_attach_timeout(void) const
//     {
//         return this->browser_attach_timeout_;
//     }
//     bool ignore_process_match(void) const
//     {
//         return this->ignore_process_match_;
//     }
//     std::string initial_browser_url(void);
//     std::string browser_command_line_switches(void);
// 
//     int browser_version(void) const
//     {
//         return this->ie_major_version_;
//     }
// 
...
//     static bool IsWindowsVersionOrGreater(unsigned short major_version, unsigned short minor_version, unsigned short service_pack);
// 
...
// 
//     bool CreateLowIntegrityLevelToken(HANDLE* process_token_handle, HANDLE* mic_token_handle, PSID* sid);
// 
//     bool AttachToBrowserUsingShellWindows(ProcessWindowInfo* process_window_info, std::string* error_message);
//     bool AttachToBrowserUsingActiveAccessibility(ProcessWindowInfo* process_window_info, std::string* error_message);
// 
...
//     void LaunchBrowserUsingCreateProcess(PROCESS_INFORMATION* proc_info, std::string* error_message);
//     void LaunchEdgeInIEMode(PROCESS_INFORMATION* proc_info, std::string* error_message);
//     void LaunchBrowserUsingIELaunchURL(PROCESS_INFORMATION* proc_info, std::string* error_message);
