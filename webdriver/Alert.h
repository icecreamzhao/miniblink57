...
public:
    ...
    bool is_standard_alert(void) const
    {
        return this->is_standard_alert_;
    }
    bool is_security_alert(void) const
    {
        return this->is_security_alert_;
    }
...
private:
    ...
    enum BUTTON_TYPE { OK, CANCEL };

    int SendKeysInternal(const std::string& keys, TextBoxFindInfo* text_box_find_info);
