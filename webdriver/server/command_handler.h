...
public:
    ...
    {
        this->ExecuteInternal(executor, command.command_parameters(), response);
    }

protected:
    virtual void ExecuteInternal(const T& executor, const ParametersMap& command_parameters, Response* response) = 0;
