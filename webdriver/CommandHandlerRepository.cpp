...
{
    CommandHandlerMap::const_iterator found_iterator = this->command_handlers_.find(command_name);
...
{
    WDLOG(TRACE) << "Entering CommandHandlerRepository::PopulateCommandHandlers";
