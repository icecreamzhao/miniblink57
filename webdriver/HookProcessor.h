...
enum HookCommunicationType { OneWay = 0, TwoWay = 1 };
...
public:
    ...
    bool PushData(int data_size, void* pointer_to_data);
...
private:
    ...
    bool InstallWindowsHook(const std::string& hook_proc_name, const int hook_proc_type);
