...
public:
    ...
    // IServiceProvider
    STDMETHOD(QueryService)(REFGUID guid_service, REFIID riid, void** object_pointer);

    // ICanHandleException
    STDMETHOD(CanHandleException)(EXCEPINFO* exception_info_pointer, VARIANT* variant_value);
