...
class MBServer : public Server {
public:
    MBServer(int port, const std::string& host, const std::string& log_level, const std::string& log_file, const std::string& version, const std::string& acl);
    virtual ~MBServer(void);
