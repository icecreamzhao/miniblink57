...
STDMETHODIMP ScriptException::QueryService(REFGUID guid_service, REFIID riid, void** object_pointer)
{
    return S_OK;
}

STDMETHODIMP ScriptException::CanHandleException(EXCEPINFO* exception_info_pointer, VARIANT* variant_value)
{
