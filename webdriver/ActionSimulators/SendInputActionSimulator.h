...
private:
    void GetNormalizedCoordinates(HWND window_handle, int x, int y, int* normalized_x, int* normalized_y);
    unsigned long NormalizeButtons(bool is_button_swapped, unsigned long input_flags);
