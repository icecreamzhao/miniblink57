...
int JavaScriptActionSimulator::SimulateActions(BrowserHandle browser_wrapper, std::vector<INPUT> inputs, InputState* input_state)
{
...
int JavaScriptActionSimulator::SimulateKeyDown(BrowserHandle browser_wrapper, INPUT input)
{
    ...
    std::wstring script_source = L"(function() { return function(){" + atoms::asString(atoms::INPUTS_BIN) + L"; return webdriver.atoms.inputs.sendKeys("
        + L"arguments[0], arguments[1], arguments[2], arguments[3]);" + L"};})();";
...
int JavaScriptActionSimulator::SimulatePointerMove(BrowserHandle browser_wrapper, INPUT input)
{
    ...
    std::wstring script_source = L"(function() { return function(){" + atoms::asString(atoms::INPUTS_BIN)
        + L"; return webdriver.atoms.inputs.mouseMove(arguments[0], arguments[1], arguments[2], arguments[3]);" + L"};})();";
...
int JavaScriptActionSimulator::SimulatePointerDown(BrowserHandle browser_wrapper, INPUT input)
{
    LOG(DEBUG) << "Using synthetic events for mouse button down";
    std::wstring script_source = L"(function() { return function(){" + atoms::asString(atoms::INPUTS_BIN)
        + L"; return webdriver.atoms.inputs.mouseButtonDown(arguments[0]);" + L"};})();";
...
int JavaScriptActionSimulator::SimulatePointerUp(BrowserHandle browser_wrapper, INPUT input)
{
    LOG(DEBUG) << "Using synthetic events for mouse button up";
    std::wstring script_source = L"(function() { return function(){" + atoms::asString(atoms::INPUTS_BIN)
        + L"; return webdriver.atoms.inputs.mouseButtonUp(arguments[0]);" + L"};})();";
...
int JavaScriptActionSimulator::SimulatePause(BrowserHandle browser_wrapper, INPUT input)
{
    ::Sleep(input.hi.uMsg);
    return WD_SUCCESS;
}
