...
public:
    ...
    bool is_firing_events(void) const
    {
        return this->is_firing_events_;
    }
    void set_is_firing_events(const bool value)
    {
        this->is_firing_events_ = value;
    }
    ...
    {
        this->is_running_ = value;
    }

    HWND target_window_handle(void) const
    {
        return this->target_window_handle_;
    }
    long x_coordinate(void) const
    {
        return this->x_coordinate_;
    }
    long y_coordinate(void) const
    {
        return this->y_coordinate_;
    }
    WPARAM button_state(void) const
    {
