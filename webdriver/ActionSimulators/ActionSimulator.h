...
public:
    ...
    virtual bool UseExtraInfo(void) const
    {
        return false;
    }

    virtual int SimulateActions(BrowserHandle browser_wrapper, std::vector<INPUT> inputs, InputState* input_state) = 0;
    void UpdateInputState(INPUT current_input, InputState* input_state);
};
