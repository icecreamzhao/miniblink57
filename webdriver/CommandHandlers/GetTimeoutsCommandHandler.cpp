...
#include "webdriver/CommandHandlers/GetTimeoutsCommandHandler.h"
...
void GetTimeoutsCommandHandler::ExecuteInternal(const MBCommandExecutor& executor, const ParametersMap& command_parameters, Response* response)
{
...
//     } else {
//         response_value[SCRIPT_TIMEOUT_NAME] = 15000/*executor.async_script_timeout()*/;
//     }
