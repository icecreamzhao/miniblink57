...
GetElementTagNameCommandHandler::GetElementTagNameCommandHandler(void)
{
}
...
void GetElementTagNameCommandHandler::ExecuteInternal(const IECommandExecutor& executor, const ParametersMap& command_parameters, Response* response)
{
