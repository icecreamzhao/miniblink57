...
IsElementEnabledCommandHandler::IsElementEnabledCommandHandler(void)
{
}
...
void IsElementEnabledCommandHandler::ExecuteInternal(const IECommandExecutor& executor, const ParametersMap& command_parameters, Response* response)
{
