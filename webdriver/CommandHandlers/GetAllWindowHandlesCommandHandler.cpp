...
#include "webdriver/CommandHandlers/GetAllWindowHandlesCommandHandler.h"
...
void GetAllWindowHandlesCommandHandler::ExecuteInternal(const MBCommandExecutor& executor, const ParametersMap& command_parameters, Response* response)
{
