...
#include "webdriver/CommandHandlers/ScreenshotCommandHandler.h"
// #include <atlenc.h>
// #include <atlimage.h>
...
void ScreenshotCommandHandler::ExecuteInternal(const MBCommandExecutor& executor, const ParametersMap& command_parameters, Response* response)
{
    WDLOG(TRACE) << "Entering ScreenshotCommandHandler::ExecuteInternal";
...
// }
// 
// void ScreenshotCommandHandler::CaptureWindow(HWND window_handle, long width, long height)
// {
...
// 
//     BOOL print_result = ::PrintWindow(window_handle, device_context_handle, PW_CLIENTONLY);
//     if (!print_result) {
...
//                 if (first_pixel_red != current_pixel_red || first_pixel_green != current_pixel_green || first_pixel_blue != current_pixel_blue) {
//                     return false;
//                 }
//             }
//         }
...
//     if (!::Base64Encode(global_lock, stream_size, data_array, &length, ATL_BASE64_FLAG_NOCRLF)) {
//         delete[] data_array;
//         ::GlobalUnlock(global_memory_handle);
...
// }
// 
// void ScreenshotCommandHandler::GetWindowDimensions(HWND window_handle, int* width, int* height)
// {
//     RECT window_rect;
...
// }
// 
// void ScreenshotCommandHandler::CropImage(HWND content_window_handle, LocationInfo element_location)
// {
//     RECT viewport_rect;
//     ::GetWindowRect(content_window_handle, &viewport_rect);
//     ::OffsetRect(&viewport_rect, -1 * viewport_rect.left, -1 * viewport_rect.top);
// 
...
// 
//     RECT element_rect
//         = { element_rect_origin.x, element_rect_origin.y, element_rect_origin.x + element_location.width, element_rect_origin.y + element_location.height };
// 
