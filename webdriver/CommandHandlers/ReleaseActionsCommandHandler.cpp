...
#include "webdriver/CommandHandlers/ReleaseActionsCommandHandler.h"
...
void ReleaseActionsCommandHandler::ExecuteInternal(const MBCommandExecutor& executor, const ParametersMap& command_parameters, Response* response)
{
