...
void GetElementValueOfCssPropertyCommandHandler::ExecuteInternal(const IECommandExecutor& executor, const ParametersMap& command_parameters, Response* response)
{
    ...
    if (id_parameter_iterator == command_parameters.end()) {
        ...
        response->SetErrorResponse(ERROR_INVALID_ARGUMENT, "Missing parameter in URL: propertyName");
        return;
    } else {
...
std::string GetElementValueOfCssPropertyCommandHandler::MangleColour(const std::string& property_name, const std::string& to_mangle)
{
