...
#include "webdriver/CommandHandlers/GoToUrlCommandHandler.h"
#include <shlwapi.h>
...
void GoToUrlCommandHandler::ExecuteInternal(const MBCommandExecutor& executor, const ParametersMap& command_parameters, Response* response)
{
...
//             if (FAILED(hr)) {
//                 response->SetErrorResponse(ERROR_INVALID_ARGUMENT, "Specified URL (" + url + ") is a file, " + "but the path was not valid.");
//                 return;
//             } else {
...
//                             "Specified URL (" + url + ") is a directory, " + "and the browser opens directories outside the browser window.");
//                         return;
//                     }
//                 }
//             }
...
//                 "Failed to navigate to " + url + ". This usually means that a call to the COM method "
//                     + "IWebBrowser2::Navigate2() failed. The error returned is: " + error_message);
//             return;
//         }
