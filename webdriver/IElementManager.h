...
public:
    ...
    virtual int GetManagedElement(const std::string& element_id, ElementHandle* element_wrapper) const = 0;
    virtual bool AddManagedElement(IHTMLElement* element, ElementHandle* element_wrapper) = 0;
