...
namespace mojom {
    namespace blink { // static
            ...
            mojo::Message* message)
        {
            ...
            ::device::mojom::blink::SensorClientRequest p_client_request {};
        ...
        void SensorProviderProxy::GetSensor(
            ::device::mojom::blink::SensorType in_type, ::device::mojom::blink::SensorRequest in_sensor_request, const GetSensorCallback& callback)
        {
        ...
        private:
            ...
            void Run(
                SensorInitParamsPtr in_init_params, ::device::mojom::blink::SensorClientRequest in_client_request);
            ...
            mojo::MessageReceiverWithStatus* responder)
        {
            ...
            case internal::kSensorProvider_GetSensor_Name: {
                ...
                ::device::mojom::blink::SensorRequest p_sensor_request {};
