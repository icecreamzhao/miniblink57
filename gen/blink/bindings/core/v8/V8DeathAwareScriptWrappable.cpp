...
// clang-format off
#include "V8DeathAwareScriptWrappable.h"
...
#endif
const WrapperTypeInfo V8DeathAwareScriptWrappable::wrapperTypeInfo = { gin::kEmbedderBlink, V8DeathAwareScriptWrappable::domTemplate, V8DeathAwareScriptWrappable::trace, V8DeathAwareScriptWrappable::traceWrappers, 0, nullptr, "DeathAwareScriptWrappable", 0, WrapperTypeInfo::WrapperTypeObjectPrototype, WrapperTypeInfo::ObjectClassId, WrapperTypeInfo::NotInheritFromActiveScriptWrappable, WrapperTypeInfo::NotInheritFromEventTarget, WrapperTypeInfo::Independent };
#if defined(COMPONENT_BUILD) && defined(WIN32) && COMPILER(CLANG)
...
const WrapperTypeInfo& DeathAwareScriptWrappable::s_wrapperTypeInfo = V8DeathAwareScriptWrappable::wrapperTypeInfo;
...
static void installV8DeathAwareScriptWrappableTemplate(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::FunctionTemplate> interfaceTemplate) {
  // Initialize the interface object's template.
  V8DOMConfiguration::initializeDOMInterfaceTemplate(isolate, interfaceTemplate, V8DeathAwareScriptWrappable::wrapperTypeInfo.interfaceName, v8::Local<v8::FunctionTemplate>(), V8DeathAwareScriptWrappable::internalFieldCount);
