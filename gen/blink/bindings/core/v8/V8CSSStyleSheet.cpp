...
#endif
const WrapperTypeInfo V8CSSStyleSheet::wrapperTypeInfo = { gin::kEmbedderBlink, V8CSSStyleSheet::domTemplate, V8CSSStyleSheet::trace, V8CSSStyleSheet::traceWrappers, V8CSSStyleSheet::visitDOMWrapper, nullptr, "CSSStyleSheet", &V8StyleSheet::wrapperTypeInfo, WrapperTypeInfo::WrapperTypeObjectPrototype, WrapperTypeInfo::ObjectClassId, WrapperTypeInfo::NotInheritFromActiveScriptWrappable, WrapperTypeInfo::NotInheritFromEventTarget, WrapperTypeInfo::Dependent };
#if defined(COMPONENT_BUILD) && defined(WIN32) && COMPILER(CLANG)
