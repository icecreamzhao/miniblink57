...
#endif
const WrapperTypeInfo V8SVGFEFuncAElement::wrapperTypeInfo = { gin::kEmbedderBlink, V8SVGFEFuncAElement::domTemplate, V8SVGFEFuncAElement::trace, V8SVGFEFuncAElement::traceWrappers, 0, nullptr, "SVGFEFuncAElement", &V8SVGComponentTransferFunctionElement::wrapperTypeInfo, WrapperTypeInfo::WrapperTypeObjectPrototype, WrapperTypeInfo::NodeClassId, WrapperTypeInfo::NotInheritFromActiveScriptWrappable, WrapperTypeInfo::InheritFromEventTarget, WrapperTypeInfo::Dependent };
#if defined(COMPONENT_BUILD) && defined(WIN32) && COMPILER(CLANG)
