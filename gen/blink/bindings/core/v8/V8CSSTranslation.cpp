...
#endif
const WrapperTypeInfo V8CSSTranslation::wrapperTypeInfo = { gin::kEmbedderBlink, V8CSSTranslation::domTemplate, V8CSSTranslation::trace, V8CSSTranslation::traceWrappers, 0, nullptr, "CSSTranslation", &V8CSSTransformComponent::wrapperTypeInfo, WrapperTypeInfo::WrapperTypeObjectPrototype, WrapperTypeInfo::ObjectClassId, WrapperTypeInfo::NotInheritFromActiveScriptWrappable, WrapperTypeInfo::NotInheritFromEventTarget, WrapperTypeInfo::Independent };
#if defined(COMPONENT_BUILD) && defined(WIN32) && COMPILER(CLANG)
...
static_assert(
    !std::is_base_of<ActiveScriptWrappableBase, CSSTranslation>::value,
    "CSSTranslation inherits from ActiveScriptWrappable<>, but is not specifying "
