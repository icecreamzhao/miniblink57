...
#endif
const WrapperTypeInfo V8Float32Array::wrapperTypeInfo = { gin::kEmbedderBlink, 0, V8Float32Array::trace, V8Float32Array::traceWrappers, 0, nullptr, "Float32Array", &V8ArrayBufferView::wrapperTypeInfo, WrapperTypeInfo::WrapperTypeObjectPrototype, WrapperTypeInfo::ObjectClassId, WrapperTypeInfo::NotInheritFromActiveScriptWrappable, WrapperTypeInfo::NotInheritFromEventTarget, WrapperTypeInfo::Independent };
#if defined(COMPONENT_BUILD) && defined(WIN32) && COMPILER(CLANG)
