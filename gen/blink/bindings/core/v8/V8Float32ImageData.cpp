...
#endif
const WrapperTypeInfo V8Float32ImageData::wrapperTypeInfo = { gin::kEmbedderBlink, V8Float32ImageData::domTemplate, V8Float32ImageData::trace, V8Float32ImageData::traceWrappers, 0, nullptr, "Float32ImageData", 0, WrapperTypeInfo::WrapperTypeObjectPrototype, WrapperTypeInfo::ObjectClassId, WrapperTypeInfo::NotInheritFromActiveScriptWrappable, WrapperTypeInfo::NotInheritFromEventTarget, WrapperTypeInfo::Independent };
#if defined(COMPONENT_BUILD) && defined(WIN32) && COMPILER(CLANG)
#pragma clang diagnostic pop
#endif

// This static member must be declared by DEFINE_WRAPPERTYPEINFO in Float32ImageData.h.
// For details, see the comment of DEFINE_WRAPPERTYPEINFO in
// bindings/core/v8/ScriptWrappable.h.
const WrapperTypeInfo& Float32ImageData::s_wrapperTypeInfo = V8Float32ImageData::wrapperTypeInfo;

// not [ActiveScriptWrappable]
static_assert(
    !std::is_base_of<ActiveScriptWrappableBase, Float32ImageData>::value,
    "Float32ImageData inherits from ActiveScriptWrappable<>, but is not specifying "
