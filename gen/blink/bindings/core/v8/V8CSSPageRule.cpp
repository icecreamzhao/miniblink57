...
static void styleAttributeGetter(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ...
  const char kKeepAliveKey[] = "KeepAlive#CSSPageRule#style";
...
const V8DOMConfiguration::AccessorConfiguration V8CSSPageRuleAccessors[] = {
    {"selectorText", CSSPageRuleV8Internal::selectorTextAttributeGetterCallback, CSSPageRuleV8Internal::selectorTextAttributeSetterCallback, 0, 0, nullptr, 0, v8::DEFAULT, static_cast<v8::PropertyAttribute>(v8::None), V8DOMConfiguration::OnPrototype, V8DOMConfiguration::CheckHolder},
    {"style", CSSPageRuleV8Internal::styleAttributeGetterCallback, 0, 0, 0, nullptr, 0, v8::DEFAULT, static_cast<v8::PropertyAttribute>(v8::ReadOnly), V8DOMConfiguration::OnPrototype, V8DOMConfiguration::CheckHolder},
};
