...
#endif
const WrapperTypeInfo V8MutationObserver::wrapperTypeInfo = { gin::kEmbedderBlink, V8MutationObserver::domTemplate, V8MutationObserver::trace, V8MutationObserver::traceWrappers, V8MutationObserver::visitDOMWrapper, nullptr, "MutationObserver", 0, WrapperTypeInfo::WrapperTypeObjectPrototype, WrapperTypeInfo::ObjectClassId, WrapperTypeInfo::NotInheritFromActiveScriptWrappable, WrapperTypeInfo::NotInheritFromEventTarget, WrapperTypeInfo::Dependent };
#if defined(COMPONENT_BUILD) && defined(WIN32) && COMPILER(CLANG)
...
static_assert(
    ...
    "MutationObserver inherits from ActiveScriptWrappable<>, but is not specifying "
