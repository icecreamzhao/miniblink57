...
#endif
const WrapperTypeInfo V8StyleSheet::wrapperTypeInfo = { gin::kEmbedderBlink, V8StyleSheet::domTemplate, V8StyleSheet::trace, V8StyleSheet::traceWrappers, V8StyleSheet::visitDOMWrapper, nullptr, "StyleSheet", 0, WrapperTypeInfo::WrapperTypeObjectPrototype, WrapperTypeInfo::ObjectClassId, WrapperTypeInfo::NotInheritFromActiveScriptWrappable, WrapperTypeInfo::NotInheritFromEventTarget, WrapperTypeInfo::Dependent };
#if defined(COMPONENT_BUILD) && defined(WIN32) && COMPILER(CLANG)
