...
#endif
const WrapperTypeInfo V8HTMLTableCaptionElement::wrapperTypeInfo = { gin::kEmbedderBlink, V8HTMLTableCaptionElement::domTemplate, V8HTMLTableCaptionElement::trace, V8HTMLTableCaptionElement::traceWrappers, 0, nullptr, "HTMLTableCaptionElement", &V8HTMLElement::wrapperTypeInfo, WrapperTypeInfo::WrapperTypeObjectPrototype, WrapperTypeInfo::NodeClassId, WrapperTypeInfo::NotInheritFromActiveScriptWrappable, WrapperTypeInfo::InheritFromEventTarget, WrapperTypeInfo::Dependent };
#if defined(COMPONENT_BUILD) && defined(WIN32) && COMPILER(CLANG)
...
const V8DOMConfiguration::AccessorConfiguration V8HTMLTableCaptionElementAccessors[] = {
    {"align", HTMLTableCaptionElementV8Internal::alignAttributeGetterCallback, HTMLTableCaptionElementV8Internal::alignAttributeSetterCallback, 0, 0, nullptr, 0, v8::DEFAULT, static_cast<v8::PropertyAttribute>(v8::None), V8DOMConfiguration::OnPrototype, V8DOMConfiguration::CheckHolder},
};
