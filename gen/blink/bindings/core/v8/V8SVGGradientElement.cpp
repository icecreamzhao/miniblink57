...
#endif
const WrapperTypeInfo V8SVGGradientElement::wrapperTypeInfo = { gin::kEmbedderBlink, V8SVGGradientElement::domTemplate, V8SVGGradientElement::trace, V8SVGGradientElement::traceWrappers, 0, nullptr, "SVGGradientElement", &V8SVGElement::wrapperTypeInfo, WrapperTypeInfo::WrapperTypeObjectPrototype, WrapperTypeInfo::NodeClassId, WrapperTypeInfo::NotInheritFromActiveScriptWrappable, WrapperTypeInfo::InheritFromEventTarget, WrapperTypeInfo::Dependent };
#if defined(COMPONENT_BUILD) && defined(WIN32) && COMPILER(CLANG)
