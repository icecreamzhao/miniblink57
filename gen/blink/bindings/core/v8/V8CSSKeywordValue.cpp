...
#endif
const WrapperTypeInfo V8CSSKeywordValue::wrapperTypeInfo = { gin::kEmbedderBlink, V8CSSKeywordValue::domTemplate, V8CSSKeywordValue::trace, V8CSSKeywordValue::traceWrappers, 0, nullptr, "CSSKeywordValue", &V8CSSStyleValue::wrapperTypeInfo, WrapperTypeInfo::WrapperTypeObjectPrototype, WrapperTypeInfo::ObjectClassId, WrapperTypeInfo::NotInheritFromActiveScriptWrappable, WrapperTypeInfo::NotInheritFromEventTarget, WrapperTypeInfo::Independent };
#if defined(COMPONENT_BUILD) && defined(WIN32) && COMPILER(CLANG)
