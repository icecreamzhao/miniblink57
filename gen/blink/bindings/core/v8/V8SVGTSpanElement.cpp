...
#endif
const WrapperTypeInfo V8SVGTSpanElement::wrapperTypeInfo = { gin::kEmbedderBlink, V8SVGTSpanElement::domTemplate, V8SVGTSpanElement::trace, V8SVGTSpanElement::traceWrappers, 0, nullptr, "SVGTSpanElement", &V8SVGTextPositioningElement::wrapperTypeInfo, WrapperTypeInfo::WrapperTypeObjectPrototype, WrapperTypeInfo::NodeClassId, WrapperTypeInfo::NotInheritFromActiveScriptWrappable, WrapperTypeInfo::InheritFromEventTarget, WrapperTypeInfo::Dependent };
#if defined(COMPONENT_BUILD) && defined(WIN32) && COMPILER(CLANG)
