...
static_assert(
    !std::is_base_of<ActiveScriptWrappableBase, ClientRect>::value,
    "ClientRect inherits from ActiveScriptWrappable<>, but is not specifying "
