...
#endif
const WrapperTypeInfo V8SVGViewElement::wrapperTypeInfo = { gin::kEmbedderBlink, V8SVGViewElement::domTemplate, V8SVGViewElement::trace, V8SVGViewElement::traceWrappers, 0, nullptr, "SVGViewElement", &V8SVGElement::wrapperTypeInfo, WrapperTypeInfo::WrapperTypeObjectPrototype, WrapperTypeInfo::NodeClassId, WrapperTypeInfo::NotInheritFromActiveScriptWrappable, WrapperTypeInfo::InheritFromEventTarget, WrapperTypeInfo::Dependent };
#if defined(COMPONENT_BUILD) && defined(WIN32) && COMPILER(CLANG)
