...
#endif
const WrapperTypeInfo V8ValidityState::wrapperTypeInfo = { gin::kEmbedderBlink, V8ValidityState::domTemplate, V8ValidityState::trace, V8ValidityState::traceWrappers, 0, nullptr, "ValidityState", 0, WrapperTypeInfo::WrapperTypeObjectPrototype, WrapperTypeInfo::ObjectClassId, WrapperTypeInfo::NotInheritFromActiveScriptWrappable, WrapperTypeInfo::NotInheritFromEventTarget, WrapperTypeInfo::Independent };
#if defined(COMPONENT_BUILD) && defined(WIN32) && COMPILER(CLANG)
