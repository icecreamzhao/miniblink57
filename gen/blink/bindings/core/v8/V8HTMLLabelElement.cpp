...
#endif
const WrapperTypeInfo V8HTMLLabelElement::wrapperTypeInfo = { gin::kEmbedderBlink, V8HTMLLabelElement::domTemplate, V8HTMLLabelElement::trace, V8HTMLLabelElement::traceWrappers, 0, nullptr, "HTMLLabelElement", &V8HTMLElement::wrapperTypeInfo, WrapperTypeInfo::WrapperTypeObjectPrototype, WrapperTypeInfo::NodeClassId, WrapperTypeInfo::NotInheritFromActiveScriptWrappable, WrapperTypeInfo::InheritFromEventTarget, WrapperTypeInfo::Dependent };
#if defined(COMPONENT_BUILD) && defined(WIN32) && COMPILER(CLANG)
...
namespace HTMLLabelElementV8Internal {
    ...
    CORE_EXPORT void controlAttributeGetterCallback(const v8::FunctionCallbackInfo<v8::Value>& info)
    {
...
const V8DOMConfiguration::AccessorConfiguration V8HTMLLabelElementAccessors[] = {
    { "form", HTMLLabelElementV8Internal::formAttributeGetterCallback, 0, 0, 0, nullptr, 0, v8::DEFAULT, static_cast<v8::PropertyAttribute>(v8::ReadOnly), V8DOMConfiguration::OnPrototype, V8DOMConfiguration::CheckHolder },
    { "htmlFor", HTMLLabelElementV8Internal::htmlForAttributeGetterCallback, HTMLLabelElementV8Internal::htmlForAttributeSetterCallback, 0, 0, nullptr, 0, v8::DEFAULT, static_cast<v8::PropertyAttribute>(v8::None), V8DOMConfiguration::OnPrototype, V8DOMConfiguration::CheckHolder },
    { "control", HTMLLabelElementV8Internal::controlAttributeGetterCallback, 0, 0, 0, nullptr, 0, v8::DEFAULT, static_cast<v8::PropertyAttribute>(v8::ReadOnly), V8DOMConfiguration::OnPrototype, V8DOMConfiguration::CheckHolder },
};
