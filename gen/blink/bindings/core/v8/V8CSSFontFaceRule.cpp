...
namespace CSSFontFaceRuleV8Internal {
    ...
    static void styleAttributeGetter(const v8::FunctionCallbackInfo<v8::Value>& info)
    {
        ...
        const char kKeepAliveKey[] = "KeepAlive#CSSFontFaceRule#style";
    ...
    {
        UseCounter::count(currentExecutionContext(info.GetIsolate()), UseCounter::V8CSSFontFaceRule_Style_AttributeGetter);
...
const V8DOMConfiguration::AccessorConfiguration V8CSSFontFaceRuleAccessors[] = {
    { "style", CSSFontFaceRuleV8Internal::styleAttributeGetterCallback, 0, 0, 0, nullptr, 0, v8::DEFAULT, static_cast<v8::PropertyAttribute>(v8::ReadOnly), V8DOMConfiguration::OnPrototype, V8DOMConfiguration::CheckHolder },
};
