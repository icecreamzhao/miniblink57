...
#endif
const WrapperTypeInfo V8CSSImportRule::wrapperTypeInfo = { gin::kEmbedderBlink, V8CSSImportRule::domTemplate, V8CSSImportRule::trace, V8CSSImportRule::traceWrappers, 0, nullptr, "CSSImportRule", &V8CSSRule::wrapperTypeInfo, WrapperTypeInfo::WrapperTypeObjectPrototype, WrapperTypeInfo::ObjectClassId, WrapperTypeInfo::NotInheritFromActiveScriptWrappable, WrapperTypeInfo::NotInheritFromEventTarget, WrapperTypeInfo::Dependent };
#if defined(COMPONENT_BUILD) && defined(WIN32) && COMPILER(CLANG)
...
namespace CSSImportRuleV8Internal {
    ...
    static void mediaAttributeGetter(const v8::FunctionCallbackInfo<v8::Value>& info)
    {
        ...
        const char kKeepAliveKey[] = "KeepAlive#CSSImportRule#media";
    ...
    static void styleSheetAttributeGetter(const v8::FunctionCallbackInfo<v8::Value>& info)
    {
        ...
        if (cppValue && DOMDataStore::setReturnValue(info.GetReturnValue(), cppValue))
            return;
        v8::Local<v8::Value> v8Value(ToV8(cppValue, holder, info.GetIsolate()));
        const char kKeepAliveKey[] = "KeepAlive#CSSImportRule#styleSheet";
        V8HiddenValue::setHiddenValue(ScriptState::current(info.GetIsolate()), holder, v8AtomicString(info.GetIsolate(), StringView(kKeepAliveKey, sizeof kKeepAliveKey)), v8Value);

        v8SetReturnValue(info, v8Value);
    }

    CORE_EXPORT void styleSheetAttributeGetterCallback(const v8::FunctionCallbackInfo<v8::Value>& info)
    {
...
const V8DOMConfiguration::AccessorConfiguration V8CSSImportRuleAccessors[] = {
    { "href", CSSImportRuleV8Internal::hrefAttributeGetterCallback, 0, 0, 0, nullptr, 0, v8::DEFAULT, static_cast<v8::PropertyAttribute>(v8::ReadOnly), V8DOMConfiguration::OnPrototype, V8DOMConfiguration::CheckHolder },
    { "media", CSSImportRuleV8Internal::mediaAttributeGetterCallback, 0, 0, 0, nullptr, 0, v8::DEFAULT, static_cast<v8::PropertyAttribute>(v8::ReadOnly), V8DOMConfiguration::OnPrototype, V8DOMConfiguration::CheckHolder },
    { "styleSheet", CSSImportRuleV8Internal::styleSheetAttributeGetterCallback, 0, 0, 0, nullptr, 0, v8::DEFAULT, static_cast<v8::PropertyAttribute>(v8::ReadOnly), V8DOMConfiguration::OnPrototype, V8DOMConfiguration::CheckHolder },
};
