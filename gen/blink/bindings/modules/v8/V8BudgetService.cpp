...
#endif
const WrapperTypeInfo V8BudgetService::wrapperTypeInfo = { gin::kEmbedderBlink, V8BudgetService::domTemplate, V8BudgetService::trace, V8BudgetService::traceWrappers, 0, nullptr, "BudgetService", 0, WrapperTypeInfo::WrapperTypeObjectPrototype, WrapperTypeInfo::ObjectClassId, WrapperTypeInfo::NotInheritFromActiveScriptWrappable, WrapperTypeInfo::NotInheritFromEventTarget, WrapperTypeInfo::Independent };
#if defined(COMPONENT_BUILD) && defined(WIN32) && COMPILER(CLANG)
