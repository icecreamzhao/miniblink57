...
#endif
const WrapperTypeInfo V8PushEvent::wrapperTypeInfo = { gin::kEmbedderBlink, V8PushEvent::domTemplate, V8PushEvent::trace, V8PushEvent::traceWrappers, 0, nullptr, "PushEvent", &V8ExtendableEvent::wrapperTypeInfo, WrapperTypeInfo::WrapperTypeObjectPrototype, WrapperTypeInfo::ObjectClassId, WrapperTypeInfo::NotInheritFromActiveScriptWrappable, WrapperTypeInfo::NotInheritFromEventTarget, WrapperTypeInfo::Independent };
#if defined(COMPONENT_BUILD) && defined(WIN32) && COMPILER(CLANG)
...
namespace PushEventV8Internal {
    ...
    static void dataAttributeGetter(const v8::FunctionCallbackInfo<v8::Value>& info)
    {
        ...
        const char kKeepAliveKey[] = "KeepAlive#PushEvent#data";
    ...
    {
        ExceptionState exceptionState(info.GetIsolate(), ExceptionState::ConstructionContext, "PushEvent");
...
const V8DOMConfiguration::AccessorConfiguration V8PushEventAccessors[] = {
    { "data", PushEventV8Internal::dataAttributeGetterCallback, 0, 0, 0, nullptr, 0, v8::DEFAULT, static_cast<v8::PropertyAttribute>(v8::ReadOnly), V8DOMConfiguration::OnPrototype, V8DOMConfiguration::CheckHolder },
};
