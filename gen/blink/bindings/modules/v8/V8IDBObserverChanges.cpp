...
static void databaseAttributeGetter(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ...
  const char kKeepAliveKey[] = "KeepAlive#IDBObserverChanges#database";
  V8HiddenValue::setHiddenValue(ScriptState::current(info.GetIsolate()), holder, v8AtomicString(info.GetIsolate(), StringView(kKeepAliveKey, sizeof kKeepAliveKey)), v8Value);

  v8SetReturnValue(info, v8Value);
}

MODULES_EXPORT void databaseAttributeGetterCallback(const v8::FunctionCallbackInfo<v8::Value>& info) {
...
static void transactionAttributeGetter(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ...
  if (cppValue && DOMDataStore::setReturnValue(info.GetReturnValue(), cppValue))
    return;
  v8::Local<v8::Value> v8Value(ToV8(cppValue, holder, info.GetIsolate()));
  const char kKeepAliveKey[] = "KeepAlive#IDBObserverChanges#transaction";
  V8HiddenValue::setHiddenValue(ScriptState::current(info.GetIsolate()), holder, v8AtomicString(info.GetIsolate(), StringView(kKeepAliveKey, sizeof kKeepAliveKey)), v8Value);
...
MODULES_EXPORT void recordsAttributeGetterCallback(const v8::FunctionCallbackInfo<v8::Value>& info) {
...
const V8DOMConfiguration::AccessorConfiguration V8IDBObserverChangesAccessors[] = {
    {"database", IDBObserverChangesV8Internal::databaseAttributeGetterCallback, 0, 0, 0, nullptr, 0, v8::DEFAULT, static_cast<v8::PropertyAttribute>(v8::ReadOnly), V8DOMConfiguration::OnPrototype, V8DOMConfiguration::CheckHolder},
    {"transaction", IDBObserverChangesV8Internal::transactionAttributeGetterCallback, 0, 0, 0, nullptr, 0, v8::DEFAULT, static_cast<v8::PropertyAttribute>(v8::ReadOnly), V8DOMConfiguration::OnPrototype, V8DOMConfiguration::CheckHolder},
    {"records", IDBObserverChangesV8Internal::recordsAttributeGetterCallback, 0, 0, 0, nullptr, 0, v8::DEFAULT, static_cast<v8::PropertyAttribute>(v8::ReadOnly), V8DOMConfiguration::OnPrototype, V8DOMConfiguration::CheckHolder},
};
