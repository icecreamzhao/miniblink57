...
// clang-format on
#ifndef V8WaveShaperOptions_h
#define V8WaveShaperOptions_h
...
public:
    MODULES_EXPORT static void toImpl(v8::Isolate*, v8::Local<v8::Value>, WaveShaperOptions&, ExceptionState&);
};
...
template <>
struct NativeValueTraits<WaveShaperOptions> {
    static WaveShaperOptions nativeValue(v8::Isolate*, v8::Local<v8::Value>, ExceptionState&);
};
