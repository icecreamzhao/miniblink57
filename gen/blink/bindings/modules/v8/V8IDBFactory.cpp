...
#endif
const WrapperTypeInfo V8IDBFactory::wrapperTypeInfo = { gin::kEmbedderBlink, V8IDBFactory::domTemplate, V8IDBFactory::trace, V8IDBFactory::traceWrappers, 0, nullptr, "IDBFactory", 0, WrapperTypeInfo::WrapperTypeObjectPrototype, WrapperTypeInfo::ObjectClassId, WrapperTypeInfo::NotInheritFromActiveScriptWrappable, WrapperTypeInfo::NotInheritFromEventTarget, WrapperTypeInfo::Independent };
#if defined(COMPONENT_BUILD) && defined(WIN32) && COMPILER(CLANG)
