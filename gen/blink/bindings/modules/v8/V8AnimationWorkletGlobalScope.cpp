...
// clang-format off
#include "V8AnimationWorkletGlobalScope.h"
...
#endif
const WrapperTypeInfo V8AnimationWorkletGlobalScope::wrapperTypeInfo = { gin::kEmbedderBlink, V8AnimationWorkletGlobalScope::domTemplate, V8AnimationWorkletGlobalScope::trace, V8AnimationWorkletGlobalScope::traceWrappers, 0, nullptr, "AnimationWorkletGlobalScope", &V8WorkletGlobalScope::wrapperTypeInfo, WrapperTypeInfo::WrapperTypeObjectPrototype, WrapperTypeInfo::ObjectClassId, WrapperTypeInfo::NotInheritFromActiveScriptWrappable, WrapperTypeInfo::NotInheritFromEventTarget, WrapperTypeInfo::Independent };
#if defined(COMPONENT_BUILD) && defined(WIN32) && COMPILER(CLANG)
...
const WrapperTypeInfo& AnimationWorkletGlobalScope::s_wrapperTypeInfo = V8AnimationWorkletGlobalScope::wrapperTypeInfo;

// not [ActiveScriptWrappable]
static_assert(
    !std::is_base_of<ActiveScriptWrappableBase, AnimationWorkletGlobalScope>::value,
    "AnimationWorkletGlobalScope inherits from ActiveScriptWrappable<>, but is not specifying "
    "[ActiveScriptWrappable] extended attribute in the IDL file.  "
    "Be consistent.");
static_assert(
    std::is_same<decltype(&AnimationWorkletGlobalScope::hasPendingActivity),
                 decltype(&ScriptWrappable::hasPendingActivity)>::value,
    "AnimationWorkletGlobalScope is overriding hasPendingActivity(), but is not specifying "
    "[ActiveScriptWrappable] extended attribute in the IDL file.  "
    "Be consistent.");
...
static void installV8AnimationWorkletGlobalScopeTemplate(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::FunctionTemplate> interfaceTemplate) {
  // Initialize the interface object's template.
  V8DOMConfiguration::initializeDOMInterfaceTemplate(isolate, interfaceTemplate, V8AnimationWorkletGlobalScope::wrapperTypeInfo.interfaceName, V8WorkletGlobalScope::domTemplate(isolate, world), V8AnimationWorkletGlobalScope::internalFieldCount);
