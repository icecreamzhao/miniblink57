...
// clang-format on
#ifndef V8GainOptions_h
#define V8GainOptions_h
...
class V8GainOptions {
public:
    MODULES_EXPORT static void toImpl(v8::Isolate*, v8::Local<v8::Value>, GainOptions&, ExceptionState&);
};
...
template <>
struct NativeValueTraits<GainOptions> {
    static GainOptions nativeValue(v8::Isolate*, v8::Local<v8::Value>, ExceptionState&);
};
