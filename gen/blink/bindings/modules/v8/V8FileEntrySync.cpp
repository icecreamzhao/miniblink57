...
#endif
const WrapperTypeInfo V8FileEntrySync::wrapperTypeInfo = { gin::kEmbedderBlink, V8FileEntrySync::domTemplate, V8FileEntrySync::trace, V8FileEntrySync::traceWrappers, 0, nullptr, "FileEntrySync", &V8EntrySync::wrapperTypeInfo, WrapperTypeInfo::WrapperTypeObjectPrototype, WrapperTypeInfo::ObjectClassId, WrapperTypeInfo::NotInheritFromActiveScriptWrappable, WrapperTypeInfo::NotInheritFromEventTarget, WrapperTypeInfo::Independent };
#if defined(COMPONENT_BUILD) && defined(WIN32) && COMPILER(CLANG)
