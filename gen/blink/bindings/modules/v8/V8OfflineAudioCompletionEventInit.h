...
template <>
struct NativeValueTraits<OfflineAudioCompletionEventInit> {
    static OfflineAudioCompletionEventInit nativeValue(v8::Isolate*, v8::Local<v8::Value>, ExceptionState&);
};
