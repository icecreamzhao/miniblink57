...
#endif
const WrapperTypeInfo V8WebGLCompressedTexturePVRTC::wrapperTypeInfo = { gin::kEmbedderBlink, V8WebGLCompressedTexturePVRTC::domTemplate, V8WebGLCompressedTexturePVRTC::trace, V8WebGLCompressedTexturePVRTC::traceWrappers, V8WebGLCompressedTexturePVRTC::visitDOMWrapper, nullptr, "WebGLCompressedTexturePVRTC", 0, WrapperTypeInfo::WrapperTypeObjectPrototype, WrapperTypeInfo::ObjectClassId, WrapperTypeInfo::NotInheritFromActiveScriptWrappable, WrapperTypeInfo::NotInheritFromEventTarget, WrapperTypeInfo::Dependent };
#if defined(COMPONENT_BUILD) && defined(WIN32) && COMPILER(CLANG)
