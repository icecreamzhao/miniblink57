...
#endif
const WrapperTypeInfo V8MediaKeys::wrapperTypeInfo = { gin::kEmbedderBlink, V8MediaKeys::domTemplate, V8MediaKeys::trace, V8MediaKeys::traceWrappers, 0, nullptr, "MediaKeys", 0, WrapperTypeInfo::WrapperTypeObjectPrototype, WrapperTypeInfo::ObjectClassId, WrapperTypeInfo::InheritFromActiveScriptWrappable, WrapperTypeInfo::NotInheritFromEventTarget, WrapperTypeInfo::Dependent };
#if defined(COMPONENT_BUILD) && defined(WIN32) && COMPILER(CLANG)
