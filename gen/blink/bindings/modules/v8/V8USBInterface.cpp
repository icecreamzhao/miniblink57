...
#endif
const WrapperTypeInfo V8USBInterface::wrapperTypeInfo = { gin::kEmbedderBlink, V8USBInterface::domTemplate, V8USBInterface::trace, V8USBInterface::traceWrappers, 0, nullptr, "USBInterface", 0, WrapperTypeInfo::WrapperTypeObjectPrototype, WrapperTypeInfo::ObjectClassId, WrapperTypeInfo::NotInheritFromActiveScriptWrappable, WrapperTypeInfo::NotInheritFromEventTarget, WrapperTypeInfo::Independent };
#if defined(COMPONENT_BUILD) && defined(WIN32) && COMPILER(CLANG)
