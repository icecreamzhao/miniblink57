...
// clang-format off
#include "V8GyroscopeReadingInit.h"

#include "bindings/core/v8/ExceptionState.h"

namespace blink {

void V8GyroscopeReadingInit::toImpl(v8::Isolate* isolate, v8::Local<v8::Value> v8Value, GyroscopeReadingInit& impl, ExceptionState& exceptionState) {
...
v8::Local<v8::Value> GyroscopeReadingInit::toV8Impl(v8::Local<v8::Object> creationContext, v8::Isolate* isolate) const {
  v8::Local<v8::Object> v8Object = v8::Object::New(isolate);
  if (!toV8GyroscopeReadingInit(*this, v8Object, creationContext, isolate))
    return v8::Undefined(isolate);
  return v8Object;
}

bool toV8GyroscopeReadingInit(const GyroscopeReadingInit& impl, v8::Local<v8::Object> dictionary, v8::Local<v8::Object> creationContext, v8::Isolate* isolate) {
  if (impl.hasX()) {
...
GyroscopeReadingInit NativeValueTraits<GyroscopeReadingInit>::nativeValue(v8::Isolate* isolate, v8::Local<v8::Value> value, ExceptionState& exceptionState) {
  GyroscopeReadingInit impl;
  V8GyroscopeReadingInit::toImpl(isolate, value, impl, exceptionState);
  return impl;
}
