...
#include "bindings/modules/v8/V8MediaStreamAudioSourceOptions.h"
...
#endif
const WrapperTypeInfo V8MediaStreamAudioSourceNode::wrapperTypeInfo = { gin::kEmbedderBlink, V8MediaStreamAudioSourceNode::domTemplate, V8MediaStreamAudioSourceNode::trace, V8MediaStreamAudioSourceNode::traceWrappers, 0, nullptr, "MediaStreamAudioSourceNode", &V8AudioSourceNode::wrapperTypeInfo, WrapperTypeInfo::WrapperTypeObjectPrototype, WrapperTypeInfo::ObjectClassId, WrapperTypeInfo::NotInheritFromActiveScriptWrappable, WrapperTypeInfo::InheritFromEventTarget, WrapperTypeInfo::Dependent };
#if defined(COMPONENT_BUILD) && defined(WIN32) && COMPILER(CLANG)
...
static_assert(
    ...
    "MediaStreamAudioSourceNode inherits from ActiveScriptWrappable<>, but is not specifying "
