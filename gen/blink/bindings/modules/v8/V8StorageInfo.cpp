...
void V8StorageInfo::toImpl(v8::Isolate* isolate, v8::Local<v8::Value> v8Value, StorageInfo& impl, ExceptionState& exceptionState) {
...
v8::Local<v8::Value> StorageInfo::toV8Impl(v8::Local<v8::Object> creationContext, v8::Isolate* isolate) const {
  v8::Local<v8::Object> v8Object = v8::Object::New(isolate);
  if (!toV8StorageInfo(*this, v8Object, creationContext, isolate))
    return v8::Undefined(isolate);
  return v8Object;
}

bool toV8StorageInfo(const StorageInfo& impl, v8::Local<v8::Object> dictionary, v8::Local<v8::Object> creationContext, v8::Isolate* isolate) {
  if (impl.hasQuota()) {
...
StorageInfo NativeValueTraits<StorageInfo>::nativeValue(v8::Isolate* isolate, v8::Local<v8::Value> value, ExceptionState& exceptionState) {
  StorageInfo impl;
  V8StorageInfo::toImpl(isolate, value, impl, exceptionState);
  return impl;
}
