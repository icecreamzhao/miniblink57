...
#endif
const WrapperTypeInfo V8WebGLVertexArrayObjectOES::wrapperTypeInfo = { gin::kEmbedderBlink, V8WebGLVertexArrayObjectOES::domTemplate, V8WebGLVertexArrayObjectOES::trace, V8WebGLVertexArrayObjectOES::traceWrappers, 0, nullptr, "WebGLVertexArrayObjectOES", 0, WrapperTypeInfo::WrapperTypeObjectPrototype, WrapperTypeInfo::ObjectClassId, WrapperTypeInfo::NotInheritFromActiveScriptWrappable, WrapperTypeInfo::NotInheritFromEventTarget, WrapperTypeInfo::Independent };
#if defined(COMPONENT_BUILD) && defined(WIN32) && COMPILER(CLANG)
