...
#endif
const WrapperTypeInfo V8OESVertexArrayObject::wrapperTypeInfo = { gin::kEmbedderBlink, V8OESVertexArrayObject::domTemplate, V8OESVertexArrayObject::trace, V8OESVertexArrayObject::traceWrappers, V8OESVertexArrayObject::visitDOMWrapper, nullptr, "OESVertexArrayObject", 0, WrapperTypeInfo::WrapperTypeObjectPrototype, WrapperTypeInfo::ObjectClassId, WrapperTypeInfo::NotInheritFromActiveScriptWrappable, WrapperTypeInfo::NotInheritFromEventTarget, WrapperTypeInfo::Dependent };
#if defined(COMPONENT_BUILD) && defined(WIN32) && COMPILER(CLANG)
