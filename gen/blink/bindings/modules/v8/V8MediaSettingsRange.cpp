...
static_assert(
    !std::is_base_of<ActiveScriptWrappableBase, MediaSettingsRange>::value,
    "MediaSettingsRange inherits from ActiveScriptWrappable<>, but is not specifying "
