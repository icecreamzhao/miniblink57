...
namespace DedicatedWorkerGlobalScopePartialV8Internal {
    ...
    {
        ExceptionState exceptionState(info.GetIsolate(), ExceptionState::ExecutionContext, "DedicatedWorkerGlobalScope", "webkitRequestFileSystem");
    ...
    {
        ExceptionState exceptionState(info.GetIsolate(), ExceptionState::ExecutionContext, "DedicatedWorkerGlobalScope", "webkitRequestFileSystemSync");
    ...
    {
        ExceptionState exceptionState(info.GetIsolate(), ExceptionState::ExecutionContext, "DedicatedWorkerGlobalScope", "webkitResolveLocalFileSystemSyncURL");
...
//     }
    ...
    if (RuntimeEnabledFeatures::fileSystemEnabled()) {
        const V8DOMConfiguration::MethodConfiguration webkitRequestFileSystemMethodConfiguration = { "webkitRequestFileSystem", DedicatedWorkerGlobalScopePartialV8Internal::webkitRequestFileSystemMethodCallback, 0, 2, v8::None, V8DOMConfiguration::OnInstance, V8DOMConfiguration::CheckHolder };
    ...
    if (RuntimeEnabledFeatures::fileSystemEnabled()) {
        const V8DOMConfiguration::MethodConfiguration webkitRequestFileSystemSyncMethodConfiguration = { "webkitRequestFileSystemSync", DedicatedWorkerGlobalScopePartialV8Internal::webkitRequestFileSystemSyncMethodCallback, 0, 2, v8::None, V8DOMConfiguration::OnInstance, V8DOMConfiguration::CheckHolder };
    ...
    if (RuntimeEnabledFeatures::fileSystemEnabled()) {
        const V8DOMConfiguration::MethodConfiguration webkitResolveLocalFileSystemURLMethodConfiguration = { "webkitResolveLocalFileSystemURL", DedicatedWorkerGlobalScopePartialV8Internal::webkitResolveLocalFileSystemURLMethodCallback, 0, 2, v8::None, V8DOMConfiguration::OnInstance, V8DOMConfiguration::CheckHolder };
...
// void V8DedicatedWorkerGlobalScopePartial::installServiceWorkerNavigationPreload(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::Object> instance, v8::Local<v8::Object> prototype, v8::Local<v8::Function> interface)
// {
...
// }
// 
// void V8DedicatedWorkerGlobalScopePartial::installServiceWorkerNavigationPreload(ScriptState* scriptState, v8::Local<v8::Object> instance)
// {
