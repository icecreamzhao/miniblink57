...
#endif
const WrapperTypeInfo V8TextDetector::wrapperTypeInfo = { gin::kEmbedderBlink, V8TextDetector::domTemplate, V8TextDetector::trace, V8TextDetector::traceWrappers, 0, nullptr, "TextDetector", 0, WrapperTypeInfo::WrapperTypeObjectPrototype, WrapperTypeInfo::ObjectClassId, WrapperTypeInfo::NotInheritFromActiveScriptWrappable, WrapperTypeInfo::NotInheritFromEventTarget, WrapperTypeInfo::Independent };
#if defined(COMPONENT_BUILD) && defined(WIN32) && COMPILER(CLANG)
...
const WrapperTypeInfo& TextDetector::s_wrapperTypeInfo = V8TextDetector::wrapperTypeInfo;
...
static void detectMethod(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ExceptionState exceptionState(info.GetIsolate(), ExceptionState::ExecutionContext, "TextDetector", "detect");
...
static void constructor(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ...
  TextDetector* impl = TextDetector::create(document);
...
const V8DOMConfiguration::MethodConfiguration V8TextDetectorMethods[] = {
    {"detect", TextDetectorV8Internal::detectMethodCallback, 0, 1, v8::None, V8DOMConfiguration::OnPrototype, V8DOMConfiguration::DoNotCheckHolder},
};
...
static void installV8TextDetectorTemplate(v8::Isolate* isolate, const DOMWrapperWorld& world, v8::Local<v8::FunctionTemplate> interfaceTemplate) {
  // Initialize the interface object's template.
  V8DOMConfiguration::initializeDOMInterfaceTemplate(isolate, interfaceTemplate, V8TextDetector::wrapperTypeInfo.interfaceName, v8::Local<v8::FunctionTemplate>(), V8TextDetector::internalFieldCount);
  ...
  V8DOMConfiguration::installMethods(isolate, world, instanceTemplate, prototypeTemplate, interfaceTemplate, signature, V8TextDetectorMethods, WTF_ARRAY_LENGTH(V8TextDetectorMethods));
}
