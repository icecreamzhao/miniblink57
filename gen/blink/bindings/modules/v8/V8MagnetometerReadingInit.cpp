...
// clang-format off
#include "V8MagnetometerReadingInit.h"

#include "bindings/core/v8/ExceptionState.h"

namespace blink {

void V8MagnetometerReadingInit::toImpl(v8::Isolate* isolate, v8::Local<v8::Value> v8Value, MagnetometerReadingInit& impl, ExceptionState& exceptionState) {
...
v8::Local<v8::Value> MagnetometerReadingInit::toV8Impl(v8::Local<v8::Object> creationContext, v8::Isolate* isolate) const {
  v8::Local<v8::Object> v8Object = v8::Object::New(isolate);
  if (!toV8MagnetometerReadingInit(*this, v8Object, creationContext, isolate))
    return v8::Undefined(isolate);
  return v8Object;
}

bool toV8MagnetometerReadingInit(const MagnetometerReadingInit& impl, v8::Local<v8::Object> dictionary, v8::Local<v8::Object> creationContext, v8::Isolate* isolate) {
  if (impl.hasX()) {
...
MagnetometerReadingInit NativeValueTraits<MagnetometerReadingInit>::nativeValue(v8::Isolate* isolate, v8::Local<v8::Value> value, ExceptionState& exceptionState) {
  MagnetometerReadingInit impl;
  V8MagnetometerReadingInit::toImpl(isolate, value, impl, exceptionState);
  return impl;
}
