...
#endif
const WrapperTypeInfo V8PositionError::wrapperTypeInfo = { gin::kEmbedderBlink, V8PositionError::domTemplate, V8PositionError::trace, V8PositionError::traceWrappers, 0, nullptr, "PositionError", 0, WrapperTypeInfo::WrapperTypeObjectPrototype, WrapperTypeInfo::ObjectClassId, WrapperTypeInfo::NotInheritFromActiveScriptWrappable, WrapperTypeInfo::NotInheritFromEventTarget, WrapperTypeInfo::Independent };
#if defined(COMPONENT_BUILD) && defined(WIN32) && COMPILER(CLANG)
...
static_assert(
    !std::is_base_of<ActiveScriptWrappableBase, PositionError>::value,
    "PositionError inherits from ActiveScriptWrappable<>, but is not specifying "
