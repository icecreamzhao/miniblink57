...
#endif
const WrapperTypeInfo V8USBIsochronousInTransferPacket::wrapperTypeInfo = { gin::kEmbedderBlink, V8USBIsochronousInTransferPacket::domTemplate, V8USBIsochronousInTransferPacket::trace, V8USBIsochronousInTransferPacket::traceWrappers, 0, nullptr, "USBIsochronousInTransferPacket", 0, WrapperTypeInfo::WrapperTypeObjectPrototype, WrapperTypeInfo::ObjectClassId, WrapperTypeInfo::NotInheritFromActiveScriptWrappable, WrapperTypeInfo::NotInheritFromEventTarget, WrapperTypeInfo::Independent };
#if defined(COMPONENT_BUILD) && defined(WIN32) && COMPILER(CLANG)
...
static void dataAttributeGetter(const v8::FunctionCallbackInfo<v8::Value>& info) {
  ...
  const char kKeepAliveKey[] = "KeepAlive#USBIsochronousInTransferPacket#data";
...
const V8DOMConfiguration::AccessorConfiguration V8USBIsochronousInTransferPacketAccessors[] = {
    {"status", USBIsochronousInTransferPacketV8Internal::statusAttributeGetterCallback, 0, 0, 0, nullptr, 0, v8::DEFAULT, static_cast<v8::PropertyAttribute>(v8::ReadOnly), V8DOMConfiguration::OnPrototype, V8DOMConfiguration::CheckHolder},
    {"data", USBIsochronousInTransferPacketV8Internal::dataAttributeGetterCallback, 0, 0, 0, nullptr, 0, v8::DEFAULT, static_cast<v8::PropertyAttribute>(v8::ReadOnly), V8DOMConfiguration::OnPrototype, V8DOMConfiguration::CheckHolder},
};
