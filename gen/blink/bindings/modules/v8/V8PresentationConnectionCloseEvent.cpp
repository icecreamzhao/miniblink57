...
namespace PresentationConnectionCloseEventV8Internal {
    ...
    {
        ExceptionState exceptionState(info.GetIsolate(), ExceptionState::ConstructionContext, "PresentationConnectionCloseEvent");
...
const V8DOMConfiguration::AccessorConfiguration V8PresentationConnectionCloseEventAccessors[] = {
    { "reason", PresentationConnectionCloseEventV8Internal::reasonAttributeGetterCallback, 0, 0, 0, nullptr, 0, v8::DEFAULT, static_cast<v8::PropertyAttribute>(v8::ReadOnly), V8DOMConfiguration::OnPrototype, V8DOMConfiguration::CheckHolder },
    { "message", PresentationConnectionCloseEventV8Internal::messageAttributeGetterCallback, 0, 0, 0, nullptr, 0, v8::DEFAULT, static_cast<v8::PropertyAttribute>(v8::ReadOnly), V8DOMConfiguration::OnPrototype, V8DOMConfiguration::CheckHolder },
};
