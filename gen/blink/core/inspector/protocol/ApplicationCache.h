    ...
    namespace ApplicationCache {
        ...
        public:
            ...
            private:
                ...
                ApplicationCacheResourceBuilder()
                    : m_result(new ApplicationCacheResource())
                {
                }

                template <int STEP>
                ApplicationCacheResourceBuilder<STATE | STEP>& castState()
                {
        ...
        public:
            ...
            private:
                ...
                ApplicationCacheBuilder()
                    : m_result(new ApplicationCache())
                {
                }

                template <int STEP>
                ApplicationCacheBuilder<STATE | STEP>& castState()
                {
        ...
        public:
            ...
            private:
                ...
                FrameWithManifestBuilder()
                    : m_result(new FrameWithManifest())
                {
                }

                template <int STEP>
                FrameWithManifestBuilder<STATE | STEP>& castState()
                {
        ...
        public:
            ...
            private:
                ...
                ApplicationCacheStatusUpdatedNotificationBuilder()
                    : m_result(new ApplicationCacheStatusUpdatedNotification())
                {
                }

                template <int STEP>
                ApplicationCacheStatusUpdatedNotificationBuilder<STATE | STEP>& castState()
                {
        ...
        public:
            ...
            private:
                ...
                NetworkStateUpdatedNotificationBuilder()
                    : m_result(new NetworkStateUpdatedNotification())
                {
                }

                template <int STEP>
                NetworkStateUpdatedNotificationBuilder<STATE | STEP>& castState()
                {
