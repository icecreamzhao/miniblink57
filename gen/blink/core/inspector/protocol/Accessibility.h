...
namespace protocol {
    namespace Accessibility {
        ...
        using AXGlobalStates = String;
        // Attributes which apply to nodes in live regions.
        using AXLiveRegionAttributes = String;
        // Attributes which apply to widgets.
        using AXWidgetAttributes = String;
        // States which apply to widgets.
        using AXWidgetStates = String;
        // Relationships between elements other than parent/child/sibling.
        using AXRelationshipAttributes = String;
        ...
        public:
            ...
            private:
                ...
                template <int STEP>
                AXValueSourceBuilder<STATE | STEP>& castState()
                {
        ...
        public:
            ...
            private:
                ...
                template <int STEP>
                AXRelatedNodeBuilder<STATE | STEP>& castState()
                {
        ...
        public:
            ...
            private:
                ...
                template <int STEP>
                AXPropertyBuilder<STATE | STEP>& castState()
                {
        ...
        public:
            ...
            private:
                ...
                template <int STEP>
                AXValueBuilder<STATE | STEP>& castState()
                {
        ...
        public:
            ...
            private:
                ...
                template <int STEP>
                AXNodeBuilder<STATE | STEP>& castState()
                {
        ...
        public:
            ...
            virtual DispatchResponse getPartialAXTree(int in_nodeId, Maybe<bool> in_fetchRelatives, std::unique_ptr<protocol::Array<protocol::Accessibility::AXNode>>* out_nodes) = 0;
