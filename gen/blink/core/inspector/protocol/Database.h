    ...
    namespace Database {
        ...
        public:
            ...
            private:
                ...
                template <int STEP>
                DatabaseBuilder<STATE | STEP>& castState()
                {
        ...
        public:
            ...
            private:
                ...
                template <int STEP>
                ErrorBuilder<STATE | STEP>& castState()
                {
        ...
        public:
            ...
            private:
                ...
                AddDatabaseNotificationBuilder()
                    : m_result(new AddDatabaseNotification())
                {
                }

                template <int STEP>
                AddDatabaseNotificationBuilder<STATE | STEP>& castState()
                {
