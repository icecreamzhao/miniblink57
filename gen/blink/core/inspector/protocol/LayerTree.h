    ...
    namespace LayerTree {
        ...
        public:
            ...
            private:
                ...
                template <int STEP>
                ScrollRectBuilder<STATE | STEP>& castState()
                {
        ...
        public:
            ...
            private:
                ...
                template <int STEP>
                PictureTileBuilder<STATE | STEP>& castState()
                {
        ...
        public:
            ...
            private:
                ...
                template <int STEP>
                LayerBuilder<STATE | STEP>& castState()
                {
        ...
        public:
            ...
            private:
                ...
                LayerTreeDidChangeNotificationBuilder()
                    : m_result(new LayerTreeDidChangeNotification())
                {
                }

                template <int STEP>
                LayerTreeDidChangeNotificationBuilder<STATE | STEP>& castState()
                {
        ...
        public:
            ...
            private:
                ...
                LayerPaintedNotificationBuilder()
                    : m_result(new LayerPaintedNotification())
                {
                }

                template <int STEP>
                LayerPaintedNotificationBuilder<STATE | STEP>& castState()
                {
