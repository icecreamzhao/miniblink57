...
namespace protocol {
    namespace Log {
        ...
        // Log entry.
        class CORE_EXPORT LogEntry : public Serializable {
        ...
        public:
            ...
            public:
                ...
                LogEntryBuilder<STATE>& setStackTrace(std::unique_ptr<v8_inspector::protocol::Runtime::API::StackTrace> value)
                {
            ...
            private:
                ...
                LogEntryBuilder()
                    : m_result(new LogEntry())
                {
                }

                template <int STEP>
                LogEntryBuilder<STATE | STEP>& castState()
                {
        ...
        private:
            ...
            Maybe<v8_inspector::protocol::Runtime::API::StackTrace> m_stackTrace;
            Maybe<String> m_networkRequestId;
            Maybe<String> m_workerId;
        };

        // Violation configuration setting.
        class CORE_EXPORT ViolationSetting : public Serializable {
        ...
        public:
            ...
            private:
                ...
                ViolationSettingBuilder()
                    : m_result(new ViolationSetting())
                {
                }

                template <int STEP>
                ViolationSettingBuilder<STATE | STEP>& castState()
                {
        ...
        // Wrapper for notification params
        class CORE_EXPORT EntryAddedNotification : public Serializable {
        ...
        public:
            ...
            private:
                ...
                EntryAddedNotificationBuilder()
                    : m_result(new EntryAddedNotification())
                {
                }

                template <int STEP>
                EntryAddedNotificationBuilder<STATE | STEP>& castState()
                {
