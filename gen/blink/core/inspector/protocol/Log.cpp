    ...
    namespace Log {
        ...
        std::unique_ptr<LogEntry> LogEntry::fromValue(protocol::Value* value, ErrorSupport* errors)
        {
            ...
            if (stackTraceValue) {
                ...
                result->m_stackTrace = ValueConversions<v8_inspector::protocol::Runtime::API::StackTrace>::fromValue(stackTraceValue, errors);
            }
        ...
        std::unique_ptr<protocol::DictionaryValue> LogEntry::toValue() const
        {
            ...
            if (m_stackTrace.isJust())
                result->setValue("stackTrace", ValueConversions<v8_inspector::protocol::Runtime::API::StackTrace>::toValue(m_stackTrace.fromJust()));
