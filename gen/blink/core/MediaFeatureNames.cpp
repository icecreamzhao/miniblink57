...
namespace MediaFeatureNames {
    ...
    const AtomicString& shapeMediaFeature = reinterpret_cast<AtomicString*>(&NamesStorage)[41];
    const AtomicString& widthMediaFeature = reinterpret_cast<AtomicString*>(&NamesStorage)[42];
