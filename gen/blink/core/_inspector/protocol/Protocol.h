...
#ifndef blink_protocol_Collections_h
#define blink_protocol_Collections_h
...
#endif // !defined(blink_protocol_Collections_h)

// Copyright 2016 The Chromium Authors. All rights reserved.
// Use of this source code is governed by a BSD-style license that can be
// found in the LICENSE file.

#ifndef blink_protocol_ErrorSupport_h
#define blink_protocol_ErrorSupport_h
...
namespace protocol {
    ...
    class CORE_EXPORT ErrorSupport {
    public:
        ErrorSupport();
        ~ErrorSupport();
...
#endif // !defined(blink_protocol_ErrorSupport_h)
...
namespace protocol {
    ...
    class CORE_EXPORT SerializedValue : public Value {
    public:
...
#ifndef blink_protocol_Maybe_h
#define blink_protocol_Maybe_h
...
#endif // !defined(blink_protocol_Maybe_h)

// Copyright 2016 The Chromium Authors. All rights reserved.
// Use of this source code is governed by a BSD-style license that can be
// found in the LICENSE file.

#ifndef blink_protocol_Array_h
#define blink_protocol_Array_h
...
#endif // !defined(blink_protocol_Array_h)

// Copyright 2016 The Chromium Authors. All rights reserved.
// Use of this source code is governed by a BSD-style license that can be
// found in the LICENSE file.

#ifndef blink_protocol_DispatcherBase_h
#define blink_protocol_DispatcherBase_h
...
namespace protocol {
    ...
    class CORE_EXPORT DispatchResponse {
    public:
        enum Status {
            kSuccess = 0,
            kError = 1,
    ...
    class CORE_EXPORT DispatcherBase {
        PROTOCOL_DISALLOW_COPY(DispatcherBase);

    public:
        static const char kInvalidParamsString[];
        class CORE_EXPORT WeakPtr {
        public:
    ...
    class CORE_EXPORT UberDispatcher {
...
#endif // !defined(blink_protocol_DispatcherBase_h)

// Copyright 2016 The Chromium Authors. All rights reserved.
// Use of this source code is governed by a BSD-style license that can be
// found in the LICENSE file.

#ifndef blink_protocol_Parser_h
#define blink_protocol_Parser_h
...
namespace protocol {
    ...
    CORE_EXPORT std::unique_ptr<Value> parseJSONCharacters(const uint8_t*, unsigned);
    CORE_EXPORT std::unique_ptr<Value> parseJSONCharacters(const uint16_t*, unsigned);

} // namespace blink
} // namespace protocol

#endif // !defined(blink_protocol_Parser_h)
