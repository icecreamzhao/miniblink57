...
namespace protocol {
    namespace CSS {
        ...
        // CSS rule collection for a single pseudo style.
        class CORE_EXPORT PseudoElementMatches : public Serializable {
        ...
        public:
            ...
            private:
                ...
                template <int STEP>
                PseudoElementMatchesBuilder<STATE | STEP>& castState()
                {
        ...
        // Inherited CSS rule collection from ancestor node.
        class CORE_EXPORT InheritedStyleEntry : public Serializable {
        ...
        public:
            ...
            private:
                ...
                template <int STEP>
                InheritedStyleEntryBuilder<STATE | STEP>& castState()
                {
        ...
        // Match data for a CSS rule.
        class CORE_EXPORT RuleMatch : public Serializable {
        ...
        public:
            ...
            private:
                ...
                template <int STEP>
                RuleMatchBuilder<STATE | STEP>& castState()
                {
        ...
        public:
            ...
            private:
                ...
                template <int STEP>
                ValueBuilder<STATE | STEP>& castState()
                {
        ...
        // Selector list data.
        class CORE_EXPORT SelectorList : public Serializable {
        ...
        public:
            ...
            private:
                ...
                template <int STEP>
                SelectorListBuilder<STATE | STEP>& castState()
                {
        ...
        // CSS stylesheet metainformation.
        class CORE_EXPORT CSSStyleSheetHeader : public Serializable {
        ...
        public:
            ...
            private:
                ...
                template <int STEP>
                CSSStyleSheetHeaderBuilder<STATE | STEP>& castState()
                {
        ...
        // CSS rule representation.
        class CORE_EXPORT CSSRule : public Serializable {
        ...
        public:
            ...
            private:
                ...
                template <int STEP>
                CSSRuleBuilder<STATE | STEP>& castState()
                {
        ...
        // CSS rule usage information.
        class CORE_EXPORT RuleUsage : public Serializable {
        ...
        public:
            ...
            public:
                enum {
                    ...
                    RangeSet = 1 << 2,
                    UsedSet = 1 << 3,
                    AllFieldsSet = (StyleSheetIdSet | RangeSet | UsedSet | 0)
                };
                ...
                RuleUsageBuilder<STATE | RangeSet>& setRange(std::unique_ptr<protocol::CSS::SourceRange> value)
                {
            ...
            private:
                ...
                template <int STEP>
                RuleUsageBuilder<STATE | STEP>& castState()
                {
        ...
        // Text range within a resource. All numbers are zero-based.
        class CORE_EXPORT SourceRange : public Serializable {
        ...
        public:
            ...
            private:
                ...
                template <int STEP>
                SourceRangeBuilder<STATE | STEP>& castState()
                {
        ...
        //
        class CORE_EXPORT ShorthandEntry : public Serializable {
        ...
        public:
            ...
            private:
                ...
                template <int STEP>
                ShorthandEntryBuilder<STATE | STEP>& castState()
                {
        ...
        //
        class CORE_EXPORT CSSComputedStyleProperty : public Serializable {
        ...
        public:
            ...
            private:
                ...
                template <int STEP>
                CSSComputedStylePropertyBuilder<STATE | STEP>& castState()
                {
        ...
        // CSS style representation.
        class CORE_EXPORT CSSStyle : public Serializable {
        ...
        public:
            ...
            private:
                ...
                template <int STEP>
                CSSStyleBuilder<STATE | STEP>& castState()
                {
        ...
        // CSS property declaration data.
        class CORE_EXPORT CSSProperty : public Serializable {
        ...
        public:
            ...
            private:
                ...
                template <int STEP>
                CSSPropertyBuilder<STATE | STEP>& castState()
                {
        ...
        // CSS media rule descriptor.
        class CORE_EXPORT CSSMedia : public Serializable {
        ...
        public:
            ...
            private:
                ...
                template <int STEP>
                CSSMediaBuilder<STATE | STEP>& castState()
                {
        ...
        // Media query descriptor.
        class CORE_EXPORT MediaQuery : public Serializable {
        ...
        public:
            ...
            private:
                ...
                template <int STEP>
                MediaQueryBuilder<STATE | STEP>& castState()
                {
        ...
        // Media query expression descriptor.
        class CORE_EXPORT MediaQueryExpression : public Serializable {
        ...
        public:
            ...
            private:
                ...
                template <int STEP>
                MediaQueryExpressionBuilder<STATE | STEP>& castState()
                {
        ...
        // Information about amount of glyphs that were rendered with given font.
        class CORE_EXPORT PlatformFontUsage : public Serializable {
        ...
        public:
            ...
            private:
                ...
                template <int STEP>
                PlatformFontUsageBuilder<STATE | STEP>& castState()
                {
        ...
        // CSS keyframes rule representation.
        class CORE_EXPORT CSSKeyframesRule : public Serializable {
        ...
        public:
            ...
            private:
                ...
                template <int STEP>
                CSSKeyframesRuleBuilder<STATE | STEP>& castState()
                {
        ...
        // CSS keyframe rule representation.
        class CORE_EXPORT CSSKeyframeRule : public Serializable {
        ...
        public:
            ...
            private:
                ...
                template <int STEP>
                CSSKeyframeRuleBuilder<STATE | STEP>& castState()
                {
        ...
        // A descriptor of operation to mutate style declaration text.
        class CORE_EXPORT StyleDeclarationEdit : public Serializable {
        ...
        public:
            ...
            private:
                ...
                template <int STEP>
                StyleDeclarationEditBuilder<STATE | STEP>& castState()
                {
        ...
        public:
            ...
            private:
                ...
                template <int STEP>
                InlineTextBoxBuilder<STATE | STEP>& castState()
                {
                    return *reinterpret_cast<InlineTextBoxBuilder<STATE | STEP>*>(this);
                }

                std::unique_ptr<protocol::CSS::InlineTextBox> m_result;
            };
        ...
        public:
            ...
            protocol::Array<protocol::CSS::InlineTextBox>* getInlineTextNodes(protocol::Array<protocol::CSS::InlineTextBox>* defaultValue) { return m_inlineTextNodes.isJust() ? m_inlineTextNodes.fromJust() : defaultValue; }
            void setInlineTextNodes(std::unique_ptr<protocol::Array<protocol::CSS::InlineTextBox>> value) { m_inlineTextNodes = std::move(value); }
            ...
            public:
                enum {
                    ...
                    NodeIdSet = 1 << 1,
                    BoundingBoxSet = 1 << 2,
                    AllFieldsSet = (NodeIdSet | BoundingBoxSet | 0)
                };

                LayoutTreeNodeBuilder<STATE | NodeIdSet>& setNodeId(int value)
                {
                ...
                LayoutTreeNodeBuilder<STATE>& setInlineTextNodes(std::unique_ptr<protocol::Array<protocol::CSS::InlineTextBox>> value)
                {
            ...
            private:
                ...
                template <int STEP>
                LayoutTreeNodeBuilder<STATE | STEP>& castState()
                {
                    return *reinterpret_cast<LayoutTreeNodeBuilder<STATE | STEP>*>(this);
                }

                std::unique_ptr<protocol::CSS::LayoutTreeNode> m_result;
            };
        ...
        private:
            ...
            Maybe<protocol::Array<protocol::CSS::InlineTextBox>> m_inlineTextNodes;
        ...
        public:
            ...
            protocol::Array<protocol::CSS::CSSComputedStyleProperty>* getProperties() { return m_properties.get(); }
            void setProperties(std::unique_ptr<protocol::Array<protocol::CSS::CSSComputedStyleProperty>> value) { m_properties = std::move(value); }
            ...
            public:
                ...
                ComputedStyleBuilder<STATE | PropertiesSet>& setProperties(std::unique_ptr<protocol::Array<protocol::CSS::CSSComputedStyleProperty>> value)
                {
            ...
            private:
                ...
                template <int STEP>
                ComputedStyleBuilder<STATE | STEP>& castState()
                {
                    return *reinterpret_cast<ComputedStyleBuilder<STATE | STEP>*>(this);
                }

                std::unique_ptr<protocol::CSS::ComputedStyle> m_result;
            };
        ...
        private:
            ...
            std::unique_ptr<protocol::Array<protocol::CSS::CSSComputedStyleProperty>> m_properties;
        };

        // Wrapper for notification params
        class CORE_EXPORT StyleSheetChangedNotification : public Serializable {
        ...
        public:
            ...
            private:
                ...
                StyleSheetChangedNotificationBuilder()
                    : m_result(new StyleSheetChangedNotification())
                {
                }

                template <int STEP>
                StyleSheetChangedNotificationBuilder<STATE | STEP>& castState()
                {
        ...
        // Wrapper for notification params
        class CORE_EXPORT StyleSheetAddedNotification : public Serializable {
        ...
        public:
            ...
            private:
                ...
                StyleSheetAddedNotificationBuilder()
                    : m_result(new StyleSheetAddedNotification())
                {
                }

                template <int STEP>
                StyleSheetAddedNotificationBuilder<STATE | STEP>& castState()
                {
        ...
        // Wrapper for notification params
        class CORE_EXPORT StyleSheetRemovedNotification : public Serializable {
        ...
        public:
            ...
            private:
                ...
                StyleSheetRemovedNotificationBuilder()
                    : m_result(new StyleSheetRemovedNotification())
                {
                }

                template <int STEP>
                StyleSheetRemovedNotificationBuilder<STATE | STEP>& castState()
                {
        ...
        public:
            ...
            virtual DispatchResponse getBackgroundColors(int in_nodeId, Maybe<protocol::Array<String>>* out_backgroundColors) = 0;
            virtual DispatchResponse getLayoutTreeAndStyles(std::unique_ptr<protocol::Array<String>> in_computedStyleWhitelist, std::unique_ptr<protocol::Array<protocol::CSS::LayoutTreeNode>>* out_layoutTreeNodes, std::unique_ptr<protocol::Array<protocol::CSS::ComputedStyle>>* out_computedStyles) = 0;
