...
namespace protocol {
    namespace Target {
        ...
        //
        class CORE_EXPORT RemoteLocation : public Serializable {
        ...
        // Wrapper for notification params
        class CORE_EXPORT TargetCreatedNotification : public Serializable {
        ...
        // Wrapper for notification params
        class CORE_EXPORT TargetDestroyedNotification : public Serializable {
