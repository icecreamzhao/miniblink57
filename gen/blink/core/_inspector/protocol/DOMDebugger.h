...
namespace protocol {
    namespace DOMDebugger {
        ...
        public:
            ...
            v8_inspector::protocol::Runtime::API::RemoteObject* getRemoveFunction(v8_inspector::protocol::Runtime::API::RemoteObject* defaultValue) { return m_removeFunction.isJust() ? m_removeFunction.fromJust() : defaultValue; }
            void setRemoveFunction(std::unique_ptr<v8_inspector::protocol::Runtime::API::RemoteObject> value) { m_removeFunction = std::move(value); }
            ...
            public:
                ...
                EventListenerBuilder<STATE>& setRemoveFunction(std::unique_ptr<v8_inspector::protocol::Runtime::API::RemoteObject> value)
                {
            ...
            private:
                ...
                EventListenerBuilder()
                    : m_result(new EventListener())
                {
                }

                template <int STEP>
                EventListenerBuilder<STATE | STEP>& castState()
                {
        ...
        private:
            ...
            Maybe<v8_inspector::protocol::Runtime::API::RemoteObject> m_removeFunction;
        };
        ...
        public:
            ...
            virtual DispatchResponse getEventListeners(const String& in_objectId, std::unique_ptr<protocol::Array<protocol::DOMDebugger::EventListener>>* out_listeners) = 0;
