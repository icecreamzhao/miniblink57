...
namespace mojom {
    namespace blink { // static
        SurfaceInfoPtr SurfaceInfo::New()
        {
            SurfaceInfoPtr rv;
            mojo::internal::StructHelper<SurfaceInfo>::Initialize(&rv);
            return rv;
        }
...
// static
bool StructTraits<::cc::mojom::blink::SurfaceInfo::DataView, ::cc::mojom::blink::SurfaceInfoPtr>::Read(
    ::cc::mojom::blink::SurfaceInfo::DataView input,
    ::cc::mojom::blink::SurfaceInfoPtr* output)
{
    bool success = true;
    ::cc::mojom::blink::SurfaceInfoPtr result(::cc::mojom::blink::SurfaceInfo::New());
