...
// static
bool StructTraits<::cc::mojom::blink::FilterOperation::DataView, ::cc::mojom::blink::FilterOperationPtr>::Read(
    ::cc::mojom::blink::FilterOperation::DataView input,
    ::cc::mojom::blink::FilterOperationPtr* output)
{
    bool success = true;
    ::cc::mojom::blink::FilterOperationPtr result(::cc::mojom::blink::FilterOperation::New());
