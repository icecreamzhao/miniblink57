...
// static
bool StructTraits<::cc::mojom::LocalFrameId::DataView, ::cc::mojom::LocalFrameIdPtr>::Read(
    ::cc::mojom::LocalFrameId::DataView input,
    ::cc::mojom::LocalFrameIdPtr* output)
{
    bool success = true;
    ::cc::mojom::LocalFrameIdPtr result(::cc::mojom::LocalFrameId::New());
