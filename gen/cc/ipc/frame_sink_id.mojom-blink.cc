...
// static
bool StructTraits<::cc::mojom::blink::FrameSinkId::DataView, ::cc::mojom::blink::FrameSinkIdPtr>::Read(
    ::cc::mojom::blink::FrameSinkId::DataView input,
    ::cc::mojom::blink::FrameSinkIdPtr* output)
{
    bool success = true;
    ::cc::mojom::blink::FrameSinkIdPtr result(::cc::mojom::blink::FrameSinkId::New());
