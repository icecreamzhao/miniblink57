...
#ifndef CC_IPC_SURFACE_SEQUENCE_MOJOM_SHARED_H_
#define CC_IPC_SURFACE_SEQUENCE_MOJOM_SHARED_H_
...
namespace internal {
    ...
    template <>
    struct MojomTypeTraits<::cc::mojom::SurfaceSequenceDataView> {
        using Data = ::cc::mojom::internal::SurfaceSequence_Data;
...
namespace internal {
    ...
    struct Serializer<::cc::mojom::SurfaceSequenceDataView, MaybeConstUserType> {
        using UserType = typename std::remove_const<MaybeConstUserType>::type;
        using Traits = StructTraits<::cc::mojom::SurfaceSequenceDataView, UserType>;
            ...
            SerializationContext* context)
        {
            ...
            auto result = ::cc::mojom::internal::SurfaceSequence_Data::New(buffer);
            ...
            MOJO_INTERNAL_DLOG_SERIALIZATION_WARNING(
                ...
                "null frame_sink_id in SurfaceSequence struct");
...
namespace mojom {
    ...
    inline void SurfaceSequenceDataView::GetFrameSinkIdDataView(
        ::cc::mojom::FrameSinkIdDataView* output)
    {
        auto pointer = data_->frame_sink_id.Get();
...
#endif // CC_IPC_SURFACE_SEQUENCE_MOJOM_SHARED_H_
