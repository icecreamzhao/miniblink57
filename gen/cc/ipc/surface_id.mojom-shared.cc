    ...
    namespace internal {
            ...
            mojo::internal::ValidationContext* validation_context)
        {
            ...
            if (!mojo::internal::ValidatePointerNonNullable(
                    object->frame_sink_id, "null frame_sink_id field in SurfaceId",
                    validation_context)) {
                return false;
            }
            ...
            if (!mojo::internal::ValidatePointerNonNullable(
                    object->local_frame_id, "null local_frame_id field in SurfaceId",
                    validation_context)) {
                return false;
            }
            if (!mojo::internal::ValidateStruct(object->local_frame_id, validation_context))
                return false;
