...
// static
bool StructTraits<::cc::mojom::blink::TransferableResource::DataView, ::cc::mojom::blink::TransferableResourcePtr>::Read(
    ::cc::mojom::blink::TransferableResource::DataView input,
    ::cc::mojom::blink::TransferableResourcePtr* output)
{
    bool success = true;
    ::cc::mojom::blink::TransferableResourcePtr result(::cc::mojom::blink::TransferableResource::New());
