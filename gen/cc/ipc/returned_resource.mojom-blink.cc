...
// static
bool StructTraits<::cc::mojom::blink::ReturnedResource::DataView, ::cc::mojom::blink::ReturnedResourcePtr>::Read(
    ::cc::mojom::blink::ReturnedResource::DataView input,
    ::cc::mojom::blink::ReturnedResourcePtr* output)
{
    bool success = true;
    ::cc::mojom::blink::ReturnedResourcePtr result(::cc::mojom::blink::ReturnedResource::New());
...
// static
bool StructTraits<::cc::mojom::blink::ReturnedResourceArray::DataView, ::cc::mojom::blink::ReturnedResourceArrayPtr>::Read(
    ::cc::mojom::blink::ReturnedResourceArray::DataView input,
    ::cc::mojom::blink::ReturnedResourceArrayPtr* output)
{
    bool success = true;
    ::cc::mojom::blink::ReturnedResourceArrayPtr result(::cc::mojom::blink::ReturnedResourceArray::New());
