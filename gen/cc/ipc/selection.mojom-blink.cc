...
namespace mojom {
    namespace blink { // static
        ...
        size_t Selection::Hash(size_t seed) const
        {
            seed = mojo::internal::WTFHash(seed, this->start);
            seed = mojo::internal::WTFHash(seed, this->end);
            seed = mojo::internal::WTFHash(seed, this->is_editable);
            seed = mojo::internal::WTFHash(seed, this->is_empty_text_form_control);
            return seed;
        }
    } // namespace blink
} // namespace mojom
...
// static
bool StructTraits<::cc::mojom::blink::Selection::DataView, ::cc::mojom::blink::SelectionPtr>::Read(
    ::cc::mojom::blink::Selection::DataView input,
    ::cc::mojom::blink::SelectionPtr* output)
{
    bool success = true;
    ::cc::mojom::blink::SelectionPtr result(::cc::mojom::blink::Selection::New());
