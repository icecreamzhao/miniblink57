...
// static
bool StructTraits<::cc::mojom::SurfaceInfo::DataView, ::cc::mojom::SurfaceInfoPtr>::Read(
    ::cc::mojom::SurfaceInfo::DataView input,
    ::cc::mojom::SurfaceInfoPtr* output)
{
    bool success = true;
    ::cc::mojom::SurfaceInfoPtr result(::cc::mojom::SurfaceInfo::New());
