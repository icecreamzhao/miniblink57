...
// static
bool StructTraits<::cc::mojom::blink::SharedQuadState::DataView, ::cc::mojom::blink::SharedQuadStatePtr>::Read(
    ::cc::mojom::blink::SharedQuadState::DataView input,
    ::cc::mojom::blink::SharedQuadStatePtr* output)
{
    bool success = true;
    ::cc::mojom::blink::SharedQuadStatePtr result(::cc::mojom::blink::SharedQuadState::New());
