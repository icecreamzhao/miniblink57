...
namespace mojom { // static
    FrameSinkIdPtr FrameSinkId::New()
    {
        FrameSinkIdPtr rv;
        mojo::internal::StructHelper<FrameSinkId>::Initialize(&rv);
        return rv;
    }
...
// static
bool StructTraits<::cc::mojom::FrameSinkId::DataView, ::cc::mojom::FrameSinkIdPtr>::Read(
    ::cc::mojom::FrameSinkId::DataView input,
    ::cc::mojom::FrameSinkIdPtr* output)
{
    bool success = true;
    ::cc::mojom::FrameSinkIdPtr result(::cc::mojom::FrameSinkId::New());
