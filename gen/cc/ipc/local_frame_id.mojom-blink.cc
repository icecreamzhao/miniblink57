...
namespace mojom {
    namespace blink { // static
        LocalFrameIdPtr LocalFrameId::New()
        {
            LocalFrameIdPtr rv;
            mojo::internal::StructHelper<LocalFrameId>::Initialize(&rv);
            return rv;
        }
...
// static
bool StructTraits<::cc::mojom::blink::LocalFrameId::DataView, ::cc::mojom::blink::LocalFrameIdPtr>::Read(
    ::cc::mojom::blink::LocalFrameId::DataView input,
    ::cc::mojom::blink::LocalFrameIdPtr* output)
{
    bool success = true;
    ::cc::mojom::blink::LocalFrameIdPtr result(::cc::mojom::blink::LocalFrameId::New());

    result->local_id = input.local_id();
    if (!input.ReadNonce(&result->nonce))
        success = false;
