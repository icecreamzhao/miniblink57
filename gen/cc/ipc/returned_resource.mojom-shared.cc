...
namespace mojom {
    ...
    namespace internal {
        ...
        // static
        bool ReturnedResourceArray_Data::Validate(
            const void* data,
            mojo::internal::ValidationContext* validation_context)
        {
            if (!data)
            ...
            // NOTE: The memory backing |object| may be smaller than |sizeof(*object)| if
            // the message comes from an older version.
            const ReturnedResourceArray_Data* object = static_cast<const ReturnedResourceArray_Data*>(data);
            ...
            if (!mojo::internal::ValidatePointerNonNullable(
                    object->returned_resources, "null returned_resources field in ReturnedResourceArray",
                    validation_context)) {
                return false;
            }
            const mojo::internal::ContainerValidateParams returned_resources_validate_params(
                0, false, nullptr);
            if (!mojo::internal::ValidateContainer(object->returned_resources, validation_context,
                    &returned_resources_validate_params)) {
                return false;
            }
