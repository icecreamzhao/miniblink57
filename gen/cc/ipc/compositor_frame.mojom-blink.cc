...
// static
bool StructTraits<::cc::mojom::blink::CompositorFrame::DataView, ::cc::mojom::blink::CompositorFramePtr>::Read(
    ::cc::mojom::blink::CompositorFrame::DataView input,
    ::cc::mojom::blink::CompositorFramePtr* output)
{
    bool success = true;
    ::cc::mojom::blink::CompositorFramePtr result(::cc::mojom::blink::CompositorFrame::New());
