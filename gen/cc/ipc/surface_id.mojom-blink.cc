...
// static
bool StructTraits<::cc::mojom::blink::SurfaceId::DataView, ::cc::mojom::blink::SurfaceIdPtr>::Read(
    ::cc::mojom::blink::SurfaceId::DataView input,
    ::cc::mojom::blink::SurfaceIdPtr* output)
{
    ...
    if (!input.ReadFrameSinkId(&result->frame_sink_id))
        success = false;
    if (!input.ReadLocalFrameId(&result->local_frame_id))
        success = false;
