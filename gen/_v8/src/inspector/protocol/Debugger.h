    ...
    namespace Debugger {
        ...
        public:
            ...
            private:
                ...
                template <int STEP>
                LocationBuilder<STATE | STEP>& castState()
                {
        ...
        public:
            ...
            private:
                ...
                ScriptPositionBuilder()
                    : m_result(new ScriptPosition())
                {
                }

                template <int STEP>
                ScriptPositionBuilder<STATE | STEP>& castState()
                {
        ...
        public:
            ...
            private:
                ...
                template <int STEP>
                ScopeBuilder<STATE | STEP>& castState()
                {
        ...
        public:
            ...
            private:
                ...
                ScriptParsedNotificationBuilder()
                    : m_result(new ScriptParsedNotification())
                {
                }

                template <int STEP>
                ScriptParsedNotificationBuilder<STATE | STEP>& castState()
                {
        ...
        public:
            ...
            private:
                ...
                ScriptFailedToParseNotificationBuilder()
                    : m_result(new ScriptFailedToParseNotification())
                {
                }

                template <int STEP>
                ScriptFailedToParseNotificationBuilder<STATE | STEP>& castState()
                {
        ...
        public:
            ...
            private:
                ...
                BreakpointResolvedNotificationBuilder()
                    : m_result(new BreakpointResolvedNotification())
                {
                }

                template <int STEP>
                BreakpointResolvedNotificationBuilder<STATE | STEP>& castState()
                {
        ...
        public:
            ...
            private:
                ...
                template <int STEP>
                PausedNotificationBuilder<STATE | STEP>& castState()
                {
        ...
        public:
            ...
            virtual DispatchResponse getPossibleBreakpoints(std::unique_ptr<protocol::Debugger::Location> in_start, Maybe<protocol::Debugger::Location> in_end, std::unique_ptr<protocol::Array<protocol::Debugger::Location>>* out_locations) = 0;
