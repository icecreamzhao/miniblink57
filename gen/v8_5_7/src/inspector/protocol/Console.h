    ...
    namespace Console {
        ...
        public:
            ...
            private:
                ...
                template <int STEP>
                ConsoleMessageBuilder<STATE | STEP>& castState()
                {
        ...
        public:
            ...
            private:
                ...
                MessageAddedNotificationBuilder()
                    : m_result(new MessageAddedNotification())
                {
                }

                template <int STEP>
                MessageAddedNotificationBuilder<STATE | STEP>& castState()
                {
