    ...
    namespace HeapProfiler {
        ...
        public:
            ...
            private:
                ...
                template <int STEP>
                SamplingHeapProfileNodeBuilder<STATE | STEP>& castState()
                {
        ...
        public:
            ...
            private:
                ...
                template <int STEP>
                SamplingHeapProfileBuilder<STATE | STEP>& castState()
                {
        ...
        public:
            ...
            private:
                ...
                AddHeapSnapshotChunkNotificationBuilder()
                    : m_result(new AddHeapSnapshotChunkNotification())
                {
                }

                template <int STEP>
                AddHeapSnapshotChunkNotificationBuilder<STATE | STEP>& castState()
                {
        ...
        public:
            ...
            private:
                ...
                ReportHeapSnapshotProgressNotificationBuilder()
                    : m_result(new ReportHeapSnapshotProgressNotification())
                {
                }

                template <int STEP>
                ReportHeapSnapshotProgressNotificationBuilder<STATE | STEP>& castState()
                {
        ...
        public:
            ...
            private:
                ...
                LastSeenObjectIdNotificationBuilder()
                    : m_result(new LastSeenObjectIdNotification())
                {
                }

                template <int STEP>
                LastSeenObjectIdNotificationBuilder<STATE | STEP>& castState()
                {
        ...
        public:
            ...
            private:
                ...
                HeapStatsUpdateNotificationBuilder()
                    : m_result(new HeapStatsUpdateNotification())
                {
                }

                template <int STEP>
                HeapStatsUpdateNotificationBuilder<STATE | STEP>& castState()
                {
