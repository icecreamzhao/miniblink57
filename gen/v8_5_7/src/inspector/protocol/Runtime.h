    ...
    namespace Runtime {
        ...
        public:
            ...
            private:
                ...
                template <int STEP>
                RemoteObjectBuilder<STATE | STEP>& castState()
                {
        ...
        public:
            ...
            private:
                ...
                template <int STEP>
                CustomPreviewBuilder<STATE | STEP>& castState()
                {
        ...
        public:
            ...
            private:
                ...
                template <int STEP>
                ObjectPreviewBuilder<STATE | STEP>& castState()
                {
        ...
        public:
            ...
            private:
                ...
                template <int STEP>
                PropertyPreviewBuilder<STATE | STEP>& castState()
                {
        ...
        public:
            ...
            private:
                ...
                template <int STEP>
                EntryPreviewBuilder<STATE | STEP>& castState()
                {
        ...
        public:
            ...
            private:
                ...
                template <int STEP>
                PropertyDescriptorBuilder<STATE | STEP>& castState()
                {
        ...
        public:
            ...
            private:
                ...
                template <int STEP>
                InternalPropertyDescriptorBuilder<STATE | STEP>& castState()
                {
        ...
        public:
            ...
            private:
                ...
                template <int STEP>
                CallArgumentBuilder<STATE | STEP>& castState()
                {
        ...
        public:
            ...
            private:
                ...
                template <int STEP>
                ExecutionContextDescriptionBuilder<STATE | STEP>& castState()
                {
        ...
        public:
            ...
            private:
                ...
                template <int STEP>
                ExceptionDetailsBuilder<STATE | STEP>& castState()
                {
        ...
        public:
            ...
            private:
                ...
                template <int STEP>
                CallFrameBuilder<STATE | STEP>& castState()
                {
        ...
        public:
            ...
            private:
                ...
                template <int STEP>
                StackTraceBuilder<STATE | STEP>& castState()
                {
        ...
        public:
            ...
            private:
                ...
                ExecutionContextCreatedNotificationBuilder()
                    : m_result(new ExecutionContextCreatedNotification())
                {
                }

                template <int STEP>
                ExecutionContextCreatedNotificationBuilder<STATE | STEP>& castState()
                {
        ...
        public:
            ...
            private:
                ...
                ExecutionContextDestroyedNotificationBuilder()
                    : m_result(new ExecutionContextDestroyedNotification())
                {
                }

                template <int STEP>
                ExecutionContextDestroyedNotificationBuilder<STATE | STEP>& castState()
                {
        ...
        public:
            ...
            private:
                ...
                ExceptionThrownNotificationBuilder()
                    : m_result(new ExceptionThrownNotification())
                {
                }

                template <int STEP>
                ExceptionThrownNotificationBuilder<STATE | STEP>& castState()
                {
        ...
        public:
            ...
            private:
                ...
                ExceptionRevokedNotificationBuilder()
                    : m_result(new ExceptionRevokedNotification())
                {
                }

                template <int STEP>
                ExceptionRevokedNotificationBuilder<STATE | STEP>& castState()
                {
        ...
        public:
            ...
            private:
                ...
                ConsoleAPICalledNotificationBuilder()
                    : m_result(new ConsoleAPICalledNotification())
                {
                }

                template <int STEP>
                ConsoleAPICalledNotificationBuilder<STATE | STEP>& castState()
                {
        ...
        public:
            ...
            private:
                ...
                InspectRequestedNotificationBuilder()
                    : m_result(new InspectRequestedNotification())
                {
                }

                template <int STEP>
                InspectRequestedNotificationBuilder<STATE | STEP>& castState()
                {
