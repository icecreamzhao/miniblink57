...
namespace audioproc {
    ...
    public:
        ...
        PROTOBUF_DEPRECATED_ATTR bool has_device_sample_rate() const;
        PROTOBUF_DEPRECATED_ATTR void clear_device_sample_rate();
        PROTOBUF_DEPRECATED_ATTR static const int kDeviceSampleRateFieldNumber = 2;
        PROTOBUF_DEPRECATED_ATTR ::google::protobuf::int32 device_sample_rate() const;
        PROTOBUF_DEPRECATED_ATTR void set_device_sample_rate(::google::protobuf::int32 value);
    ...
    private:
        ...
        inline void set_has_intelligibility_enhancer_enabled();
        inline void clear_has_intelligibility_enhancer_enabled();
...
namespace protobuf {
    ...
    template <>
    struct is_proto_enum<::webrtc::audioproc::Event_Type> : ::google::protobuf::internal::true_type {
    };
