...
namespace internal {
    ...
    struct Serializer<::gfx::mojom::RangeDataView, MaybeConstUserType> {
            ...
            SerializationContext* context)
        {
            ...
            size_t size = sizeof(::gfx::mojom::internal::Range_Data);
            return size;
        }

        static void Serialize(MaybeConstUserType& input,
            Buffer* buffer,
            ::gfx::mojom::internal::Range_Data** output,
            SerializationContext* context)
        {
            if (CallIsNullIfExists<Traits>(input)) {
                *output = nullptr;
            ...
            auto result = ::gfx::mojom::internal::Range_Data::New(buffer);
            ALLOW_UNUSED_LOCAL(result);
            result->start = CallWithContext(Traits::start, input, custom_context);
            result->end = CallWithContext(Traits::end, input, custom_context);
            *output = result;
...
namespace internal {
    ...
    struct Serializer<::gfx::mojom::RangeFDataView, MaybeConstUserType> {
            ...
            SerializationContext* context)
        {
            ...
            size_t size = sizeof(::gfx::mojom::internal::RangeF_Data);
            return size;
        }

        static void Serialize(MaybeConstUserType& input,
            Buffer* buffer,
            ::gfx::mojom::internal::RangeF_Data** output,
            SerializationContext* context)
        {
            if (CallIsNullIfExists<Traits>(input)) {
                *output = nullptr;
            ...
            auto result = ::gfx::mojom::internal::RangeF_Data::New(buffer);
            ALLOW_UNUSED_LOCAL(result);
            result->start = CallWithContext(Traits::start, input, custom_context);
            result->end = CallWithContext(Traits::end, input, custom_context);
            *output = result;
