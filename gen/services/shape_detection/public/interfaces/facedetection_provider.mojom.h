...
#ifndef SERVICES_SHAPE_DETECTION_PUBLIC_INTERFACES_FACEDETECTION_PROVIDER_MOJOM_H_
#define SERVICES_SHAPE_DETECTION_PUBLIC_INTERFACES_FACEDETECTION_PROVIDER_MOJOM_H_
...
namespace mojom {
    ...
    public:
        ...
        virtual void CreateFaceDetection(::shape_detection::mojom::FaceDetectionRequest request, ::shape_detection::mojom::FaceDetectorOptionsPtr options) = 0;
    };
    ...
    public:
        ...
        void CreateFaceDetection(::shape_detection::mojom::FaceDetectionRequest request, ::shape_detection::mojom::FaceDetectorOptionsPtr options) override;
...
#endif // SERVICES_SHAPE_DETECTION_PUBLIC_INTERFACES_FACEDETECTION_PROVIDER_MOJOM_H_