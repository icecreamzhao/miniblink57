...
#ifndef SERVICES_SHAPE_DETECTION_PUBLIC_INTERFACES_TEXTDETECTION_MOJOM_BLINK_H_
#define SERVICES_SHAPE_DETECTION_PUBLIC_INTERFACES_TEXTDETECTION_MOJOM_BLINK_H_
...
namespace mojom {
    namespace blink {
        ...
        public:
            ...
            using DetectCallback = base::Callback<void(WTF::Vector<TextDetectionResultPtr>)>;
        ...
        public:
                ...
                UserType* output)
            {
                return mojo::internal::StructDeserializeImpl<
                    TextDetectionResult::DataView, WTF::Vector<uint8_t>>(
                    input, output);
            }
        ...
        private:
            DISALLOW_COPY_AND_ASSIGN(TextDetectionResult);
        };
...
#endif // SERVICES_SHAPE_DETECTION_PUBLIC_INTERFACES_TEXTDETECTION_MOJOM_BLINK_H_