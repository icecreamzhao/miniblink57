...
namespace mojom {
    ...
    namespace internal {
        ...
        // static
        bool ServiceControl_RequestQuit_Params_Data::Validate(
            const void* data,
            mojo::internal::ValidationContext* validation_context)
        {
            ...
            const ServiceControl_RequestQuit_Params_Data* object = static_cast<const ServiceControl_RequestQuit_Params_Data*>(data);
