...
namespace mojom { // static
    ...
    void ResolverProxy::ResolveServiceName(
        const std::string& in_service_name, const ResolveServiceNameCallback& callback)
    {
...
// static
bool StructTraits<::service_manager::mojom::ResolveResult::DataView, ::service_manager::mojom::ResolveResultPtr>::Read(
    ::service_manager::mojom::ResolveResult::DataView input,
    ::service_manager::mojom::ResolveResultPtr* output)
{
    bool success = true;
