...
#ifndef SERVICES_SERVICE_MANAGER_PUBLIC_INTERFACES_RESOLVER_MOJOM_BLINK_H_
#define SERVICES_SERVICE_MANAGER_PUBLIC_INTERFACES_RESOLVER_MOJOM_BLINK_H_
...
#include "mojo/common/file_path.mojom-blink.h"
...
namespace mojom {
    namespace blink {
        ...
        public:
            ...
            virtual void ResolveServiceName(const WTF::String& service_name, const ResolveServiceNameCallback& callback) = 0;
        };
        ...
        public:
            ...
            void ResolveServiceName(const WTF::String& service_name, const ResolveServiceNameCallback& callback) override;
        ...
        public:
            ...
            static WTF::Vector<uint8_t> Serialize(UserType* input)
            {
                return mojo::internal::StructSerializeImpl<
                    ResolveResult::DataView, WTF::Vector<uint8_t>>(input);
            }
                ...
                UserType* output)
            {
                return mojo::internal::StructDeserializeImpl<
                    ResolveResult::DataView, WTF::Vector<uint8_t>>(
                    input, output);
            }

            WTF::String name;
            WTF::HashMap<WTF::String, ::service_manager::mojom::blink::InterfaceProviderSpecPtr> interface_provider_specs;
            ::mojo::common::mojom::blink::FilePathPtr package_path;

        private:
            DISALLOW_COPY_AND_ASSIGN(ResolveResult);
        };
...
template <>
struct StructTraits<::service_manager::mojom::blink::ResolveResult::DataView,
    ::service_manager::mojom::blink::ResolveResultPtr> {
    static bool IsNull(const ::service_manager::mojom::blink::ResolveResultPtr& input) { return !input; }
    static void SetToNull(::service_manager::mojom::blink::ResolveResultPtr* output) { output->reset(); }

    static const decltype(::service_manager::mojom::blink::ResolveResult::name)& name(
        const ::service_manager::mojom::blink::ResolveResultPtr& input)
    {
        return input->name;
    }

    static const decltype(::service_manager::mojom::blink::ResolveResult::interface_provider_specs)& interface_provider_specs(
        const ::service_manager::mojom::blink::ResolveResultPtr& input)
    {
        return input->interface_provider_specs;
    }

    static const decltype(::service_manager::mojom::blink::ResolveResult::package_path)& package_path(
        const ::service_manager::mojom::blink::ResolveResultPtr& input)
    {
        return input->package_path;
    }

    static bool Read(::service_manager::mojom::blink::ResolveResult::DataView input, ::service_manager::mojom::blink::ResolveResultPtr* output);
};

} // namespace mojo

#endif // SERVICES_SERVICE_MANAGER_PUBLIC_INTERFACES_RESOLVER_MOJOM_BLINK_H_