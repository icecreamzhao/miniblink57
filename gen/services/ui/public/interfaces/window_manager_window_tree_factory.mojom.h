...
namespace mojom {
    ...
    using ThreadSafeWindowManagerWindowTreeFactoryPtr = mojo::ThreadSafeInterfacePtr<WindowManagerWindowTreeFactory>;
    using WindowManagerWindowTreeFactoryRequest = mojo::InterfaceRequest<WindowManagerWindowTreeFactory>;
    using WindowManagerWindowTreeFactoryAssociatedPtr = mojo::AssociatedInterfacePtr<WindowManagerWindowTreeFactory>;
    using ThreadSafeWindowManagerWindowTreeFactoryAssociatedPtr = mojo::ThreadSafeAssociatedInterfacePtr<WindowManagerWindowTreeFactory>;
    using WindowManagerWindowTreeFactoryAssociatedPtrInfo = mojo::AssociatedInterfacePtrInfo<WindowManagerWindowTreeFactory>;
    using WindowManagerWindowTreeFactoryAssociatedRequest = mojo::AssociatedInterfaceRequest<WindowManagerWindowTreeFactory>;
    ...
    public:
        static bool Accept(WindowManagerWindowTreeFactory* impl,
            mojo::internal::SerializationContext* context,
            mojo::Message* message);
        static bool AcceptWithResponder(WindowManagerWindowTreeFactory* impl,
            mojo::internal::SerializationContext* context,
            mojo::Message* message,
            mojo::MessageReceiverWithStatus* responder);
    };

    template <typename ImplRefTraits = mojo::RawPtrImplRefTraits<WindowManagerWindowTreeFactory>>
    class WindowManagerWindowTreeFactoryStub
    ...
    class WindowManagerWindowTreeFactoryRequestValidator : public NON_EXPORTED_BASE(mojo::MessageReceiver) {
    public:
        bool Accept(mojo::Message* message) override;
    };
