...
namespace mojom {
    ...
    using ThreadSafeAccessibilityManagerPtr = mojo::ThreadSafeInterfacePtr<AccessibilityManager>;
    using AccessibilityManagerRequest = mojo::InterfaceRequest<AccessibilityManager>;
    using AccessibilityManagerAssociatedPtr = mojo::AssociatedInterfacePtr<AccessibilityManager>;
    using ThreadSafeAccessibilityManagerAssociatedPtr = mojo::ThreadSafeAssociatedInterfacePtr<AccessibilityManager>;
    using AccessibilityManagerAssociatedPtrInfo = mojo::AssociatedInterfacePtrInfo<AccessibilityManager>;
    using AccessibilityManagerAssociatedRequest = mojo::AssociatedInterfaceRequest<AccessibilityManager>;
    ...
    public:
        static bool Accept(AccessibilityManager* impl,
            mojo::internal::SerializationContext* context,
            mojo::Message* message);
        static bool AcceptWithResponder(AccessibilityManager* impl,
            mojo::internal::SerializationContext* context,
            mojo::Message* message,
            mojo::MessageReceiverWithStatus* responder);
    };

    template <typename ImplRefTraits = mojo::RawPtrImplRefTraits<AccessibilityManager>>
    class AccessibilityManagerStub
    ...
    class AccessibilityManagerRequestValidator : public NON_EXPORTED_BASE(mojo::MessageReceiver) {
    public:
        bool Accept(mojo::Message* message) override;
    };
