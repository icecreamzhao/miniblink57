...
namespace mojom {
    ...
    using ThreadSafeWindowServerTestPtr = mojo::ThreadSafeInterfacePtr<WindowServerTest>;
    using WindowServerTestRequest = mojo::InterfaceRequest<WindowServerTest>;
    using WindowServerTestAssociatedPtr = mojo::AssociatedInterfacePtr<WindowServerTest>;
    using ThreadSafeWindowServerTestAssociatedPtr = mojo::ThreadSafeAssociatedInterfacePtr<WindowServerTest>;
    using WindowServerTestAssociatedPtrInfo = mojo::AssociatedInterfacePtrInfo<WindowServerTest>;
    using WindowServerTestAssociatedRequest = mojo::AssociatedInterfaceRequest<WindowServerTest>;
    ...
    public:
        ...
        virtual void EnsureClientHasDrawnWindow(const std::string& client_name, const EnsureClientHasDrawnWindowCallback& callback) = 0;
    };
    ...
    public:
        ...
        void EnsureClientHasDrawnWindow(const std::string& client_name, const EnsureClientHasDrawnWindowCallback& callback) override;
    ...
    public:
        static bool Accept(WindowServerTest* impl,
            mojo::internal::SerializationContext* context,
            mojo::Message* message);
        static bool AcceptWithResponder(WindowServerTest* impl,
            mojo::internal::SerializationContext* context,
            mojo::Message* message,
            mojo::MessageReceiverWithStatus* responder);
    };

    template <typename ImplRefTraits = mojo::RawPtrImplRefTraits<WindowServerTest>>
    class WindowServerTestStub
    ...
    class WindowServerTestRequestValidator : public NON_EXPORTED_BASE(mojo::MessageReceiver) {
    public:
        bool Accept(mojo::Message* message) override;
    };
    class WindowServerTestResponseValidator : public NON_EXPORTED_BASE(mojo::MessageReceiver) {
    public:
        bool Accept(mojo::Message* message) override;
    };
