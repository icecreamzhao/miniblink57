...
namespace mojom {
        ...
        const std::string& in_user_id)
    {
        ...
        size += mojo::internal::PrepareToSerialize<mojo::StringDataView>(
            in_user_id, &serialization_context);
        mojo::internal::MessageBuilder builder(internal::kUserAccessManager_SetActiveUser_Name, size);

        auto params = ::ui::mojom::internal::UserAccessManager_SetActiveUser_Params_Data::New(builder.buffer());
        ALLOW_UNUSED_LOCAL(params);
        typename decltype(params->user_id)::BaseType* user_id_ptr;
        mojo::internal::Serialize<mojo::StringDataView>(
            in_user_id, builder.buffer(), &user_id_ptr, &serialization_context);
    ...
    // static
    bool UserAccessManagerStubDispatch::Accept(
        UserAccessManager* impl,
        mojo::internal::SerializationContext* context,
        mojo::Message* message)
    {
        switch (message->header()->name) {
        case internal::kUserAccessManager_SetActiveUser_Name: {
            internal::UserAccessManager_SetActiveUser_Params_Data* params = reinterpret_cast<internal::UserAccessManager_SetActiveUser_Params_Data*>(
    ...
    // static
    bool UserAccessManagerStubDispatch::AcceptWithResponder(
        UserAccessManager* impl,
        mojo::internal::SerializationContext* context,
        mojo::Message* message,
