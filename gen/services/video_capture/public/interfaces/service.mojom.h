...
#ifndef SERVICES_VIDEO_CAPTURE_PUBLIC_INTERFACES_SERVICE_MOJOM_H_
#define SERVICES_VIDEO_CAPTURE_PUBLIC_INTERFACES_SERVICE_MOJOM_H_
...
namespace mojom {
    ...
    public:
        ...
        enum MethodMinVersions : uint32_t {
            ...
            kConnectToFakeDeviceFactoryMinVersion = 0,
        };
        virtual ~Service() { }

        virtual void ConnectToDeviceFactory(::video_capture::mojom::DeviceFactoryRequest request) = 0;

        virtual void ConnectToFakeDeviceFactory(::video_capture::mojom::DeviceFactoryRequest request) = 0;
    };
    ...
    public:
        ...
        void ConnectToFakeDeviceFactory(::video_capture::mojom::DeviceFactoryRequest request) override;
...
#endif // SERVICES_VIDEO_CAPTURE_PUBLIC_INTERFACES_SERVICE_MOJOM_H_