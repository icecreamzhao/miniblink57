...
namespace mojom {
    ...
    namespace internal {
        ...
        // static
        bool I420CaptureFormat_Data::Validate(
            const void* data,
            mojo::internal::ValidationContext* validation_context)
        {
            ...
            const I420CaptureFormat_Data* object = static_cast<const I420CaptureFormat_Data*>(data);
            ...
            if (!mojo::internal::ValidatePointerNonNullable(
                    object->frame_size, "null frame_size field in I420CaptureFormat",
                    validation_context)) {
                return false;
            }
        ...
        // static
        bool CaptureSettings_Data::Validate(
            const void* data,
            mojo::internal::ValidationContext* validation_context)
        {
            if (!data)
            ...
            // NOTE: The memory backing |object| may be smaller than |sizeof(*object)| if
            // the message comes from an older version.
            const CaptureSettings_Data* object = static_cast<const CaptureSettings_Data*>(data);
            ...
            if (!mojo::internal::ValidatePointerNonNullable(
                    object->format, "null format field in CaptureSettings",
                    validation_context)) {
                return false;
            }
