...
namespace mojom {
    ...
    namespace internal {
            ...
            mojo::internal::ValidationContext* validation_context)
        {
            ...
            if (!::filesystem::mojom::internal::FileError_Data ::Validate(object->err, validation_context))
                return false;
            ...
            mojo::internal::ValidationContext* validation_context)
        {
            ...
            if (!::filesystem::mojom::internal::Whence_Data ::Validate(object->whence, validation_context))
                return false;
            ...
            mojo::internal::ValidationContext* validation_context)
        {
            ...
            if (!::filesystem::mojom::internal::FileError_Data ::Validate(object->error, validation_context))
                return false;
