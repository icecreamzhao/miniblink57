...
namespace mojom {
    ...
    {
        internal::OutputProtection_QueryStatus_ResponseParams_Data* params = reinterpret_cast<internal::OutputProtection_QueryStatus_ResponseParams_Data*>(
    ...
    bool OutputProtection_EnableProtection_ForwardToCallback::Accept(
        mojo::Message* message)
    {
        internal::OutputProtection_EnableProtection_ResponseParams_Data* params = reinterpret_cast<internal::OutputProtection_EnableProtection_ResponseParams_Data*>(
            message->mutable_payload());
        ...
        const QueryStatusCallback& callback)
    {
        ...
        auto params = ::media::mojom::internal::OutputProtection_QueryStatus_Params_Data::New(builder.buffer());
        ALLOW_UNUSED_LOCAL(params);
        (&serialization_context)->handles.Swap(builder.message()->mutable_handles());
        mojo::MessageReceiver* responder = new OutputProtection_QueryStatus_ForwardToCallback(
        ...
        uint32_t in_desired_protection_mask, const EnableProtectionCallback& callback)
    {
        ...
        auto params = ::media::mojom::internal::OutputProtection_EnableProtection_Params_Data::New(builder.buffer());
        ALLOW_UNUSED_LOCAL(params);
        params->desired_protection_mask = in_desired_protection_mask;
        (&serialization_context)->handles.Swap(builder.message()->mutable_handles());
        mojo::MessageReceiver* responder = new OutputProtection_EnableProtection_ForwardToCallback(
            std::move(callback), group_controller_);
        if (!receiver_->AcceptWithResponder(builder.message(), responder))
            delete responder;
    }
        ...
        bool in_success, uint32_t in_link_mask, uint32_t in_protection_mask)
    {
        ...
        auto params = ::media::mojom::internal::OutputProtection_QueryStatus_ResponseParams_Data::New(builder.buffer());
        ALLOW_UNUSED_LOCAL(params);
        ...
        bool in_success)
    {
        ...
        mojo::internal::ResponseMessageBuilder builder(
            ...
            is_sync_ ? mojo::Message::kFlagIsSync : 0);
        auto params = ::media::mojom::internal::OutputProtection_EnableProtection_ResponseParams_Data::New(builder.buffer());
        ALLOW_UNUSED_LOCAL(params);
        params->success = in_success;
        (&serialization_context_)->handles.Swap(builder.message()->mutable_handles());
        bool ok = responder_->Accept(builder.message());
        ...
        mojo::MessageReceiverWithStatus* responder)
    {
        switch (message->header()->name) {
        case internal::kOutputProtection_QueryStatus_Name: {
            internal::OutputProtection_QueryStatus_Params_Data* params = reinterpret_cast<internal::OutputProtection_QueryStatus_Params_Data*>(
                message->mutable_payload());
            ...
            OutputProtection::QueryStatusCallback callback = OutputProtection_QueryStatus_ProxyToResponder::CreateCallback(
                message->request_id(),
        ...
        case internal::kOutputProtection_EnableProtection_Name: {
            internal::OutputProtection_EnableProtection_Params_Data* params = reinterpret_cast<internal::OutputProtection_EnableProtection_Params_Data*>(
                message->mutable_payload());
            ...
            OutputProtection::EnableProtectionCallback callback = OutputProtection_EnableProtection_ProxyToResponder::CreateCallback(
                message->request_id(),
                message->has_flag(mojo::Message::kFlagIsSync), responder,
                context->group_controller);
            // A null |impl| means no implementation was bound.
