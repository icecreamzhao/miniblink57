    ...
    namespace ServiceWorker {
        ...
        public:
            ...
            private:
                ...
                ServiceWorkerRegistrationBuilder()
                    : m_result(new ServiceWorkerRegistration())
                {
                }

                template <int STEP>
                ServiceWorkerRegistrationBuilder<STATE | STEP>& castState()
                {
        ...
        public:
            ...
            private:
                ...
                ServiceWorkerVersionBuilder()
                    : m_result(new ServiceWorkerVersion())
                {
                }

                template <int STEP>
                ServiceWorkerVersionBuilder<STATE | STEP>& castState()
                {
        ...
        public:
            ...
            private:
                ...
                ServiceWorkerErrorMessageBuilder()
                    : m_result(new ServiceWorkerErrorMessage())
                {
                }

                template <int STEP>
                ServiceWorkerErrorMessageBuilder<STATE | STEP>& castState()
                {
        ...
        public:
            ...
            private:
                ...
                WorkerRegistrationUpdatedNotificationBuilder()
                    : m_result(new WorkerRegistrationUpdatedNotification())
                {
                }

                template <int STEP>
                WorkerRegistrationUpdatedNotificationBuilder<STATE | STEP>& castState()
                {
        ...
        public:
            ...
            private:
                ...
                WorkerVersionUpdatedNotificationBuilder()
                    : m_result(new WorkerVersionUpdatedNotification())
                {
                }

                template <int STEP>
                WorkerVersionUpdatedNotificationBuilder<STATE | STEP>& castState()
                {
        ...
        public:
            ...
            private:
                ...
                WorkerErrorReportedNotificationBuilder()
                    : m_result(new WorkerErrorReportedNotification())
                {
                }

                template <int STEP>
                WorkerErrorReportedNotificationBuilder<STATE | STEP>& castState()
                {
