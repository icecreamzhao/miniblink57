...
#ifndef content_protocol_Collections_h
#define content_protocol_Collections_h
...
#endif // !defined(content_protocol_Collections_h)

// Copyright 2016 The Chromium Authors. All rights reserved.
// Use of this source code is governed by a BSD-style license that can be
// found in the LICENSE file.

#ifndef content_protocol_ErrorSupport_h
#define content_protocol_ErrorSupport_h
...
namespace protocol {
    ...
    class CONTENT_EXPORT ErrorSupport {
    public:
        ErrorSupport();
        ~ErrorSupport();
...
#endif // !defined(content_protocol_ErrorSupport_h)

// Copyright 2016 The Chromium Authors. All rights reserved.
// Use of this source code is governed by a BSD-style license that can be
// found in the LICENSE file.

#ifndef content_protocol_Values_h
#define content_protocol_Values_h
...
namespace protocol {
    ...
    class CONTENT_EXPORT Value : public Serializable {
    ...
    class CONTENT_EXPORT FundamentalValue : public Value {
    public:
    ...
    class CONTENT_EXPORT StringValue : public Value {
    public:
    ...
    class CONTENT_EXPORT SerializedValue : public Value {
    public:
    ...
    private:
        explicit SerializedValue(const String& value)
            : Value(TypeSerialized)
    ...
    class CONTENT_EXPORT DictionaryValue : public Value {
    public:
    ...
    class CONTENT_EXPORT ListValue : public Value {
    public:
...
#endif // content_protocol_Values_h

// Copyright 2016 The Chromium Authors. All rights reserved.
// Use of this source code is governed by a BSD-style license that can be
// found in the LICENSE file.

#ifndef content_protocol_Object_h
#define content_protocol_Object_h
...
#endif // !defined(content_protocol_Object_h)

// Copyright 2016 The Chromium Authors. All rights reserved.
// Use of this source code is governed by a BSD-style license that can be
// found in the LICENSE file.

#ifndef content_protocol_ValueConversions_h
#define content_protocol_ValueConversions_h
...
#endif // !defined(content_protocol_ValueConversions_h)

// Copyright 2016 The Chromium Authors. All rights reserved.
// Use of this source code is governed by a BSD-style license that can be
// found in the LICENSE file.

#ifndef content_protocol_Maybe_h
#define content_protocol_Maybe_h
...
#endif // !defined(content_protocol_Maybe_h)

// Copyright 2016 The Chromium Authors. All rights reserved.
// Use of this source code is governed by a BSD-style license that can be
// found in the LICENSE file.

#ifndef content_protocol_Array_h
#define content_protocol_Array_h
...
namespace protocol {
    ...
    template <>
    class Array<String> : public ArrayBase<String> {
    };
    template <>
    class Array<int> : public ArrayBase<int> {
    };
    template <>
    class Array<double> : public ArrayBase<double> {
    };
    template <>
    class Array<bool> : public ArrayBase<bool> {
    };

} // namespace content
} // namespace protocol

#endif // !defined(content_protocol_Array_h)

// Copyright 2016 The Chromium Authors. All rights reserved.
// Use of this source code is governed by a BSD-style license that can be
// found in the LICENSE file.

#ifndef content_protocol_DispatcherBase_h
#define content_protocol_DispatcherBase_h
...
namespace protocol {
    ...
    class CONTENT_EXPORT DispatchResponse {
    public:
        enum Status {
            kSuccess = 0,
            kError = 1,
    ...
    class CONTENT_EXPORT DispatcherBase {
        PROTOCOL_DISALLOW_COPY(DispatcherBase);

    public:
        static const char kInvalidParamsString[];
        class CONTENT_EXPORT WeakPtr {
        public:
    ...
    class CONTENT_EXPORT UberDispatcher {
...
#endif // !defined(content_protocol_DispatcherBase_h)

// Copyright 2016 The Chromium Authors. All rights reserved.
// Use of this source code is governed by a BSD-style license that can be
// found in the LICENSE file.

#ifndef content_protocol_Parser_h
#define content_protocol_Parser_h
...
namespace protocol {
    ...
    CONTENT_EXPORT std::unique_ptr<Value> parseJSONCharacters(const uint8_t*, unsigned);
    CONTENT_EXPORT std::unique_ptr<Value> parseJSONCharacters(const uint16_t*, unsigned);

} // namespace content
} // namespace protocol

#endif // !defined(content_protocol_Parser_h)
