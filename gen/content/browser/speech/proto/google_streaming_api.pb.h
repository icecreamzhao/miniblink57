...
namespace proto {
    ...
    public:
        ...
        static const StatusCode StatusCode_MIN = SpeechRecognitionEvent_StatusCode_StatusCode_MIN;
        static const StatusCode StatusCode_MAX = SpeechRecognitionEvent_StatusCode_StatusCode_MAX;
        static const int StatusCode_ARRAYSIZE = SpeechRecognitionEvent_StatusCode_StatusCode_ARRAYSIZE;
        ...
        static const EndpointerEventType EndpointerEventType_MIN = SpeechRecognitionEvent_EndpointerEventType_EndpointerEventType_MIN;
        static const EndpointerEventType EndpointerEventType_MAX = SpeechRecognitionEvent_EndpointerEventType_EndpointerEventType_MAX;
        static const int EndpointerEventType_ARRAYSIZE = SpeechRecognitionEvent_EndpointerEventType_EndpointerEventType_ARRAYSIZE;
...
namespace protobuf {
    ...
    template <>
    struct is_proto_enum<::content::proto::SpeechRecognitionEvent_StatusCode> : ::google::protobuf::internal::true_type {
    };
    template <>
    struct is_proto_enum<::content::proto::SpeechRecognitionEvent_EndpointerEventType> : ::google::protobuf::internal::true_type {
    };
