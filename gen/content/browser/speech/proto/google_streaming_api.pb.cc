...
#define ZR_HELPER_(f)                                                                                            \
    _Pragma("clang diagnostic push")                                                                             \
        _Pragma("clang diagnostic ignored \"-Winvalid-offsetof\"") __builtin_offsetof(SpeechRecognitionEvent, f) \
...
#undef DO_
    ...
    int SpeechRecognitionEvent::ByteSize() const
    {
        ...
        if (_has_bits_[0 / 32] & 5u) {
            ...
            // optional .content.proto.SpeechRecognitionEvent.EndpointerEventType endpoint = 4;
            if (has_endpoint()) {
                total_size += 1 + ::google::protobuf::internal::WireFormatLite::EnumSize(this->endpoint());
            }
        }
        // repeated .content.proto.SpeechRecognitionResult result = 2;
...
#define ZR_HELPER_(f)                                                                                             \
    _Pragma("clang diagnostic push")                                                                              \
        _Pragma("clang diagnostic ignored \"-Winvalid-offsetof\"") __builtin_offsetof(SpeechRecognitionResult, f) \
            _Pragma("clang diagnostic pop")
#else
#define ZR_HELPER_(f) reinterpret_cast<char*>( \
...
#undef DO_
    ...
    int SpeechRecognitionAlternative::ByteSize() const
    {
        ...
        if (_has_bits_[0 / 32] & 3u) {
            // optional string transcript = 1;
            if (has_transcript()) {
                total_size += 1 + ::google::protobuf::internal::WireFormatLite::StringSize(this->transcript());
            }
