...
namespace mojom {
    ...
    using ThreadSafeImageDownloaderPtr = mojo::ThreadSafeInterfacePtr<ImageDownloader>;
    using ImageDownloaderRequest = mojo::InterfaceRequest<ImageDownloader>;
    using ImageDownloaderAssociatedPtr = mojo::AssociatedInterfacePtr<ImageDownloader>;
    using ThreadSafeImageDownloaderAssociatedPtr = mojo::ThreadSafeAssociatedInterfacePtr<ImageDownloader>;
    using ImageDownloaderAssociatedPtrInfo = mojo::AssociatedInterfacePtrInfo<ImageDownloader>;
    using ImageDownloaderAssociatedRequest = mojo::AssociatedInterfaceRequest<ImageDownloader>;
    ...
    public:
        static bool Accept(ImageDownloader* impl,
            mojo::internal::SerializationContext* context,
            mojo::Message* message);
        static bool AcceptWithResponder(ImageDownloader* impl,
            mojo::internal::SerializationContext* context,
            mojo::Message* message,
            mojo::MessageReceiverWithStatus* responder);
    };

    template <typename ImplRefTraits = mojo::RawPtrImplRefTraits<ImageDownloader>>
    class ImageDownloaderStub
    ...
    class CONTENT_EXPORT ImageDownloaderRequestValidator : public NON_EXPORTED_BASE(mojo::MessageReceiver) {
    public:
        bool Accept(mojo::Message* message) override;
    };
    class CONTENT_EXPORT ImageDownloaderResponseValidator : public NON_EXPORTED_BASE(mojo::MessageReceiver) {
    public:
        bool Accept(mojo::Message* message) override;
    };
