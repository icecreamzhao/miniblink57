    ...
    namespace internal {
            ...
            mojo::internal::ValidationContext* validation_context)
        {
            ...
            if (!mojo::internal::ValidatePointerNonNullable(
                    object->params, "null params field in EmbeddedWorkerInstanceClient_StartWorker_Params",
                    validation_context)) {
                return false;
            }
            ...
            if (!mojo::internal::ValidateHandleOrInterfaceNonNullable(
                    object->dispatcher_request,
                    "invalid dispatcher_request field in EmbeddedWorkerInstanceClient_StartWorker_Params", validation_context)) {
                return false;
            }
        ...
        // static
        bool EmbeddedWorkerInstanceClient_StopWorker_ResponseParams_Data::Validate(
            const void* data,
            mojo::internal::ValidationContext* validation_context)
        {
            if (!data)
            ...
            // NOTE: The memory backing |object| may be smaller than |sizeof(*object)| if
            // the message comes from an older version.
            const EmbeddedWorkerInstanceClient_StopWorker_ResponseParams_Data* object = static_cast<const EmbeddedWorkerInstanceClient_StopWorker_ResponseParams_Data*>(data);
            ...
            mojo::internal::ValidationContext* validation_context)
        {
            ...
            if (!mojo::internal::ValidatePointerNonNullable(
                    object->message, "null message field in EmbeddedWorkerInstanceClient_AddMessageToConsole_Params",
                    validation_context)) {
                return false;
            }
