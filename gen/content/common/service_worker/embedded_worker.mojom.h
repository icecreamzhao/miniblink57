...
#include "third_party/WebKit/public/web/console_message.mojom.h"
...
namespace mojom {
    ...
    using ThreadSafeEmbeddedWorkerInstanceClientPtr = mojo::ThreadSafeInterfacePtr<EmbeddedWorkerInstanceClient>;
    using EmbeddedWorkerInstanceClientRequest = mojo::InterfaceRequest<EmbeddedWorkerInstanceClient>;
    using EmbeddedWorkerInstanceClientAssociatedPtr = mojo::AssociatedInterfacePtr<EmbeddedWorkerInstanceClient>;
    using ThreadSafeEmbeddedWorkerInstanceClientAssociatedPtr = mojo::ThreadSafeAssociatedInterfacePtr<EmbeddedWorkerInstanceClient>;
    using EmbeddedWorkerInstanceClientAssociatedPtrInfo = mojo::AssociatedInterfacePtrInfo<EmbeddedWorkerInstanceClient>;
    using EmbeddedWorkerInstanceClientAssociatedRequest = mojo::AssociatedInterfaceRequest<EmbeddedWorkerInstanceClient>;

    using EmbeddedWorkerStartParams = mojo::NativeStruct;
    using EmbeddedWorkerStartParamsPtr = mojo::NativeStructPtr;
    ...
    class EmbeddedWorkerInstanceClientResponseValidator;
    ...
    public:
        ...
        using ResponseValidator_ = EmbeddedWorkerInstanceClientResponseValidator;
        ...
        virtual void StartWorker(const ::content::EmbeddedWorkerStartParams& params, ::content::mojom::ServiceWorkerEventDispatcherRequest dispatcher_request) = 0;

        using StopWorkerCallback = base::Callback<void()>;
        virtual void StopWorker(const StopWorkerCallback& callback) = 0;
    ...
    public:
        ...
        void StartWorker(const ::content::EmbeddedWorkerStartParams& params, ::content::mojom::ServiceWorkerEventDispatcherRequest dispatcher_request) override;
    ...
    public:
        static bool Accept(EmbeddedWorkerInstanceClient* impl,
            mojo::internal::SerializationContext* context,
            mojo::Message* message);
        static bool AcceptWithResponder(EmbeddedWorkerInstanceClient* impl,
            mojo::internal::SerializationContext* context,
            mojo::Message* message,
    ...
    class CONTENT_EXPORT EmbeddedWorkerInstanceClientRequestValidator : public NON_EXPORTED_BASE(mojo::MessageReceiver) {
    public:
        bool Accept(mojo::Message* message) override;
    };
    class CONTENT_EXPORT EmbeddedWorkerInstanceClientResponseValidator : public NON_EXPORTED_BASE(mojo::MessageReceiver) {
    public:
        bool Accept(mojo::Message* message) override;
    };
