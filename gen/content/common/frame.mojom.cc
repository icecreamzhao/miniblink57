...
namespace mojom {
        ...
        ::service_manager::mojom::InterfaceProviderRequest in_interfaces)
    {
        ...
        auto params = ::content::mojom::internal::Frame_GetInterfaceProvider_Params_Data::New(builder.buffer());
        ...
        mojo::Message* message)
    {
        ...
        case internal::kFrame_GetInterfaceProvider_Name: {
            internal::Frame_GetInterfaceProvider_Params_Data* params = reinterpret_cast<internal::Frame_GetInterfaceProvider_Params_Data*>(
        ...
        ::service_manager::mojom::InterfaceProviderRequest in_interfaces)
    {
        ...
        auto params = ::content::mojom::internal::FrameHost_GetInterfaceProvider_Params_Data::New(builder.buffer());
        ALLOW_UNUSED_LOCAL(params);
        mojo::internal::Serialize<::service_manager::mojom::InterfaceProviderRequestDataView>(
            in_interfaces, &params->interfaces, &serialization_context);
        MOJO_INTERNAL_DLOG_SERIALIZATION_WARNING(
        ...
        mojo::Message* message)
    {
        ...
        case internal::kFrameHost_GetInterfaceProvider_Name: {
            internal::FrameHost_GetInterfaceProvider_Params_Data* params = reinterpret_cast<internal::FrameHost_GetInterfaceProvider_Params_Data*>(
                message->mutable_payload());
        ...
        int32_t in_frame_routing_id, FrameRequest in_frame, FrameHostPtr in_host)
    {
        ...
        auto params = ::content::mojom::internal::FrameFactory_CreateFrame_Params_Data::New(builder.buffer());
        ALLOW_UNUSED_LOCAL(params);
        ...
        mojo::internal::Serialize<::content::mojom::FrameHostPtrDataView>(
        ...
        mojo::Message* message)
    {
        ...
        case internal::kFrameFactory_CreateFrame_Name: {
            internal::FrameFactory_CreateFrame_Params_Data* params = reinterpret_cast<internal::FrameFactory_CreateFrame_Params_Data*>(
                message->mutable_payload());
            ...
            p_frame = input_data_view.TakeFrame<decltype(p_frame)>();
