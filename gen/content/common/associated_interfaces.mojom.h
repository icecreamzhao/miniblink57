...
namespace mojom {
    ...
    using ThreadSafeAssociatedInterfacePtr = mojo::ThreadSafeInterfacePtr<AssociatedInterface>;
    using AssociatedInterfaceRequest = mojo::InterfaceRequest<AssociatedInterface>;
    using AssociatedInterfaceAssociatedPtr = mojo::AssociatedInterfacePtr<AssociatedInterface>;
    using ThreadSafeAssociatedInterfaceAssociatedPtr = mojo::ThreadSafeAssociatedInterfacePtr<AssociatedInterface>;
    using AssociatedInterfaceAssociatedPtrInfo = mojo::AssociatedInterfacePtrInfo<AssociatedInterface>;
    using AssociatedInterfaceAssociatedRequest = mojo::AssociatedInterfaceRequest<AssociatedInterface>;
    ...
    using ThreadSafeAssociatedInterfaceProviderPtr = mojo::ThreadSafeInterfacePtr<AssociatedInterfaceProvider>;
    using AssociatedInterfaceProviderRequest = mojo::InterfaceRequest<AssociatedInterfaceProvider>;
    using AssociatedInterfaceProviderAssociatedPtr = mojo::AssociatedInterfacePtr<AssociatedInterfaceProvider>;
    using ThreadSafeAssociatedInterfaceProviderAssociatedPtr = mojo::ThreadSafeAssociatedInterfacePtr<AssociatedInterfaceProvider>;
    using AssociatedInterfaceProviderAssociatedPtrInfo = mojo::AssociatedInterfacePtrInfo<AssociatedInterfaceProvider>;
    using AssociatedInterfaceProviderAssociatedRequest = mojo::AssociatedInterfaceRequest<AssociatedInterfaceProvider>;

    class RouteProvider;
    using RouteProviderPtr = mojo::InterfacePtr<RouteProvider>;
    using RouteProviderPtrInfo = mojo::InterfacePtrInfo<RouteProvider>;
    using ThreadSafeRouteProviderPtr = mojo::ThreadSafeInterfacePtr<RouteProvider>;
    using RouteProviderRequest = mojo::InterfaceRequest<RouteProvider>;
    using RouteProviderAssociatedPtr = mojo::AssociatedInterfacePtr<RouteProvider>;
    using ThreadSafeRouteProviderAssociatedPtr = mojo::ThreadSafeAssociatedInterfacePtr<RouteProvider>;
    using RouteProviderAssociatedPtrInfo = mojo::AssociatedInterfacePtrInfo<RouteProvider>;
    using RouteProviderAssociatedRequest = mojo::AssociatedInterfaceRequest<RouteProvider>;
    ...
    public:
        static bool Accept(AssociatedInterface* impl,
            mojo::internal::SerializationContext* context,
            mojo::Message* message);
        static bool AcceptWithResponder(AssociatedInterface* impl,
            mojo::internal::SerializationContext* context,
            mojo::Message* message,
    ...
    public:
        static bool Accept(AssociatedInterfaceProvider* impl,
            mojo::internal::SerializationContext* context,
            mojo::Message* message);
        static bool AcceptWithResponder(AssociatedInterfaceProvider* impl,
            mojo::internal::SerializationContext* context,
            mojo::Message* message,
            mojo::MessageReceiverWithStatus* responder);
    };
    ...
    public:
        static bool Accept(RouteProvider* impl,
            mojo::internal::SerializationContext* context,
            mojo::Message* message);
        static bool AcceptWithResponder(RouteProvider* impl,
            mojo::internal::SerializationContext* context,
            mojo::Message* message,
            mojo::MessageReceiverWithStatus* responder);
    };

    template <typename ImplRefTraits = mojo::RawPtrImplRefTraits<RouteProvider>>
    class RouteProviderStub
        : public NON_EXPORTED_BASE(mojo::MessageReceiverWithResponderStatus) {
    public:
        using ImplPointerType = typename ImplRefTraits::PointerType;
    ...
    class CONTENT_EXPORT AssociatedInterfaceRequestValidator : public NON_EXPORTED_BASE(mojo::MessageReceiver) {
    public:
        bool Accept(mojo::Message* message) override;
    };
    class CONTENT_EXPORT AssociatedInterfaceProviderRequestValidator : public NON_EXPORTED_BASE(mojo::MessageReceiver) {
    public:
        bool Accept(mojo::Message* message) override;
    };
    class CONTENT_EXPORT RouteProviderRequestValidator : public NON_EXPORTED_BASE(mojo::MessageReceiver) {
    public:
        bool Accept(mojo::Message* message) override;
    };
