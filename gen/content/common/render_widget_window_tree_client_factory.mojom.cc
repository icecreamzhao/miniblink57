...
namespace mojom {
        ...
        uint32_t in_routing_id, ::ui::mojom::WindowTreeClientRequest in_window_tree_client)
    {
        ...
        auto params = ::content::mojom::internal::RenderWidgetWindowTreeClientFactory_CreateWindowTreeClientForRenderWidget_Params_Data::New(builder.buffer());
        ...
        mojo::Message* message)
    {
        ...
        case internal::kRenderWidgetWindowTreeClientFactory_CreateWindowTreeClientForRenderWidget_Name: {
            internal::RenderWidgetWindowTreeClientFactory_CreateWindowTreeClientForRenderWidget_Params_Data* params = reinterpret_cast<internal::RenderWidgetWindowTreeClientFactory_CreateWindowTreeClientForRenderWidget_Params_Data*>(
            ...
            p_window_tree_client = input_data_view.TakeWindowTreeClient<decltype(p_window_tree_client)>();
            if (!success) {
