...
namespace mojom {
    ...
    using ThreadSafeChildMemoryCoordinatorPtr = mojo::ThreadSafeInterfacePtr<ChildMemoryCoordinator>;
    using ChildMemoryCoordinatorRequest = mojo::InterfaceRequest<ChildMemoryCoordinator>;
    using ChildMemoryCoordinatorAssociatedPtr = mojo::AssociatedInterfacePtr<ChildMemoryCoordinator>;
    using ThreadSafeChildMemoryCoordinatorAssociatedPtr = mojo::ThreadSafeAssociatedInterfacePtr<ChildMemoryCoordinator>;
    using ChildMemoryCoordinatorAssociatedPtrInfo = mojo::AssociatedInterfacePtrInfo<ChildMemoryCoordinator>;
    using ChildMemoryCoordinatorAssociatedRequest = mojo::AssociatedInterfaceRequest<ChildMemoryCoordinator>;
    ...
    public:
        static bool Accept(ChildMemoryCoordinator* impl,
            mojo::internal::SerializationContext* context,
            mojo::Message* message);
        static bool AcceptWithResponder(ChildMemoryCoordinator* impl,
            mojo::internal::SerializationContext* context,
            mojo::Message* message,
            mojo::MessageReceiverWithStatus* responder);
    };

    template <typename ImplRefTraits = mojo::RawPtrImplRefTraits<ChildMemoryCoordinator>>
    class ChildMemoryCoordinatorStub
    ...
    class CONTENT_EXPORT ChildMemoryCoordinatorRequestValidator : public NON_EXPORTED_BASE(mojo::MessageReceiver) {
    public:
        bool Accept(mojo::Message* message) override;
    };
