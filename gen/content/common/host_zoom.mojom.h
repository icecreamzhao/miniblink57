...
namespace mojom {
    ...
    using ThreadSafeHostZoomPtr = mojo::ThreadSafeInterfacePtr<HostZoom>;
    using HostZoomRequest = mojo::InterfaceRequest<HostZoom>;
    using HostZoomAssociatedPtr = mojo::AssociatedInterfacePtr<HostZoom>;
    using ThreadSafeHostZoomAssociatedPtr = mojo::ThreadSafeAssociatedInterfacePtr<HostZoom>;
    using HostZoomAssociatedPtrInfo = mojo::AssociatedInterfacePtrInfo<HostZoom>;
    using HostZoomAssociatedRequest = mojo::AssociatedInterfaceRequest<HostZoom>;
    ...
    public:
        static bool Accept(HostZoom* impl,
            mojo::internal::SerializationContext* context,
            mojo::Message* message);
        static bool AcceptWithResponder(HostZoom* impl,
            mojo::internal::SerializationContext* context,
            mojo::Message* message,
            mojo::MessageReceiverWithStatus* responder);
    };

    template <typename ImplRefTraits = mojo::RawPtrImplRefTraits<HostZoom>>
    class HostZoomStub
    ...
    class CONTENT_EXPORT HostZoomRequestValidator : public NON_EXPORTED_BASE(mojo::MessageReceiver) {
    public:
        bool Accept(mojo::Message* message) override;
    };
