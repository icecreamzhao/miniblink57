...
namespace content {
namespace mojom {
    extern const char kNavigation_FrameSpec[];
    class Frame;
    using FramePtr = mojo::InterfacePtr<Frame>;
    using FramePtrInfo = mojo::InterfacePtrInfo<Frame>;
    using ThreadSafeFramePtr = mojo::ThreadSafeInterfacePtr<Frame>;
    using FrameRequest = mojo::InterfaceRequest<Frame>;
    using FrameAssociatedPtr = mojo::AssociatedInterfacePtr<Frame>;
    using ThreadSafeFrameAssociatedPtr = mojo::ThreadSafeAssociatedInterfacePtr<Frame>;
    using FrameAssociatedPtrInfo = mojo::AssociatedInterfacePtrInfo<Frame>;
    using FrameAssociatedRequest = mojo::AssociatedInterfaceRequest<Frame>;

    class FrameHost;
    using FrameHostPtr = mojo::InterfacePtr<FrameHost>;
    using FrameHostPtrInfo = mojo::InterfacePtrInfo<FrameHost>;
    using ThreadSafeFrameHostPtr = mojo::ThreadSafeInterfacePtr<FrameHost>;
    using FrameHostRequest = mojo::InterfaceRequest<FrameHost>;
    using FrameHostAssociatedPtr = mojo::AssociatedInterfacePtr<FrameHost>;
    using ThreadSafeFrameHostAssociatedPtr = mojo::ThreadSafeAssociatedInterfacePtr<FrameHost>;
    using FrameHostAssociatedPtrInfo = mojo::AssociatedInterfacePtrInfo<FrameHost>;
    using FrameHostAssociatedRequest = mojo::AssociatedInterfaceRequest<FrameHost>;

    class FrameFactory;
    using FrameFactoryPtr = mojo::InterfacePtr<FrameFactory>;
    using FrameFactoryPtrInfo = mojo::InterfacePtrInfo<FrameFactory>;
    using ThreadSafeFrameFactoryPtr = mojo::ThreadSafeInterfacePtr<FrameFactory>;
    using FrameFactoryRequest = mojo::InterfaceRequest<FrameFactory>;
    using FrameFactoryAssociatedPtr = mojo::AssociatedInterfacePtr<FrameFactory>;
    using ThreadSafeFrameFactoryAssociatedPtr = mojo::ThreadSafeAssociatedInterfacePtr<FrameFactory>;
    using FrameFactoryAssociatedPtrInfo = mojo::AssociatedInterfacePtrInfo<FrameFactory>;
    using FrameFactoryAssociatedRequest = mojo::AssociatedInterfaceRequest<FrameFactory>;
    ...
    public:
        static bool Accept(Frame* impl,
            mojo::internal::SerializationContext* context,
            mojo::Message* message);
        static bool AcceptWithResponder(Frame* impl,
            mojo::internal::SerializationContext* context,
            mojo::Message* message,
            mojo::MessageReceiverWithStatus* responder);
    };

    template <typename ImplRefTraits = mojo::RawPtrImplRefTraits<Frame>>
    class FrameStub
    ...
    public:
        static bool Accept(FrameHost* impl,
            mojo::internal::SerializationContext* context,
            mojo::Message* message);
        static bool AcceptWithResponder(FrameHost* impl,
            mojo::internal::SerializationContext* context,
            mojo::Message* message,
            mojo::MessageReceiverWithStatus* responder);
    };

    template <typename ImplRefTraits = mojo::RawPtrImplRefTraits<FrameHost>>
    class FrameHostStub
        : public NON_EXPORTED_BASE(mojo::MessageReceiverWithResponderStatus) {
    public:
        using ImplPointerType = typename ImplRefTraits::PointerType;
    ...
    public:
        static bool Accept(FrameFactory* impl,
            mojo::internal::SerializationContext* context,
            mojo::Message* message);
        static bool AcceptWithResponder(FrameFactory* impl,
            mojo::internal::SerializationContext* context,
            mojo::Message* message,
            mojo::MessageReceiverWithStatus* responder);
    };

    template <typename ImplRefTraits = mojo::RawPtrImplRefTraits<FrameFactory>>
    class FrameFactoryStub
        : public NON_EXPORTED_BASE(mojo::MessageReceiverWithResponderStatus) {
    public:
        using ImplPointerType = typename ImplRefTraits::PointerType;
    ...
    class CONTENT_EXPORT FrameRequestValidator : public NON_EXPORTED_BASE(mojo::MessageReceiver) {
    public:
        bool Accept(mojo::Message* message) override;
    };
    class CONTENT_EXPORT FrameHostRequestValidator : public NON_EXPORTED_BASE(mojo::MessageReceiver) {
    public:
        bool Accept(mojo::Message* message) override;
    };
    class CONTENT_EXPORT FrameFactoryRequestValidator : public NON_EXPORTED_BASE(mojo::MessageReceiver) {
    public:
        bool Accept(mojo::Message* message) override;
    };
