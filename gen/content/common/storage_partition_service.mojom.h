...
namespace mojom {
    ...
    using ThreadSafeStoragePartitionServicePtr = mojo::ThreadSafeInterfacePtr<StoragePartitionService>;
    using StoragePartitionServiceRequest = mojo::InterfaceRequest<StoragePartitionService>;
    using StoragePartitionServiceAssociatedPtr = mojo::AssociatedInterfacePtr<StoragePartitionService>;
    using ThreadSafeStoragePartitionServiceAssociatedPtr = mojo::ThreadSafeAssociatedInterfacePtr<StoragePartitionService>;
    using StoragePartitionServiceAssociatedPtrInfo = mojo::AssociatedInterfacePtrInfo<StoragePartitionService>;
    using StoragePartitionServiceAssociatedRequest = mojo::AssociatedInterfaceRequest<StoragePartitionService>;
    ...
    public:
        static bool Accept(StoragePartitionService* impl,
            mojo::internal::SerializationContext* context,
            mojo::Message* message);
        static bool AcceptWithResponder(StoragePartitionService* impl,
            mojo::internal::SerializationContext* context,
            mojo::Message* message,
            mojo::MessageReceiverWithStatus* responder);
    };

    template <typename ImplRefTraits = mojo::RawPtrImplRefTraits<StoragePartitionService>>
    class StoragePartitionServiceStub
    ...
    class CONTENT_EXPORT StoragePartitionServiceRequestValidator : public NON_EXPORTED_BASE(mojo::MessageReceiver) {
    public:
        bool Accept(mojo::Message* message) override;
    };
