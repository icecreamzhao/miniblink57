...
namespace mojom {
    ...
    using ThreadSafeMemoryCoordinatorHandlePtr = mojo::ThreadSafeInterfacePtr<MemoryCoordinatorHandle>;
    using MemoryCoordinatorHandleRequest = mojo::InterfaceRequest<MemoryCoordinatorHandle>;
    using MemoryCoordinatorHandleAssociatedPtr = mojo::AssociatedInterfacePtr<MemoryCoordinatorHandle>;
    using ThreadSafeMemoryCoordinatorHandleAssociatedPtr = mojo::ThreadSafeAssociatedInterfacePtr<MemoryCoordinatorHandle>;
    using MemoryCoordinatorHandleAssociatedPtrInfo = mojo::AssociatedInterfacePtrInfo<MemoryCoordinatorHandle>;
    using MemoryCoordinatorHandleAssociatedRequest = mojo::AssociatedInterfaceRequest<MemoryCoordinatorHandle>;
    ...
    public:
        static bool Accept(MemoryCoordinatorHandle* impl,
            mojo::internal::SerializationContext* context,
            mojo::Message* message);
        static bool AcceptWithResponder(MemoryCoordinatorHandle* impl,
            mojo::internal::SerializationContext* context,
            mojo::Message* message,
            mojo::MessageReceiverWithStatus* responder);
    };

    template <typename ImplRefTraits = mojo::RawPtrImplRefTraits<MemoryCoordinatorHandle>>
    class MemoryCoordinatorHandleStub
    ...
    class CONTENT_EXPORT MemoryCoordinatorHandleRequestValidator : public NON_EXPORTED_BASE(mojo::MessageReceiver) {
    public:
        bool Accept(mojo::Message* message) override;
    };
