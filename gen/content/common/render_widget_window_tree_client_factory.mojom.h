...
namespace mojom {
    ...
    using ThreadSafeRenderWidgetWindowTreeClientFactoryPtr = mojo::ThreadSafeInterfacePtr<RenderWidgetWindowTreeClientFactory>;
    using RenderWidgetWindowTreeClientFactoryRequest = mojo::InterfaceRequest<RenderWidgetWindowTreeClientFactory>;
    using RenderWidgetWindowTreeClientFactoryAssociatedPtr = mojo::AssociatedInterfacePtr<RenderWidgetWindowTreeClientFactory>;
    using ThreadSafeRenderWidgetWindowTreeClientFactoryAssociatedPtr = mojo::ThreadSafeAssociatedInterfacePtr<RenderWidgetWindowTreeClientFactory>;
    using RenderWidgetWindowTreeClientFactoryAssociatedPtrInfo = mojo::AssociatedInterfacePtrInfo<RenderWidgetWindowTreeClientFactory>;
    using RenderWidgetWindowTreeClientFactoryAssociatedRequest = mojo::AssociatedInterfaceRequest<RenderWidgetWindowTreeClientFactory>;
    ...
    public:
        static bool Accept(RenderWidgetWindowTreeClientFactory* impl,
            mojo::internal::SerializationContext* context,
            mojo::Message* message);
        static bool AcceptWithResponder(RenderWidgetWindowTreeClientFactory* impl,
            mojo::internal::SerializationContext* context,
            mojo::Message* message,
            mojo::MessageReceiverWithStatus* responder);
    };

    template <typename ImplRefTraits = mojo::RawPtrImplRefTraits<RenderWidgetWindowTreeClientFactory>>
    class RenderWidgetWindowTreeClientFactoryStub
    ...
    class CONTENT_EXPORT RenderWidgetWindowTreeClientFactoryRequestValidator : public NON_EXPORTED_BASE(mojo::MessageReceiver) {
    public:
        bool Accept(mojo::Message* message) override;
    };
