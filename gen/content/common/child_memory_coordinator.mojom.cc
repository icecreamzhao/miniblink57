...
namespace mojom {
        ...
        MemoryState in_state)
    {
        mojo::internal::SerializationContext serialization_context(
            group_controller_);
        size_t size = sizeof(::content::mojom::internal::ChildMemoryCoordinator_OnStateChange_Params_Data);
        mojo::internal::MessageBuilder builder(internal::kChildMemoryCoordinator_OnStateChange_Name, size);

        auto params = ::content::mojom::internal::ChildMemoryCoordinator_OnStateChange_Params_Data::New(builder.buffer());
        ...
        mojo::Message* message)
    {
        ...
        case internal::kChildMemoryCoordinator_OnStateChange_Name: {
            internal::ChildMemoryCoordinator_OnStateChange_Params_Data* params = reinterpret_cast<internal::ChildMemoryCoordinator_OnStateChange_Params_Data*>(
