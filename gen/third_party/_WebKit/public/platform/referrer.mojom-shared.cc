...
namespace mojom {
    ...
    namespace internal {
            ...
            mojo::internal::ValidationContext* validation_context)
        {
            ...
            const Referrer_Data* object = static_cast<const Referrer_Data*>(data);
            ...
            if (!mojo::internal::ValidatePointerNonNullable(
                    object->url, "null url field in Referrer",
                    validation_context)) {
                return false;
            }
            ...
            if (!::blink::mojom::internal::ReferrerPolicy_Data ::Validate(object->policy, validation_context))
                return false;
