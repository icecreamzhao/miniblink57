...
// static
bool StructTraits<::blink::mojom::HttpHeader::DataView, ::blink::mojom::HttpHeaderPtr>::Read(
    ::blink::mojom::HttpHeader::DataView input,
    ::blink::mojom::HttpHeaderPtr* output)
{
    bool success = true;
    ::blink::mojom::HttpHeaderPtr result(::blink::mojom::HttpHeader::New());
...
// static
bool StructTraits<::blink::mojom::WebSocketHandshakeRequest::DataView, ::blink::mojom::WebSocketHandshakeRequestPtr>::Read(
    ::blink::mojom::WebSocketHandshakeRequest::DataView input,
    ::blink::mojom::WebSocketHandshakeRequestPtr* output)
{
    bool success = true;
    ::blink::mojom::WebSocketHandshakeRequestPtr result(::blink::mojom::WebSocketHandshakeRequest::New());
...
// static
bool StructTraits<::blink::mojom::WebSocketHandshakeResponse::DataView, ::blink::mojom::WebSocketHandshakeResponsePtr>::Read(
    ::blink::mojom::WebSocketHandshakeResponse::DataView input,
    ::blink::mojom::WebSocketHandshakeResponsePtr* output)
{
    bool success = true;
    ::blink::mojom::WebSocketHandshakeResponsePtr result(::blink::mojom::WebSocketHandshakeResponse::New());
