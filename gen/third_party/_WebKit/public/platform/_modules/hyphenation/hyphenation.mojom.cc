...
namespace mojom {
    ...
    bool Hyphenation::OpenDictionary(const std::string& locale, base::File* hyphenation_dictionary_handle)
    {
        NOTREACHED();
        return false;
    }
    ...
    bool HyphenationProxy::OpenDictionary(
        const std::string& param_locale, base::File* param_hyphenation_dictionary_handle)
    {
    ...
    void HyphenationProxy::OpenDictionary(
        const std::string& in_locale, const OpenDictionaryCallback& callback)
    {
        mojo::internal::SerializationContext serialization_context(
            group_controller_);
        size_t size = sizeof(::blink::mojom::internal::Hyphenation_OpenDictionary_Params_Data);
