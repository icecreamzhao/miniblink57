...
namespace mojom {
    ...
    void OffscreenCanvasCompositorFrameSinkProviderProxy::CreateCompositorFrameSink(
        const cc::FrameSinkId& in_frame_sink_id, ::cc::mojom::MojoCompositorFrameSinkClientPtr in_client, ::cc::mojom::MojoCompositorFrameSinkRequest in_sink)
    {
        mojo::internal::SerializationContext serialization_context(
            group_controller_);
        ...
        mojo::Message* message)
    {
        ...
        case internal::kOffscreenCanvasCompositorFrameSinkProvider_CreateCompositorFrameSink_Name: {
            ...
            ::cc::mojom::MojoCompositorFrameSinkRequest p_sink {};
