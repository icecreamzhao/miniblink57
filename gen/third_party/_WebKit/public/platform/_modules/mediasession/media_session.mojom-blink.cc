...
#include "third_party/WebKit/public/platform/modules/mediasession/media_session.mojom-blink.h"
...
// static
bool StructTraits<::blink::mojom::blink::MediaImage::DataView, ::blink::mojom::blink::MediaImagePtr>::Read(
    ::blink::mojom::blink::MediaImage::DataView input,
    ::blink::mojom::blink::MediaImagePtr* output)
{
    bool success = true;
    ::blink::mojom::blink::MediaImagePtr result(::blink::mojom::blink::MediaImage::New());
...
// static
bool StructTraits<::blink::mojom::blink::MediaMetadata::DataView, ::blink::mojom::blink::MediaMetadataPtr>::Read(
    ::blink::mojom::blink::MediaMetadata::DataView input,
    ::blink::mojom::blink::MediaMetadataPtr* output)
{
    bool success = true;
    ::blink::mojom::blink::MediaMetadataPtr result(::blink::mojom::blink::MediaMetadata::New());
