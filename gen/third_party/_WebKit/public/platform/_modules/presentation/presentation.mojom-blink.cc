...
namespace mojom {
    namespace blink { // static
        ...
        void PresentationServiceProxy::StartSession(
            const WTF::Vector<::blink::KURL>& in_presentation_urls, const StartSessionCallback& callback)
        {
            mojo::internal::SerializationContext serialization_context(
                group_controller_);
        ...
        void PresentationServiceProxy::JoinSession(
            const WTF::Vector<::blink::KURL>& in_presentation_urls, const WTF::String& in_presentation_id, const JoinSessionCallback& callback)
        {
            mojo::internal::SerializationContext serialization_context(
                group_controller_);
        ...
        void PresentationServiceClientProxy::OnScreenAvailabilityUpdated(
            const ::blink::KURL& in_url, bool in_available)
        {
            mojo::internal::SerializationContext serialization_context(
                group_controller_);
        ...
        void PresentationServiceClientProxy::OnConnectionMessagesReceived(
            PresentationSessionInfoPtr in_sessionInfo, WTF::Vector<ConnectionMessagePtr> in_messages)
        {
            mojo::internal::SerializationContext serialization_context(
                group_controller_);
            ...
            mojo::Message* message)
        {
            ...
            case internal::kPresentationServiceClient_OnConnectionMessagesReceived_Name: {
                ...
                bool success = true;
                PresentationSessionInfoPtr p_sessionInfo {};
                WTF::Vector<ConnectionMessagePtr> p_messages {};
...
// static
bool StructTraits<::blink::mojom::blink::PresentationSessionInfo::DataView, ::blink::mojom::blink::PresentationSessionInfoPtr>::Read(
    ::blink::mojom::blink::PresentationSessionInfo::DataView input,
...
// static
bool StructTraits<::blink::mojom::blink::ConnectionMessage::DataView, ::blink::mojom::blink::ConnectionMessagePtr>::Read(
    ::blink::mojom::blink::ConnectionMessage::DataView input,
    ::blink::mojom::blink::ConnectionMessagePtr* output)
{
    bool success = true;
    ::blink::mojom::blink::ConnectionMessagePtr result(::blink::mojom::blink::ConnectionMessage::New());
