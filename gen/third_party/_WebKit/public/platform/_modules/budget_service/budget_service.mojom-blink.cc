...
#include "third_party/WebKit/public/platform/modules/budget_service/budget_service.mojom-blink.h"
...
namespace mojom {
    namespace blink { // static
        ...
        {
            seed = mojo::internal::WTFHash(seed, this->budget_at);
            seed = mojo::internal::WTFHash(seed, this->time);
            return seed;
        }
            ...
            mojo::Message* message)
        {
            ...
            WTF::Vector<BudgetStatePtr> p_budget {};
        ...
        void BudgetServiceProxy::GetBudget(
            const RefPtr<::blink::SecurityOrigin>& in_origin, const GetBudgetCallback& callback)
        {
            mojo::internal::SerializationContext serialization_context(
                group_controller_);
        ...
        void BudgetServiceProxy::Reserve(
            const RefPtr<::blink::SecurityOrigin>& in_origin, BudgetOperationType in_operation, const ReserveCallback& callback)
        {
            mojo::internal::SerializationContext serialization_context(
                group_controller_);
        ...
        private:
            ...
            void Run(
                BudgetServiceErrorType in_error_type, WTF::Vector<BudgetStatePtr> in_budget);
...
// static
bool StructTraits<::blink::mojom::blink::BudgetState::DataView, ::blink::mojom::blink::BudgetStatePtr>::Read(
    ::blink::mojom::blink::BudgetState::DataView input,
    ::blink::mojom::blink::BudgetStatePtr* output)
{
    bool success = true;
    ::blink::mojom::blink::BudgetStatePtr result(::blink::mojom::blink::BudgetState::New());
