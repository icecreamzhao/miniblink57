...
namespace mojom {
    ...
    namespace internal {
        ...
        // static
        bool InstallationService_OnInstall_Params_Data::Validate(
            const void* data,
            mojo::internal::ValidationContext* validation_context)
        {
            ...
            const InstallationService_OnInstall_Params_Data* object = static_cast<const InstallationService_OnInstall_Params_Data*>(data);
