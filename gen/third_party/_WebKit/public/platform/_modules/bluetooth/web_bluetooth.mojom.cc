...
namespace mojom { // static
    ...
    void WebBluetoothServiceProxy::RemoteServiceGetCharacteristics(
        const std::string& in_service_instance_id, WebBluetoothGATTQueryQuantity in_quantity, const base::Optional<device::BluetoothUUID>& in_characteristics_uuid, const RemoteServiceGetCharacteristicsCallback& callback)
    {
        mojo::internal::SerializationContext serialization_context(
            group_controller_);
    ...
    void WebBluetoothServiceProxy::RemoteCharacteristicReadValue(
        const std::string& in_characteristic_instance_id, const RemoteCharacteristicReadValueCallback& callback)
    {
        mojo::internal::SerializationContext serialization_context(
            group_controller_);
    ...
    void WebBluetoothServiceProxy::RemoteCharacteristicWriteValue(
        const std::string& in_characteristic_instance_id, const std::vector<uint8_t>& in_value, const RemoteCharacteristicWriteValueCallback& callback)
    {
        mojo::internal::SerializationContext serialization_context(
            group_controller_);
    ...
    void WebBluetoothServiceProxy::RemoteCharacteristicStartNotifications(
        const std::string& in_characteristic_instance_id, const RemoteCharacteristicStartNotificationsCallback& callback)
    {
        mojo::internal::SerializationContext serialization_context(
            group_controller_);
    ...
    void WebBluetoothServiceProxy::RemoteCharacteristicStopNotifications(
        const std::string& in_characteristic_instance_id, const RemoteCharacteristicStopNotificationsCallback& callback)
    {
        mojo::internal::SerializationContext serialization_context(
            group_controller_);
    ...
    void WebBluetoothServiceProxy::RemoteCharacteristicGetDescriptors(
        const std::string& in_characteristics_instance_id, WebBluetoothGATTQueryQuantity in_quantity, const base::Optional<device::BluetoothUUID>& in_descriptor_uuid, const RemoteCharacteristicGetDescriptorsCallback& callback)
    {
        mojo::internal::SerializationContext serialization_context(
            group_controller_);
    ...
    void WebBluetoothServiceClientProxy::RemoteCharacteristicValueChanged(
        const std::string& in_characteristic_instance_id, const std::vector<uint8_t>& in_value)
    {
        mojo::internal::SerializationContext serialization_context(
            group_controller_);
...
// static
bool StructTraits<::blink::mojom::WebBluetoothScanFilter::DataView, ::blink::mojom::WebBluetoothScanFilterPtr>::Read(
    ::blink::mojom::WebBluetoothScanFilter::DataView input,
