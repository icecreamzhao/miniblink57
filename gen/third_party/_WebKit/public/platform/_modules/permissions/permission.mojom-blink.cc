...
namespace mojom {
    namespace blink { // static
        ...
        void PermissionServiceProxy::HasPermission(
            PermissionDescriptorPtr in_permission, const RefPtr<::blink::SecurityOrigin>& in_origin, const HasPermissionCallback& callback)
        {
            mojo::internal::SerializationContext serialization_context(
                group_controller_);
        ...
        void PermissionServiceProxy::RequestPermission(
            PermissionDescriptorPtr in_permission, const RefPtr<::blink::SecurityOrigin>& in_origin, bool in_user_gesture, const RequestPermissionCallback& callback)
        {
            mojo::internal::SerializationContext serialization_context(
                group_controller_);
        ...
        void PermissionServiceProxy::RequestPermissions(
            WTF::Vector<PermissionDescriptorPtr> in_permission, const RefPtr<::blink::SecurityOrigin>& in_origin, bool in_user_gesture, const RequestPermissionsCallback& callback)
        {
            mojo::internal::SerializationContext serialization_context(
                group_controller_);
        ...
        void PermissionServiceProxy::RevokePermission(
            PermissionDescriptorPtr in_permission, const RefPtr<::blink::SecurityOrigin>& in_origin, const RevokePermissionCallback& callback)
        {
            mojo::internal::SerializationContext serialization_context(
                group_controller_);
        ...
        void PermissionServiceProxy::AddPermissionObserver(
            PermissionDescriptorPtr in_permission, const RefPtr<::blink::SecurityOrigin>& in_origin, ::blink::mojom::blink::PermissionStatus in_last_known_status, PermissionObserverPtr in_observer)
        {
            mojo::internal::SerializationContext serialization_context(
                group_controller_);
...
{
    *output = ::blink::mojom::blink::PermissionDescriptorExtension::New();
    ::blink::mojom::blink::PermissionDescriptorExtensionPtr& result = *output;

    internal::UnionAccessor<::blink::mojom::blink::PermissionDescriptorExtension> result_acc(result.get());
    switch (input.tag()) {
    case ::blink::mojom::blink::PermissionDescriptorExtension::Tag::MIDI: {
        result_acc.SwitchActive(::blink::mojom::blink::PermissionDescriptorExtension::Tag::MIDI);
