...
#ifndef THIRD_PARTY_WEBKIT_PUBLIC_PLATFORM_SITE_ENGAGEMENT_MOJOM_BLINK_H_
#define THIRD_PARTY_WEBKIT_PUBLIC_PLATFORM_SITE_ENGAGEMENT_MOJOM_BLINK_H_
...
namespace mojom {
    namespace blink {
        ...
        public:
            ...
            virtual void SetEngagementLevel(const RefPtr<::blink::SecurityOrigin>& origin, EngagementLevel level) = 0;
        };
        ...
        public:
            ...
            void SetEngagementLevel(const RefPtr<::blink::SecurityOrigin>& origin, EngagementLevel level) override;
        ...
        class BLINK_PLATFORM_EXPORT EngagementClientRequestValidator : public NON_EXPORTED_BASE(mojo::MessageReceiver) {
        public:
            bool Accept(mojo::Message* message) override;
        };
...
#endif // THIRD_PARTY_WEBKIT_PUBLIC_PLATFORM_SITE_ENGAGEMENT_MOJOM_BLINK_H_