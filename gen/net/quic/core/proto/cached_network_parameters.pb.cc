...
#define ZR_HELPER_(f)                                                                                             \
    _Pragma("clang diagnostic push")                                                                              \
        _Pragma("clang diagnostic ignored \"-Winvalid-offsetof\"") __builtin_offsetof(CachedNetworkParameters, f) \
    ...
    for (;;) {
        ...
        case 1: {
            ...
            if (input->ExpectTag(16))
                goto parse_bandwidth_estimate_bytes_per_second;
            break;
        }
        ...
        case 3: {
            ...
            if (input->ExpectTag(32))
                goto parse_previous_connection_state;
            break;
        }
        ...
        case 4: {
            ...
            if (input->ExpectTag(40))
                goto parse_max_bandwidth_estimate_bytes_per_second;
            break;
        }
        ...
        case 5: {
            ...
            if (input->ExpectTag(48))
                goto parse_max_bandwidth_timestamp_seconds;
            break;
        }
...
int CachedNetworkParameters::ByteSize() const
{
    ...
    if (_has_bits_[0 / 32] & 127u) {
        // optional string serving_region = 1;
        if (has_serving_region()) {
            total_size += 1 + ::google::protobuf::internal::WireFormatLite::StringSize(this->serving_region());
        }

        // optional int32 bandwidth_estimate_bytes_per_second = 2;
        if (has_bandwidth_estimate_bytes_per_second()) {
            total_size += 1 + ::google::protobuf::internal::WireFormatLite::Int32Size(this->bandwidth_estimate_bytes_per_second());
        }

        // optional int32 max_bandwidth_estimate_bytes_per_second = 5;
        if (has_max_bandwidth_estimate_bytes_per_second()) {
            total_size += 1 + ::google::protobuf::internal::WireFormatLite::Int32Size(this->max_bandwidth_estimate_bytes_per_second());
        }

        // optional int64 max_bandwidth_timestamp_seconds = 6;
        if (has_max_bandwidth_timestamp_seconds()) {
            total_size += 1 + ::google::protobuf::internal::WireFormatLite::Int64Size(this->max_bandwidth_timestamp_seconds());
        }

        // optional int32 min_rtt_ms = 3;
        if (has_min_rtt_ms()) {
            total_size += 1 + ::google::protobuf::internal::WireFormatLite::Int32Size(this->min_rtt_ms());
        }

        // optional int32 previous_connection_state = 4;
        if (has_previous_connection_state()) {
            total_size += 1 + ::google::protobuf::internal::WireFormatLite::Int32Size(this->previous_connection_state());
        }
