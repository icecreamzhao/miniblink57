...
public:
    ...
    static const PreviousConnectionState PreviousConnectionState_MIN = CachedNetworkParameters_PreviousConnectionState_PreviousConnectionState_MIN;
    static const PreviousConnectionState PreviousConnectionState_MAX = CachedNetworkParameters_PreviousConnectionState_PreviousConnectionState_MAX;
    static const int PreviousConnectionState_ARRAYSIZE = CachedNetworkParameters_PreviousConnectionState_PreviousConnectionState_ARRAYSIZE;
...
namespace protobuf {
    ...
    template <>
    struct is_proto_enum<::net::CachedNetworkParameters_PreviousConnectionState> : ::google::protobuf::internal::true_type {
    };
