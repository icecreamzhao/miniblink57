    ...
    for (;;) {
        ...
        case 2: {
            ...
            if (input->ExpectTag(26))
                goto parse_cached_network_parameters;
            break;
        }
...
int SourceAddressToken::RequiredFieldsByteSizeFallback() const
{
    ...
    if (has_ip()) {
        // required bytes ip = 1;
        total_size += 1 + ::google::protobuf::internal::WireFormatLite::BytesSize(this->ip());
    }
...
int SourceAddressToken::ByteSize() const
{
    ...
    // optional .net.CachedNetworkParameters cached_network_parameters = 3;
    if (has_cached_network_parameters()) {
        total_size += 1 + ::google::protobuf::internal::WireFormatLite::MessageSizeNoVirtual(*this->cached_network_parameters_);
    }
...
bool SourceAddressTokens::IsInitialized() const
{
    ...
    if (!::google::protobuf::internal::AllAreInitialized(this->tokens()))
        return false;
    return true;
}
