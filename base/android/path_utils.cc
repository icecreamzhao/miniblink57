...
namespace android {
    ...
    bool GetDataDirectory(FilePath* result)
    {
        ...
        ScopedJavaLocalRef<jstring> path = Java_PathUtils_getDataDirectory(env, GetApplicationContext());
    ...
    {
        JNIEnv* env = AttachCurrentThread();
        ScopedJavaLocalRef<jstring> path = Java_PathUtils_getDatabaseDirectory(env, GetApplicationContext());
        FilePath data_path(ConvertJavaStringToUTF8(path));
        *result = data_path;
        return true;
    }
    ...
    {
        JNIEnv* env = AttachCurrentThread();
        ScopedJavaLocalRef<jstring> path = Java_PathUtils_getCacheDirectory(env, GetApplicationContext());
    ...
    {
        JNIEnv* env = AttachCurrentThread();
        ScopedJavaLocalRef<jstring> path = Java_PathUtils_getThumbnailCacheDirectory(env, GetApplicationContext());
    ...
    {
        JNIEnv* env = AttachCurrentThread();
        ScopedJavaLocalRef<jstring> path = Java_PathUtils_getDownloadsDirectory(env, GetApplicationContext());
    ...
    {
        JNIEnv* env = AttachCurrentThread();
        ScopedJavaLocalRef<jstring> path = Java_PathUtils_getNativeLibraryDirectory(env, GetApplicationContext());
    ...
    {
        JNIEnv* env = AttachCurrentThread();
        ScopedJavaLocalRef<jstring> path = Java_PathUtils_getExternalStorageDirectory(env);
