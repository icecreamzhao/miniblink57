...
namespace {
const char kInnerStructAClassPath[] = "org/chromium/example/jni_generator/SampleForTests$InnerStructA";
const char kSampleForTestsClassPath[] = "org/chromium/example/jni_generator/SampleForTests";
const char kInnerStructBClassPath[] = "org/chromium/example/jni_generator/SampleForTests$InnerStructB";
...
namespace android {
    ...
    static jdouble GetDoubleFunction(JNIEnv* env, const JavaParamRef<jobject>& jcaller);
    ...
    static jfloat GetFloatFunction(JNIEnv* env, const JavaParamRef<jclass>& jcaller);
    ...
    static ScopedJavaLocalRef<jobject> GetNonPODDatatype(JNIEnv* env, const JavaParamRef<jobject>& jcaller);
        ...
        jlong nativeCPPClass)
    {
        ...
        return native->ReturnAString(env, JavaParamRef<jobject>(env, jcaller)).Release();
    }
        ...
        JniIntWrapper bar)
    {
        ...
        jint ret = env->CallIntMethod(obj,
    ...
    static jboolean Java_SampleForTests_staticJavaMethod(JNIEnv* env)
    {
        ...
        jboolean ret = env->CallStaticBooleanMethod(SampleForTests_clazz(env),
            method_id);
        jni_generator::CheckException(env);
        return ret;
    }
    ...
    static ScopedJavaLocalRef<jobject> Java_InnerStructA_create(JNIEnv* env, jlong l,
        JniIntWrapper i,
        jstring s)
    {
        /* Must call RegisterNativesImpl()  */
        ...
        jobject ret = env->CallStaticObjectMethod(InnerStructA_clazz(env),
    ...
    static jlong Java_InnerStructB_getKey(JNIEnv* env, jobject obj)
    {
        ...
        jlong ret = env->CallLongMethod(obj,
            method_id);
        jni_generator::CheckException(env);
        return ret;
    }
        ...
        jobject obj)
    {
        ...
        jstring ret = static_cast<jstring>(env->CallObjectMethod(obj,
            method_id));
        jni_generator::CheckException(env);
