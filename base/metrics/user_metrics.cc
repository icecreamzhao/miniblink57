...
namespace {
    ...
    LazyInstance<std::vector<ActionCallback>> g_callbacks = LAZY_INSTANCE_INITIALIZER;
    LazyInstance<scoped_refptr<SingleThreadTaskRunner>> g_task_runner = LAZY_INSTANCE_INITIALIZER;
