...
static_assert(File::FROM_BEGIN == FILE_BEGIN && File::FROM_CURRENT == FILE_CURRENT && File::FROM_END == FILE_END,
...
bool File::SetLength(int64_t length)
{
    ...
    return ((::SetEndOfFile(file_.Get()) != FALSE) && (::SetFilePointerEx(file_.Get(), file_pointer, NULL, FILE_BEGIN) != FALSE));
}
