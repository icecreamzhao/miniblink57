...
enum OldFileDeletionState { DELETE_OLD_LOG_FILE,
...
#define CHECK_OP(name, op, val1, val2)                                                             \
    ...
    case 0:                                                                                        \
    default:                                                                                       \
        if (::logging::CheckOpResult true_if_passed = ::logging::Check##name##Impl((val1), (val2), \
                #val1 " " #op " " #val2))                                                          \
            ;                                                                                      \
        else                                                                                       \
...
inline typename std::enable_if<
    base::internal::SupportsOstreamOperator<const T&>::value && !std::is_function<typename std::remove_pointer<T>::type>::value,
    void>::type
...
template <typename T>
inline typename std::enable_if<
    !base::internal::SupportsOstreamOperator<const T&>::value && std::is_enum<T>::value,
    void>::type
MakeCheckOpValueString(std::ostream* os, const T& v)
{
...
#define DCHECK_OP(name, op, val1, val2)                                                                             \
    ...
    case 0:                                                                                                         \
    default:                                                                                                        \
        if (::logging::CheckOpResult true_if_passed = DCHECK_IS_ON() ? ::logging::Check##name##Impl((val1), (val2), \
                                                          #val1 " " #op " " #val2)                                  \
                                                                     : nullptr)                                     \
            ;                                                                                                       \
        else                                                                                                        \
