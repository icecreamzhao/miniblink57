...
#define CMP_Y(op, x, y)                                                                                                     \
    {                                                                                                                       \
        ...
        ASSERT_TRUE((BasicStringPiece<TypeParam>((lhs.c_str())).compare(BasicStringPiece<TypeParam>((rhs.c_str()))) op 0)); \
    }
...
#define CMP_N(op, x, y)                                                                                                      \
    {                                                                                                                        \
        ...
        ASSERT_FALSE((BasicStringPiece<TypeParam>((lhs.c_str())) op                                                          \
                BasicStringPiece<TypeParam>((rhs.c_str()))));                                                                \
        ASSERT_FALSE((BasicStringPiece<TypeParam>((lhs.c_str())).compare(BasicStringPiece<TypeParam>((rhs.c_str()))) op 0)); \
    }
...
{
    ASSERT_TRUE(TestFixture::as_string("hello").c_str() == TestFixture::as_string("hello"));
    ASSERT_TRUE(TestFixture::as_string("hello").c_str() < TestFixture::as_string("world"));
}
...
TYPED_TEST(CommonStringPieceTest, CheckConstructors)
{
    ...
    ASSERT_TRUE(TestFixture::as_string("hello") == BasicStringPiece<TypeParam>(str.c_str(), 5));
    ASSERT_TRUE(empty == BasicStringPiece<TypeParam>(str.c_str(), static_cast<typename BasicStringPiece<TypeParam>::size_type>(0)));
    ASSERT_TRUE(empty == BasicStringPiece<TypeParam>(NULL));
    ASSERT_TRUE(empty == BasicStringPiece<TypeParam>(NULL, static_cast<typename BasicStringPiece<TypeParam>::size_type>(0)));
