...
// complain, but clang does.
                ...
                static_assert(kSSizeMaxConst == static_cast<size_t>(std::numeric_limits<ssize_t>::max()),
                ...
                format_character_found:
                    ...
                    case '9':
                        ...
                        for (;;) {
                            ...
                            if (padding > max_padding / 10 || 10 * padding > max_padding - (ch - '0')) {
                                DEBUG_CHECK(padding <= max_padding / 10 && 10 * padding <= max_padding - (ch - '0'));
                    ...
                    case 'p': { // Output a pointer value.
                        ...
                        if (ch != 'p') {
                            ...
                            } else if (arg.type == Arg::INT && arg.integer.width == sizeof(NULL) && arg.integer.i == 0) { // Allow C++'s version of NULL
                                i = 0;
                            } else {
