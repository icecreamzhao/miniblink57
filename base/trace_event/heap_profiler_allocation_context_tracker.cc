...
namespace trace_event {
    ...
    subtle::Atomic32 AllocationContextTracker::capture_mode_ = static_cast<int32_t>(AllocationContextTracker::CaptureMode::DISABLED);

    namespace {

        const size_t kMaxStackDepth = 128u;
        const size_t kMaxTaskDepth = 16u;
        AllocationContextTracker* const kInitializingSentinel = reinterpret_cast<AllocationContextTracker*>(-1);
    ...
    {
        AllocationContextTracker* tracker = static_cast<AllocationContextTracker*>(g_tls_alloc_ctx_tracker.Get());
    ...
    AllocationContext AllocationContextTracker::GetContextSnapshot()
    {
        ...
        case CaptureMode::NATIVE_STACK: {
            ...
            size_t top_frame_index = (backtrace_capacity >= frame_count) ? 0 : frame_count - backtrace_capacity;
