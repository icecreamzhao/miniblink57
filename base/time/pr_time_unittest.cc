...
protected:
    void SetUp() override
    {
        ...
        comparison_time_local_ = mktime(&local_comparison_tm) * Time::kMicrosecondsPerSecond;
        ...
        comparison_time_local_2_ = mktime(&local_comparison_tm_2) * Time::kMicrosecondsPerSecond;
