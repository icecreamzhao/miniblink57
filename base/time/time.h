...
private:
    ...
    /*constexpr*/ explicit TimeDelta(int64_t delta_us)
        : delta_(delta_us)
    {
    }
...
namespace time_internal {
    ...
    public:
        ...
        static const int64_t kMillisecondsPerDay = kMillisecondsPerSecond * 60 * 60 * kHoursPerDay;
        ...
        static const int64_t kMicrosecondsPerDay = kMicrosecondsPerHour * kHoursPerDay;
...
public:
    ...
    {
#if (defined(_POSIX_THREAD_CPUTIME) && (_POSIX_THREAD_CPUTIME >= 0)) || (defined(OS_MACOSX) && !defined(OS_IOS)) || defined(OS_ANDROID)
        return true;
#elif defined(OS_WIN)
...
private:
    ...
    explicit ThreadTicks(int64_t us)
        : TimeBase(us)
    {
    }
