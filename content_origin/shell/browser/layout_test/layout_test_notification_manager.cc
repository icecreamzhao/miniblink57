    ...
    base::Closure* cancel_callback)
{
    ...
    *cancel_callback = base::Bind(&LayoutTestNotificationManager::Close,
    ...
    notification_id_map_[base::UTF16ToUTF8(notification_data.title)] = notification_id;
}
    ...
    const base::NullableString16& reply)
{
    ...
    const auto non_persistent_iter = non_persistent_notifications_.find(notification_id);
