...
namespace {
    ...
    base::StringPiece PlatformResourceProvider(int key)
    {
        if (key == IDR_DIR_HEADER_HTML) {
            base::StringPiece html_data = ui::ResourceBundle::GetSharedInstance().GetRawDataResource(
                IDR_DIR_HEADER_HTML);
            return html_data;
        }
...
int ShellBrowserMainParts::PreCreateThreads()
{
    ...
    if (base::CommandLine::ForCurrentProcess()->HasSwitch(
        ...
        base::FilePath crash_dumps_dir = base::CommandLine::ForCurrentProcess()->GetSwitchValuePath(
