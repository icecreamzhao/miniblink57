...
bool ShellMainDelegate::BasicStartupComplete(int* exit_code)
{
    ...
    if (command_line.HasSwitch(switches::kRunLayoutTest)) {
        ...
        if (!command_line.HasSwitch(switches::kUseGpuInTests) && !command_line.HasSwitch(switches::kUseGL)) {
        ...
        if (!command_line.HasSwitch(switches::kForceGpuRasterization) && !command_line.HasSwitch(switches::kEnableGpuRasterization)) {
...
void ShellMainDelegate::PreSandboxStartup()
{
    ...
    if (base::CommandLine::ForCurrentProcess()->HasSwitch(
        ...
        std::string process_type = base::CommandLine::ForCurrentProcess()->GetSwitchValueASCII(
    ...
    const MainFunctionParams& main_function_params)
{
    ...
    base::CommandLine& command_line = *base::CommandLine::ForCurrentProcess();
    return command_line.HasSwitch(switches::kRunLayoutTest) || command_line.HasSwitch(switches::kCheckLayoutTestSysDeps)
...
void ShellMainDelegate::InitializeResourceBundle()
{
    ...
    if (pak_fd >= 0) {
        ...
        pak_fd = base::android::OpenApkAsset("assets/content_shell.pak", &pak_region);
