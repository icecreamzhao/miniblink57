...
void ExportLayoutTestSpecificPreferences(
    ...
    WebPreferences* to)
{
    to->allow_universal_access_from_file_urls = from.allow_universal_access_from_file_urls;
    ...
    to->javascript_can_open_windows_automatically = from.java_script_can_open_windows_automatically;
    ...
    to->strict_powerful_feature_restrictions = from.strict_powerful_feature_restrictions;
...
void ApplyLayoutTestDefaultPreferences(WebPreferences* prefs)
{
    ...
    base::string16 serif;
#if defined(OS_MACOSX)
    prefs->cursive_font_family_map[kCommonScript] = base::ASCIIToUTF16("Apple Chancery");
    prefs->fantasy_font_family_map[kCommonScript] = base::ASCIIToUTF16("Papyrus");
    serif = base::ASCIIToUTF16("Times");
#else
    prefs->cursive_font_family_map[kCommonScript] = base::ASCIIToUTF16("Comic Sans MS");
    ...
    prefs->sans_serif_font_family_map[kCommonScript] = base::ASCIIToUTF16("Helvetica");
    prefs->minimum_logical_font_size = 9;
    prefs->accelerated_2d_canvas_enabled = command_line.HasSwitch(switches::kEnableAccelerated2DCanvas);
