...
const char InterfaceRegistryJsWrapper::kPerFrameModuleName[] = "content/shell/renderer/layout_test/frame_interface_registry";
const char InterfaceRegistryJsWrapper::kPerProcessModuleName[] = "content/shell/renderer/layout_test/interface_registry";
    ...
    service_manager::InterfaceRegistry* interface_registry)
{
    return gin::CreateHandle(
        isolate, new InterfaceRegistryJsWrapper(isolate, context, interface_registry->GetWeakPtr()));
}
