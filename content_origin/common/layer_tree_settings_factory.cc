    ...
    const base::CommandLine& cmd)
{
    if (cmd.HasSwitch(cc::switches::kBrowserControlsShowThreshold)) {
        std::string top_threshold_str = cmd.GetSwitchValueASCII(cc::switches::kBrowserControlsShowThreshold);
    ...
    if (cmd.HasSwitch(cc::switches::kBrowserControlsHideThreshold)) {
        std::string top_threshold_str = cmd.GetSwitchValueASCII(cc::switches::kBrowserControlsHideThreshold);
