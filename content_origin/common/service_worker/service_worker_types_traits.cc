...
content::mojom::ServiceWorkerProviderType EnumTraits<
    ...
    content::ServiceWorkerProviderType>::ToMojom(content::ServiceWorkerProviderType input)
{
    return static_cast<content::mojom::ServiceWorkerProviderType>(input);
}

bool EnumTraits<content::mojom::ServiceWorkerProviderType,
    content::ServiceWorkerProviderType>::FromMojom(content::mojom::ServiceWorkerProviderType input,
