...
{
    return UseDedicatedProcessesForAllSites() || IsTopDocumentIsolationEnabled() || GetContentClient()->IsSupplementarySiteIsolationModeEnabled() || base::FeatureList::IsEnabled(::features::kGuestViewCrossProcessFrames);
}
