...
bool LocalMediaStreamAudioSource::EnsureSourceIsStarted()
{
    ...
    source_ = AudioDeviceFactory::NewAudioCapturerSource(consumer_render_frame_id_);
    ...
    bool key_pressed)
{
    ...
    MediaStreamAudioSource::DeliverDataToTracks(
        *audio_bus,
        base::TimeTicks::Now() - base::TimeDelta::FromMilliseconds(audio_delay_milliseconds));
}
