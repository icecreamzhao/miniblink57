...
namespace {
    ...
    base::LazyInstance<ConnectionMap>::Leaky g_connections = LAZY_INSTANCE_INITIALIZER;
}
    ...
    std::unique_ptr<InputEventAck> input_event_ack)
{
    ...
    pending_ack_.Run(input_event_ack->state == InputEventAckState::INPUT_EVENT_ACK_STATE_CONSUMED
