    ...
    std::unique_ptr<ServiceWorkerContextClient> context_client)
{
    ...
    start_data.userAgent = blink::WebString::fromUTF8(GetContentClient()->GetUserAgent());
    start_data.waitForDebuggerMode = params.wait_for_debugger
    ...
    start_data.pauseAfterDownloadMode = params.pause_after_download
