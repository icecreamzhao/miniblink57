...
TEST_F(PepperFileChooserHostTest, Show)
{
    ...
    RenderFrameImpl* frame_impl = static_cast<RenderFrameImpl*>(view_->GetMainRenderFrame());
    ...
    const std::vector<ppapi::FileRefCreateInfo>& chooser_results = std::get<0>(reply_msg_param);
