    ...
    base::SyncSocket::Handle socket_handle)
{
    ...
    if (result == PP_OK) {
        IPC::PlatformFileForTransit temp_socket = IPC::InvalidPlatformFileForTransit();
    ...
    base::SharedMemoryHandle* remote_shared_memory_handle)
{
    ...
    *remote_shared_memory_handle = renderer_ppapi_host_->ShareSharedMemoryHandleWithRemote(
