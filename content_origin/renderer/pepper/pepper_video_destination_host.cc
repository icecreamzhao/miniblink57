    ...
    PP_TimeTicks timestamp)
{
    ...
    PPB_ImageData_Impl* image_data_impl = static_cast<PPB_ImageData_Impl*>(enter.object());
    ...
    // nanoseconds).
    const int64_t timestamp_ns = static_cast<int64_t>(timestamp * base::Time::kNanosecondsPerSecond);
