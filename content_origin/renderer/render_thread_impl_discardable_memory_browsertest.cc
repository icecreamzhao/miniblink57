...
namespace {
    ...
    private:
        ...
        {
            child_discardable_shared_memory_manager_ = RenderThreadImpl::current()->GetDiscardableSharedMemoryManagerForTest();
        }
        ...
        LockDiscardableMemory)
    {
        ...
        std::unique_ptr<base::DiscardableMemory> memory = child_discardable_shared_memory_manager()
...
// See http://crbug.com/667837 for detail.
        ...
        ReleaseFreeDiscardableMemory)
    {
        ...
        base::TimeTicks end = base::TimeTicks::Now() + base::TimeDelta::FromSeconds(5);
