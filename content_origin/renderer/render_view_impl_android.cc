...
// are kept in sync.
static_assert(int(BROWSER_CONTROLS_STATE_SHOWN) == int(blink::WebBrowserControlsShown),
    "mismatching enums: SHOWN");
static_assert(int(BROWSER_CONTROLS_STATE_HIDDEN) == int(blink::WebBrowserControlsHidden),
    "mismatching enums: HIDDEN");
static_assert(int(BROWSER_CONTROLS_STATE_BOTH) == int(blink::WebBrowserControlsBoth),
