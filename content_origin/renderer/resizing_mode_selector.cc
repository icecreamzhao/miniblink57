...
{
    return is_synchronous_mode_ && params.is_fullscreen_granted == widget->is_fullscreen_granted() && params.display_mode == widget->display_mode() && params.screen_info.device_scale_factor == widget->screenInfo().deviceScaleFactor;
}
