...
protected:
    void SetUp() override
    {
        ...
        shared_memory_ = mojo::SharedBufferHandle::Create(sizeof(DeviceLightHardwareBuffer));
...
TEST_F(DeviceLightEventPumpTest, DidStartPollingValuesEqual)
{
    ...
    base::ThreadTaskRunnerHandle::Get()->PostTask(
        FROM_HERE, base::Bind(&DeviceLightEventPumpForTesting::FireEvent, base::Unretained(light_pump())));
    base::RunLoop().Run();
