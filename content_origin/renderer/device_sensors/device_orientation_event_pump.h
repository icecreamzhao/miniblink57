...
using DeviceOrientationEventPump = DeviceSensorMojoClientMixin<DeviceOrientationEventPumpBase,
    device::mojom::OrientationSensor>;

using DeviceOrientationAbsoluteEventPump = DeviceSensorMojoClientMixin<DeviceOrientationEventPumpBase,
