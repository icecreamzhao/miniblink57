...
void BootstrapSandboxManager::RegisterRendererPolicy()
{
    ...
    policy.rules["com.apple.FontObjectsServer"] = sandbox::Rule(sandbox::POLICY_ALLOW);
    ...
    policy.rules["com.apple.windowserver.active"] = sandbox::Rule(sandbox::POLICY_ALLOW);
    ...
    if (base::mac::IsAtLeastOS10_10()) {
        policy.rules["com.apple.coreservices.launchservicesd"] = sandbox::Rule(sandbox::POLICY_ALLOW);
    }
