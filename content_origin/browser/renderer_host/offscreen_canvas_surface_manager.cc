...
namespace {
    base::LazyInstance<OffscreenCanvasSurfaceManager>::Leaky g_manager = LAZY_INSTANCE_INITIALIZER;
}
...
{
    auto surface_iter = registered_surface_instances_.find(surface_info.id().frame_sink_id());
