...
const int kDeviceSensorIntervalMicroseconds = base::Time::kMicrosecondsPerSecond / kDeviceSensorSamplingRateHz;
...
const int kLightSensorIntervalMicroseconds = base::Time::kMicrosecondsPerSecond / kLightSensorSamplingRateHz;
