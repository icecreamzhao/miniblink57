...
using DeviceLightHost = DeviceSensorHost<device::mojom::LightSensor, CONSUMER_TYPE_LIGHT>;
using DeviceMotionHost = DeviceSensorHost<device::mojom::MotionSensor, CONSUMER_TYPE_MOTION>;
using DeviceOrientationHost = DeviceSensorHost<device::mojom::OrientationSensor,
    CONSUMER_TYPE_ORIENTATION>;
using DeviceOrientationAbsoluteHost = DeviceSensorHost<device::mojom::OrientationAbsoluteSensor,
