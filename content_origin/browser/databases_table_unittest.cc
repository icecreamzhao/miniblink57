...
TEST(DatabasesTableTest, TestIt)
{
    ...
    EXPECT_TRUE(databases_table.GetDatabaseDetails(
        ...
        details_in1.database_name,
        &details_out1));
    EXPECT_EQ(1, databases_table.GetDatabaseID(details_in1.origin_identifier, details_in1.database_name));
    ...
    EXPECT_EQ(2, databases_table.GetDatabaseID(details_in2.origin_identifier, details_in2.database_name));
    ...
    EXPECT_EQ(3, databases_table.GetDatabaseID(details_in3.origin_identifier, details_in3.database_name));
