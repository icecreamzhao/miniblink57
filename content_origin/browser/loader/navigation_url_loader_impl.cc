    ...
    , weak_factory_(this)
{
    ...
    ServiceWorkerNavigationHandleCore* service_worker_handle_core = service_worker_handle ? service_worker_handle->core() : nullptr;
    AppCacheNavigationHandleCore* appcache_handle_core = appcache_handle ? appcache_handle->core() : nullptr;
