...
// Key:
CONTENT_EXPORT extern const char kTextureSharedMode[];
// Value:
CONTENT_EXPORT extern const char kUseEglImageKhr[];
CONTENT_EXPORT extern const char kUseShareGroup[];
CONTENT_EXPORT extern const char kUseSyncUpload[];
#endif
