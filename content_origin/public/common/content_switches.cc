...
const char kAllowLoopbackInPeerConnection[] = "allow-loopback-in-peer-connection";
...
// available.
const char kDisableAcceleratedMjpegDecode[] = "disable-accelerated-mjpeg-decode";

// Disables hardware acceleration of video decode, where available.
const char kDisableAcceleratedVideoDecode[] = "disable-accelerated-video-decode";
...
extern const char kDisableBackgroundingOccludedWindowsForTesting[] = "disable-backgrounding-occluded-windows";

// Disable task throttling of timer tasks from background pages.
const char kDisableBackgroundTimerThrottling[] = "disable-background-timer-throttling";
...
const char kDisableDomainBlockingFor3DAPIs[] = "disable-domain-blocking-for-3d-apis";
...
const char kDisableGestureRequirementForMediaPlayback[] = "disable-gesture-requirement-for-media-playback";

// Disable user gesture requirement for presentation.
const char kDisableGestureRequirementForPresentation[] = "disable-gesture-requirement-for-presentation";
...
const char kDisableGpuMemoryBufferCompositorResources[] = "disable-gpu-memory-buffer-compositor-resources";

// Disable GpuMemoryBuffer backed VideoFrames.
const char kDisableGpuMemoryBufferVideoFrames[] = "disable-gpu-memory-buffer-video-frames";
...
// stacked mode.
const char kDisableHideInactiveStackedTabCloseButtons[] = "disable-hide-inactive-stacked-tab-close-buttons";
...
const char kDisablePreferCompositingToLCDText[] = "disable-prefer-compositing-to-lcd-text";
...
const char kDisableSlimmingPaintInvalidation[] = "disable-slimming-paint-invalidation";
...
const char kDisableAcceleratedJpegDecoding[] = "disable-accelerated-jpeg-decoding";
...
const char kEnablePreferCompositingToLCDText[] = "enable-prefer-compositing-to-lcd-text";
...
const char kEnableColorCorrectRenderingDefaultMode[] = "enable-color-correct-rendering-default-mode";
...
const char kEnableCanvas2dDynamicRenderingModeSwitching[] = "enable-canvas-2d-dynamic-rendering-mode-switching";

// Enable experimental canvas features, e.g. canvas 2D context attributes
const char kEnableExperimentalCanvasFeatures[] = "enable-experimental-canvas-features";

// Enables Web Platform features that are in development.
const char kEnableExperimentalWebPlatformFeatures[] = "enable-experimental-web-platform-features";
...
const char kEnableWebFontsInterventionV2SwitchValueEnabledWith2G[] = "enabled-2g";
const char kEnableWebFontsInterventionV2SwitchValueEnabledWith3G[] = "enabled-3g";
const char kEnableWebFontsInterventionV2SwitchValueEnabledWithSlow2G[] = "enabled-slow2g";
...
const char kEnableGpuMemoryBufferCompositorResources[] = "enable-gpu-memory-buffer-compositor-resources";

// Enable GpuMemoryBuffer backed VideoFrames.
const char kEnableGpuMemoryBufferVideoFrames[] = "enable-gpu-memory-buffer-video-frames";
...
const char kEnablePluginPlaceholderTesting[] = "enable-plugin-placeholder-testing";
...
const char kV8CacheStrategiesForCacheStorage[] = "v8-cache-strategies-for-cache-storage";
...
const char kEnableSlimmingPaintInvalidation[] = "enable-slimming-paint-invalidation";
...
const char kEnableStrictMixedContentChecking[] = "enable-strict-mixed-content-checking";
...
const char kEnableStrictPowerfulFeatureRestrictions[] = "enable-strict-powerful-feature-restrictions";
...
const char kEnableUserMediaScreenCapturing[] = "enable-usermedia-screen-capturing";
...
const char kEnableWebFontsInterventionTrigger[] = "enable-webfonts-intervention-trigger";
...
const char kGenerateAccessibilityTestExpectations[] = "generate-accessibility-test-expectations";
...
const char kHistoryEntryRequiresUserGesture[] = "history-entry-requires-user-gesture";
...
const char kDisableJavaScriptHarmonyShipping[] = "disable-javascript-harmony-shipping";
...
const char kMainFrameResizesAreOrientationChanges[] = "main-frame-resizes-are-orientation-changes";
...
const char kOverridePluginPowerSaverForTesting[] = "override-plugin-power-saver-for-testing";
...
// Defaults to '1'.
const char kOverscrollHistoryNavigation[] = "overscroll-history-navigation";
...
const char kEnforceWebRtcIPPermissionCheck[] = "enforce-webrtc-ip-permission-check";
...
// viewport boundaries.
const char kEnableAdaptiveSelectionHandleOrientation[] = "enable-adaptive-selection-handle-orientation";

// Enable content intent detection in the renderer.
const char kEnableContentIntentDetection[] = "enable-content-intent-detection";
...
const char kEnableAggressiveDOMStorageFlushing[] = "enable-aggressive-domstorage-flushing";

// Enable audio for desktop share.
const char kDisableAudioSupportForDesktopShare[] = "disable-audio-support-for-desktop-share";
...
// processes.
const char kPpapiSubpixelRenderingSetting[] = "ppapi-subpixel-rendering-setting";
...
const char kTextureSharedMode[] = "texture-shared-mode";
const char kUseEglImageKhr[] = "use_egl-image-khr";
const char kUseShareGroup[] = "use-share-group";
const char kUseSyncUpload[] = "use-sync-upload";
#endif
