...
using ViewProxyCreationCallback = base::Callback<void(RenderView*, test_runner::WebViewTestProxyBase*)>;
using WidgetProxyCreationCallback = base::Callback<void(blink::WebWidget*,
    test_runner::WebWidgetTestProxyBase*)>;
using FrameProxyCreationCallback = base::Callback<void(RenderFrame*, test_runner::WebFrameTestProxyBase*)>;
