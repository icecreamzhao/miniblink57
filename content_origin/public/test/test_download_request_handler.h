...
public:
    ...
    using OnStartResponseCallback = base::Callback<void(const std::string&, net::Error)>;
    ...
    struct CompletedRequest {
        ...
        std::string referrer;
        net::URLRequest::ReferrerPolicy referrer_policy = net::URLRequest::NEVER_CLEAR_REFERRER;

        GURL first_party_for_cookies;
        net::URLRequest::FirstPartyURLPolicy first_party_url_policy = net::URLRequest::NEVER_CHANGE_FIRST_PARTY_URL;
