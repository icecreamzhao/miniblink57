    ...
    blink::WebMediaStream* web_media_stream)
{
    ...
    MediaStreamVideoSource* const media_stream_source = new MediaStreamVideoCapturerSource(
        MediaStreamSource::SourceStoppedCallback(), std::move(video_source));
    const blink::WebString track_id = blink::WebString::fromUTF8(base::GenerateGUID());
    ...
    blink::WebMediaStream* web_media_stream)
{
    ...
    web_media_stream_source.initialize(track_id,
        ...
        track_id, is_remote);
    MediaStreamAudioSource* const media_stream_source = new ExternalMediaStreamAudioSource(std::move(audio_source), sample_rate,
    ...
    const blink::WebMediaStreamTrack& video_track)
{
    ...
    MediaStreamVideoSource* const source = MediaStreamVideoSource::GetVideoSource(video_track.source());
    if (!source)
        return nullptr;
