...
static void GetNativeThemeCustomExtraParams(
    ...
    ui::NativeTheme::ExtraParams* native_theme_extra_params)
{
    switch (part) {
    case WebThemeEngine::PartCheckbox:
        native_theme_extra_params->button.is_night_mode = extra_params->button.isNightMode;
        break;
    case WebThemeEngine::PartRadio:
        native_theme_extra_params->button.is_night_mode = extra_params->button.isNightMode;
        break;
    case WebThemeEngine::PartButton:
        ...
        break;
    case WebThemeEngine::PartTextField:
        native_theme_extra_params->text_field.is_focused = extra_params->textField.isFocused;
        native_theme_extra_params->text_field.is_night_mode = extra_params->textField.isNightMode;
        break;
    case WebThemeEngine::PartMenuList:
        native_theme_extra_params->menu_list.is_night_mode = extra_params->menuList.isNightMode;
        native_theme_extra_params->menu_list.use_arrow_color = extra_params->menuList.useArrowColor;
        break;
    default:
...
{
#ifdef TENCENT_CHANGES
    GetNativeThemeCustomExtraParams(part, state, extra_params, native_theme_extra_params);
#endif
    switch (part) {
    case WebThemeEngine::PartScrollbarHorizontalTrack:
    case WebThemeEngine::PartScrollbarVerticalTrack:
    ...
    case WebThemeEngine::PartCheckbox:
        ...
        native_theme_extra_params->button.indeterminate = extra_params->button.indeterminate;
        break;
    case WebThemeEngine::PartRadio:
        native_theme_extra_params->button.checked = extra_params->button.checked;
        break;
    case WebThemeEngine::PartButton:
        native_theme_extra_params->button.is_default = extra_params->button.isDefault;
        native_theme_extra_params->button.has_border = extra_params->button.hasBorder;
        // Native buttons have a different focus style.
        native_theme_extra_params->button.is_focused = false;
        native_theme_extra_params->button.background_color = extra_params->button.backgroundColor;
        break;
    case WebThemeEngine::PartTextField:
        native_theme_extra_params->text_field.is_text_area = extra_params->textField.isTextArea;
        native_theme_extra_params->text_field.is_listbox = extra_params->textField.isListbox;
        native_theme_extra_params->text_field.background_color = extra_params->textField.backgroundColor;
        break;
    case WebThemeEngine::PartMenuList:
        native_theme_extra_params->menu_list.has_border = extra_params->menuList.hasBorder;
        native_theme_extra_params->menu_list.has_border_radius = extra_params->menuList.hasBorderRadius;
        native_theme_extra_params->menu_list.arrow_x = extra_params->menuList.arrowX;
        native_theme_extra_params->menu_list.arrow_y = extra_params->menuList.arrowY;
        native_theme_extra_params->menu_list.arrow_size = extra_params->menuList.arrowSize;
        native_theme_extra_params->menu_list.arrow_color = extra_params->menuList.arrowColor;
        native_theme_extra_params->menu_list.background_color = extra_params->menuList.backgroundColor;
        break;
    case WebThemeEngine::PartSliderTrack:
    case WebThemeEngine::PartSliderThumb:
        ...
        break;
    case WebThemeEngine::PartInnerSpinButton:
        native_theme_extra_params->inner_spin.spin_up = extra_params->innerSpin.spinUp;
        native_theme_extra_params->inner_spin.read_only = extra_params->innerSpin.readOnly;
        break;
    case WebThemeEngine::PartProgressBar:
        native_theme_extra_params->progress_bar.determinate = extra_params->progressBar.determinate;
        native_theme_extra_params->progress_bar.value_rect_x = extra_params->progressBar.valueRectX;
        native_theme_extra_params->progress_bar.value_rect_y = extra_params->progressBar.valueRectY;
        native_theme_extra_params->progress_bar.value_rect_width = extra_params->progressBar.valueRectWidth;
        native_theme_extra_params->progress_bar.value_rect_height = extra_params->progressBar.valueRectHeight;
        break;
    default:
        break; // Parts that have no extra params get here.
    }
