...
namespace {
    LazyInstance<std::unique_ptr<ContentMainRunner>> g_content_runner = LAZY_INSTANCE_INITIALIZER;

    LazyInstance<std::unique_ptr<ContentMainDelegate>> g_content_main_delegate = LAZY_INSTANCE_INITIALIZER;
