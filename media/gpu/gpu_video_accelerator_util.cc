    ...
    const gpu::VideoDecodeAcceleratorCapabilities& gpu_capabilities)
{
    ...
    capabilities.supported_profiles = ConvertGpuToMediaDecodeProfiles(gpu_capabilities.supported_profiles);
    ...
    const VideoDecodeAccelerator::Capabilities& media_capabilities)
{
    ...
    capabilities.supported_profiles = ConvertMediaToGpuDecodeProfiles(media_capabilities.supported_profiles);
    ...
    const VideoDecodeAccelerator::SupportedProfiles& media_profiles)
{
    ...
    for (const auto& media_profile : media_profiles) {
        ...
        profile.profile = static_cast<gpu::VideoCodecProfile>(media_profile.profile);
