...
#if (defined(OS_MACOSX) || defined(OS_WIN)) && (defined(ARCH_CPU_X86) || defined(ARCH_CPU_X86_64))
...
{
    base::FilePath path;
    const std::string kPlatformArch = std::string(kComponentPlatform) + "_" + kComponentArch;
