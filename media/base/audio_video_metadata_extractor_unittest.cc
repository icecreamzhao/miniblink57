...
{
    std::unique_ptr<AudioVideoMetadataExtractor> extractor = GetExtractor("9ch.ogg", true, true, 0, -1, -1);
...
{
    std::unique_ptr<AudioVideoMetadataExtractor> extractor = GetExtractor("sfx_u8.wav", true, true, 0, -1, -1);
...
{
    std::unique_ptr<AudioVideoMetadataExtractor> extractor = GetExtractor("bear-320x240-multitrack.webm", true, true, 2, 320, 240);
...
{
    std::unique_ptr<AudioVideoMetadataExtractor> extractor = GetExtractor("90rotation.mp4", true, true, 0, 1920, 1080);
    ...
    EXPECT_EQ("isom3gp4", GetTagValue(extractor->stream_infos()[0].tags, "compatible_brands"));
...
{
    std::unique_ptr<AudioVideoMetadataExtractor> extractor = GetExtractor("id3_png_test.mp3", true, true, 1, -1, -1);
