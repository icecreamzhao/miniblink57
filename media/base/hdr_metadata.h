...
struct MEDIA_EXPORT MasteringMetadata {
    ...
    {
        return ((primary_r_chromaticity_x == rhs.primary_r_chromaticity_x) && (primary_r_chromaticity_y == rhs.primary_r_chromaticity_y) && (primary_g_chromaticity_x == rhs.primary_g_chromaticity_x) && (primary_g_chromaticity_y == rhs.primary_g_chromaticity_y) && (primary_b_chromaticity_x == rhs.primary_b_chromaticity_x) && (primary_b_chromaticity_y == rhs.primary_b_chromaticity_y) && (white_point_chromaticity_x == rhs.white_point_chromaticity_x) && (white_point_chromaticity_y == rhs.white_point_chromaticity_y) && (luminance_max == rhs.luminance_max) && (luminance_min == rhs.luminance_min));
    }
};
...
struct MEDIA_EXPORT HDRMetadata {
    ...
    {
        return ((max_cll == rhs.max_cll) && (max_fall == rhs.max_fall) && (mastering_metadata == rhs.mastering_metadata));
    }
};
