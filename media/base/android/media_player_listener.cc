...
void MediaPlayerListener::OnMediaError(JNIEnv* /* env */,
    ...
    jint error_type)
{
    task_runner_->PostTask(FROM_HERE, base::Bind(&MediaPlayerAndroid::OnMediaError, media_player_, error_type));
}
...
void MediaPlayerListener::OnVideoSizeChanged(
    ...
    jint height)
{
    task_runner_->PostTask(FROM_HERE, base::Bind(&MediaPlayerAndroid::OnVideoSizeChanged, media_player_, width, height));
}
...
void MediaPlayerListener::OnBufferingUpdate(
    ...
    jint percent)
{
    task_runner_->PostTask(FROM_HERE, base::Bind(&MediaPlayerAndroid::OnBufferingUpdate, media_player_, percent));
}
...
void MediaPlayerListener::OnPlaybackComplete(
    ...
    const JavaParamRef<jobject>& /* obj */)
{
    task_runner_->PostTask(FROM_HERE, base::Bind(&MediaPlayerAndroid::OnPlaybackComplete, media_player_));
}
...
void MediaPlayerListener::OnSeekComplete(
    ...
    const JavaParamRef<jobject>& /* obj */)
{
    task_runner_->PostTask(FROM_HERE, base::Bind(&MediaPlayerAndroid::OnSeekComplete, media_player_));
}
...
void MediaPlayerListener::OnMediaPrepared(
    ...
    const JavaParamRef<jobject>& /* obj */)
{
    task_runner_->PostTask(FROM_HERE, base::Bind(&MediaPlayerAndroid::OnMediaPrepared, media_player_));
}
...
void MediaPlayerListener::OnMediaInterrupted(
    ...
    const JavaParamRef<jobject>& /* obj */)
{
    task_runner_->PostTask(FROM_HERE, base::Bind(&MediaPlayerAndroid::OnMediaInterrupted, media_player_));
}
