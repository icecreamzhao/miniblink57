...
public:
    ...
    static constexpr SampleType kMinValue = std::numeric_limits<SampleType>::min();
    static constexpr SampleType kMaxValue = std::numeric_limits<SampleType>::max();
    static constexpr SampleType kZeroPointValue = (kMinValue == 0) ? (kMaxValue / 2 + 1) : 0;
...
private:
    ...
    struct ScalingFactors {
        ...
        static constexpr FloatType kForPositiveInput = static_cast<FloatType>(kMaxValue) - static_cast<FloatType>(kZeroPointValue);
        ...
        static constexpr FloatType kForNegativeInput = static_cast<FloatType>(kZeroPointValue) - static_cast<FloatType>(kMinValue);

        static constexpr FloatType kInverseForPositiveInput = 1.0f / kForPositiveInput;

        static constexpr FloatType kInverseForNegativeInput = 1.0f / kForNegativeInput;
    };
    ...
    static SampleType From(FloatType source_value)
    {
        ...
        if (source_value < 0) {
            ...
            return static_cast<SampleType>(
                (source_value * ScalingFactors<FloatType>::kForNegativeInput) + static_cast<FloatType>(kZeroPointValue));
        } else {
            // Apply clipping (aka. clamping).
            ...
            if (source_value >= FloatSampleTypeTraits<float>::kMaxValue)
                return kMaxValue;
            return static_cast<SampleType>(
                (source_value * ScalingFactors<FloatType>::kForPositiveInput) + static_cast<FloatType>(kZeroPointValue));
        }
    }
    ...
    static FloatType To(SampleType source_value)
    {
        FloatType offset_value = static_cast<FloatType>(source_value - kZeroPointValue);
