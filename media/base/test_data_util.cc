...
const base::FilePath::CharType kTestDataPath[] = FILE_PATH_LITERAL("media/test/data");
    ...
    std::string* key)
{
    ...
    bool result = LookupTestKeyVector(std::vector<uint8_t>(key_id.begin(), key_id.end()),
