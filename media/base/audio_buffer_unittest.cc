...
TEST(AudioBufferTest, CopyFrom)
{
    ...
    scoped_refptr<AudioBuffer> new_buffer = AudioBuffer::CopyFrom(kSampleFormatU8,
...
TEST(AudioBufferTest, FrameSize)
{
    ...
    scoped_refptr<AudioBuffer> buffer = AudioBuffer::CopyFrom(kSampleFormatU8,
...
TEST(AudioBufferTest, ReadU8)
{
    ...
    scoped_refptr<AudioBuffer> buffer = MakeAudioBuffer<uint8_t>(kSampleFormatU8, channel_layout, channels,
...
TEST(AudioBufferTest, ReadS16)
{
    ...
    const int frames = 10;
    const base::TimeDelta start_time;
    scoped_refptr<AudioBuffer> buffer = MakeAudioBuffer<int16_t>(kSampleFormatS16, channel_layout, channels,
...
TEST(AudioBufferTest, ReadS32)
{
    ...
    const int frames = 20;
    const base::TimeDelta start_time;
    scoped_refptr<AudioBuffer> buffer = MakeAudioBuffer<int32_t>(kSampleFormatS32, channel_layout, channels,
        kSampleRate, 1, 1, frames, start_time);
    std::unique_ptr<AudioBus> bus = AudioBus::Create(channels, frames);
    buffer->ReadFrames(frames, 0, 0, bus.get());
...
TEST(AudioBufferTest, ReadS16Planar)
{
    ...
    const int frames = 20;
    const base::TimeDelta start_time;
    scoped_refptr<AudioBuffer> buffer = MakeAudioBuffer<int16_t>(kSampleFormatPlanarS16, channel_layout, channels,
        kSampleRate, 1, 1, frames, start_time);
    std::unique_ptr<AudioBus> bus = AudioBus::Create(channels, frames);
    buffer->ReadFrames(10, 0, 0, bus.get());
...
TEST(AudioBufferTest, ReadF32Planar)
{
    ...
    const base::TimeDelta start_time;
    scoped_refptr<AudioBuffer> buffer = MakeAudioBuffer<float>(kSampleFormatPlanarF32,
        channel_layout,
        channels,
        kSampleRate,
        1.0f,
