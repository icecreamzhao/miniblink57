...
namespace {
    ...
    TEST_F(UIResourceLayerTest, SetUIResourceId)
    {
        ...
        std::unique_ptr<ScopedUIResource> resource = ScopedUIResource::Create(layer_tree_host_->GetUIResourceManager(),
        ...
        std::unique_ptr<ScopedUIResource> shared_resource = ScopedUIResource::Create(layer_tree_host_->GetUIResourceManager(),
