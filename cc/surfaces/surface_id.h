...
public:
    ...
    /*const*/ SurfaceId(const SurfaceId& other) = default;
    ...
    /*const*/ SurfaceId(const FrameSinkId& frame_sink_id,
    ...
    {
        return frame_sink_id_ == other.frame_sink_id_ && local_frame_id_ == other.local_frame_id_;
    }
    ...
    bool operator<(const SurfaceId& other) const
    {
        return std::tie(frame_sink_id_, local_frame_id_) < std::tie(other.frame_sink_id_, other.local_frame_id_);
    }
