...
public:
    ...
    {
        T delta_from_impl_thread = T(main_thread_value).InverseCombine(engine_main_base_);
        unsent_delta_from_impl_thread_ = unsent_delta_from_impl_thread_.Combine(delta_from_impl_thread);
    }
    ...
    {
        DCHECK(sent_but_unapplied_delta_from_impl_thread_.get() == T::Identity().get());
    ...
    void DidApplySentDeltaOnEngine()
    {
        ...
        engine_main_base_ = engine_main_base_.Combine(sent_but_unapplied_delta_from_impl_thread_);
