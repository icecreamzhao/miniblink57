...
public:
    ...
    void Rerecord()
    {
        ...
        scoped_refptr<DisplayItemList> display_list = client_.PaintContentsToDisplayList(
            ContentLayerClient::PAINTING_BEHAVIOR_NORMAL);
        size_t painter_reported_memory_usage = client_.GetApproximateUnsharedMemoryUsage();
