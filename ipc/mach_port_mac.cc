    ...
    param_type* r)
{
    ...
    if (brokerable_attachment->GetBrokerableType() != BrokerableAttachment::MACH_PORT) {
        return false;
    }
    IPC::internal::MachPortAttachmentMac* mach_port_attachment = static_cast<IPC::internal::MachPortAttachmentMac*>(brokerable_attachment);
