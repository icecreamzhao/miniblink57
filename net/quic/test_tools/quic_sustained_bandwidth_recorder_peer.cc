...
namespace test {
        ...
        int32_t bandwidth_estimate_kbytes_per_second)
    {
        ...
        bandwidth_recorder->bandwidth_estimate_ = QuicBandwidth::FromKBytesPerSecond(bandwidth_estimate_kbytes_per_second);
    }
    ...
    {
        bandwidth_recorder->max_bandwidth_estimate_ = QuicBandwidth::FromKBytesPerSecond(
