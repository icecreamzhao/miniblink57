...
{
    NetworkChangeNotifier::ConnectionType type = NetworkChangeNotifier::GetConnectionType();
    ...
    if (connection_type_ == NetworkChangeNotifier::CONNECTION_UNKNOWN || connection_type_ == NetworkChangeNotifier::CONNECTION_WIFI) {
