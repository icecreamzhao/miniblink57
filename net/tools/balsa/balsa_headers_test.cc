...
namespace {
    ...
    TEST_F(BalsaHeadersTest, AppendHeader)
    {
        ...
        ASSERT_EQ(5, std::distance(headers_->header_lines_begin(), headers_->header_lines_end()));
    ...
    TEST_F(BalsaHeadersTest, ReplaceOrAppendHeader)
    {
        ...
        ASSERT_EQ(1, std::distance(headers_->header_lines_begin(), headers_->header_lines_end()));
    ...
    TEST_F(BalsaHeadersTest, GetHeaderPosition)
    {
        ...
        BalsaHeaders::const_header_lines_iterator i = headers_->GetHeaderPosition("key2");
    ...
    TEST_F(BalsaHeadersTest, GetIteratorForKey)
    {
        ...
        BalsaHeaders::const_header_lines_key_iterator i = headers_->GetIteratorForKey("key1");
    ...
    TEST_F(BalsaHeadersTest, RemoveAllOfHeader)
    {
        ...
        ASSERT_EQ(6, std::distance(headers_->header_lines_begin(), headers_->header_lines_end()));
        headers_->RemoveAllOfHeader("key1");
        ASSERT_EQ(2, std::distance(headers_->header_lines_begin(), headers_->header_lines_end()));
    }
