...
namespace {
    ...
    public:
        ...
        MOCK_METHOD8(ProcessRequestFirstLine, void(const char*, size_t, const char*, size_t, const char*, size_t, const char*, size_t));
        MOCK_METHOD8(ProcessResponseFirstLine, void(const char*, size_t, const char*, size_t, const char*, size_t, const char*, size_t));
    ...
    TEST_F(BalsaFrameTest, InvalidHeader)
    {
        ...
        ASSERT_EQ("/", StringPiece(request_uri, request_uri_length));
        ASSERT_EQ("HTTP/1.0", StringPiece(version, version_length));
        ASSERT_EQ(2, std::distance(frame_headers_->header_lines_begin(), frame_headers_->header_lines_end()));
    }
