...
int main(int argc, const char* argv[])
{
    ...
    if (command_line.HasSwitch(kDumpAllocation) && command_line.HasSwitch(kDumpFile)) {
        base::FilePath name = input_path.AppendASCII(command_line.GetSwitchValueASCII(kDumpFile));
