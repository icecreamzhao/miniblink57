...
const PublicKeyWhitelist kBuiltinWhitelist[] = {
    ...
    {
        const SHA256HashValue* search_key = reinterpret_cast<const SHA256HashValue*>(key);
    ...
    const HashValueVector& public_key_hashes)
{
    ...
    for (size_t i = 0; i < g_whitelist_size; ++i) {
        for (const auto& hash : public_key_hashes) {
            ...
            const SHA256HashValue leaf_hash = X509Certificate::CalculateFingerprint256(cert.os_cert_handle());
