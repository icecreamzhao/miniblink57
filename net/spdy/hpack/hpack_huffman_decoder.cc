...
namespace {
    ...
    const HuffmanCodeLength kHuffmanWordLength = std::numeric_limits<HuffmanWord>::digits;
    ...
    HuffmanWord bits)
{
    ...
    HuffmanWord ordinal_in_length = ((bits - first_lj_code) >> (kHuffmanWordLength - code_length));
