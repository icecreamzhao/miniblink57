...
namespace test {
    ...
    public:
        ...
        public:
            ...
            void OnPushPromise(SpdyStreamId stream_id,
                ...
                bool end) override
            {
                SpdyPushPromiseIR* push_promise = new SpdyPushPromiseIR(stream_id, promised_stream_id);
    ...
    public:
        ...
        void SimulateInFramer(const unsigned char* input, size_t size)
        {
            ...
            while (input_remaining > 0 && framer_.error_code() == SpdyFramer::SPDY_NO_ERROR) {
                // To make the tests more interesting, we feed random (and small) chunks
                // into the framer.  This simulates getting strange-sized reads from
                // the socket.
                const size_t kMaxReadSize = 32;
                size_t bytes_read = (rand() % std::min(input_remaining, kMaxReadSize)) + 1;
    ...
    protected:
        ...
        {
            const unsigned char* actual = reinterpret_cast<const unsigned char*>(actual_frame.data());
    ...
    TEST_P(SpdyFramerTest, BasicCompression)
    {
        ...
        size_t compressed_size1 = visitor->last_frame_len_ - framer.GetSynStreamMinimumSize();
        ...
        size_t compressed_size2 = visitor->last_frame_len_ - framer.GetSynStreamMinimumSize();
        ...
        size_t compressed_size4 = visitor->last_frame_len_ - framer.GetSynStreamMinimumSize();
  ...
  const unsigned char kV3Input[] = {
    ...
    TEST_P(SpdyFramerTest, HeaderCompression)
    {
        ...
        StringPiece serialized_headers = GetSerializedHeaders(decompressed, send_framer);
  ...
  const unsigned char kV3FrameData[] = {
    ...
    const unsigned char kV3FrameData[] = {
      ...
      'o'
            ...
            frame = framer.SerializeDataFrameHeaderWithPaddingLengthField(data_header_ir);
            CompareCharArraysWithHexError(
    ...
    const unsigned char kV3FrameData[] = {
      ...
      'o'
        ...
        {
            const char kDescription[] = "'hello' data frame with 1 byte padding, no FIN";
            // clang-format off
    const unsigned char kV3FrameData[] = {
      0x00, 0x00, 0x00, 0x01,
      0x00, 0x00, 0x00, 0x05,
    ...
    const unsigned char kV3FrameData[] = {
      ...
      'a',  'r'
        ...
        {
            const char kDescription[] = "SYN_STREAM frame with a 0-length header name, highest pri, FIN, "
                                        "max stream ID";
    ...
    const unsigned char kV3FrameData[] = {
      ...
      'b',  'a',  'r'
        ...
        {
            const char kDescription[] = "SYN_STREAM frame with a 0-length header val, high pri, FIN, "
                                        "max stream ID";
...
// to workaround http://crbug.com/139744.
      ...
      0xff,
            ...
            if (IsSpdy3()) {
                if (memcmp(frame_data, kV3SIMDFrameData,
                        std::min(arraysize(kV3SIMDFrameData), frame.size()))
                    != 0) {
    ...
    const unsigned char kV3FrameData[] = {
      ...
      0x03, 'b',  'a',  'r'
        ...
        {
            const char kDescription[] = "SYN_REPLY frame with a 0-length header name, FIN, max stream ID";
    ...
    const unsigned char kV3FrameData[] = {
      ...
      'r'
        ...
        {
            const char kDescription[] = "SYN_REPLY frame with a 0-length header val, FIN, max stream ID";
...
// to workaround http://crbug.com/139744.
    ...
    const unsigned char kV3FrameData[] = {
      ...
      0x03, 'b',  'a',  'r'
        ...
        {
            const char kDescription[] = "HEADERS frame with a 0-length header name, FIN, max stream ID";
    ...
    const unsigned char kV3FrameData[] = {
      ...
      'r'
        ...
        {
            const char kDescription[] = "HEADERS frame with a 0-length header val, FIN, max stream ID";
    ...
    const unsigned char kV3FrameData[] = {
      ...
      0x00
        ...
        {
            const char kDescription[] = "HEADERS frame with a 0-length header val, FIN, max stream ID, pri";
        ...
        {
            const char kDescription[] = "HEADERS frame with a 0-length header name, FIN, max stream ID, padded";
...
// to workaround http://crbug.com/139744.
    ...
    TEST_P(SpdyFramerTest, GetNumberRequiredContinuationFrames)
    {
        ...
        SpdyFramer framer(spdy_version_);
        EXPECT_EQ(1u, SpdyFramerPeer::GetNumberRequiredContinuationFrames(&framer, 16383 + 16374));
        EXPECT_EQ(2u, SpdyFramerPeer::GetNumberRequiredContinuationFrames(&framer, 16383 + 16374 + 1));
        EXPECT_EQ(2u, SpdyFramerPeer::GetNumberRequiredContinuationFrames(&framer, 16383 + 2 * 16374));
        EXPECT_EQ(3u, SpdyFramerPeer::GetNumberRequiredContinuationFrames(&framer, 16383 + 2 * 16374 + 1));
    }
    ...
    TEST_P(SpdyFramerTest, CreatePushPromiseThenContinuationUncompressed)
    {
...

        {
            ...
            SpdyFramer framer(spdy_version_);
            framer.set_enable_compression(false);
            const char kDescription[] = "PUSH_PROMISE and CONTINUATION frames with one byte of padding";
    ...
    TEST_P(SpdyFramerTest, ControlFrameAtMaxSizeLimit)
    {
        ...
        SpdySerializedFrame control_frame(framer.SerializeSynStream(syn_stream));
        const size_t kBigValueSize = TestSpdyVisitor::sent_control_frame_max_size() - control_frame.size();
    ...
    TEST_P(SpdyFramerTest, ControlFrameTooLarge)
    {
        ...
        syn_stream.set_priority(1);
        SpdySerializedFrame control_frame(framer.SerializeSynStream(syn_stream));
        const size_t kBigValueSize = TestSpdyVisitor::received_control_frame_max_size() + SpdyConstants::GetControlFrameHeaderSize(spdy_version_) - control_frame.size() + 1;
        ...
        EXPECT_EQ(TestSpdyVisitor::received_control_frame_max_size() + SpdyConstants::GetControlFrameHeaderSize(spdy_version_) + 1,
            control_frame.size());
    ...
    TEST_P(SpdyFramerTest, ControlFrameMuchTooLarge)
    {
        ...
        const size_t kHeaderBufferSize = TestSpdyVisitor::header_data_chunk_max_size() * kHeaderBufferChunks;
    ...
    TEST_P(SpdyFramerTest, ControlFrameSizesAreValidated)
    {
        ...
        const size_t less_than_min_length = framer.GetGoAwayMinimumSize() - framer.GetControlFrameHeaderSize() - 1;
        ...
        const size_t pad_length = length + framer.GetControlFrameHeaderSize() - (IsSpdy3() ? sizeof(kV3FrameData) : sizeof(kH2FrameData));
  ...
  const unsigned char kV3FrameData[] = {
    ...
    TEST_P(SpdyFramerTest, ReadPushPromiseWithContinuation)
    {
        ...
        const unsigned char kInput[] = {
            ...
            0x02,
            0x00,
            0x00, // Stream 1, Pad length field
            0x00,
            0x2A,
            0x00,
            0x06, // Promised stream 42
            'c',
            'o',
            'o',
            'k',
  ...
  const unsigned char kFrameData[] = {
    ...
    TEST_P(SpdyFramerTest, StateToStringTest)
    {
        ...
        EXPECT_STREQ("UNKNOWN_STATE", SpdyFramer::StateToString(SpdyFramer::SPDY_ALTSVC_FRAME_PAYLOAD + 1));
    }
    ...
    TEST_P(SpdyFramerTest, ErrorCodeToStringTest)
    {
        ...
        EXPECT_STREQ("INVALID_STREAM_ID", SpdyFramer::ErrorCodeToString(SpdyFramer::SPDY_INVALID_STREAM_ID));
        EXPECT_STREQ(
        ...
        EXPECT_STREQ("ZLIB_INIT_FAILURE", SpdyFramer::ErrorCodeToString(SpdyFramer::SPDY_ZLIB_INIT_FAILURE));
        EXPECT_STREQ(
            "UNSUPPORTED_VERSION",
            SpdyFramer::ErrorCodeToString(SpdyFramer::SPDY_UNSUPPORTED_VERSION));
        EXPECT_STREQ("DECOMPRESS_FAILURE", SpdyFramer::ErrorCodeToString(SpdyFramer::SPDY_DECOMPRESS_FAILURE));
        EXPECT_STREQ("COMPRESS_FAILURE", SpdyFramer::ErrorCodeToString(SpdyFramer::SPDY_COMPRESS_FAILURE));
    ...
    TEST_P(SpdyFramerTest, SynStreamFrameFlags)
    {
        ...
        do {
            ...
            if (flags & ~(CONTROL_FLAG_FIN | CONTROL_FLAG_UNIDIRECTIONAL)) {
                ...
                EXPECT_CALL(visitor, OnSynStream(8, 3, 1, flags & CONTROL_FLAG_FIN, flags & CONTROL_FLAG_UNIDIRECTIONAL));
    ...
    TEST_P(SpdyFramerTest, SettingsFrameFlagsOldFormat)
    {
        ...
        do {
            ...
            if (flags & ~SETTINGS_FLAG_CLEAR_PREVIOUSLY_PERSISTED_SETTINGS) {
                ...
                EXPECT_CALL(
                    visitor,
                    OnSettings(flags & SETTINGS_FLAG_CLEAR_PREVIOUSLY_PERSISTED_SETTINGS));
                EXPECT_CALL(visitor, OnSetting(SETTINGS_UPLOAD_BANDWIDTH, SETTINGS_FLAG_NONE, 54321));
    ...
    TEST_P(SpdyFramerTest, HeadersFrameFlags)
    {
        ...
        do {
            ...
            EXPECT_CALL(visitor, OnHeaders(stream_id, has_priority, priority, parent_stream_id, exclusive, fin, end));
            EXPECT_CALL(visitor, OnHeaderFrameStart(57)).Times(1);
            if (end) {
                EXPECT_CALL(visitor, OnHeaderFrameEnd(57, _)).Times(1);
            }
            if (flags & DATA_FLAG_FIN && (IsSpdy3() || flags & HEADERS_FLAG_END_HEADERS)) {
                EXPECT_CALL(visitor, OnStreamEnd(_));
            } else {
                // Do not close the stream if we are expecting a CONTINUATION frame.
                EXPECT_CALL(visitor, OnStreamEnd(_)).Times(0);
    ...
    TEST_P(SpdyFramerTest, EmptySynStream)
    {
        ...
        SetFrameLength(&frame, framer.GetSynStreamMinimumSize() - framer.GetControlFrameHeaderSize(),
            spdy_version_);
    ...
    TEST_P(SpdyFramerTest, SettingsFlagsAndId)
    {
        ...
        SettingsFlagsAndId id_and_flags = SettingsFlagsAndId::FromWireFormat(spdy_version_, kWireFormat);
