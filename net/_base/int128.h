...
inline uint128::uint128(const uint128& v)
    : lo_(v.lo_)
    , hi_(v.hi_)
{
}
...
inline uint128::uint128(uint64_t bottom)
    : lo_(bottom)
    , hi_(0)
{
}
inline uint128::uint128(uint32_t bottom)
    : lo_(bottom)
    , hi_(0)
{
}
...
inline uint128 operator<<(const uint128& val, int amount)
{
    ...
    if (amount < 64) {
        ...
        uint64_t new_hi = (Uint128High64(val) << amount) | (Uint128Low64(val) >> (64 - amount));
...
inline uint128 operator>>(const uint128& val, int amount)
{
    ...
    if (amount < 64) {
        ...
        uint64_t new_lo = (Uint128Low64(val) >> amount) | (Uint128High64(val) << (64 - amount));
        return uint128(new_hi, new_lo);
    } else if (amount < 128) {
