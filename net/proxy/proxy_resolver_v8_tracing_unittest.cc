...
namespace {
    ...
    private:
        ...
        public:
            explicit ForwardingBindings(MockBindings* bindings)
                : bindings_(bindings)
            {
            }
    ...
    TEST_F(ProxyResolverV8TracingTest, Simple)
    {
        ...
        std::unique_ptr<ProxyResolverV8Tracing> resolver = CreateResolver(mock_bindings.CreateBindings(), "simple.js");
    ...
    TEST_F(ProxyResolverV8TracingTest, JavascriptError)
    {
        ...
        std::unique_ptr<ProxyResolverV8Tracing> resolver = CreateResolver(mock_bindings.CreateBindings(), "error.js");
    ...
    TEST_F(ProxyResolverV8TracingTest, TooManyAlerts)
    {
        ...
        std::unique_ptr<ProxyResolverV8Tracing> resolver = CreateResolver(mock_bindings.CreateBindings(), "too_many_alerts.js");
    ...
    TEST_F(ProxyResolverV8TracingTest, Dns)
    {
        ...
        std::unique_ptr<ProxyResolverV8Tracing> resolver = CreateResolver(mock_bindings.CreateBindings(), "dns.js");
        ...
        const char* kExpectedResult = "122.133.144.155-" // myIpAddress()
                                      "null-" // dnsResolve('')
    ...
    TEST_F(ProxyResolverV8TracingTest, DnsChecksCache)
    {
        ...
        std::unique_ptr<ProxyResolverV8Tracing> resolver = CreateResolver(mock_bindings.CreateBindings(), "simple_dns.js");
    ...
    TEST_F(ProxyResolverV8TracingTest, FallBackToSynchronous1)
    {
        ...
        std::unique_ptr<ProxyResolverV8Tracing> resolver = CreateResolver(mock_bindings.CreateBindings(), "global_sideffects1.js");
    ...
    TEST_F(ProxyResolverV8TracingTest, FallBackToSynchronous2)
    {
        ...
        std::unique_ptr<ProxyResolverV8Tracing> resolver = CreateResolver(mock_bindings.CreateBindings(), "global_sideffects2.js");
    ...
    TEST_F(ProxyResolverV8TracingTest, InfiniteDNSSequence)
    {
        ...
        std::unique_ptr<ProxyResolverV8Tracing> resolver = CreateResolver(mock_bindings.CreateBindings(), "global_sideffects3.js");
    ...
    TEST_F(ProxyResolverV8TracingTest, InfiniteDNSSequence2)
    {
        ...
        std::unique_ptr<ProxyResolverV8Tracing> resolver = CreateResolver(mock_bindings.CreateBindings(), "global_sideffects4.js");
    ...
    void DnsDuringInitHelper(bool synchronous_host_resolver)
    {
        ...
        std::unique_ptr<ProxyResolverV8Tracing> resolver = CreateResolver(mock_bindings.CreateBindings(), "dns_during_init.js");
    ...
    TEST_F(ProxyResolverV8TracingTest, Terminate)
    {
        ...
        std::unique_ptr<ProxyResolverV8Tracing> resolver = CreateResolver(mock_bindings.CreateBindings(), "terminate.js");
    ...
    TEST_F(ProxyResolverV8TracingTest, MultipleResolvers)
    {
        ...
        std::unique_ptr<ProxyResolverV8Tracing> resolver0 = CreateResolver(mock_bindings0.CreateBindings(), "dns.js");

        // ------------------------
        // Setup resolver1
        // ------------------------
        std::unique_ptr<ProxyResolverV8Tracing> resolver1 = CreateResolver(mock_bindings0.CreateBindings(), "dns.js");

        // ------------------------
        // Setup resolver2
        // ------------------------
        std::unique_ptr<ProxyResolverV8Tracing> resolver2 = CreateResolver(mock_bindings0.CreateBindings(), "simple.js");
        ...
        std::unique_ptr<ProxyResolverV8Tracing> resolver3 = CreateResolver(mock_bindings3.CreateBindings(), "simple_dns.js");
        ...
        const char* kExpectedForDnsJs = "122.133.144.155-" // myIpAddress()
                                        "null-" // dnsResolve('')
                                        "__1_192.168.1.1-" // dnsResolveEx('host1')
                                        "null-" // dnsResolve('host2')
                                        "166.155.144.33-" // dnsResolve('host3')
