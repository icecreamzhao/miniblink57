...
{
    const base::FilePath::CharType kAppendDir1[] = FILE_PATH_LITERAL("test/path_append1");
    const base::FilePath::CharType kAppendDir2[] = FILE_PATH_LITERAL("test/path_append2");
