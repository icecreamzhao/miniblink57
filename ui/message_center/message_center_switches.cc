...
// top down or not.
const char kEnableMessageCenterAlwaysScrollUpUponNotificationRemoval[] = "enable-message-center-always-scroll-up-upon-notification-removal";
...
const char kMessageCenterChangesWhileOpen[] = "message-center-changes-while-open";
