...
TEST(CandidateWindow, GetInfolistEntries_SparseCase)
{
    ...
    std::vector<CandidateWindow::Entry>* candidates = candidate_window.mutable_candidates();
    (*candidates)[2].description_title = base::UTF8ToUTF16(kSampleDescriptionTitle[2]);
    (*candidates)[2].description_body = base::UTF8ToUTF16(kSampleDescriptionBody[2]);
