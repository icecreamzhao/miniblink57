...
int GetAvailablePointerTypes()
{
    JNIEnv* env = base::android::AttachCurrentThread();
    jobject context = base::android::GetApplicationContext();
    jint available_pointer_types = Java_TouchDevice_availablePointerTypes(env, context);
...
int GetAvailableHoverTypes()
{
    JNIEnv* env = base::android::AttachCurrentThread();
    jobject context = base::android::GetApplicationContext();
    jint available_hover_types = Java_TouchDevice_availableHoverTypes(env, context);
