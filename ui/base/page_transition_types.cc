...
bool PageTransitionIsMainFrame(PageTransition type)
{
    ...
    return (t != PAGE_TRANSITION_AUTO_SUBFRAME && t != PAGE_TRANSITION_MANUAL_SUBFRAME);
}
...
{
    return (type & PAGE_TRANSITION_FORWARD_BACK) == 0 && !PageTransitionCoreTypeIs(type, PAGE_TRANSITION_RELOAD);
}
...
const char* PageTransitionGetCoreTransitionString(PageTransition type)
{
    ...
    case PAGE_TRANSITION_GENERATED:
        return "generated";
    case PAGE_TRANSITION_AUTO_TOPLEVEL:
        return "auto_toplevel";
    case PAGE_TRANSITION_FORM_SUBMIT:
        return "form_submit";
    case PAGE_TRANSITION_RELOAD:
        return "reload";
    case PAGE_TRANSITION_KEYWORD:
        return "keyword";
    case PAGE_TRANSITION_KEYWORD_GENERATED:
