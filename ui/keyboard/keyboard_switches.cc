...
namespace switches {
    ...
    const char kEnableExperimentalInputViewFeatures[] = "enable-experimental-input-view-features";
    ...
    const char kEnableFloatingVirtualKeyboard[] = "enable-floating-virtual-keyboard";
    const char kDisableSmartVirtualKeyboard[] = "disable-smart-virtual-keyboard";
    const char kDisableVirtualKeyboardOverscroll[] = "disable-virtual-keyboard-overscroll";
