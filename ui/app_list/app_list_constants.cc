...
const ui::ResourceBundle::FontStyle kItemTextFontStyle = ui::ResourceBundle::SmallFont;
...
const char kSearchResultOpenDisplayTypeHistogram[] = "Apps.AppListSearchResultOpenDisplayType";
...
const char kSearchResultDistanceFromOrigin[] = "Apps.AppListSearchResultDistanceFromOrigin";
...
const gfx::ShadowValues& IconStartShadows()
{
    CR_DEFINE_STATIC_LOCAL(const gfx::ShadowValues, icon_shadows,
        (1, gfx::ShadowValue(gfx::Vector2d(0, 1), 2, SkColorSetARGB(0x33, 0, 0, 0))));
    return icon_shadows;
}
...
{
    CR_DEFINE_STATIC_LOCAL(const gfx::ShadowValues, icon_shadows,
        (1, gfx::ShadowValue(gfx::Vector2d(0, 4), 4, SkColorSetARGB(0x50, 0, 0, 0))));
    return icon_shadows;
}
