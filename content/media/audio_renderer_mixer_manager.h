...
class AudioRendererMixerManager : public media::AudioRendererMixerPool {
public:
    ...
    media::AudioRendererMixer* GetMixer(int source_render_frame_id,
        ...
        media::OutputDeviceStatus* device_status) override;

    void ReturnMixer(media::AudioRendererMixer* mixer) override;
