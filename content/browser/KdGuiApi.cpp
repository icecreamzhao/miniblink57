...
static bool IsInputEvent(UINT message)
{
    ...
    case WM_IME_STARTCOMPOSITION:
        OUTPUTSTR(L"WM_IME_STARTCOMPOSITION\n");
        return true;
    case WM_IME_ENDCOMPOSITION:
        OUTPUTSTR(L"WM_IME_ENDCOMPOSITION\n");
        return true;
    case WM_IME_COMPOSITION:
        OUTPUTSTR(L"WM_IME_COMPOSITION\n");
        return true;
    case WM_IME_SETCONTEXT:
        OUTPUTSTR(L"WM_IME_SETCONTEXT\n");
        return true;
    case WM_IME_NOTIFY:
        OUTPUTSTR(L"WM_IME_NOTIFY\n");
        return true;
    case WM_IME_CONTROL:
        OUTPUTSTR(L"WM_IME_CONTROL\n");
        return true;
    case WM_IME_COMPOSITIONFULL:
        OUTPUTSTR(L"WM_IME_COMPOSITIONFULL\n");
        return true;
    case WM_IME_SELECT:
        OUTPUTSTR(L"WM_IME_SELECT\n");
        return true;
    case WM_IME_CHAR:
        OUTPUTSTR(L"WM_IME_CHAR\n");
        return true;
    case WM_IME_REQUEST:
        OUTPUTSTR(L"WM_IME_REQUEST\n");
        return true;
    case WM_IME_KEYDOWN:
        OUTPUTSTR(L"WM_IME_KEYDOWN\n");
        return true;
    case WM_IME_KEYUP:
        OUTPUTSTR(L"WM_IME_KEYUP\n");
        return true;
    }
