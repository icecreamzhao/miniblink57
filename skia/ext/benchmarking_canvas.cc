...
std::unique_ptr<base::Value> AsValue(const SkPath& path)
{
    ...
    static const char* gFillStrings[] = { "winding", "even-odd", "inverse-winding", "inverse-even-odd" };
    ...
    static const char* gVerbStrings[] = { "move", "line", "quad", "conic", "cubic", "close", "done" };
