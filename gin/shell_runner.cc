    ...
    : delegate_(delegate)
{
    ...
    v8::Local<v8::Context> context = Context::New(isolate, NULL, delegate_->GetGlobalTemplate(this, isolate));
    ...
    v8::Local<v8::Value> argv[])
{
    ...
    auto maybe_result = function->Call(GetContextHolder()->context(), receiver, argc, argv);
