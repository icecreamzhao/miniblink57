...
public:
    explicit Menu(v8::Isolate* isolate, v8::Local<v8::Object> wrapper)
        : m_hideWndHelp(L"HideParentWindowClass", )
    {
    ...
    void _popupApi() {
        ...
        ::SetForegroundWindow(m_hHideParentWindow);
...
private:
    ...
    void createHideParentWindow() {
        ...
        m_hHideParentWindow = ::CreateWindow(L"HideParentWindowClass", L"HideParentWindowClass",
            WS_OVERLAPPEDWINDOW, CW_USEDEFAULT, CW_USEDEFAULT, 100, 100, NULL, NULL, NULL, NULL);

        ::ShowWindow(m_hHideParentWindow, SW_SHOW);
    }
