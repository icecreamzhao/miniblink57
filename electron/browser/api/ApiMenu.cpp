...
public:
    ...
    void _popupApi(const v8::FunctionCallbackInfo<v8::Value>& args)
    {
        Menu* self = this;
        if (!m_hideWndHelp) {
            m_hideWndHelp = new HideWndHelp(u16("HideParentWindowClass"), [self](HWND hWnd, UINT uMsg, WPARAM wParam, LPARAM lParam) -> LRESULT {
...
void MenuItem::insertPlatformMenu(size_t pos, HMENU hMenu) const
{
    ...
    base::string16 labelW = base::UTF8ToUTF16(m_label);
    if (!labelW.empty()) {
