...
template<> base::ThreadLocalPointer<v8::Persistent<v8::Function> >* atom::api::KeyWeakMap<int32_t>::constructorTlsKey = nullptr;
template<> base::ThreadLocalPointer<v8::Persistent<v8::Function> >* atom::api::KeyWeakMap<std::pair<int32_t, int32_t>>::constructorTlsKey = nullptr;

template<> gin::WrapperInfo atom::api::KeyWeakMap<int32_t>::kWrapperInfo = { gin::kEmbedderNativeGin };
template<> gin::WrapperInfo atom::api::KeyWeakMap<std::pair<int32_t, int32_t>>::kWrapperInfo = { gin::kEmbedderNativeGin };
