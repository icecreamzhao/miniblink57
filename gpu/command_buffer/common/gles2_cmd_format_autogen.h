...
struct ClearBufferfvImmediate {
    ...
    {
        return static_cast<uint32_t>(sizeof(GLfloat) * GLES2Util::CalcClearBufferfvDataCount(buffer));
    }
    ...
    void Init(GLenum _buffer, GLint _drawbuffers, const GLfloat* _value)
    {
        ...
        char* pointer = reinterpret_cast<char*>(ImmediateDataAddress(this)) + ComputeEffectiveDataSize(buffer);
...
struct ClearBufferivImmediate {
    ...
    static uint32_t ComputeEffectiveDataSize(GLenum buffer)
    {
        return static_cast<uint32_t>(sizeof(GLint) * GLES2Util::CalcClearBufferivDataCount(buffer));
    }
...
struct DeleteBuffersImmediate {
    ...
    {
        return static_cast<uint32_t>(sizeof(ValueType) + ComputeDataSize(n)); // NOLINT
    }
...
struct InvalidateFramebufferImmediate {
    ...
    {
        return static_cast<uint32_t>(sizeof(ValueType) + ComputeDataSize(count)); // NOLINT
    }
