...
TEST_F(GLES2ImplementationTest, CheckFramebufferStatus)
{
    ...
    Cmds expected;
    ExpectedMemoryInfo result1 = GetExpectedResultMemory(sizeof(cmds::CheckFramebufferStatus::Result));
...
TEST_F(GLES2ImplementationTest, IsBuffer)
{
    ...
    Cmds expected;
    ExpectedMemoryInfo result1 = GetExpectedResultMemory(sizeof(cmds::IsBuffer::Result));
...
TEST_F(GLES2ImplementationTest, IsFramebuffer)
{
    ...
    Cmds expected;
    ExpectedMemoryInfo result1 = GetExpectedResultMemory(sizeof(cmds::IsFramebuffer::Result));
    expected.cmd.Init(1, result1.id, result1.offset);
...
TEST_F(GLES2ImplementationTest, IsProgram)
{
    ...
    Cmds expected;
    ExpectedMemoryInfo result1 = GetExpectedResultMemory(sizeof(cmds::IsProgram::Result));
    expected.cmd.Init(1, result1.id, result1.offset);
...
TEST_F(GLES2ImplementationTest, IsRenderbuffer)
{
    ...
    Cmds expected;
    ExpectedMemoryInfo result1 = GetExpectedResultMemory(sizeof(cmds::IsRenderbuffer::Result));
    expected.cmd.Init(1, result1.id, result1.offset);
...
TEST_F(GLES2ImplementationTest, IsSampler)
{
    ...
    Cmds expected;
    ExpectedMemoryInfo result1 = GetExpectedResultMemory(sizeof(cmds::IsSampler::Result));
    expected.cmd.Init(1, result1.id, result1.offset);
...
TEST_F(GLES2ImplementationTest, IsShader)
{
    ...
    Cmds expected;
    ExpectedMemoryInfo result1 = GetExpectedResultMemory(sizeof(cmds::IsShader::Result));
    expected.cmd.Init(1, result1.id, result1.offset);
...
TEST_F(GLES2ImplementationTest, IsSync)
{
    ...
    Cmds expected;
    ExpectedMemoryInfo result1 = GetExpectedResultMemory(sizeof(cmds::IsSync::Result));
    expected.cmd.Init(1, result1.id, result1.offset);
...
TEST_F(GLES2ImplementationTest, IsTexture)
{
    ...
    Cmds expected;
    ExpectedMemoryInfo result1 = GetExpectedResultMemory(sizeof(cmds::IsTexture::Result));
    expected.cmd.Init(1, result1.id, result1.offset);
...
TEST_F(GLES2ImplementationTest, IsTransformFeedback)
{
    ...
    Cmds expected;
    ExpectedMemoryInfo result1 = GetExpectedResultMemory(sizeof(cmds::IsTransformFeedback::Result));
    expected.cmd.Init(1, result1.id, result1.offset);
...
TEST_F(GLES2ImplementationTest, ShaderSource)
{
    ...
    const size_t kPaddedHeaderSize = transfer_buffer_->RoundToAlignment(kHeaderSize);
    const size_t kPaddedString1Size = transfer_buffer_->RoundToAlignment(kString1Size);
    const size_t kPaddedString2Size = transfer_buffer_->RoundToAlignment(kString2Size);
    struct Cmds {
...
TEST_F(GLES2ImplementationTest, ShaderSourceWithLength)
{
    ...
    const size_t kPaddedHeaderSize = transfer_buffer_->RoundToAlignment(kHeaderSize);
    const size_t kPaddedStringSize = transfer_buffer_->RoundToAlignment(kStringSize + 1);
    struct Cmds {
        cmd::SetBucketSize set_bucket_size;
        cmd::SetBucketData set_bucket_header;
        cmd::SetToken set_token1;
...
TEST_F(GLES2ImplementationTest, IsVertexArrayOES)
{
    ...
    Cmds expected;
    ExpectedMemoryInfo result1 = GetExpectedResultMemory(sizeof(cmds::IsVertexArrayOES::Result));
    expected.cmd.Init(1, result1.id, result1.offset);
...
TEST_F(GLES2ImplementationTest, IsPathCHROMIUM)
{
    ...
    Cmds expected;
    ExpectedMemoryInfo result1 = GetExpectedResultMemory(sizeof(cmds::IsPathCHROMIUM::Result));
    expected.cmd.Init(1, result1.id, result1.offset);
