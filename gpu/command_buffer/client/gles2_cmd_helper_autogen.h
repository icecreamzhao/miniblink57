...
{
    gles2::cmds::BindAttribLocationBucket* c = GetCmdSpace<gles2::cmds::BindAttribLocationBucket>();
    if (c) {
...
{
    gles2::cmds::BindRenderbuffer* c = GetCmdSpace<gles2::cmds::BindRenderbuffer>();
    if (c) {
...
{
    gles2::cmds::BindTransformFeedback* c = GetCmdSpace<gles2::cmds::BindTransformFeedback>();
    if (c) {
...
{
    gles2::cmds::BlendEquationSeparate* c = GetCmdSpace<gles2::cmds::BlendEquationSeparate>();
    if (c) {
...
void BlendFuncSeparate(GLenum srcRGB,
    ...
    GLenum dstAlpha)
{
    gles2::cmds::BlendFuncSeparate* c = GetCmdSpace<gles2::cmds::BlendFuncSeparate>();
    if (c) {
...
{
    gles2::cmds::CheckFramebufferStatus* c = GetCmdSpace<gles2::cmds::CheckFramebufferStatus>();
    if (c) {
    ...
    const GLfloat* value)
{
    ...
    gles2::cmds::ClearBufferfvImmediate* c = GetImmediateCmdSpaceTotalSize<gles2::cmds::ClearBufferfvImmediate>(size);
    if (c) {
    ...
    const GLint* value)
{
    ...
    gles2::cmds::ClearBufferivImmediate* c = GetImmediateCmdSpaceTotalSize<gles2::cmds::ClearBufferivImmediate>(size);
    if (c) {
        c->Init(buffer, drawbuffers, value);
    }
}
    ...
    const GLuint* value)
{
    ...
    gles2::cmds::ClearBufferuivImmediate* c = GetImmediateCmdSpaceTotalSize<gles2::cmds::ClearBufferuivImmediate>(size);
    if (c) {
        c->Init(buffer, drawbuffers, value);
    }
}
...
void CompressedTexImage2DBucket(GLenum target,
    ...
    GLuint bucket_id)
{
    gles2::cmds::CompressedTexImage2DBucket* c = GetCmdSpace<gles2::cmds::CompressedTexImage2DBucket>();
    if (c) {
...
void CompressedTexImage2D(GLenum target,
    ...
    uint32_t data_shm_offset)
{
    gles2::cmds::CompressedTexImage2D* c = GetCmdSpace<gles2::cmds::CompressedTexImage2D>();
    if (c) {
...
void CompressedTexSubImage2DBucket(GLenum target,
    ...
    GLuint bucket_id)
{
    gles2::cmds::CompressedTexSubImage2DBucket* c = GetCmdSpace<gles2::cmds::CompressedTexSubImage2DBucket>();
    if (c) {
...
void CompressedTexSubImage2D(GLenum target,
    ...
    uint32_t data_shm_offset)
{
    gles2::cmds::CompressedTexSubImage2D* c = GetCmdSpace<gles2::cmds::CompressedTexSubImage2D>();
    if (c) {
...
void CompressedTexImage3DBucket(GLenum target,
    ...
    GLuint bucket_id)
{
    gles2::cmds::CompressedTexImage3DBucket* c = GetCmdSpace<gles2::cmds::CompressedTexImage3DBucket>();
    if (c) {
...
void CompressedTexImage3D(GLenum target,
    ...
    uint32_t data_shm_offset)
{
    gles2::cmds::CompressedTexImage3D* c = GetCmdSpace<gles2::cmds::CompressedTexImage3D>();
    if (c) {
...
void CompressedTexSubImage3DBucket(GLenum target,
    ...
    GLuint bucket_id)
{
    gles2::cmds::CompressedTexSubImage3DBucket* c = GetCmdSpace<gles2::cmds::CompressedTexSubImage3DBucket>();
    if (c) {
...
void CompressedTexSubImage3D(GLenum target,
    ...
    uint32_t data_shm_offset)
{
    gles2::cmds::CompressedTexSubImage3D* c = GetCmdSpace<gles2::cmds::CompressedTexSubImage3D>();
    if (c) {
        c->Init(target, level, xoffset, yoffset, zoffset, width, height, depth,
...
void CopyBufferSubData(GLenum readtarget,
    ...
    GLsizeiptr size)
{
    gles2::cmds::CopyBufferSubData* c = GetCmdSpace<gles2::cmds::CopyBufferSubData>();
    if (c) {
...
void CopyTexSubImage2D(GLenum target,
    ...
    GLsizei height)
{
    gles2::cmds::CopyTexSubImage2D* c = GetCmdSpace<gles2::cmds::CopyTexSubImage2D>();
    if (c) {
...
void CopyTexSubImage3D(GLenum target,
    ...
    GLsizei height)
{
    gles2::cmds::CopyTexSubImage3D* c = GetCmdSpace<gles2::cmds::CopyTexSubImage3D>();
    if (c) {
...
void DeleteBuffersImmediate(GLsizei n, const GLuint* buffers)
{
    ...
    gles2::cmds::DeleteBuffersImmediate* c = GetImmediateCmdSpaceTotalSize<gles2::cmds::DeleteBuffersImmediate>(size);
    if (c) {
        c->Init(n, buffers);
    }
}
...
{
    const uint32_t size = gles2::cmds::DeleteFramebuffersImmediate::ComputeSize(n);
    gles2::cmds::DeleteFramebuffersImmediate* c = GetImmediateCmdSpaceTotalSize<gles2::cmds::DeleteFramebuffersImmediate>(
        size);
    if (c) {
...
{
    const uint32_t size = gles2::cmds::DeleteRenderbuffersImmediate::ComputeSize(n);
    gles2::cmds::DeleteRenderbuffersImmediate* c = GetImmediateCmdSpaceTotalSize<gles2::cmds::DeleteRenderbuffersImmediate>(
        size);
    if (c) {
...
void DeleteSamplersImmediate(GLsizei n, const GLuint* samplers)
{
    ...
    gles2::cmds::DeleteSamplersImmediate* c = GetImmediateCmdSpaceTotalSize<gles2::cmds::DeleteSamplersImmediate>(size);
    if (c) {
        c->Init(n, samplers);
    }
}
...
void DeleteTexturesImmediate(GLsizei n, const GLuint* textures)
{
    ...
    gles2::cmds::DeleteTexturesImmediate* c = GetImmediateCmdSpaceTotalSize<gles2::cmds::DeleteTexturesImmediate>(size);
    if (c) {
        c->Init(n, textures);
    }
}
...
{
    const uint32_t size = gles2::cmds::DeleteTransformFeedbacksImmediate::ComputeSize(n);
    gles2::cmds::DeleteTransformFeedbacksImmediate* c = GetImmediateCmdSpaceTotalSize<
...
{
    gles2::cmds::DisableVertexAttribArray* c = GetCmdSpace<gles2::cmds::DisableVertexAttribArray>();
    if (c) {
        c->Init(index);
    }
}
...
{
    gles2::cmds::EnableVertexAttribArray* c = GetCmdSpace<gles2::cmds::EnableVertexAttribArray>();
    if (c) {
        c->Init(index);
    }
}
...
void FramebufferRenderbuffer(GLenum target,
    ...
    GLuint renderbuffer)
{
    gles2::cmds::FramebufferRenderbuffer* c = GetCmdSpace<gles2::cmds::FramebufferRenderbuffer>();
    if (c) {
...
void FramebufferTexture2D(GLenum target,
    ...
    GLint level)
{
    gles2::cmds::FramebufferTexture2D* c = GetCmdSpace<gles2::cmds::FramebufferTexture2D>();
    if (c) {
...
void FramebufferTextureLayer(GLenum target,
    ...
    GLint layer)
{
    gles2::cmds::FramebufferTextureLayer* c = GetCmdSpace<gles2::cmds::FramebufferTextureLayer>();
    if (c) {
...
void GenBuffersImmediate(GLsizei n, GLuint* buffers)
{
    ...
    gles2::cmds::GenBuffersImmediate* c = GetImmediateCmdSpaceTotalSize<gles2::cmds::GenBuffersImmediate>(size);
    if (c) {
        c->Init(n, buffers);
    }
}
...
void GenFramebuffersImmediate(GLsizei n, GLuint* framebuffers)
{
    ...
    gles2::cmds::GenFramebuffersImmediate* c = GetImmediateCmdSpaceTotalSize<gles2::cmds::GenFramebuffersImmediate>(
        size);
    if (c) {
        c->Init(n, framebuffers);
    }
...
void GenRenderbuffersImmediate(GLsizei n, GLuint* renderbuffers)
{
    ...
    gles2::cmds::GenRenderbuffersImmediate* c = GetImmediateCmdSpaceTotalSize<gles2::cmds::GenRenderbuffersImmediate>(
        size);
    if (c) {
        c->Init(n, renderbuffers);
    }
...
void GenSamplersImmediate(GLsizei n, GLuint* samplers)
{
    ...
    gles2::cmds::GenSamplersImmediate* c = GetImmediateCmdSpaceTotalSize<gles2::cmds::GenSamplersImmediate>(size);
    if (c) {
        c->Init(n, samplers);
    }
}
...
void GenTexturesImmediate(GLsizei n, GLuint* textures)
{
    ...
    gles2::cmds::GenTexturesImmediate* c = GetImmediateCmdSpaceTotalSize<gles2::cmds::GenTexturesImmediate>(size);
    if (c) {
        c->Init(n, textures);
    }
}
...
{
    const uint32_t size = gles2::cmds::GenTransformFeedbacksImmediate::ComputeSize(n);
    gles2::cmds::GenTransformFeedbacksImmediate* c = GetImmediateCmdSpaceTotalSize<
...
void GetActiveUniform(GLuint program,
    ...
    uint32_t result_shm_offset)
{
    gles2::cmds::GetActiveUniform* c = GetCmdSpace<gles2::cmds::GetActiveUniform>();
    if (c) {
        c->Init(program, index, name_bucket_id, result_shm_id, result_shm_offset);
    }
}
...
{
    gles2::cmds::GetActiveUniformBlockiv* c = GetCmdSpace<gles2::cmds::GetActiveUniformBlockiv>();
    if (c) {
...
void GetActiveUniformBlockName(GLuint program,
    ...
    uint32_t result_shm_offset)
{
    gles2::cmds::GetActiveUniformBlockName* c = GetCmdSpace<gles2::cmds::GetActiveUniformBlockName>();
    if (c) {
        c->Init(program, index, name_bucket_id, result_shm_id, result_shm_offset);
    }
}
...
void GetActiveUniformsiv(GLuint program,
    ...
    uint32_t params_shm_offset)
{
    gles2::cmds::GetActiveUniformsiv* c = GetCmdSpace<gles2::cmds::GetActiveUniformsiv>();
    if (c) {
...
{
    gles2::cmds::GetAttachedShaders* c = GetCmdSpace<gles2::cmds::GetAttachedShaders>();
    if (c) {
...
{
    gles2::cmds::GetAttribLocation* c = GetCmdSpace<gles2::cmds::GetAttribLocation>();
    if (c) {
...
void GetBufferParameteri64v(GLenum target,
    ...
    uint32_t params_shm_offset)
{
    gles2::cmds::GetBufferParameteri64v* c = GetCmdSpace<gles2::cmds::GetBufferParameteri64v>();
    if (c) {
...
void GetBufferParameteriv(GLenum target,
    ...
    uint32_t params_shm_offset)
{
    gles2::cmds::GetBufferParameteriv* c = GetCmdSpace<gles2::cmds::GetBufferParameteriv>();
    if (c) {
        c->Init(target, pname, params_shm_id, params_shm_offset);
    }
}
...
void GetFragDataLocation(GLuint program,
    ...
    uint32_t location_shm_offset)
{
    gles2::cmds::GetFragDataLocation* c = GetCmdSpace<gles2::cmds::GetFragDataLocation>();
    if (c) {
        c->Init(program, name_bucket_id, location_shm_id, location_shm_offset);
    }
}
...
void GetFramebufferAttachmentParameteriv(GLenum target,
    ...
    uint32_t params_shm_offset)
{
    gles2::cmds::GetFramebufferAttachmentParameteriv* c = GetCmdSpace<gles2::cmds::GetFramebufferAttachmentParameteriv>();
    if (c) {
...
void GetInternalformativ(GLenum target,
    ...
    uint32_t params_shm_offset)
{
    gles2::cmds::GetInternalformativ* c = GetCmdSpace<gles2::cmds::GetInternalformativ>();
    if (c) {
...
{
    gles2::cmds::GetProgramInfoLog* c = GetCmdSpace<gles2::cmds::GetProgramInfoLog>();
    if (c) {
...
void GetRenderbufferParameteriv(GLenum target,
    ...
    uint32_t params_shm_offset)
{
    gles2::cmds::GetRenderbufferParameteriv* c = GetCmdSpace<gles2::cmds::GetRenderbufferParameteriv>();
    if (c) {
        c->Init(target, pname, params_shm_id, params_shm_offset);
    }
}
...
void GetSamplerParameterfv(GLuint sampler,
    ...
    uint32_t params_shm_offset)
{
    gles2::cmds::GetSamplerParameterfv* c = GetCmdSpace<gles2::cmds::GetSamplerParameterfv>();
    if (c) {
...
void GetSamplerParameteriv(GLuint sampler,
    ...
    uint32_t params_shm_offset)
{
    gles2::cmds::GetSamplerParameteriv* c = GetCmdSpace<gles2::cmds::GetSamplerParameteriv>();
    if (c) {
        c->Init(sampler, pname, params_shm_id, params_shm_offset);
    }
}
...
{
    gles2::cmds::GetShaderInfoLog* c = GetCmdSpace<gles2::cmds::GetShaderInfoLog>();
    if (c) {
...
void GetShaderPrecisionFormat(GLenum shadertype,
    ...
    uint32_t result_shm_offset)
{
    gles2::cmds::GetShaderPrecisionFormat* c = GetCmdSpace<gles2::cmds::GetShaderPrecisionFormat>();
    if (c) {
...
void GetTexParameterfv(GLenum target,
    ...
    uint32_t params_shm_offset)
{
    gles2::cmds::GetTexParameterfv* c = GetCmdSpace<gles2::cmds::GetTexParameterfv>();
    if (c) {
        c->Init(target, pname, params_shm_id, params_shm_offset);
    }
}
...
void GetTexParameteriv(GLenum target,
    ...
    uint32_t params_shm_offset)
{
    gles2::cmds::GetTexParameteriv* c = GetCmdSpace<gles2::cmds::GetTexParameteriv>();
    if (c) {
        c->Init(target, pname, params_shm_id, params_shm_offset);
    }
}
...
void GetTransformFeedbackVarying(GLuint program,
    ...
    uint32_t result_shm_offset)
{
    gles2::cmds::GetTransformFeedbackVarying* c = GetCmdSpace<gles2::cmds::GetTransformFeedbackVarying>();
    if (c) {
        c->Init(program, index, name_bucket_id, result_shm_id, result_shm_offset);
    }
}
...
{
    gles2::cmds::GetUniformBlockIndex* c = GetCmdSpace<gles2::cmds::GetUniformBlockIndex>();
    if (c) {
...
{
    gles2::cmds::GetUniformIndices* c = GetCmdSpace<gles2::cmds::GetUniformIndices>();
    if (c) {
...
void GetUniformLocation(GLuint program,
    ...
    uint32_t location_shm_offset)
{
    gles2::cmds::GetUniformLocation* c = GetCmdSpace<gles2::cmds::GetUniformLocation>();
    if (c) {
        c->Init(program, name_bucket_id, location_shm_id, location_shm_offset);
    }
}
...
void GetVertexAttribfv(GLuint index,
    ...
    uint32_t params_shm_offset)
{
    gles2::cmds::GetVertexAttribfv* c = GetCmdSpace<gles2::cmds::GetVertexAttribfv>();
    if (c) {
...
void GetVertexAttribiv(GLuint index,
    ...
    uint32_t params_shm_offset)
{
    gles2::cmds::GetVertexAttribiv* c = GetCmdSpace<gles2::cmds::GetVertexAttribiv>();
    if (c) {
        c->Init(index, pname, params_shm_id, params_shm_offset);
    }
}
...
void GetVertexAttribIiv(GLuint index,
    ...
    uint32_t params_shm_offset)
{
    gles2::cmds::GetVertexAttribIiv* c = GetCmdSpace<gles2::cmds::GetVertexAttribIiv>();
    if (c) {
        c->Init(index, pname, params_shm_id, params_shm_offset);
    }
}
...
void GetVertexAttribIuiv(GLuint index,
    ...
    uint32_t params_shm_offset)
{
    gles2::cmds::GetVertexAttribIuiv* c = GetCmdSpace<gles2::cmds::GetVertexAttribIuiv>();
    if (c) {
        c->Init(index, pname, params_shm_id, params_shm_offset);
    }
}
...
{
    gles2::cmds::GetVertexAttribPointerv* c = GetCmdSpace<gles2::cmds::GetVertexAttribPointerv>();
    if (c) {
...
{
    const uint32_t size = gles2::cmds::InvalidateFramebufferImmediate::ComputeSize(count);
    gles2::cmds::InvalidateFramebufferImmediate* c = GetImmediateCmdSpaceTotalSize<
...
void InvalidateSubFramebufferImmediate(GLenum target,
    ...
    GLsizei height)
{
    const uint32_t size = gles2::cmds::InvalidateSubFramebufferImmediate::ComputeSize(count);
    gles2::cmds::InvalidateSubFramebufferImmediate* c = GetImmediateCmdSpaceTotalSize<
...
void IsTransformFeedback(GLuint transformfeedback,
    ...
    uint32_t result_shm_offset)
{
    gles2::cmds::IsTransformFeedback* c = GetCmdSpace<gles2::cmds::IsTransformFeedback>();
    if (c) {
...
{
    gles2::cmds::PauseTransformFeedback* c = GetCmdSpace<gles2::cmds::PauseTransformFeedback>();
    if (c) {
        c->Init();
    }
}
...
{
    gles2::cmds::ReleaseShaderCompiler* c = GetCmdSpace<gles2::cmds::ReleaseShaderCompiler>();
    if (c) {
        c->Init();
    }
}
...
void RenderbufferStorage(GLenum target,
    ...
    GLsizei height)
{
    gles2::cmds::RenderbufferStorage* c = GetCmdSpace<gles2::cmds::RenderbufferStorage>();
    if (c) {
...
{
    gles2::cmds::ResumeTransformFeedback* c = GetCmdSpace<gles2::cmds::ResumeTransformFeedback>();
    if (c) {
        c->Init();
    }
}
...
{
    gles2::cmds::SamplerParameterf* c = GetCmdSpace<gles2::cmds::SamplerParameterf>();
    if (c) {
    ...
    const GLfloat* params)
{
    ...
    gles2::cmds::SamplerParameterfvImmediate* c = GetImmediateCmdSpaceTotalSize<gles2::cmds::SamplerParameterfvImmediate>(
        size);
    if (c) {
...
{
    gles2::cmds::SamplerParameteri* c = GetCmdSpace<gles2::cmds::SamplerParameteri>();
    if (c) {
        c->Init(sampler, pname, param);
    }
}
    ...
    const GLint* params)
{
    ...
    gles2::cmds::SamplerParameterivImmediate* c = GetImmediateCmdSpaceTotalSize<gles2::cmds::SamplerParameterivImmediate>(
        size);
    if (c) {
        c->Init(sampler, pname, params);
    }
...
{
    gles2::cmds::ShaderSourceBucket* c = GetCmdSpace<gles2::cmds::ShaderSourceBucket>();
    if (c) {
...
{
    gles2::cmds::StencilFuncSeparate* c = GetCmdSpace<gles2::cmds::StencilFuncSeparate>();
    if (c) {
...
{
    gles2::cmds::StencilMaskSeparate* c = GetCmdSpace<gles2::cmds::StencilMaskSeparate>();
    if (c) {
        c->Init(face, mask);
    }
}
...
{
    gles2::cmds::StencilOpSeparate* c = GetCmdSpace<gles2::cmds::StencilOpSeparate>();
    if (c) {
    ...
    const GLfloat* params)
{
    ...
    gles2::cmds::TexParameterfvImmediate* c = GetImmediateCmdSpaceTotalSize<gles2::cmds::TexParameterfvImmediate>(size);
    if (c) {
...
void TexParameterivImmediate(GLenum target, GLenum pname, const GLint* params)
{
    ...
    gles2::cmds::TexParameterivImmediate* c = GetImmediateCmdSpaceTotalSize<gles2::cmds::TexParameterivImmediate>(size);
    if (c) {
        c->Init(target, pname, params);
    }
}
...
void TransformFeedbackVaryingsBucket(GLuint program,
    ...
    GLenum buffermode)
{
    gles2::cmds::TransformFeedbackVaryingsBucket* c = GetCmdSpace<gles2::cmds::TransformFeedbackVaryingsBucket>();
    if (c) {
...
void Uniform1fvImmediate(GLint location, GLsizei count, const GLfloat* v)
{
    ...
    gles2::cmds::Uniform1fvImmediate* c = GetImmediateCmdSpaceTotalSize<gles2::cmds::Uniform1fvImmediate>(size);
    if (c) {
...
void Uniform1ivImmediate(GLint location, GLsizei count, const GLint* v)
{
    ...
    gles2::cmds::Uniform1ivImmediate* c = GetImmediateCmdSpaceTotalSize<gles2::cmds::Uniform1ivImmediate>(size);
    if (c) {
        c->Init(location, count, v);
    }
}
...
void Uniform1uivImmediate(GLint location, GLsizei count, const GLuint* v)
{
    ...
    gles2::cmds::Uniform1uivImmediate* c = GetImmediateCmdSpaceTotalSize<gles2::cmds::Uniform1uivImmediate>(size);
    if (c) {
        c->Init(location, count, v);
    }
}
...
void Uniform2fvImmediate(GLint location, GLsizei count, const GLfloat* v)
{
    ...
    gles2::cmds::Uniform2fvImmediate* c = GetImmediateCmdSpaceTotalSize<gles2::cmds::Uniform2fvImmediate>(size);
    if (c) {
        c->Init(location, count, v);
    }
}
...
void Uniform2ivImmediate(GLint location, GLsizei count, const GLint* v)
{
    ...
    gles2::cmds::Uniform2ivImmediate* c = GetImmediateCmdSpaceTotalSize<gles2::cmds::Uniform2ivImmediate>(size);
    if (c) {
        c->Init(location, count, v);
    }
}
...
void Uniform2uivImmediate(GLint location, GLsizei count, const GLuint* v)
{
    ...
    gles2::cmds::Uniform2uivImmediate* c = GetImmediateCmdSpaceTotalSize<gles2::cmds::Uniform2uivImmediate>(size);
    if (c) {
        c->Init(location, count, v);
    }
}
...
void Uniform3fvImmediate(GLint location, GLsizei count, const GLfloat* v)
{
    ...
    gles2::cmds::Uniform3fvImmediate* c = GetImmediateCmdSpaceTotalSize<gles2::cmds::Uniform3fvImmediate>(size);
    if (c) {
        c->Init(location, count, v);
    }
}
...
void Uniform3ivImmediate(GLint location, GLsizei count, const GLint* v)
{
    ...
    gles2::cmds::Uniform3ivImmediate* c = GetImmediateCmdSpaceTotalSize<gles2::cmds::Uniform3ivImmediate>(size);
    if (c) {
        c->Init(location, count, v);
    }
}
...
void Uniform3uivImmediate(GLint location, GLsizei count, const GLuint* v)
{
    ...
    gles2::cmds::Uniform3uivImmediate* c = GetImmediateCmdSpaceTotalSize<gles2::cmds::Uniform3uivImmediate>(size);
    if (c) {
        c->Init(location, count, v);
    }
}
...
void Uniform4fvImmediate(GLint location, GLsizei count, const GLfloat* v)
{
    ...
    gles2::cmds::Uniform4fvImmediate* c = GetImmediateCmdSpaceTotalSize<gles2::cmds::Uniform4fvImmediate>(size);
    if (c) {
        c->Init(location, count, v);
    }
}
...
void Uniform4ivImmediate(GLint location, GLsizei count, const GLint* v)
{
    ...
    gles2::cmds::Uniform4ivImmediate* c = GetImmediateCmdSpaceTotalSize<gles2::cmds::Uniform4ivImmediate>(size);
    if (c) {
        c->Init(location, count, v);
    }
}
...
void Uniform4uivImmediate(GLint location, GLsizei count, const GLuint* v)
{
    ...
    gles2::cmds::Uniform4uivImmediate* c = GetImmediateCmdSpaceTotalSize<gles2::cmds::Uniform4uivImmediate>(size);
    if (c) {
        c->Init(location, count, v);
    }
}
...
{
    gles2::cmds::UniformBlockBinding* c = GetCmdSpace<gles2::cmds::UniformBlockBinding>();
    if (c) {
...
void UniformMatrix2fvImmediate(GLint location,
    ...
    const GLfloat* value)
{
    const uint32_t size = gles2::cmds::UniformMatrix2fvImmediate::ComputeSize(count);
    gles2::cmds::UniformMatrix2fvImmediate* c = GetImmediateCmdSpaceTotalSize<gles2::cmds::UniformMatrix2fvImmediate>(
        size);
    if (c) {
...
void UniformMatrix2x3fvImmediate(GLint location,
    ...
    const GLfloat* value)
{
    const uint32_t size = gles2::cmds::UniformMatrix2x3fvImmediate::ComputeSize(count);
    gles2::cmds::UniformMatrix2x3fvImmediate* c = GetImmediateCmdSpaceTotalSize<gles2::cmds::UniformMatrix2x3fvImmediate>(
        size);
    if (c) {
        c->Init(location, count, transpose, value);
    }
...
void UniformMatrix2x4fvImmediate(GLint location,
    ...
    const GLfloat* value)
{
    const uint32_t size = gles2::cmds::UniformMatrix2x4fvImmediate::ComputeSize(count);
    gles2::cmds::UniformMatrix2x4fvImmediate* c = GetImmediateCmdSpaceTotalSize<gles2::cmds::UniformMatrix2x4fvImmediate>(
        size);
    if (c) {
        c->Init(location, count, transpose, value);
    }
...
void UniformMatrix3fvImmediate(GLint location,
    ...
    const GLfloat* value)
{
    const uint32_t size = gles2::cmds::UniformMatrix3fvImmediate::ComputeSize(count);
    gles2::cmds::UniformMatrix3fvImmediate* c = GetImmediateCmdSpaceTotalSize<gles2::cmds::UniformMatrix3fvImmediate>(
        size);
    if (c) {
        c->Init(location, count, transpose, value);
    }
...
void UniformMatrix3x2fvImmediate(GLint location,
    ...
    const GLfloat* value)
{
    const uint32_t size = gles2::cmds::UniformMatrix3x2fvImmediate::ComputeSize(count);
    gles2::cmds::UniformMatrix3x2fvImmediate* c = GetImmediateCmdSpaceTotalSize<gles2::cmds::UniformMatrix3x2fvImmediate>(
        size);
    if (c) {
        c->Init(location, count, transpose, value);
    }
...
void UniformMatrix3x4fvImmediate(GLint location,
    ...
    const GLfloat* value)
{
    const uint32_t size = gles2::cmds::UniformMatrix3x4fvImmediate::ComputeSize(count);
    gles2::cmds::UniformMatrix3x4fvImmediate* c = GetImmediateCmdSpaceTotalSize<gles2::cmds::UniformMatrix3x4fvImmediate>(
        size);
    if (c) {
        c->Init(location, count, transpose, value);
    }
...
void UniformMatrix4fvImmediate(GLint location,
    ...
    const GLfloat* value)
{
    const uint32_t size = gles2::cmds::UniformMatrix4fvImmediate::ComputeSize(count);
    gles2::cmds::UniformMatrix4fvImmediate* c = GetImmediateCmdSpaceTotalSize<gles2::cmds::UniformMatrix4fvImmediate>(
        size);
    if (c) {
        c->Init(location, count, transpose, value);
    }
...
void UniformMatrix4x2fvImmediate(GLint location,
    ...
    const GLfloat* value)
{
    const uint32_t size = gles2::cmds::UniformMatrix4x2fvImmediate::ComputeSize(count);
    gles2::cmds::UniformMatrix4x2fvImmediate* c = GetImmediateCmdSpaceTotalSize<gles2::cmds::UniformMatrix4x2fvImmediate>(
        size);
    if (c) {
        c->Init(location, count, transpose, value);
    }
...
void UniformMatrix4x3fvImmediate(GLint location,
    ...
    const GLfloat* value)
{
    const uint32_t size = gles2::cmds::UniformMatrix4x3fvImmediate::ComputeSize(count);
    gles2::cmds::UniformMatrix4x3fvImmediate* c = GetImmediateCmdSpaceTotalSize<gles2::cmds::UniformMatrix4x3fvImmediate>(
        size);
    if (c) {
        c->Init(location, count, transpose, value);
    }
...
void VertexAttrib1fvImmediate(GLuint indx, const GLfloat* values)
{
    ...
    gles2::cmds::VertexAttrib1fvImmediate* c = GetImmediateCmdSpaceTotalSize<gles2::cmds::VertexAttrib1fvImmediate>(
        size);
    if (c) {
        c->Init(indx, values);
    }
...
void VertexAttrib2fvImmediate(GLuint indx, const GLfloat* values)
{
    ...
    gles2::cmds::VertexAttrib2fvImmediate* c = GetImmediateCmdSpaceTotalSize<gles2::cmds::VertexAttrib2fvImmediate>(
        size);
    if (c) {
        c->Init(indx, values);
    }
...
void VertexAttrib3fvImmediate(GLuint indx, const GLfloat* values)
{
    ...
    gles2::cmds::VertexAttrib3fvImmediate* c = GetImmediateCmdSpaceTotalSize<gles2::cmds::VertexAttrib3fvImmediate>(
        size);
    if (c) {
        c->Init(indx, values);
    }
...
void VertexAttrib4fvImmediate(GLuint indx, const GLfloat* values)
{
    ...
    gles2::cmds::VertexAttrib4fvImmediate* c = GetImmediateCmdSpaceTotalSize<gles2::cmds::VertexAttrib4fvImmediate>(
        size);
    if (c) {
        c->Init(indx, values);
    }
...
void VertexAttribI4ivImmediate(GLuint indx, const GLint* values)
{
    ...
    gles2::cmds::VertexAttribI4ivImmediate* c = GetImmediateCmdSpaceTotalSize<gles2::cmds::VertexAttribI4ivImmediate>(
        size);
    if (c) {
        c->Init(indx, values);
    }
...
{
    gles2::cmds::VertexAttribI4ui* c = GetCmdSpace<gles2::cmds::VertexAttribI4ui>();
    if (c) {
        c->Init(indx, x, y, z, w);
    }
}
...
void VertexAttribI4uivImmediate(GLuint indx, const GLuint* values)
{
    ...
    gles2::cmds::VertexAttribI4uivImmediate* c = GetImmediateCmdSpaceTotalSize<gles2::cmds::VertexAttribI4uivImmediate>(
        size);
    if (c) {
        c->Init(indx, values);
    }
...
void VertexAttribIPointer(GLuint indx,
    ...
    GLuint offset)
{
    gles2::cmds::VertexAttribIPointer* c = GetCmdSpace<gles2::cmds::VertexAttribIPointer>();
    if (c) {
...
void VertexAttribPointer(GLuint indx,
    ...
    GLuint offset)
{
    gles2::cmds::VertexAttribPointer* c = GetCmdSpace<gles2::cmds::VertexAttribPointer>();
    if (c) {
...
void BlitFramebufferCHROMIUM(GLint srcX0,
    ...
    GLenum filter)
{
    gles2::cmds::BlitFramebufferCHROMIUM* c = GetCmdSpace<gles2::cmds::BlitFramebufferCHROMIUM>();
    if (c) {
...
void RenderbufferStorageMultisampleCHROMIUM(GLenum target,
    ...
    GLsizei height)
{
    gles2::cmds::RenderbufferStorageMultisampleCHROMIUM* c = GetCmdSpace<gles2::cmds::RenderbufferStorageMultisampleCHROMIUM>();
    if (c) {
...
void RenderbufferStorageMultisampleEXT(GLenum target,
    ...
    GLsizei height)
{
    gles2::cmds::RenderbufferStorageMultisampleEXT* c = GetCmdSpace<gles2::cmds::RenderbufferStorageMultisampleEXT>();
    if (c) {
        c->Init(target, samples, internalformat, width, height);
    }
}
...
void FramebufferTexture2DMultisampleEXT(GLenum target,
    ...
    GLsizei samples)
{
    gles2::cmds::FramebufferTexture2DMultisampleEXT* c = GetCmdSpace<gles2::cmds::FramebufferTexture2DMultisampleEXT>();
    if (c) {
...
void GenQueriesEXTImmediate(GLsizei n, GLuint* queries)
{
    ...
    gles2::cmds::GenQueriesEXTImmediate* c = GetImmediateCmdSpaceTotalSize<gles2::cmds::GenQueriesEXTImmediate>(size);
    if (c) {
        c->Init(n, queries);
    }
}
...
void DeleteQueriesEXTImmediate(GLsizei n, const GLuint* queries)
{
    ...
    gles2::cmds::DeleteQueriesEXTImmediate* c = GetImmediateCmdSpaceTotalSize<gles2::cmds::DeleteQueriesEXTImmediate>(
        size);
    if (c) {
        c->Init(n, queries);
    }
...
{
    gles2::cmds::BeginTransformFeedback* c = GetCmdSpace<gles2::cmds::BeginTransformFeedback>();
    if (c) {
...
{
    gles2::cmds::EndTransformFeedback* c = GetCmdSpace<gles2::cmds::EndTransformFeedback>();
    if (c) {
        c->Init();
    }
}
...
void SetDisjointValueSyncCHROMIUM(uint32_t sync_data_shm_id,
    uint32_t sync_data_shm_offset)
{
    gles2::cmds::SetDisjointValueSyncCHROMIUM* c = GetCmdSpace<gles2::cmds::SetDisjointValueSyncCHROMIUM>();
    if (c) {
...
{
    gles2::cmds::InsertEventMarkerEXT* c = GetCmdSpace<gles2::cmds::InsertEventMarkerEXT>();
    if (c) {
        c->Init(bucket_id);
    }
}
...
{
    gles2::cmds::PushGroupMarkerEXT* c = GetCmdSpace<gles2::cmds::PushGroupMarkerEXT>();
    if (c) {
        c->Init(bucket_id);
    }
}
...
{
    gles2::cmds::PopGroupMarkerEXT* c = GetCmdSpace<gles2::cmds::PopGroupMarkerEXT>();
    if (c) {
        c->Init();
    }
}
...
{
    const uint32_t size = gles2::cmds::GenVertexArraysOESImmediate::ComputeSize(n);
    gles2::cmds::GenVertexArraysOESImmediate* c = GetImmediateCmdSpaceTotalSize<gles2::cmds::GenVertexArraysOESImmediate>(
        size);
    if (c) {
        c->Init(n, arrays);
    }
...
{
    const uint32_t size = gles2::cmds::DeleteVertexArraysOESImmediate::ComputeSize(n);
    gles2::cmds::DeleteVertexArraysOESImmediate* c = GetImmediateCmdSpaceTotalSize<
...
void IsVertexArrayOES(GLuint array,
    ...
    uint32_t result_shm_offset)
{
    gles2::cmds::IsVertexArrayOES* c = GetCmdSpace<gles2::cmds::IsVertexArrayOES>();
    if (c) {
...
{
    gles2::cmds::BindVertexArrayOES* c = GetCmdSpace<gles2::cmds::BindVertexArrayOES>();
    if (c) {
        c->Init(array);
    }
}
...
void GetMaxValueInBufferCHROMIUM(GLuint buffer_id,
    ...
    uint32_t result_shm_offset)
{
    gles2::cmds::GetMaxValueInBufferCHROMIUM* c = GetCmdSpace<gles2::cmds::GetMaxValueInBufferCHROMIUM>();
    if (c) {
...
void EnableFeatureCHROMIUM(GLuint bucket_id,
    ...
    uint32_t result_shm_offset)
{
    gles2::cmds::EnableFeatureCHROMIUM* c = GetCmdSpace<gles2::cmds::EnableFeatureCHROMIUM>();
    if (c) {
...
{
    gles2::cmds::GetRequestableExtensionsCHROMIUM* c = GetCmdSpace<gles2::cmds::GetRequestableExtensionsCHROMIUM>();
    if (c) {
        c->Init(bucket_id);
    }
}
...
{
    gles2::cmds::RequestExtensionCHROMIUM* c = GetCmdSpace<gles2::cmds::RequestExtensionCHROMIUM>();
    if (c) {
        c->Init(bucket_id);
    }
}
...
{
    gles2::cmds::GetProgramInfoCHROMIUM* c = GetCmdSpace<gles2::cmds::GetProgramInfoCHROMIUM>();
    if (c) {
        c->Init(program, bucket_id);
    }
}
...
{
    gles2::cmds::GetUniformBlocksCHROMIUM* c = GetCmdSpace<gles2::cmds::GetUniformBlocksCHROMIUM>();
    if (c) {
        c->Init(program, bucket_id);
    }
}
...
{
    gles2::cmds::GetTransformFeedbackVaryingsCHROMIUM* c = GetCmdSpace<gles2::cmds::GetTransformFeedbackVaryingsCHROMIUM>();
    if (c) {
        c->Init(program, bucket_id);
    }
}
...
{
    gles2::cmds::GetUniformsES3CHROMIUM* c = GetCmdSpace<gles2::cmds::GetUniformsES3CHROMIUM>();
    if (c) {
        c->Init(program, bucket_id);
    }
}
...
{
    gles2::cmds::DescheduleUntilFinishedCHROMIUM* c = GetCmdSpace<gles2::cmds::DescheduleUntilFinishedCHROMIUM>();
    if (c) {
        c->Init();
    }
}
...
{
    gles2::cmds::GetTranslatedShaderSourceANGLE* c = GetCmdSpace<gles2::cmds::GetTranslatedShaderSourceANGLE>();
    if (c) {
        c->Init(shader, bucket_id);
    }
}
...
{
    gles2::cmds::PostSubBufferCHROMIUM* c = GetCmdSpace<gles2::cmds::PostSubBufferCHROMIUM>();
    if (c) {
        c->Init(x, y, width, height);
    }
}
...
{
    gles2::cmds::CopyTextureCHROMIUM* c = GetCmdSpace<gles2::cmds::CopyTextureCHROMIUM>();
    if (c) {
...
void CopySubTextureCHROMIUM(GLenum source_id,
    ...
    GLboolean unpack_unmultiply_alpha)
{
    gles2::cmds::CopySubTextureCHROMIUM* c = GetCmdSpace<gles2::cmds::CopySubTextureCHROMIUM>();
    if (c) {
...
{
    gles2::cmds::CompressedCopyTextureCHROMIUM* c = GetCmdSpace<gles2::cmds::CompressedCopyTextureCHROMIUM>();
    if (c) {
...
void DrawArraysInstancedANGLE(GLenum mode,
    ...
    GLsizei primcount)
{
    gles2::cmds::DrawArraysInstancedANGLE* c = GetCmdSpace<gles2::cmds::DrawArraysInstancedANGLE>();
    if (c) {
...
void DrawElementsInstancedANGLE(GLenum mode,
    ...
    GLsizei primcount)
{
    gles2::cmds::DrawElementsInstancedANGLE* c = GetCmdSpace<gles2::cmds::DrawElementsInstancedANGLE>();
    if (c) {
...
{
    gles2::cmds::VertexAttribDivisorANGLE* c = GetCmdSpace<gles2::cmds::VertexAttribDivisorANGLE>();
    if (c) {
...
{
    const uint32_t size = gles2::cmds::ProduceTextureCHROMIUMImmediate::ComputeSize();
    gles2::cmds::ProduceTextureCHROMIUMImmediate* c = GetImmediateCmdSpaceTotalSize<
...
{
    const uint32_t size = gles2::cmds::ProduceTextureDirectCHROMIUMImmediate::ComputeSize();
    gles2::cmds::ProduceTextureDirectCHROMIUMImmediate* c = GetImmediateCmdSpaceTotalSize<
...
{
    const uint32_t size = gles2::cmds::ConsumeTextureCHROMIUMImmediate::ComputeSize();
    gles2::cmds::ConsumeTextureCHROMIUMImmediate* c = GetImmediateCmdSpaceTotalSize<
...
void BindUniformLocationCHROMIUMBucket(GLuint program,
    ...
    uint32_t name_bucket_id)
{
    gles2::cmds::BindUniformLocationCHROMIUMBucket* c = GetCmdSpace<gles2::cmds::BindUniformLocationCHROMIUMBucket>();
    if (c) {
...
{
    gles2::cmds::BindTexImage2DCHROMIUM* c = GetCmdSpace<gles2::cmds::BindTexImage2DCHROMIUM>();
    if (c) {
...
{
    gles2::cmds::ReleaseTexImage2DCHROMIUM* c = GetCmdSpace<gles2::cmds::ReleaseTexImage2DCHROMIUM>();
    if (c) {
        c->Init(target, imageId);
    }
}
...
{
    gles2::cmds::TraceBeginCHROMIUM* c = GetCmdSpace<gles2::cmds::TraceBeginCHROMIUM>();
    if (c) {
...
{
    gles2::cmds::TraceEndCHROMIUM* c = GetCmdSpace<gles2::cmds::TraceEndCHROMIUM>();
    if (c) {
        c->Init();
    }
}
...
void DiscardFramebufferEXTImmediate(GLenum target,
    ...
    const GLenum* attachments)
{
    const uint32_t size = gles2::cmds::DiscardFramebufferEXTImmediate::ComputeSize(count);
    gles2::cmds::DiscardFramebufferEXTImmediate* c = GetImmediateCmdSpaceTotalSize<
...
{
    gles2::cmds::LoseContextCHROMIUM* c = GetCmdSpace<gles2::cmds::LoseContextCHROMIUM>();
    if (c) {
...
{
    gles2::cmds::InsertFenceSyncCHROMIUM* c = GetCmdSpace<gles2::cmds::InsertFenceSyncCHROMIUM>();
    if (c) {
...
{
    const uint32_t s = 0;
    gles2::cmds::GenSyncTokenCHROMIUMImmediate* c = GetImmediateCmdSpaceTotalSize<gles2::cmds::GenSyncTokenCHROMIUMImmediate>(
        s);
    if (c) {
        c->Init(fence_sync);
    }
...
{
    const uint32_t s = 0;
    gles2::cmds::VerifySyncTokensCHROMIUMImmediate* c = GetImmediateCmdSpaceTotalSize<
...
{
    gles2::cmds::WaitSyncTokenCHROMIUM* c = GetCmdSpace<gles2::cmds::WaitSyncTokenCHROMIUM>();
    if (c) {
...
{
    const uint32_t size = gles2::cmds::DrawBuffersEXTImmediate::ComputeSize(count);
    gles2::cmds::DrawBuffersEXTImmediate* c = GetImmediateCmdSpaceTotalSize<gles2::cmds::DrawBuffersEXTImmediate>(size);
    if (c) {
        c->Init(count, bufs);
    }
}
...
{
    gles2::cmds::DiscardBackbufferCHROMIUM* c = GetCmdSpace<gles2::cmds::DiscardBackbufferCHROMIUM>();
    if (c) {
        c->Init();
    }
}
...
void ScheduleOverlayPlaneCHROMIUM(GLint plane_z_order,
    ...
    GLfloat uv_height)
{
    gles2::cmds::ScheduleOverlayPlaneCHROMIUM* c = GetCmdSpace<gles2::cmds::ScheduleOverlayPlaneCHROMIUM>();
    if (c) {
...
void ScheduleCALayerCHROMIUM(GLuint contents_texture_id,
    ...
    GLuint shm_offset)
{
    gles2::cmds::ScheduleCALayerCHROMIUM* c = GetCmdSpace<gles2::cmds::ScheduleCALayerCHROMIUM>();
    if (c) {
...
{
    const uint32_t size = gles2::cmds::ScheduleCALayerInUseQueryCHROMIUMImmediate::ComputeSize(
        count);
    gles2::cmds::ScheduleCALayerInUseQueryCHROMIUMImmediate* c = GetImmediateCmdSpaceTotalSize<
...
{
    gles2::cmds::CommitOverlayPlanesCHROMIUM* c = GetCmdSpace<gles2::cmds::CommitOverlayPlanesCHROMIUM>();
    if (c) {
        c->Init();
    }
}
...
{
    gles2::cmds::FlushDriverCachesCHROMIUM* c = GetCmdSpace<gles2::cmds::FlushDriverCachesCHROMIUM>();
    if (c) {
        c->Init();
    }
}
...
{
    const uint32_t size = gles2::cmds::MatrixLoadfCHROMIUMImmediate::ComputeSize();
    gles2::cmds::MatrixLoadfCHROMIUMImmediate* c = GetImmediateCmdSpaceTotalSize<gles2::cmds::MatrixLoadfCHROMIUMImmediate>(
        size);
    if (c) {
        c->Init(matrixMode, m);
    }
...
{
    gles2::cmds::MatrixLoadIdentityCHROMIUM* c = GetCmdSpace<gles2::cmds::MatrixLoadIdentityCHROMIUM>();
    if (c) {
        c->Init(matrixMode);
    }
}
...
{
    gles2::cmds::GenPathsCHROMIUM* c = GetCmdSpace<gles2::cmds::GenPathsCHROMIUM>();
    if (c) {
...
{
    gles2::cmds::DeletePathsCHROMIUM* c = GetCmdSpace<gles2::cmds::DeletePathsCHROMIUM>();
    if (c) {
        c->Init(first_client_id, range);
    }
}
...
{
    gles2::cmds::PathCommandsCHROMIUM* c = GetCmdSpace<gles2::cmds::PathCommandsCHROMIUM>();
    if (c) {
...
{
    gles2::cmds::PathParameterfCHROMIUM* c = GetCmdSpace<gles2::cmds::PathParameterfCHROMIUM>();
    if (c) {
...
{
    gles2::cmds::PathParameteriCHROMIUM* c = GetCmdSpace<gles2::cmds::PathParameteriCHROMIUM>();
    if (c) {
        c->Init(path, pname, value);
    }
}
...
{
    gles2::cmds::PathStencilFuncCHROMIUM* c = GetCmdSpace<gles2::cmds::PathStencilFuncCHROMIUM>();
    if (c) {
        c->Init(func, ref, mask);
    }
}
...
{
    gles2::cmds::StencilFillPathCHROMIUM* c = GetCmdSpace<gles2::cmds::StencilFillPathCHROMIUM>();
    if (c) {
...
{
    gles2::cmds::StencilStrokePathCHROMIUM* c = GetCmdSpace<gles2::cmds::StencilStrokePathCHROMIUM>();
    if (c) {
...
{
    gles2::cmds::CoverFillPathCHROMIUM* c = GetCmdSpace<gles2::cmds::CoverFillPathCHROMIUM>();
    if (c) {
...
{
    gles2::cmds::CoverStrokePathCHROMIUM* c = GetCmdSpace<gles2::cmds::CoverStrokePathCHROMIUM>();
    if (c) {
        c->Init(path, coverMode);
    }
}
...
void StencilThenCoverFillPathCHROMIUM(GLuint path,
    ...
    GLenum coverMode)
{
    gles2::cmds::StencilThenCoverFillPathCHROMIUM* c = GetCmdSpace<gles2::cmds::StencilThenCoverFillPathCHROMIUM>();
    if (c) {
...
void StencilThenCoverStrokePathCHROMIUM(GLuint path,
    ...
    GLenum coverMode)
{
    gles2::cmds::StencilThenCoverStrokePathCHROMIUM* c = GetCmdSpace<gles2::cmds::StencilThenCoverStrokePathCHROMIUM>();
    if (c) {
...
{
    gles2::cmds::StencilFillPathInstancedCHROMIUM* c = GetCmdSpace<gles2::cmds::StencilFillPathInstancedCHROMIUM>();
    if (c) {
...
void StencilStrokePathInstancedCHROMIUM(GLsizei numPaths,
    ...
    uint32_t transformValues_shm_offset)
{
    gles2::cmds::StencilStrokePathInstancedCHROMIUM* c = GetCmdSpace<gles2::cmds::StencilStrokePathInstancedCHROMIUM>();
    if (c) {
        c->Init(numPaths, pathNameType, paths_shm_id, paths_shm_offset, pathBase,
...
void CoverFillPathInstancedCHROMIUM(GLsizei numPaths,
    ...
    uint32_t transformValues_shm_offset)
{
    gles2::cmds::CoverFillPathInstancedCHROMIUM* c = GetCmdSpace<gles2::cmds::CoverFillPathInstancedCHROMIUM>();
    if (c) {
        c->Init(numPaths, pathNameType, paths_shm_id, paths_shm_offset, pathBase,
...
void CoverStrokePathInstancedCHROMIUM(GLsizei numPaths,
    ...
    uint32_t transformValues_shm_offset)
{
    gles2::cmds::CoverStrokePathInstancedCHROMIUM* c = GetCmdSpace<gles2::cmds::CoverStrokePathInstancedCHROMIUM>();
    if (c) {
        c->Init(numPaths, pathNameType, paths_shm_id, paths_shm_offset, pathBase,
            coverMode, transformType, transformValues_shm_id,
            transformValues_shm_offset);
...
void StencilThenCoverFillPathInstancedCHROMIUM(
    ...
    uint32_t transformValues_shm_offset)
{
    gles2::cmds::StencilThenCoverFillPathInstancedCHROMIUM* c = GetCmdSpace<gles2::cmds::StencilThenCoverFillPathInstancedCHROMIUM>();
    if (c) {
        c->Init(numPaths, pathNameType, paths_shm_id, paths_shm_offset, pathBase,
...
void StencilThenCoverStrokePathInstancedCHROMIUM(
    ...
    uint32_t transformValues_shm_offset)
{
    gles2::cmds::StencilThenCoverStrokePathInstancedCHROMIUM* c = GetCmdSpace<gles2::cmds::StencilThenCoverStrokePathInstancedCHROMIUM>();
    if (c) {
        c->Init(numPaths, pathNameType, paths_shm_id, paths_shm_offset, pathBase,
...
void BindFragmentInputLocationCHROMIUMBucket(GLuint program,
    ...
    uint32_t name_bucket_id)
{
    gles2::cmds::BindFragmentInputLocationCHROMIUMBucket* c = GetCmdSpace<gles2::cmds::BindFragmentInputLocationCHROMIUMBucket>();
    if (c) {
        c->Init(program, location, name_bucket_id);
    }
}
...
{
    gles2::cmds::ProgramPathFragmentInputGenCHROMIUM* c = GetCmdSpace<gles2::cmds::ProgramPathFragmentInputGenCHROMIUM>();
    if (c) {
...
{
    gles2::cmds::CoverageModulationCHROMIUM* c = GetCmdSpace<gles2::cmds::CoverageModulationCHROMIUM>();
    if (c) {
        c->Init(components);
    }
}
...
{
    gles2::cmds::ApplyScreenSpaceAntialiasingCHROMIUM* c = GetCmdSpace<gles2::cmds::ApplyScreenSpaceAntialiasingCHROMIUM>();
    if (c) {
        c->Init();
    }
}
...
void BindFragDataLocationIndexedEXTBucket(GLuint program,
    ...
    uint32_t name_bucket_id)
{
    gles2::cmds::BindFragDataLocationIndexedEXTBucket* c = GetCmdSpace<gles2::cmds::BindFragDataLocationIndexedEXTBucket>();
    if (c) {
...
void BindFragDataLocationEXTBucket(GLuint program,
    ...
    uint32_t name_bucket_id)
{
    gles2::cmds::BindFragDataLocationEXTBucket* c = GetCmdSpace<gles2::cmds::BindFragDataLocationEXTBucket>();
    if (c) {
...
void GetFragDataIndexEXT(GLuint program,
    ...
    uint32_t index_shm_offset)
{
    gles2::cmds::GetFragDataIndexEXT* c = GetCmdSpace<gles2::cmds::GetFragDataIndexEXT>();
    if (c) {
        c->Init(program, name_bucket_id, index_shm_id, index_shm_offset);
    }
}
    ...
    const GLfloat* default_value)
{
    ...
    gles2::cmds::UniformMatrix4fvStreamTextureMatrixCHROMIUMImmediate* c = GetImmediateCmdSpaceTotalSize<
