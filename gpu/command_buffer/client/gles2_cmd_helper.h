...
#include "gpu/command_buffer/client/gles2_cmd_helper_autogen.h"
        ...
        {
            const uint32_t size = gles2::cmds::CreateAndConsumeTextureCHROMIUMImmediate::ComputeSize();
            gles2::cmds::CreateAndConsumeTextureCHROMIUMImmediate* c = GetImmediateCmdSpaceTotalSize<
