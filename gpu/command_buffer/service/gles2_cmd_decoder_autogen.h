...
error::Error GLES2DecoderImpl::HandleActiveTexture(uint32_t immediate_data_size,
    const void* cmd_data)
{
    const gles2::cmds::ActiveTexture& c = *static_cast<const gles2::cmds::ActiveTexture*>(cmd_data);
    (void)c;
...
error::Error GLES2DecoderImpl::HandleAttachShader(uint32_t immediate_data_size,
    const void* cmd_data)
{
    const gles2::cmds::AttachShader& c = *static_cast<const gles2::cmds::AttachShader*>(cmd_data);
    (void)c;
...
error::Error GLES2DecoderImpl::HandleBindBuffer(uint32_t immediate_data_size,
    const void* cmd_data)
{
    const gles2::cmds::BindBuffer& c = *static_cast<const gles2::cmds::BindBuffer*>(cmd_data);
    (void)c;
    ...
    const void* cmd_data)
{
    ...
    const gles2::cmds::BindBufferBase& c = *static_cast<const gles2::cmds::BindBufferBase*>(cmd_data);
    (void)c;
    GLenum target = static_cast<GLenum>(c.target);
    ...
    const void* cmd_data)
{
    if (!unsafe_es3_apis_enabled())
        return error::kUnknownCommand;
    const gles2::cmds::BindBufferRange& c = *static_cast<const gles2::cmds::BindBufferRange*>(cmd_data);
    (void)c;
    GLenum target = static_cast<GLenum>(c.target);
    GLuint index = static_cast<GLuint>(c.index);
    GLuint buffer = c.buffer;
...
error::Error GLES2DecoderImpl::HandleBindFramebuffer(
    ...
    const void* cmd_data)
{
    const gles2::cmds::BindFramebuffer& c = *static_cast<const gles2::cmds::BindFramebuffer*>(cmd_data);
    (void)c;
    GLenum target = static_cast<GLenum>(c.target);
...
error::Error GLES2DecoderImpl::HandleBindRenderbuffer(
    ...
    const void* cmd_data)
{
    const gles2::cmds::BindRenderbuffer& c = *static_cast<const gles2::cmds::BindRenderbuffer*>(cmd_data);
    (void)c;
    GLenum target = static_cast<GLenum>(c.target);
    ...
    const void* cmd_data)
{
    if (!unsafe_es3_apis_enabled())
        return error::kUnknownCommand;
    const gles2::cmds::BindSampler& c = *static_cast<const gles2::cmds::BindSampler*>(cmd_data);
    (void)c;
...
error::Error GLES2DecoderImpl::HandleBindTexture(uint32_t immediate_data_size,
    const void* cmd_data)
{
    const gles2::cmds::BindTexture& c = *static_cast<const gles2::cmds::BindTexture*>(cmd_data);
    (void)c;
    GLenum target = static_cast<GLenum>(c.target);
    ...
    const void* cmd_data)
{
    if (!unsafe_es3_apis_enabled())
        return error::kUnknownCommand;
    const gles2::cmds::BindTransformFeedback& c = *static_cast<const gles2::cmds::BindTransformFeedback*>(cmd_data);
    (void)c;
    GLenum target = static_cast<GLenum>(c.target);
...
error::Error GLES2DecoderImpl::HandleBlendColor(uint32_t immediate_data_size,
    const void* cmd_data)
{
    const gles2::cmds::BlendColor& c = *static_cast<const gles2::cmds::BlendColor*>(cmd_data);
    (void)c;
    ...
    if (state_.blend_color_red != red || state_.blend_color_green != green || state_.blend_color_blue != blue || state_.blend_color_alpha != alpha) {
...
error::Error GLES2DecoderImpl::HandleBlendEquation(uint32_t immediate_data_size,
    const void* cmd_data)
{
    const gles2::cmds::BlendEquation& c = *static_cast<const gles2::cmds::BlendEquation*>(cmd_data);
    (void)c;
    ...
    if (state_.blend_equation_rgb != mode || state_.blend_equation_alpha != mode) {
...
error::Error GLES2DecoderImpl::HandleBlendEquationSeparate(
    ...
    const void* cmd_data)
{
    const gles2::cmds::BlendEquationSeparate& c = *static_cast<const gles2::cmds::BlendEquationSeparate*>(cmd_data);
    (void)c;
    ...
    if (state_.blend_equation_rgb != modeRGB || state_.blend_equation_alpha != modeAlpha) {
...
error::Error GLES2DecoderImpl::HandleBlendFunc(uint32_t immediate_data_size,
    const void* cmd_data)
{
    const gles2::cmds::BlendFunc& c = *static_cast<const gles2::cmds::BlendFunc*>(cmd_data);
    (void)c;
    ...
    if (state_.blend_source_rgb != sfactor || state_.blend_dest_rgb != dfactor || state_.blend_source_alpha != sfactor || state_.blend_dest_alpha != dfactor) {
...
error::Error GLES2DecoderImpl::HandleBlendFuncSeparate(
    ...
    const void* cmd_data)
{
    const gles2::cmds::BlendFuncSeparate& c = *static_cast<const gles2::cmds::BlendFuncSeparate*>(cmd_data);
    (void)c;
    ...
    if (state_.blend_source_rgb != srcRGB || state_.blend_dest_rgb != dstRGB || state_.blend_source_alpha != srcAlpha || state_.blend_dest_alpha != dstAlpha) {
...
error::Error GLES2DecoderImpl::HandleBufferSubData(uint32_t immediate_data_size,
    const void* cmd_data)
{
    const gles2::cmds::BufferSubData& c = *static_cast<const gles2::cmds::BufferSubData*>(cmd_data);
    (void)c;
    GLenum target = static_cast<GLenum>(c.target);
    GLintptr offset = static_cast<GLintptr>(c.offset);
    GLsizeiptr size = static_cast<GLsizeiptr>(c.size);
...
error::Error GLES2DecoderImpl::HandleCheckFramebufferStatus(
    ...
    const void* cmd_data)
{
    const gles2::cmds::CheckFramebufferStatus& c = *static_cast<const gles2::cmds::CheckFramebufferStatus*>(cmd_data);
    (void)c;
    GLenum target = static_cast<GLenum>(c.target);
...
error::Error GLES2DecoderImpl::HandleClear(uint32_t immediate_data_size,
    const void* cmd_data)
{
    const gles2::cmds::Clear& c = *static_cast<const gles2::cmds::Clear*>(cmd_data);
    (void)c;
    error::Error error;
    ...
    const void* cmd_data)
{
    if (!unsafe_es3_apis_enabled())
        return error::kUnknownCommand;
    const gles2::cmds::ClearBufferfi& c = *static_cast<const gles2::cmds::ClearBufferfi*>(cmd_data);
    (void)c;
    ...
    const void* cmd_data)
{
    if (!unsafe_es3_apis_enabled())
        return error::kUnknownCommand;
    const gles2::cmds::ClearBufferfvImmediate& c = *static_cast<const gles2::cmds::ClearBufferfvImmediate*>(cmd_data);
    (void)c;
    GLenum buffer = static_cast<GLenum>(c.buffer);
    GLint drawbuffers = static_cast<GLint>(c.drawbuffers);
    uint32_t data_size;
    ...
    const void* cmd_data)
{
    if (!unsafe_es3_apis_enabled())
        return error::kUnknownCommand;
    const gles2::cmds::ClearBufferivImmediate& c = *static_cast<const gles2::cmds::ClearBufferivImmediate*>(cmd_data);
    (void)c;
    GLenum buffer = static_cast<GLenum>(c.buffer);
    GLint drawbuffers = static_cast<GLint>(c.drawbuffers);
    uint32_t data_size;
    ...
    const GLint* value = GetImmediateDataAs<const GLint*>(c, data_size, immediate_data_size);
    if (value == NULL) {
        return error::kOutOfBounds;
    }
    ...
    const void* cmd_data)
{
    if (!unsafe_es3_apis_enabled())
        return error::kUnknownCommand;
    const gles2::cmds::ClearBufferuivImmediate& c = *static_cast<const gles2::cmds::ClearBufferuivImmediate*>(cmd_data);
    (void)c;
    GLenum buffer = static_cast<GLenum>(c.buffer);
    GLint drawbuffers = static_cast<GLint>(c.drawbuffers);
    uint32_t data_size;
    ...
    const GLuint* value = GetImmediateDataAs<const GLuint*>(c, data_size, immediate_data_size);
    if (value == NULL) {
        return error::kOutOfBounds;
    }
...
error::Error GLES2DecoderImpl::HandleClearColor(uint32_t immediate_data_size,
    const void* cmd_data)
{
    const gles2::cmds::ClearColor& c = *static_cast<const gles2::cmds::ClearColor*>(cmd_data);
    (void)c;
    GLclampf red = static_cast<GLclampf>(c.red);
    GLclampf green = static_cast<GLclampf>(c.green);
    GLclampf blue = static_cast<GLclampf>(c.blue);
    GLclampf alpha = static_cast<GLclampf>(c.alpha);
    if (state_.color_clear_red != red || state_.color_clear_green != green || state_.color_clear_blue != blue || state_.color_clear_alpha != alpha) {
...
error::Error GLES2DecoderImpl::HandleClearDepthf(uint32_t immediate_data_size,
    const void* cmd_data)
{
    const gles2::cmds::ClearDepthf& c = *static_cast<const gles2::cmds::ClearDepthf*>(cmd_data);
    (void)c;
...
error::Error GLES2DecoderImpl::HandleClearStencil(uint32_t immediate_data_size,
    const void* cmd_data)
{
    const gles2::cmds::ClearStencil& c = *static_cast<const gles2::cmds::ClearStencil*>(cmd_data);
    (void)c;
...
error::Error GLES2DecoderImpl::HandleColorMask(uint32_t immediate_data_size,
    const void* cmd_data)
{
    const gles2::cmds::ColorMask& c = *static_cast<const gles2::cmds::ColorMask*>(cmd_data);
    (void)c;
    ...
    if (state_.color_mask_red != red || state_.color_mask_green != green || state_.color_mask_blue != blue || state_.color_mask_alpha != alpha) {
...
error::Error GLES2DecoderImpl::HandleCompileShader(uint32_t immediate_data_size,
    const void* cmd_data)
{
    const gles2::cmds::CompileShader& c = *static_cast<const gles2::cmds::CompileShader*>(cmd_data);
    (void)c;
    GLuint shader = c.shader;
...
error::Error GLES2DecoderImpl::HandleCompressedTexSubImage2D(
    ...
    const void* cmd_data)
{
    const gles2::cmds::CompressedTexSubImage2D& c = *static_cast<const gles2::cmds::CompressedTexSubImage2D*>(cmd_data);
    (void)c;
    GLenum target = static_cast<GLenum>(c.target);
    ...
    const void* cmd_data)
{
    if (!unsafe_es3_apis_enabled())
        return error::kUnknownCommand;
    const gles2::cmds::CompressedTexSubImage3D& c = *static_cast<const gles2::cmds::CompressedTexSubImage3D*>(cmd_data);
    (void)c;
    GLenum target = static_cast<GLenum>(c.target);
    GLint level = static_cast<GLint>(c.level);
    GLint xoffset = static_cast<GLint>(c.xoffset);
    ...
    const void* cmd_data)
{
    if (!unsafe_es3_apis_enabled())
        return error::kUnknownCommand;
    const gles2::cmds::CopyBufferSubData& c = *static_cast<const gles2::cmds::CopyBufferSubData*>(cmd_data);
    (void)c;
...
error::Error GLES2DecoderImpl::HandleCopyTexImage2D(
    ...
    const void* cmd_data)
{
    const gles2::cmds::CopyTexImage2D& c = *static_cast<const gles2::cmds::CopyTexImage2D*>(cmd_data);
    (void)c;
    error::Error error;
...
error::Error GLES2DecoderImpl::HandleCopyTexSubImage2D(
    ...
    const void* cmd_data)
{
    const gles2::cmds::CopyTexSubImage2D& c = *static_cast<const gles2::cmds::CopyTexSubImage2D*>(cmd_data);
    (void)c;
    error::Error error;
    error = WillAccessBoundFramebufferForRead();
    if (error != error::kNoError)
    ...
    const void* cmd_data)
{
    if (!unsafe_es3_apis_enabled())
        return error::kUnknownCommand;
    const gles2::cmds::CopyTexSubImage3D& c = *static_cast<const gles2::cmds::CopyTexSubImage3D*>(cmd_data);
    (void)c;
    error::Error error;
    error = WillAccessBoundFramebufferForRead();
    if (error != error::kNoError)
...
error::Error GLES2DecoderImpl::HandleCreateProgram(uint32_t immediate_data_size,
    const void* cmd_data)
{
    const gles2::cmds::CreateProgram& c = *static_cast<const gles2::cmds::CreateProgram*>(cmd_data);
    (void)c;
...
error::Error GLES2DecoderImpl::HandleCreateShader(uint32_t immediate_data_size,
    const void* cmd_data)
{
    const gles2::cmds::CreateShader& c = *static_cast<const gles2::cmds::CreateShader*>(cmd_data);
    (void)c;
...
error::Error GLES2DecoderImpl::HandleCullFace(uint32_t immediate_data_size,
    const void* cmd_data)
{
    const gles2::cmds::CullFace& c = *static_cast<const gles2::cmds::CullFace*>(cmd_data);
    (void)c;
    GLenum mode = static_cast<GLenum>(c.mode);
...
error::Error GLES2DecoderImpl::HandleDeleteBuffersImmediate(
    ...
    const void* cmd_data)
{
    const gles2::cmds::DeleteBuffersImmediate& c = *static_cast<const gles2::cmds::DeleteBuffersImmediate*>(cmd_data);
    (void)c;
...
error::Error GLES2DecoderImpl::HandleDeleteFramebuffersImmediate(
    ...
    const void* cmd_data)
{
    const gles2::cmds::DeleteFramebuffersImmediate& c = *static_cast<const gles2::cmds::DeleteFramebuffersImmediate*>(cmd_data);
    (void)c;
    GLsizei n = static_cast<GLsizei>(c.n);
    uint32_t data_size;
    if (!SafeMultiplyUint32(n, sizeof(GLuint), &data_size)) {
...
error::Error GLES2DecoderImpl::HandleDeleteRenderbuffersImmediate(
    ...
    const void* cmd_data)
{
    const gles2::cmds::DeleteRenderbuffersImmediate& c = *static_cast<const gles2::cmds::DeleteRenderbuffersImmediate*>(cmd_data);
    (void)c;
    GLsizei n = static_cast<GLsizei>(c.n);
    uint32_t data_size;
    if (!SafeMultiplyUint32(n, sizeof(GLuint), &data_size)) {
    ...
    const void* cmd_data)
{
    if (!unsafe_es3_apis_enabled())
        return error::kUnknownCommand;
    const gles2::cmds::DeleteSamplersImmediate& c = *static_cast<const gles2::cmds::DeleteSamplersImmediate*>(cmd_data);
    (void)c;
    GLsizei n = static_cast<GLsizei>(c.n);
    uint32_t data_size;
    if (!SafeMultiplyUint32(n, sizeof(GLuint), &data_size)) {
    ...
    const GLuint* samplers = GetImmediateDataAs<const GLuint*>(c, data_size, immediate_data_size);
    if (samplers == NULL) {
        return error::kOutOfBounds;
    }
    ...
    const void* cmd_data)
{
    if (!unsafe_es3_apis_enabled())
        return error::kUnknownCommand;
    const gles2::cmds::DeleteSync& c = *static_cast<const gles2::cmds::DeleteSync*>(cmd_data);
    (void)c;
    GLuint sync = c.sync;
    GLsync service_id = 0;
...
error::Error GLES2DecoderImpl::HandleDeleteTexturesImmediate(
    ...
    const void* cmd_data)
{
    const gles2::cmds::DeleteTexturesImmediate& c = *static_cast<const gles2::cmds::DeleteTexturesImmediate*>(cmd_data);
    (void)c;
    GLsizei n = static_cast<GLsizei>(c.n);
    uint32_t data_size;
    if (!SafeMultiplyUint32(n, sizeof(GLuint), &data_size)) {
    ...
    const void* cmd_data)
{
    if (!unsafe_es3_apis_enabled())
        return error::kUnknownCommand;
    const gles2::cmds::DeleteTransformFeedbacksImmediate& c = *static_cast<const gles2::cmds::DeleteTransformFeedbacksImmediate*>(
        cmd_data);
    (void)c;
    GLsizei n = static_cast<GLsizei>(c.n);
    uint32_t data_size;
    ...
    const GLuint* ids = GetImmediateDataAs<const GLuint*>(c, data_size, immediate_data_size);
    if (ids == NULL) {
        return error::kOutOfBounds;
    }
    for (GLsizei ii = 0; ii < n; ++ii) {
...
error::Error GLES2DecoderImpl::HandleDepthFunc(uint32_t immediate_data_size,
    const void* cmd_data)
{
    const gles2::cmds::DepthFunc& c = *static_cast<const gles2::cmds::DepthFunc*>(cmd_data);
    (void)c;
...
error::Error GLES2DecoderImpl::HandleDepthMask(uint32_t immediate_data_size,
    const void* cmd_data)
{
    const gles2::cmds::DepthMask& c = *static_cast<const gles2::cmds::DepthMask*>(cmd_data);
    (void)c;
...
error::Error GLES2DecoderImpl::HandleDepthRangef(uint32_t immediate_data_size,
    const void* cmd_data)
{
    const gles2::cmds::DepthRangef& c = *static_cast<const gles2::cmds::DepthRangef*>(cmd_data);
    (void)c;
...
error::Error GLES2DecoderImpl::HandleDetachShader(uint32_t immediate_data_size,
    const void* cmd_data)
{
    const gles2::cmds::DetachShader& c = *static_cast<const gles2::cmds::DetachShader*>(cmd_data);
    (void)c;
    GLuint program = c.program;
    GLuint shader = c.shader;
...
error::Error GLES2DecoderImpl::HandleDisable(uint32_t immediate_data_size,
    const void* cmd_data)
{
    const gles2::cmds::Disable& c = *static_cast<const gles2::cmds::Disable*>(cmd_data);
    (void)c;
...
error::Error GLES2DecoderImpl::HandleDisableVertexAttribArray(
    ...
    const void* cmd_data)
{
    const gles2::cmds::DisableVertexAttribArray& c = *static_cast<const gles2::cmds::DisableVertexAttribArray*>(cmd_data);
    (void)c;
    GLuint index = static_cast<GLuint>(c.index);
...
error::Error GLES2DecoderImpl::HandleEnable(uint32_t immediate_data_size,
    const void* cmd_data)
{
    const gles2::cmds::Enable& c = *static_cast<const gles2::cmds::Enable*>(cmd_data);
    (void)c;
    GLenum cap = static_cast<GLenum>(c.cap);
    if (!validators_->capability.IsValid(cap)) {
...
error::Error GLES2DecoderImpl::HandleEnableVertexAttribArray(
    ...
    const void* cmd_data)
{
    const gles2::cmds::EnableVertexAttribArray& c = *static_cast<const gles2::cmds::EnableVertexAttribArray*>(cmd_data);
    (void)c;
    GLuint index = static_cast<GLuint>(c.index);
    ...
    const void* cmd_data)
{
    if (!unsafe_es3_apis_enabled())
        return error::kUnknownCommand;
    const gles2::cmds::FenceSync& c = *static_cast<const gles2::cmds::FenceSync*>(cmd_data);
    (void)c;
...
error::Error GLES2DecoderImpl::HandleFinish(uint32_t immediate_data_size,
    const void* cmd_data)
{
    const gles2::cmds::Finish& c = *static_cast<const gles2::cmds::Finish*>(cmd_data);
    (void)c;
    error::Error error;
    error = WillAccessBoundFramebufferForRead();
    if (error != error::kNoError)
...
error::Error GLES2DecoderImpl::HandleFlush(uint32_t immediate_data_size,
    const void* cmd_data)
{
    const gles2::cmds::Flush& c = *static_cast<const gles2::cmds::Flush*>(cmd_data);
    (void)c;
    DoFlush();
    return error::kNoError;
}
...
error::Error GLES2DecoderImpl::HandleFramebufferRenderbuffer(
    ...
    const void* cmd_data)
{
    const gles2::cmds::FramebufferRenderbuffer& c = *static_cast<const gles2::cmds::FramebufferRenderbuffer*>(cmd_data);
    (void)c;
    GLenum target = static_cast<GLenum>(c.target);
...
error::Error GLES2DecoderImpl::HandleFramebufferTexture2D(
    ...
    const void* cmd_data)
{
    const gles2::cmds::FramebufferTexture2D& c = *static_cast<const gles2::cmds::FramebufferTexture2D*>(cmd_data);
    (void)c;
    GLenum target = static_cast<GLenum>(c.target);
    GLenum attachment = static_cast<GLenum>(c.attachment);
    ...
    const void* cmd_data)
{
    if (!unsafe_es3_apis_enabled())
        return error::kUnknownCommand;
    const gles2::cmds::FramebufferTextureLayer& c = *static_cast<const gles2::cmds::FramebufferTextureLayer*>(cmd_data);
    (void)c;
    GLenum target = static_cast<GLenum>(c.target);
    GLenum attachment = static_cast<GLenum>(c.attachment);
    GLuint texture = c.texture;
...
error::Error GLES2DecoderImpl::HandleFrontFace(uint32_t immediate_data_size,
    const void* cmd_data)
{
    const gles2::cmds::FrontFace& c = *static_cast<const gles2::cmds::FrontFace*>(cmd_data);
    (void)c;
    GLenum mode = static_cast<GLenum>(c.mode);
...
error::Error GLES2DecoderImpl::HandleGenBuffersImmediate(
    ...
    const void* cmd_data)
{
    const gles2::cmds::GenBuffersImmediate& c = *static_cast<const gles2::cmds::GenBuffersImmediate*>(cmd_data);
    (void)c;
    GLsizei n = static_cast<GLsizei>(c.n);
    uint32_t data_size;
    if (!SafeMultiplyUint32(n, sizeof(GLuint), &data_size)) {
...
error::Error GLES2DecoderImpl::HandleGenerateMipmap(
    ...
    const void* cmd_data)
{
    const gles2::cmds::GenerateMipmap& c = *static_cast<const gles2::cmds::GenerateMipmap*>(cmd_data);
    (void)c;
    GLenum target = static_cast<GLenum>(c.target);
    if (!validators_->texture_bind_target.IsValid(target)) {
...
error::Error GLES2DecoderImpl::HandleGenFramebuffersImmediate(
    ...
    const void* cmd_data)
{
    const gles2::cmds::GenFramebuffersImmediate& c = *static_cast<const gles2::cmds::GenFramebuffersImmediate*>(cmd_data);
    (void)c;
    GLsizei n = static_cast<GLsizei>(c.n);
    uint32_t data_size;
    if (!SafeMultiplyUint32(n, sizeof(GLuint), &data_size)) {
...
error::Error GLES2DecoderImpl::HandleGenRenderbuffersImmediate(
    ...
    const void* cmd_data)
{
    const gles2::cmds::GenRenderbuffersImmediate& c = *static_cast<const gles2::cmds::GenRenderbuffersImmediate*>(cmd_data);
    (void)c;
    GLsizei n = static_cast<GLsizei>(c.n);
    uint32_t data_size;
    if (!SafeMultiplyUint32(n, sizeof(GLuint), &data_size)) {
    ...
    const void* cmd_data)
{
    if (!unsafe_es3_apis_enabled())
        return error::kUnknownCommand;
    const gles2::cmds::GenSamplersImmediate& c = *static_cast<const gles2::cmds::GenSamplersImmediate*>(cmd_data);
    (void)c;
    GLsizei n = static_cast<GLsizei>(c.n);
    uint32_t data_size;
    if (!SafeMultiplyUint32(n, sizeof(GLuint), &data_size)) {
    ...
    GLuint* samplers = GetImmediateDataAs<GLuint*>(c, data_size, immediate_data_size);
    if (samplers == NULL) {
        return error::kOutOfBounds;
    }
    for (GLsizei ii = 0; ii < n; ++ii) {
...
error::Error GLES2DecoderImpl::HandleGenTexturesImmediate(
    ...
    const void* cmd_data)
{
    const gles2::cmds::GenTexturesImmediate& c = *static_cast<const gles2::cmds::GenTexturesImmediate*>(cmd_data);
    (void)c;
    GLsizei n = static_cast<GLsizei>(c.n);
    uint32_t data_size;
    if (!SafeMultiplyUint32(n, sizeof(GLuint), &data_size)) {
    ...
    const void* cmd_data)
{
    if (!unsafe_es3_apis_enabled())
        return error::kUnknownCommand;
    const gles2::cmds::GenTransformFeedbacksImmediate& c = *static_cast<const gles2::cmds::GenTransformFeedbacksImmediate*>(
        cmd_data);
    (void)c;
    GLsizei n = static_cast<GLsizei>(c.n);
    uint32_t data_size;
...
error::Error GLES2DecoderImpl::HandleGetBooleanv(uint32_t immediate_data_size,
    const void* cmd_data)
{
    const gles2::cmds::GetBooleanv& c = *static_cast<const gles2::cmds::GetBooleanv*>(cmd_data);
    (void)c;
    ...
    const void* cmd_data)
{
    if (!unsafe_es3_apis_enabled())
        return error::kUnknownCommand;
    const gles2::cmds::GetBufferParameteri64v& c = *static_cast<const gles2::cmds::GetBufferParameteri64v*>(cmd_data);
    (void)c;
    GLenum target = static_cast<GLenum>(c.target);
    GLenum pname = static_cast<GLenum>(c.pname);
...
error::Error GLES2DecoderImpl::HandleGetBufferParameteriv(
    ...
    const void* cmd_data)
{
    const gles2::cmds::GetBufferParameteriv& c = *static_cast<const gles2::cmds::GetBufferParameteriv*>(cmd_data);
    (void)c;
    GLenum target = static_cast<GLenum>(c.target);
    GLenum pname = static_cast<GLenum>(c.pname);
...
error::Error GLES2DecoderImpl::HandleGetError(uint32_t immediate_data_size,
    const void* cmd_data)
{
    const gles2::cmds::GetError& c = *static_cast<const gles2::cmds::GetError*>(cmd_data);
    (void)c;
...
error::Error GLES2DecoderImpl::HandleGetFloatv(uint32_t immediate_data_size,
    const void* cmd_data)
{
    const gles2::cmds::GetFloatv& c = *static_cast<const gles2::cmds::GetFloatv*>(cmd_data);
    (void)c;
    GLenum pname = static_cast<GLenum>(c.pname);
...
error::Error GLES2DecoderImpl::HandleGetFramebufferAttachmentParameteriv(
    ...
    const void* cmd_data)
{
    const gles2::cmds::GetFramebufferAttachmentParameteriv& c = *static_cast<const gles2::cmds::GetFramebufferAttachmentParameteriv*>(
        cmd_data);
    (void)c;
    GLenum target = static_cast<GLenum>(c.target);
    GLenum attachment = static_cast<GLenum>(c.attachment);
    ...
    const void* cmd_data)
{
    if (!unsafe_es3_apis_enabled())
        return error::kUnknownCommand;
    const gles2::cmds::GetInteger64v& c = *static_cast<const gles2::cmds::GetInteger64v*>(cmd_data);
    (void)c;
    GLenum pname = static_cast<GLenum>(c.pname);
    ...
    const void* cmd_data)
{
    if (!unsafe_es3_apis_enabled())
        return error::kUnknownCommand;
    const gles2::cmds::GetIntegeri_v& c = *static_cast<const gles2::cmds::GetIntegeri_v*>(cmd_data);
    (void)c;
    GLenum pname = static_cast<GLenum>(c.pname);
    GLuint index = static_cast<GLuint>(c.index);
    ...
    const void* cmd_data)
{
    if (!unsafe_es3_apis_enabled())
        return error::kUnknownCommand;
    const gles2::cmds::GetInteger64i_v& c = *static_cast<const gles2::cmds::GetInteger64i_v*>(cmd_data);
    (void)c;
    GLenum pname = static_cast<GLenum>(c.pname);
    GLuint index = static_cast<GLuint>(c.index);
...
error::Error GLES2DecoderImpl::HandleGetIntegerv(uint32_t immediate_data_size,
    const void* cmd_data)
{
    const gles2::cmds::GetIntegerv& c = *static_cast<const gles2::cmds::GetIntegerv*>(cmd_data);
    (void)c;
    GLenum pname = static_cast<GLenum>(c.pname);
...
error::Error GLES2DecoderImpl::HandleGetProgramiv(uint32_t immediate_data_size,
    const void* cmd_data)
{
    const gles2::cmds::GetProgramiv& c = *static_cast<const gles2::cmds::GetProgramiv*>(cmd_data);
    (void)c;
    GLuint program = c.program;
    GLenum pname = static_cast<GLenum>(c.pname);
...
error::Error GLES2DecoderImpl::HandleGetRenderbufferParameteriv(
    ...
    const void* cmd_data)
{
    const gles2::cmds::GetRenderbufferParameteriv& c = *static_cast<const gles2::cmds::GetRenderbufferParameteriv*>(cmd_data);
    (void)c;
    GLenum target = static_cast<GLenum>(c.target);
    GLenum pname = static_cast<GLenum>(c.pname);
    ...
    const void* cmd_data)
{
    if (!unsafe_es3_apis_enabled())
        return error::kUnknownCommand;
    const gles2::cmds::GetSamplerParameterfv& c = *static_cast<const gles2::cmds::GetSamplerParameterfv*>(cmd_data);
    (void)c;
    GLuint sampler = c.sampler;
    GLenum pname = static_cast<GLenum>(c.pname);
    ...
    const void* cmd_data)
{
    if (!unsafe_es3_apis_enabled())
        return error::kUnknownCommand;
    const gles2::cmds::GetSamplerParameteriv& c = *static_cast<const gles2::cmds::GetSamplerParameteriv*>(cmd_data);
    (void)c;
    GLuint sampler = c.sampler;
    GLenum pname = static_cast<GLenum>(c.pname);
...
error::Error GLES2DecoderImpl::HandleGetShaderiv(uint32_t immediate_data_size,
    const void* cmd_data)
{
    const gles2::cmds::GetShaderiv& c = *static_cast<const gles2::cmds::GetShaderiv*>(cmd_data);
    (void)c;
    GLuint shader = c.shader;
    GLenum pname = static_cast<GLenum>(c.pname);
    ...
    const void* cmd_data)
{
    if (!unsafe_es3_apis_enabled())
        return error::kUnknownCommand;
    const gles2::cmds::GetSynciv& c = *static_cast<const gles2::cmds::GetSynciv*>(cmd_data);
    (void)c;
...
error::Error GLES2DecoderImpl::HandleGetTexParameterfv(
    ...
    const void* cmd_data)
{
    const gles2::cmds::GetTexParameterfv& c = *static_cast<const gles2::cmds::GetTexParameterfv*>(cmd_data);
    (void)c;
    GLenum target = static_cast<GLenum>(c.target);
    GLenum pname = static_cast<GLenum>(c.pname);
...
error::Error GLES2DecoderImpl::HandleGetTexParameteriv(
    ...
    const void* cmd_data)
{
    const gles2::cmds::GetTexParameteriv& c = *static_cast<const gles2::cmds::GetTexParameteriv*>(cmd_data);
    (void)c;
    GLenum target = static_cast<GLenum>(c.target);
    GLenum pname = static_cast<GLenum>(c.pname);
...
error::Error GLES2DecoderImpl::HandleGetVertexAttribfv(
    ...
    const void* cmd_data)
{
    const gles2::cmds::GetVertexAttribfv& c = *static_cast<const gles2::cmds::GetVertexAttribfv*>(cmd_data);
    (void)c;
    GLuint index = static_cast<GLuint>(c.index);
    GLenum pname = static_cast<GLenum>(c.pname);
...
error::Error GLES2DecoderImpl::HandleGetVertexAttribiv(
    ...
    const void* cmd_data)
{
    const gles2::cmds::GetVertexAttribiv& c = *static_cast<const gles2::cmds::GetVertexAttribiv*>(cmd_data);
    (void)c;
    GLuint index = static_cast<GLuint>(c.index);
    GLenum pname = static_cast<GLenum>(c.pname);
    ...
    const void* cmd_data)
{
    if (!unsafe_es3_apis_enabled())
        return error::kUnknownCommand;
    const gles2::cmds::GetVertexAttribIiv& c = *static_cast<const gles2::cmds::GetVertexAttribIiv*>(cmd_data);
    (void)c;
    GLuint index = static_cast<GLuint>(c.index);
    GLenum pname = static_cast<GLenum>(c.pname);
    ...
    const void* cmd_data)
{
    if (!unsafe_es3_apis_enabled())
        return error::kUnknownCommand;
    const gles2::cmds::GetVertexAttribIuiv& c = *static_cast<const gles2::cmds::GetVertexAttribIuiv*>(cmd_data);
    (void)c;
    GLuint index = static_cast<GLuint>(c.index);
    GLenum pname = static_cast<GLenum>(c.pname);
    ...
    const void* cmd_data)
{
    if (!unsafe_es3_apis_enabled())
        return error::kUnknownCommand;
    const gles2::cmds::InvalidateFramebufferImmediate& c = *static_cast<const gles2::cmds::InvalidateFramebufferImmediate*>(
        cmd_data);
    (void)c;
    GLenum target = static_cast<GLenum>(c.target);
    ...
    const void* cmd_data)
{
    if (!unsafe_es3_apis_enabled())
        return error::kUnknownCommand;
    const gles2::cmds::InvalidateSubFramebufferImmediate& c = *static_cast<const gles2::cmds::InvalidateSubFramebufferImmediate*>(
        cmd_data);
    (void)c;
    GLenum target = static_cast<GLenum>(c.target);
    GLsizei count = static_cast<GLsizei>(c.count);
...
error::Error GLES2DecoderImpl::HandleIsBuffer(uint32_t immediate_data_size,
    const void* cmd_data)
{
    const gles2::cmds::IsBuffer& c = *static_cast<const gles2::cmds::IsBuffer*>(cmd_data);
    (void)c;
    GLuint buffer = c.buffer;
...
error::Error GLES2DecoderImpl::HandleIsEnabled(uint32_t immediate_data_size,
    const void* cmd_data)
{
    const gles2::cmds::IsEnabled& c = *static_cast<const gles2::cmds::IsEnabled*>(cmd_data);
    (void)c;
    GLenum cap = static_cast<GLenum>(c.cap);
...
error::Error GLES2DecoderImpl::HandleIsFramebuffer(uint32_t immediate_data_size,
    const void* cmd_data)
{
    const gles2::cmds::IsFramebuffer& c = *static_cast<const gles2::cmds::IsFramebuffer*>(cmd_data);
    (void)c;
    GLuint framebuffer = c.framebuffer;
...
error::Error GLES2DecoderImpl::HandleIsProgram(uint32_t immediate_data_size,
    const void* cmd_data)
{
    const gles2::cmds::IsProgram& c = *static_cast<const gles2::cmds::IsProgram*>(cmd_data);
    (void)c;
    GLuint program = c.program;
...
error::Error GLES2DecoderImpl::HandleIsRenderbuffer(
    ...
    const void* cmd_data)
{
    const gles2::cmds::IsRenderbuffer& c = *static_cast<const gles2::cmds::IsRenderbuffer*>(cmd_data);
    (void)c;
    GLuint renderbuffer = c.renderbuffer;
    ...
    const void* cmd_data)
{
    if (!unsafe_es3_apis_enabled())
        return error::kUnknownCommand;
    const gles2::cmds::IsSampler& c = *static_cast<const gles2::cmds::IsSampler*>(cmd_data);
    (void)c;
    GLuint sampler = c.sampler;
...
error::Error GLES2DecoderImpl::HandleIsShader(uint32_t immediate_data_size,
    const void* cmd_data)
{
    const gles2::cmds::IsShader& c = *static_cast<const gles2::cmds::IsShader*>(cmd_data);
    (void)c;
    GLuint shader = c.shader;
    ...
    const void* cmd_data)
{
    if (!unsafe_es3_apis_enabled())
        return error::kUnknownCommand;
    const gles2::cmds::IsSync& c = *static_cast<const gles2::cmds::IsSync*>(cmd_data);
    (void)c;
    GLuint sync = c.sync;
...
error::Error GLES2DecoderImpl::HandleIsTexture(uint32_t immediate_data_size,
    const void* cmd_data)
{
    const gles2::cmds::IsTexture& c = *static_cast<const gles2::cmds::IsTexture*>(cmd_data);
    (void)c;
    GLuint texture = c.texture;
    ...
    const void* cmd_data)
{
    if (!unsafe_es3_apis_enabled())
        return error::kUnknownCommand;
    const gles2::cmds::IsTransformFeedback& c = *static_cast<const gles2::cmds::IsTransformFeedback*>(cmd_data);
    (void)c;
    GLuint transformfeedback = c.transformfeedback;
...
error::Error GLES2DecoderImpl::HandleLineWidth(uint32_t immediate_data_size,
    const void* cmd_data)
{
    const gles2::cmds::LineWidth& c = *static_cast<const gles2::cmds::LineWidth*>(cmd_data);
    (void)c;
...
error::Error GLES2DecoderImpl::HandleLinkProgram(uint32_t immediate_data_size,
    const void* cmd_data)
{
    const gles2::cmds::LinkProgram& c = *static_cast<const gles2::cmds::LinkProgram*>(cmd_data);
    (void)c;
    GLuint program = c.program;
    ...
    const void* cmd_data)
{
    if (!unsafe_es3_apis_enabled())
        return error::kUnknownCommand;
    const gles2::cmds::PauseTransformFeedback& c = *static_cast<const gles2::cmds::PauseTransformFeedback*>(cmd_data);
    (void)c;
...
error::Error GLES2DecoderImpl::HandlePolygonOffset(uint32_t immediate_data_size,
    const void* cmd_data)
{
    const gles2::cmds::PolygonOffset& c = *static_cast<const gles2::cmds::PolygonOffset*>(cmd_data);
    (void)c;
    GLfloat factor = static_cast<GLfloat>(c.factor);
    GLfloat units = static_cast<GLfloat>(c.units);
    if (state_.polygon_offset_factor != factor || state_.polygon_offset_units != units) {
    ...
    const void* cmd_data)
{
    if (!unsafe_es3_apis_enabled())
        return error::kUnknownCommand;
    const gles2::cmds::ReadBuffer& c = *static_cast<const gles2::cmds::ReadBuffer*>(cmd_data);
    (void)c;
...
error::Error GLES2DecoderImpl::HandleReleaseShaderCompiler(
    ...
    const void* cmd_data)
{
    const gles2::cmds::ReleaseShaderCompiler& c = *static_cast<const gles2::cmds::ReleaseShaderCompiler*>(cmd_data);
    (void)c;
...
error::Error GLES2DecoderImpl::HandleRenderbufferStorage(
    ...
    const void* cmd_data)
{
    const gles2::cmds::RenderbufferStorage& c = *static_cast<const gles2::cmds::RenderbufferStorage*>(cmd_data);
    (void)c;
    GLenum target = static_cast<GLenum>(c.target);
    GLenum internalformat = static_cast<GLenum>(c.internalformat);
    GLsizei width = static_cast<GLsizei>(c.width);
    ...
    const void* cmd_data)
{
    if (!unsafe_es3_apis_enabled())
        return error::kUnknownCommand;
    const gles2::cmds::ResumeTransformFeedback& c = *static_cast<const gles2::cmds::ResumeTransformFeedback*>(cmd_data);
    (void)c;
...
error::Error GLES2DecoderImpl::HandleSampleCoverage(
    ...
    const void* cmd_data)
{
    const gles2::cmds::SampleCoverage& c = *static_cast<const gles2::cmds::SampleCoverage*>(cmd_data);
    (void)c;
    ...
    const void* cmd_data)
{
    if (!unsafe_es3_apis_enabled())
        return error::kUnknownCommand;
    const gles2::cmds::SamplerParameterf& c = *static_cast<const gles2::cmds::SamplerParameterf*>(cmd_data);
    (void)c;
    GLuint sampler = c.sampler;
    GLenum pname = static_cast<GLenum>(c.pname);
    ...
    const void* cmd_data)
{
    if (!unsafe_es3_apis_enabled())
        return error::kUnknownCommand;
    const gles2::cmds::SamplerParameterfvImmediate& c = *static_cast<const gles2::cmds::SamplerParameterfvImmediate*>(cmd_data);
    (void)c;
    GLuint sampler = c.sampler;
    GLenum pname = static_cast<GLenum>(c.pname);
    uint32_t data_size;
    ...
    const void* cmd_data)
{
    if (!unsafe_es3_apis_enabled())
        return error::kUnknownCommand;
    const gles2::cmds::SamplerParameteri& c = *static_cast<const gles2::cmds::SamplerParameteri*>(cmd_data);
    (void)c;
    GLuint sampler = c.sampler;
    GLenum pname = static_cast<GLenum>(c.pname);
    ...
    const void* cmd_data)
{
    if (!unsafe_es3_apis_enabled())
        return error::kUnknownCommand;
    const gles2::cmds::SamplerParameterivImmediate& c = *static_cast<const gles2::cmds::SamplerParameterivImmediate*>(cmd_data);
    (void)c;
    GLuint sampler = c.sampler;
    GLenum pname = static_cast<GLenum>(c.pname);
    uint32_t data_size;
...
error::Error GLES2DecoderImpl::HandleScissor(uint32_t immediate_data_size,
    const void* cmd_data)
{
    const gles2::cmds::Scissor& c = *static_cast<const gles2::cmds::Scissor*>(cmd_data);
    (void)c;
    GLint x = static_cast<GLint>(c.x);
    GLint y = static_cast<GLint>(c.y);
    GLsizei width = static_cast<GLsizei>(c.width);
    ...
    if (state_.scissor_x != x || state_.scissor_y != y || state_.scissor_width != width || state_.scissor_height != height) {
        state_.scissor_x = x;
        state_.scissor_y = y;
...
error::Error GLES2DecoderImpl::HandleShaderSourceBucket(
    ...
    const void* cmd_data)
{
    const gles2::cmds::ShaderSourceBucket& c = *static_cast<const gles2::cmds::ShaderSourceBucket*>(cmd_data);
    (void)c;
    ...
    const char** str = strs.size() > 0 ? const_cast<const char**>(&strs[0]) : NULL;
    const GLint* length = len.size() > 0 ? const_cast<const GLint*>(&len[0]) : NULL;
    (void)length;
...
error::Error GLES2DecoderImpl::HandleStencilFunc(uint32_t immediate_data_size,
    const void* cmd_data)
{
    const gles2::cmds::StencilFunc& c = *static_cast<const gles2::cmds::StencilFunc*>(cmd_data);
    (void)c;
    GLenum func = static_cast<GLenum>(c.func);
    ...
    if (state_.stencil_front_func != func || state_.stencil_front_ref != ref || state_.stencil_front_mask != mask || state_.stencil_back_func != func || state_.stencil_back_ref != ref || state_.stencil_back_mask != mask) {
...
error::Error GLES2DecoderImpl::HandleStencilFuncSeparate(
    ...
    const void* cmd_data)
{
    const gles2::cmds::StencilFuncSeparate& c = *static_cast<const gles2::cmds::StencilFuncSeparate*>(cmd_data);
    (void)c;
    ...
    if (face == GL_FRONT || face == GL_FRONT_AND_BACK) {
        changed |= state_.stencil_front_func != func || state_.stencil_front_ref != ref || state_.stencil_front_mask != mask;
    }
    if (face == GL_BACK || face == GL_FRONT_AND_BACK) {
        changed |= state_.stencil_back_func != func || state_.stencil_back_ref != ref || state_.stencil_back_mask != mask;
    }
    if (changed) {
        if (face == GL_FRONT || face == GL_FRONT_AND_BACK) {
            state_.stencil_front_func = func;
...
error::Error GLES2DecoderImpl::HandleStencilMask(uint32_t immediate_data_size,
    const void* cmd_data)
{
    const gles2::cmds::StencilMask& c = *static_cast<const gles2::cmds::StencilMask*>(cmd_data);
    (void)c;
    GLuint mask = static_cast<GLuint>(c.mask);
    if (state_.stencil_front_writemask != mask || state_.stencil_back_writemask != mask) {
...
error::Error GLES2DecoderImpl::HandleStencilMaskSeparate(
    ...
    const void* cmd_data)
{
    const gles2::cmds::StencilMaskSeparate& c = *static_cast<const gles2::cmds::StencilMaskSeparate*>(cmd_data);
    (void)c;
    GLenum face = static_cast<GLenum>(c.face);
    GLuint mask = static_cast<GLuint>(c.mask);
    if (!validators_->face_type.IsValid(face)) {
...
error::Error GLES2DecoderImpl::HandleStencilOp(uint32_t immediate_data_size,
    const void* cmd_data)
{
    const gles2::cmds::StencilOp& c = *static_cast<const gles2::cmds::StencilOp*>(cmd_data);
    (void)c;
    ...
    if (state_.stencil_front_fail_op != fail || state_.stencil_front_z_fail_op != zfail || state_.stencil_front_z_pass_op != zpass || state_.stencil_back_fail_op != fail || state_.stencil_back_z_fail_op != zfail || state_.stencil_back_z_pass_op != zpass) {
...
error::Error GLES2DecoderImpl::HandleStencilOpSeparate(
    ...
    const void* cmd_data)
{
    const gles2::cmds::StencilOpSeparate& c = *static_cast<const gles2::cmds::StencilOpSeparate*>(cmd_data);
    (void)c;
    GLenum face = static_cast<GLenum>(c.face);
    GLenum fail = static_cast<GLenum>(c.fail);
    GLenum zfail = static_cast<GLenum>(c.zfail);
    ...
    bool changed = false;
    if (face == GL_FRONT || face == GL_FRONT_AND_BACK) {
        changed |= state_.stencil_front_fail_op != fail || state_.stencil_front_z_fail_op != zfail || state_.stencil_front_z_pass_op != zpass;
    }
    if (face == GL_BACK || face == GL_FRONT_AND_BACK) {
        changed |= state_.stencil_back_fail_op != fail || state_.stencil_back_z_fail_op != zfail || state_.stencil_back_z_pass_op != zpass;
    }
    if (changed) {
        if (face == GL_FRONT || face == GL_FRONT_AND_BACK) {
            state_.stencil_front_fail_op = fail;
...
error::Error GLES2DecoderImpl::HandleTexParameterf(uint32_t immediate_data_size,
    const void* cmd_data)
{
    const gles2::cmds::TexParameterf& c = *static_cast<const gles2::cmds::TexParameterf*>(cmd_data);
    (void)c;
    GLenum target = static_cast<GLenum>(c.target);
    GLenum pname = static_cast<GLenum>(c.pname);
    GLfloat param = static_cast<GLfloat>(c.param);
...
error::Error GLES2DecoderImpl::HandleTexParameterfvImmediate(
    ...
    const void* cmd_data)
{
    const gles2::cmds::TexParameterfvImmediate& c = *static_cast<const gles2::cmds::TexParameterfvImmediate*>(cmd_data);
    (void)c;
    GLenum target = static_cast<GLenum>(c.target);
    GLenum pname = static_cast<GLenum>(c.pname);
    uint32_t data_size;
...
error::Error GLES2DecoderImpl::HandleTexParameteri(uint32_t immediate_data_size,
    const void* cmd_data)
{
    const gles2::cmds::TexParameteri& c = *static_cast<const gles2::cmds::TexParameteri*>(cmd_data);
    (void)c;
    GLenum target = static_cast<GLenum>(c.target);
    GLenum pname = static_cast<GLenum>(c.pname);
    GLint param = static_cast<GLint>(c.param);
...
error::Error GLES2DecoderImpl::HandleTexParameterivImmediate(
    ...
    const void* cmd_data)
{
    const gles2::cmds::TexParameterivImmediate& c = *static_cast<const gles2::cmds::TexParameterivImmediate*>(cmd_data);
    (void)c;
    GLenum target = static_cast<GLenum>(c.target);
    GLenum pname = static_cast<GLenum>(c.pname);
    uint32_t data_size;
    ...
    const void* cmd_data)
{
    if (!unsafe_es3_apis_enabled())
        return error::kUnknownCommand;
    const gles2::cmds::TexStorage3D& c = *static_cast<const gles2::cmds::TexStorage3D*>(cmd_data);
    (void)c;
    GLenum target = static_cast<GLenum>(c.target);
    ...
    const void* cmd_data)
{
    if (!unsafe_es3_apis_enabled())
        return error::kUnknownCommand;
    const gles2::cmds::TransformFeedbackVaryingsBucket& c = *static_cast<const gles2::cmds::TransformFeedbackVaryingsBucket*>(
        cmd_data);
    (void)c;
    ...
    const char** varyings = strs.size() > 0 ? const_cast<const char**>(&strs[0]) : NULL;
    const GLint* length = len.size() > 0 ? const_cast<const GLint*>(&len[0]) : NULL;
    (void)length;
...
error::Error GLES2DecoderImpl::HandleUniform1f(uint32_t immediate_data_size,
    const void* cmd_data)
{
    const gles2::cmds::Uniform1f& c = *static_cast<const gles2::cmds::Uniform1f*>(cmd_data);
    (void)c;
...
error::Error GLES2DecoderImpl::HandleUniform1fvImmediate(
    ...
    const void* cmd_data)
{
    const gles2::cmds::Uniform1fvImmediate& c = *static_cast<const gles2::cmds::Uniform1fvImmediate*>(cmd_data);
    (void)c;
    GLint location = static_cast<GLint>(c.location);
    GLsizei count = static_cast<GLsizei>(c.count);
    uint32_t data_size;
    ...
    const GLfloat* v = GetImmediateDataAs<const GLfloat*>(c, data_size, immediate_data_size);
    if (v == NULL) {
        return error::kOutOfBounds;
    }
...
error::Error GLES2DecoderImpl::HandleUniform1i(uint32_t immediate_data_size,
    const void* cmd_data)
{
    const gles2::cmds::Uniform1i& c = *static_cast<const gles2::cmds::Uniform1i*>(cmd_data);
    (void)c;
    GLint location = static_cast<GLint>(c.location);
    GLint x = static_cast<GLint>(c.x);
...
error::Error GLES2DecoderImpl::HandleUniform1ivImmediate(
    ...
    const void* cmd_data)
{
    const gles2::cmds::Uniform1ivImmediate& c = *static_cast<const gles2::cmds::Uniform1ivImmediate*>(cmd_data);
    (void)c;
    GLint location = static_cast<GLint>(c.location);
    GLsizei count = static_cast<GLsizei>(c.count);
    uint32_t data_size;
    ...
    const GLint* v = GetImmediateDataAs<const GLint*>(c, data_size, immediate_data_size);
    if (v == NULL) {
        return error::kOutOfBounds;
    }
    ...
    const void* cmd_data)
{
    if (!unsafe_es3_apis_enabled())
        return error::kUnknownCommand;
    const gles2::cmds::Uniform1ui& c = *static_cast<const gles2::cmds::Uniform1ui*>(cmd_data);
    (void)c;
    GLint location = static_cast<GLint>(c.location);
    ...
    const void* cmd_data)
{
    if (!unsafe_es3_apis_enabled())
        return error::kUnknownCommand;
    const gles2::cmds::Uniform1uivImmediate& c = *static_cast<const gles2::cmds::Uniform1uivImmediate*>(cmd_data);
    (void)c;
    GLint location = static_cast<GLint>(c.location);
    GLsizei count = static_cast<GLsizei>(c.count);
    uint32_t data_size;
    ...
    const GLuint* v = GetImmediateDataAs<const GLuint*>(c, data_size, immediate_data_size);
    if (v == NULL) {
        return error::kOutOfBounds;
    }
...
error::Error GLES2DecoderImpl::HandleUniform2f(uint32_t immediate_data_size,
    const void* cmd_data)
{
    const gles2::cmds::Uniform2f& c = *static_cast<const gles2::cmds::Uniform2f*>(cmd_data);
    (void)c;
    GLint location = static_cast<GLint>(c.location);
    GLfloat x = static_cast<GLfloat>(c.x);
...
error::Error GLES2DecoderImpl::HandleUniform2fvImmediate(
    ...
    const void* cmd_data)
{
    const gles2::cmds::Uniform2fvImmediate& c = *static_cast<const gles2::cmds::Uniform2fvImmediate*>(cmd_data);
    (void)c;
    GLint location = static_cast<GLint>(c.location);
    GLsizei count = static_cast<GLsizei>(c.count);
    uint32_t data_size;
...
error::Error GLES2DecoderImpl::HandleUniform2i(uint32_t immediate_data_size,
    const void* cmd_data)
{
    const gles2::cmds::Uniform2i& c = *static_cast<const gles2::cmds::Uniform2i*>(cmd_data);
    (void)c;
    GLint location = static_cast<GLint>(c.location);
    GLint x = static_cast<GLint>(c.x);
    GLint y = static_cast<GLint>(c.y);
...
error::Error GLES2DecoderImpl::HandleUniform2ivImmediate(
    ...
    const void* cmd_data)
{
    const gles2::cmds::Uniform2ivImmediate& c = *static_cast<const gles2::cmds::Uniform2ivImmediate*>(cmd_data);
    (void)c;
    GLint location = static_cast<GLint>(c.location);
    GLsizei count = static_cast<GLsizei>(c.count);
    uint32_t data_size;
    ...
    const void* cmd_data)
{
    if (!unsafe_es3_apis_enabled())
        return error::kUnknownCommand;
    const gles2::cmds::Uniform2ui& c = *static_cast<const gles2::cmds::Uniform2ui*>(cmd_data);
    (void)c;
    GLint location = static_cast<GLint>(c.location);
    GLuint x = static_cast<GLuint>(c.x);
    ...
    const void* cmd_data)
{
    if (!unsafe_es3_apis_enabled())
        return error::kUnknownCommand;
    const gles2::cmds::Uniform2uivImmediate& c = *static_cast<const gles2::cmds::Uniform2uivImmediate*>(cmd_data);
    (void)c;
    GLint location = static_cast<GLint>(c.location);
    GLsizei count = static_cast<GLsizei>(c.count);
    uint32_t data_size;
...
error::Error GLES2DecoderImpl::HandleUniform3f(uint32_t immediate_data_size,
    const void* cmd_data)
{
    const gles2::cmds::Uniform3f& c = *static_cast<const gles2::cmds::Uniform3f*>(cmd_data);
    (void)c;
    GLint location = static_cast<GLint>(c.location);
    GLfloat x = static_cast<GLfloat>(c.x);
    GLfloat y = static_cast<GLfloat>(c.y);
...
error::Error GLES2DecoderImpl::HandleUniform3fvImmediate(
    ...
    const void* cmd_data)
{
    const gles2::cmds::Uniform3fvImmediate& c = *static_cast<const gles2::cmds::Uniform3fvImmediate*>(cmd_data);
    (void)c;
    GLint location = static_cast<GLint>(c.location);
    GLsizei count = static_cast<GLsizei>(c.count);
    uint32_t data_size;
...
error::Error GLES2DecoderImpl::HandleUniform3i(uint32_t immediate_data_size,
    const void* cmd_data)
{
    const gles2::cmds::Uniform3i& c = *static_cast<const gles2::cmds::Uniform3i*>(cmd_data);
    (void)c;
    GLint location = static_cast<GLint>(c.location);
    GLint x = static_cast<GLint>(c.x);
    GLint y = static_cast<GLint>(c.y);
...
error::Error GLES2DecoderImpl::HandleUniform3ivImmediate(
    ...
    const void* cmd_data)
{
    const gles2::cmds::Uniform3ivImmediate& c = *static_cast<const gles2::cmds::Uniform3ivImmediate*>(cmd_data);
    (void)c;
    GLint location = static_cast<GLint>(c.location);
    GLsizei count = static_cast<GLsizei>(c.count);
    uint32_t data_size;
    ...
    const void* cmd_data)
{
    if (!unsafe_es3_apis_enabled())
        return error::kUnknownCommand;
    const gles2::cmds::Uniform3ui& c = *static_cast<const gles2::cmds::Uniform3ui*>(cmd_data);
    (void)c;
    GLint location = static_cast<GLint>(c.location);
    GLuint x = static_cast<GLuint>(c.x);
    GLuint y = static_cast<GLuint>(c.y);
    ...
    const void* cmd_data)
{
    if (!unsafe_es3_apis_enabled())
        return error::kUnknownCommand;
    const gles2::cmds::Uniform3uivImmediate& c = *static_cast<const gles2::cmds::Uniform3uivImmediate*>(cmd_data);
    (void)c;
    GLint location = static_cast<GLint>(c.location);
    GLsizei count = static_cast<GLsizei>(c.count);
    uint32_t data_size;
...
error::Error GLES2DecoderImpl::HandleUniform4f(uint32_t immediate_data_size,
    const void* cmd_data)
{
    const gles2::cmds::Uniform4f& c = *static_cast<const gles2::cmds::Uniform4f*>(cmd_data);
    (void)c;
    GLint location = static_cast<GLint>(c.location);
    GLfloat x = static_cast<GLfloat>(c.x);
    GLfloat y = static_cast<GLfloat>(c.y);
...
error::Error GLES2DecoderImpl::HandleUniform4fvImmediate(
    ...
    const void* cmd_data)
{
    const gles2::cmds::Uniform4fvImmediate& c = *static_cast<const gles2::cmds::Uniform4fvImmediate*>(cmd_data);
    (void)c;
    GLint location = static_cast<GLint>(c.location);
    GLsizei count = static_cast<GLsizei>(c.count);
    uint32_t data_size;
...
error::Error GLES2DecoderImpl::HandleUniform4i(uint32_t immediate_data_size,
    const void* cmd_data)
{
    const gles2::cmds::Uniform4i& c = *static_cast<const gles2::cmds::Uniform4i*>(cmd_data);
    (void)c;
    GLint location = static_cast<GLint>(c.location);
    GLint x = static_cast<GLint>(c.x);
    GLint y = static_cast<GLint>(c.y);
...
error::Error GLES2DecoderImpl::HandleUniform4ivImmediate(
    ...
    const void* cmd_data)
{
    const gles2::cmds::Uniform4ivImmediate& c = *static_cast<const gles2::cmds::Uniform4ivImmediate*>(cmd_data);
    (void)c;
    GLint location = static_cast<GLint>(c.location);
    GLsizei count = static_cast<GLsizei>(c.count);
    uint32_t data_size;
    ...
    const void* cmd_data)
{
    if (!unsafe_es3_apis_enabled())
        return error::kUnknownCommand;
    const gles2::cmds::Uniform4ui& c = *static_cast<const gles2::cmds::Uniform4ui*>(cmd_data);
    (void)c;
    GLint location = static_cast<GLint>(c.location);
    GLuint x = static_cast<GLuint>(c.x);
    GLuint y = static_cast<GLuint>(c.y);
    ...
    const void* cmd_data)
{
    if (!unsafe_es3_apis_enabled())
        return error::kUnknownCommand;
    const gles2::cmds::Uniform4uivImmediate& c = *static_cast<const gles2::cmds::Uniform4uivImmediate*>(cmd_data);
    (void)c;
    GLint location = static_cast<GLint>(c.location);
    GLsizei count = static_cast<GLsizei>(c.count);
    uint32_t data_size;
...
error::Error GLES2DecoderImpl::HandleUniformMatrix2fvImmediate(
    ...
    const void* cmd_data)
{
    const gles2::cmds::UniformMatrix2fvImmediate& c = *static_cast<const gles2::cmds::UniformMatrix2fvImmediate*>(cmd_data);
    (void)c;
    GLint location = static_cast<GLint>(c.location);
    GLsizei count = static_cast<GLsizei>(c.count);
    ...
    const void* cmd_data)
{
    if (!unsafe_es3_apis_enabled())
        return error::kUnknownCommand;
    const gles2::cmds::UniformMatrix2x3fvImmediate& c = *static_cast<const gles2::cmds::UniformMatrix2x3fvImmediate*>(cmd_data);
    (void)c;
    GLint location = static_cast<GLint>(c.location);
    GLsizei count = static_cast<GLsizei>(c.count);
    GLboolean transpose = static_cast<GLboolean>(c.transpose);
    ...
    const void* cmd_data)
{
    if (!unsafe_es3_apis_enabled())
        return error::kUnknownCommand;
    const gles2::cmds::UniformMatrix2x4fvImmediate& c = *static_cast<const gles2::cmds::UniformMatrix2x4fvImmediate*>(cmd_data);
    (void)c;
    GLint location = static_cast<GLint>(c.location);
    GLsizei count = static_cast<GLsizei>(c.count);
    GLboolean transpose = static_cast<GLboolean>(c.transpose);
...
error::Error GLES2DecoderImpl::HandleUniformMatrix3fvImmediate(
    ...
    const void* cmd_data)
{
    const gles2::cmds::UniformMatrix3fvImmediate& c = *static_cast<const gles2::cmds::UniformMatrix3fvImmediate*>(cmd_data);
    (void)c;
    GLint location = static_cast<GLint>(c.location);
    GLsizei count = static_cast<GLsizei>(c.count);
    GLboolean transpose = static_cast<GLboolean>(c.transpose);
    ...
    const void* cmd_data)
{
    if (!unsafe_es3_apis_enabled())
        return error::kUnknownCommand;
    const gles2::cmds::UniformMatrix3x2fvImmediate& c = *static_cast<const gles2::cmds::UniformMatrix3x2fvImmediate*>(cmd_data);
    (void)c;
    GLint location = static_cast<GLint>(c.location);
    GLsizei count = static_cast<GLsizei>(c.count);
    GLboolean transpose = static_cast<GLboolean>(c.transpose);
    ...
    const void* cmd_data)
{
    if (!unsafe_es3_apis_enabled())
        return error::kUnknownCommand;
    const gles2::cmds::UniformMatrix3x4fvImmediate& c = *static_cast<const gles2::cmds::UniformMatrix3x4fvImmediate*>(cmd_data);
    (void)c;
    GLint location = static_cast<GLint>(c.location);
    GLsizei count = static_cast<GLsizei>(c.count);
    GLboolean transpose = static_cast<GLboolean>(c.transpose);
...
error::Error GLES2DecoderImpl::HandleUniformMatrix4fvImmediate(
    ...
    const void* cmd_data)
{
    const gles2::cmds::UniformMatrix4fvImmediate& c = *static_cast<const gles2::cmds::UniformMatrix4fvImmediate*>(cmd_data);
    (void)c;
    GLint location = static_cast<GLint>(c.location);
    GLsizei count = static_cast<GLsizei>(c.count);
    GLboolean transpose = static_cast<GLboolean>(c.transpose);
    ...
    const void* cmd_data)
{
    if (!unsafe_es3_apis_enabled())
        return error::kUnknownCommand;
    const gles2::cmds::UniformMatrix4x2fvImmediate& c = *static_cast<const gles2::cmds::UniformMatrix4x2fvImmediate*>(cmd_data);
    (void)c;
    GLint location = static_cast<GLint>(c.location);
    GLsizei count = static_cast<GLsizei>(c.count);
    GLboolean transpose = static_cast<GLboolean>(c.transpose);
    ...
    const void* cmd_data)
{
    if (!unsafe_es3_apis_enabled())
        return error::kUnknownCommand;
    const gles2::cmds::UniformMatrix4x3fvImmediate& c = *static_cast<const gles2::cmds::UniformMatrix4x3fvImmediate*>(cmd_data);
    (void)c;
    GLint location = static_cast<GLint>(c.location);
    GLsizei count = static_cast<GLsizei>(c.count);
    GLboolean transpose = static_cast<GLboolean>(c.transpose);
...
error::Error GLES2DecoderImpl::HandleUseProgram(uint32_t immediate_data_size,
    const void* cmd_data)
{
    const gles2::cmds::UseProgram& c = *static_cast<const gles2::cmds::UseProgram*>(cmd_data);
    (void)c;
    GLuint program = c.program;
...
error::Error GLES2DecoderImpl::HandleValidateProgram(
    ...
    const void* cmd_data)
{
    const gles2::cmds::ValidateProgram& c = *static_cast<const gles2::cmds::ValidateProgram*>(cmd_data);
    (void)c;
    GLuint program = c.program;
...
error::Error GLES2DecoderImpl::HandleVertexAttrib1f(
    ...
    const void* cmd_data)
{
    const gles2::cmds::VertexAttrib1f& c = *static_cast<const gles2::cmds::VertexAttrib1f*>(cmd_data);
    (void)c;
...
error::Error GLES2DecoderImpl::HandleVertexAttrib1fvImmediate(
    ...
    const void* cmd_data)
{
    const gles2::cmds::VertexAttrib1fvImmediate& c = *static_cast<const gles2::cmds::VertexAttrib1fvImmediate*>(cmd_data);
    (void)c;
    GLuint indx = static_cast<GLuint>(c.indx);
    uint32_t data_size;
    if (!ComputeDataSize(1, sizeof(GLfloat), 1, &data_size)) {
    ...
    const GLfloat* values = GetImmediateDataAs<const GLfloat*>(c, data_size, immediate_data_size);
    if (values == NULL) {
        return error::kOutOfBounds;
    }
...
error::Error GLES2DecoderImpl::HandleVertexAttrib2f(
    ...
    const void* cmd_data)
{
    const gles2::cmds::VertexAttrib2f& c = *static_cast<const gles2::cmds::VertexAttrib2f*>(cmd_data);
    (void)c;
    GLuint indx = static_cast<GLuint>(c.indx);
    GLfloat x = static_cast<GLfloat>(c.x);
    GLfloat y = static_cast<GLfloat>(c.y);
...
error::Error GLES2DecoderImpl::HandleVertexAttrib2fvImmediate(
    ...
    const void* cmd_data)
{
    const gles2::cmds::VertexAttrib2fvImmediate& c = *static_cast<const gles2::cmds::VertexAttrib2fvImmediate*>(cmd_data);
    (void)c;
    GLuint indx = static_cast<GLuint>(c.indx);
    uint32_t data_size;
...
error::Error GLES2DecoderImpl::HandleVertexAttrib3f(
    ...
    const void* cmd_data)
{
    const gles2::cmds::VertexAttrib3f& c = *static_cast<const gles2::cmds::VertexAttrib3f*>(cmd_data);
    (void)c;
    GLuint indx = static_cast<GLuint>(c.indx);
    GLfloat x = static_cast<GLfloat>(c.x);
    GLfloat y = static_cast<GLfloat>(c.y);
...
error::Error GLES2DecoderImpl::HandleVertexAttrib3fvImmediate(
    ...
    const void* cmd_data)
{
    const gles2::cmds::VertexAttrib3fvImmediate& c = *static_cast<const gles2::cmds::VertexAttrib3fvImmediate*>(cmd_data);
    (void)c;
    GLuint indx = static_cast<GLuint>(c.indx);
    uint32_t data_size;
...
error::Error GLES2DecoderImpl::HandleVertexAttrib4f(
    ...
    const void* cmd_data)
{
    const gles2::cmds::VertexAttrib4f& c = *static_cast<const gles2::cmds::VertexAttrib4f*>(cmd_data);
    (void)c;
    GLuint indx = static_cast<GLuint>(c.indx);
    GLfloat x = static_cast<GLfloat>(c.x);
    GLfloat y = static_cast<GLfloat>(c.y);
...
error::Error GLES2DecoderImpl::HandleVertexAttrib4fvImmediate(
    ...
    const void* cmd_data)
{
    const gles2::cmds::VertexAttrib4fvImmediate& c = *static_cast<const gles2::cmds::VertexAttrib4fvImmediate*>(cmd_data);
    (void)c;
    GLuint indx = static_cast<GLuint>(c.indx);
    uint32_t data_size;
    if (!ComputeDataSize(1, sizeof(GLfloat), 4, &data_size)) {
    ...
    const void* cmd_data)
{
    if (!unsafe_es3_apis_enabled())
        return error::kUnknownCommand;
    const gles2::cmds::VertexAttribI4i& c = *static_cast<const gles2::cmds::VertexAttribI4i*>(cmd_data);
    (void)c;
    GLuint indx = static_cast<GLuint>(c.indx);
    GLint x = static_cast<GLint>(c.x);
    GLint y = static_cast<GLint>(c.y);
    ...
    const void* cmd_data)
{
    if (!unsafe_es3_apis_enabled())
        return error::kUnknownCommand;
    const gles2::cmds::VertexAttribI4ivImmediate& c = *static_cast<const gles2::cmds::VertexAttribI4ivImmediate*>(cmd_data);
    (void)c;
    GLuint indx = static_cast<GLuint>(c.indx);
    uint32_t data_size;
    if (!ComputeDataSize(1, sizeof(GLint), 4, &data_size)) {
    ...
    const GLint* values = GetImmediateDataAs<const GLint*>(c, data_size, immediate_data_size);
    if (values == NULL) {
        return error::kOutOfBounds;
    }
    ...
    const void* cmd_data)
{
    if (!unsafe_es3_apis_enabled())
        return error::kUnknownCommand;
    const gles2::cmds::VertexAttribI4ui& c = *static_cast<const gles2::cmds::VertexAttribI4ui*>(cmd_data);
    (void)c;
    GLuint indx = static_cast<GLuint>(c.indx);
    GLuint x = static_cast<GLuint>(c.x);
    GLuint y = static_cast<GLuint>(c.y);
    ...
    const void* cmd_data)
{
    if (!unsafe_es3_apis_enabled())
        return error::kUnknownCommand;
    const gles2::cmds::VertexAttribI4uivImmediate& c = *static_cast<const gles2::cmds::VertexAttribI4uivImmediate*>(cmd_data);
    (void)c;
    GLuint indx = static_cast<GLuint>(c.indx);
    uint32_t data_size;
    if (!ComputeDataSize(1, sizeof(GLuint), 4, &data_size)) {
    ...
    const GLuint* values = GetImmediateDataAs<const GLuint*>(c, data_size, immediate_data_size);
    if (values == NULL) {
        return error::kOutOfBounds;
    }
...
error::Error GLES2DecoderImpl::HandleViewport(uint32_t immediate_data_size,
    const void* cmd_data)
{
    const gles2::cmds::Viewport& c = *static_cast<const gles2::cmds::Viewport*>(cmd_data);
    (void)c;
    GLint x = static_cast<GLint>(c.x);
    GLint y = static_cast<GLint>(c.y);
    GLsizei width = static_cast<GLsizei>(c.width);
...
error::Error GLES2DecoderImpl::HandleBlitFramebufferCHROMIUM(
    ...
    const void* cmd_data)
{
    const gles2::cmds::BlitFramebufferCHROMIUM& c = *static_cast<const gles2::cmds::BlitFramebufferCHROMIUM*>(cmd_data);
    (void)c;
...
error::Error GLES2DecoderImpl::HandleRenderbufferStorageMultisampleCHROMIUM(
    ...
    const void* cmd_data)
{
    const gles2::cmds::RenderbufferStorageMultisampleCHROMIUM& c = *static_cast<const gles2::cmds::RenderbufferStorageMultisampleCHROMIUM*>(
        cmd_data);
    (void)c;
    if (!features().chromium_framebuffer_multisample) {
...
error::Error GLES2DecoderImpl::HandleRenderbufferStorageMultisampleEXT(
    ...
    const void* cmd_data)
{
    const gles2::cmds::RenderbufferStorageMultisampleEXT& c = *static_cast<const gles2::cmds::RenderbufferStorageMultisampleEXT*>(
        cmd_data);
    (void)c;
...
error::Error GLES2DecoderImpl::HandleFramebufferTexture2DMultisampleEXT(
    ...
    const void* cmd_data)
{
    const gles2::cmds::FramebufferTexture2DMultisampleEXT& c = *static_cast<const gles2::cmds::FramebufferTexture2DMultisampleEXT*>(
        cmd_data);
    (void)c;
    if (!features().multisampled_render_to_texture) {
        LOCAL_SET_GL_ERROR(GL_INVALID_OPERATION,
...
error::Error GLES2DecoderImpl::HandleTexStorage2DEXT(
    ...
    const void* cmd_data)
{
    const gles2::cmds::TexStorage2DEXT& c = *static_cast<const gles2::cmds::TexStorage2DEXT*>(cmd_data);
    (void)c;
    GLenum target = static_cast<GLenum>(c.target);
    GLsizei levels = static_cast<GLsizei>(c.levels);
    GLenum internalFormat = static_cast<GLenum>(c.internalFormat);
...
error::Error GLES2DecoderImpl::HandleGenQueriesEXTImmediate(
    ...
    const void* cmd_data)
{
    const gles2::cmds::GenQueriesEXTImmediate& c = *static_cast<const gles2::cmds::GenQueriesEXTImmediate*>(cmd_data);
    (void)c;
    GLsizei n = static_cast<GLsizei>(c.n);
    uint32_t data_size;
    if (!SafeMultiplyUint32(n, sizeof(GLuint), &data_size)) {
...
error::Error GLES2DecoderImpl::HandleDeleteQueriesEXTImmediate(
    ...
    const void* cmd_data)
{
    const gles2::cmds::DeleteQueriesEXTImmediate& c = *static_cast<const gles2::cmds::DeleteQueriesEXTImmediate*>(cmd_data);
    (void)c;
    GLsizei n = static_cast<GLsizei>(c.n);
    uint32_t data_size;
    if (!SafeMultiplyUint32(n, sizeof(GLuint), &data_size)) {
    ...
    const void* cmd_data)
{
    if (!unsafe_es3_apis_enabled())
        return error::kUnknownCommand;
    const gles2::cmds::BeginTransformFeedback& c = *static_cast<const gles2::cmds::BeginTransformFeedback*>(cmd_data);
    (void)c;
    ...
    const void* cmd_data)
{
    if (!unsafe_es3_apis_enabled())
        return error::kUnknownCommand;
    const gles2::cmds::EndTransformFeedback& c = *static_cast<const gles2::cmds::EndTransformFeedback*>(cmd_data);
    (void)c;
...
error::Error GLES2DecoderImpl::HandleInsertEventMarkerEXT(
    ...
    const void* cmd_data)
{
    const gles2::cmds::InsertEventMarkerEXT& c = *static_cast<const gles2::cmds::InsertEventMarkerEXT*>(cmd_data);
    (void)c;
...
error::Error GLES2DecoderImpl::HandlePushGroupMarkerEXT(
    ...
    const void* cmd_data)
{
    const gles2::cmds::PushGroupMarkerEXT& c = *static_cast<const gles2::cmds::PushGroupMarkerEXT*>(cmd_data);
    (void)c;
...
error::Error GLES2DecoderImpl::HandlePopGroupMarkerEXT(
    ...
    const void* cmd_data)
{
    const gles2::cmds::PopGroupMarkerEXT& c = *static_cast<const gles2::cmds::PopGroupMarkerEXT*>(cmd_data);
    (void)c;
    DoPopGroupMarkerEXT();
    return error::kNoError;
}
...
error::Error GLES2DecoderImpl::HandleGenVertexArraysOESImmediate(
    ...
    const void* cmd_data)
{
    const gles2::cmds::GenVertexArraysOESImmediate& c = *static_cast<const gles2::cmds::GenVertexArraysOESImmediate*>(cmd_data);
    (void)c;
    GLsizei n = static_cast<GLsizei>(c.n);
    uint32_t data_size;
    if (!SafeMultiplyUint32(n, sizeof(GLuint), &data_size)) {
...
error::Error GLES2DecoderImpl::HandleDeleteVertexArraysOESImmediate(
    ...
    const void* cmd_data)
{
    const gles2::cmds::DeleteVertexArraysOESImmediate& c = *static_cast<const gles2::cmds::DeleteVertexArraysOESImmediate*>(
        cmd_data);
    (void)c;
    GLsizei n = static_cast<GLsizei>(c.n);
    uint32_t data_size;
...
error::Error GLES2DecoderImpl::HandleIsVertexArrayOES(
    ...
    const void* cmd_data)
{
    const gles2::cmds::IsVertexArrayOES& c = *static_cast<const gles2::cmds::IsVertexArrayOES*>(cmd_data);
    (void)c;
...
error::Error GLES2DecoderImpl::HandleBindVertexArrayOES(
    ...
    const void* cmd_data)
{
    const gles2::cmds::BindVertexArrayOES& c = *static_cast<const gles2::cmds::BindVertexArrayOES*>(cmd_data);
    (void)c;
    GLuint array = c.array;
...
error::Error GLES2DecoderImpl::HandleSwapBuffers(uint32_t immediate_data_size,
    const void* cmd_data)
{
    const gles2::cmds::SwapBuffers& c = *static_cast<const gles2::cmds::SwapBuffers*>(cmd_data);
    (void)c;
    DoSwapBuffers();
    return error::kNoError;
}
...
error::Error GLES2DecoderImpl::HandleGetMaxValueInBufferCHROMIUM(
    ...
    const void* cmd_data)
{
    const gles2::cmds::GetMaxValueInBufferCHROMIUM& c = *static_cast<const gles2::cmds::GetMaxValueInBufferCHROMIUM*>(cmd_data);
    (void)c;
...
error::Error GLES2DecoderImpl::HandleTexImageIOSurface2DCHROMIUM(
    ...
    const void* cmd_data)
{
    const gles2::cmds::TexImageIOSurface2DCHROMIUM& c = *static_cast<const gles2::cmds::TexImageIOSurface2DCHROMIUM*>(cmd_data);
    (void)c;
    GLenum target = static_cast<GLenum>(c.target);
    GLsizei width = static_cast<GLsizei>(c.width);
    GLsizei height = static_cast<GLsizei>(c.height);
...
error::Error GLES2DecoderImpl::HandleCopyTextureCHROMIUM(
    ...
    const void* cmd_data)
{
    const gles2::cmds::CopyTextureCHROMIUM& c = *static_cast<const gles2::cmds::CopyTextureCHROMIUM*>(cmd_data);
    (void)c;
    GLenum target = static_cast<GLenum>(c.target);
    ...
    GLboolean unpack_premultiply_alpha = static_cast<GLboolean>(c.unpack_premultiply_alpha);
    GLboolean unpack_unmultiply_alpha = static_cast<GLboolean>(c.unpack_unmultiply_alpha);
    if (!validators_->texture_internal_format.IsValid(internalformat)) {
...
error::Error GLES2DecoderImpl::HandleCopySubTextureCHROMIUM(
    ...
    const void* cmd_data)
{
    const gles2::cmds::CopySubTextureCHROMIUM& c = *static_cast<const gles2::cmds::CopySubTextureCHROMIUM*>(cmd_data);
    (void)c;
    GLenum target = static_cast<GLenum>(c.target);
    GLenum source_id = static_cast<GLenum>(c.source_id);
    GLenum dest_id = static_cast<GLenum>(c.dest_id);
...
error::Error GLES2DecoderImpl::HandleCompressedCopyTextureCHROMIUM(
    ...
    const void* cmd_data)
{
    const gles2::cmds::CompressedCopyTextureCHROMIUM& c = *static_cast<const gles2::cmds::CompressedCopyTextureCHROMIUM*>(cmd_data);
    (void)c;
    GLenum target = static_cast<GLenum>(c.target);
    GLenum source_id = static_cast<GLenum>(c.source_id);
    GLenum dest_id = static_cast<GLenum>(c.dest_id);
...
error::Error GLES2DecoderImpl::HandleCompressedCopySubTextureCHROMIUM(
    ...
    const void* cmd_data)
{
    const gles2::cmds::CompressedCopySubTextureCHROMIUM& c = *static_cast<const gles2::cmds::CompressedCopySubTextureCHROMIUM*>(
        cmd_data);
    (void)c;
    GLenum target = static_cast<GLenum>(c.target);
    GLenum source_id = static_cast<GLenum>(c.source_id);
...
error::Error GLES2DecoderImpl::HandleProduceTextureCHROMIUMImmediate(
    ...
    const void* cmd_data)
{
    const gles2::cmds::ProduceTextureCHROMIUMImmediate& c = *static_cast<const gles2::cmds::ProduceTextureCHROMIUMImmediate*>(
        cmd_data);
    (void)c;
    GLenum target = static_cast<GLenum>(c.target);
    uint32_t data_size;
...
error::Error GLES2DecoderImpl::HandleProduceTextureDirectCHROMIUMImmediate(
    ...
    const void* cmd_data)
{
    const gles2::cmds::ProduceTextureDirectCHROMIUMImmediate& c = *static_cast<const gles2::cmds::ProduceTextureDirectCHROMIUMImmediate*>(
        cmd_data);
    (void)c;
    GLuint texture = c.texture;
    GLenum target = static_cast<GLenum>(c.target);
...
error::Error GLES2DecoderImpl::HandleConsumeTextureCHROMIUMImmediate(
    ...
    const void* cmd_data)
{
    const gles2::cmds::ConsumeTextureCHROMIUMImmediate& c = *static_cast<const gles2::cmds::ConsumeTextureCHROMIUMImmediate*>(
        cmd_data);
    (void)c;
    GLenum target = static_cast<GLenum>(c.target);
    uint32_t data_size;
...
error::Error GLES2DecoderImpl::HandleGenValuebuffersCHROMIUMImmediate(
    ...
    const void* cmd_data)
{
    const gles2::cmds::GenValuebuffersCHROMIUMImmediate& c = *static_cast<const gles2::cmds::GenValuebuffersCHROMIUMImmediate*>(
        cmd_data);
    (void)c;
    GLsizei n = static_cast<GLsizei>(c.n);
    uint32_t data_size;
...
error::Error GLES2DecoderImpl::HandleDeleteValuebuffersCHROMIUMImmediate(
    ...
    const void* cmd_data)
{
    const gles2::cmds::DeleteValuebuffersCHROMIUMImmediate& c = *static_cast<const gles2::cmds::DeleteValuebuffersCHROMIUMImmediate*>(
        cmd_data);
    (void)c;
    GLsizei n = static_cast<GLsizei>(c.n);
    uint32_t data_size;
    ...
    const GLuint* valuebuffers = GetImmediateDataAs<const GLuint*>(c, data_size, immediate_data_size);
...
error::Error GLES2DecoderImpl::HandleIsValuebufferCHROMIUM(
    ...
    const void* cmd_data)
{
    const gles2::cmds::IsValuebufferCHROMIUM& c = *static_cast<const gles2::cmds::IsValuebufferCHROMIUM*>(cmd_data);
    (void)c;
...
error::Error GLES2DecoderImpl::HandleBindValuebufferCHROMIUM(
    ...
    const void* cmd_data)
{
    const gles2::cmds::BindValuebufferCHROMIUM& c = *static_cast<const gles2::cmds::BindValuebufferCHROMIUM*>(cmd_data);
    (void)c;
    GLenum target = static_cast<GLenum>(c.target);
    GLuint valuebuffer = c.valuebuffer;
...
error::Error GLES2DecoderImpl::HandleSubscribeValueCHROMIUM(
    ...
    const void* cmd_data)
{
    const gles2::cmds::SubscribeValueCHROMIUM& c = *static_cast<const gles2::cmds::SubscribeValueCHROMIUM*>(cmd_data);
    (void)c;
    GLenum target = static_cast<GLenum>(c.target);
...
error::Error GLES2DecoderImpl::HandlePopulateSubscribedValuesCHROMIUM(
    ...
    const void* cmd_data)
{
    const gles2::cmds::PopulateSubscribedValuesCHROMIUM& c = *static_cast<const gles2::cmds::PopulateSubscribedValuesCHROMIUM*>(
        cmd_data);
    (void)c;
    GLenum target = static_cast<GLenum>(c.target);
    if (!validators_->value_buffer_target.IsValid(target)) {
...
error::Error GLES2DecoderImpl::HandleUniformValuebufferCHROMIUM(
    ...
    const void* cmd_data)
{
    const gles2::cmds::UniformValuebufferCHROMIUM& c = *static_cast<const gles2::cmds::UniformValuebufferCHROMIUM*>(cmd_data);
    (void)c;
    GLint location = static_cast<GLint>(c.location);
    GLenum target = static_cast<GLenum>(c.target);
    GLenum subscription = static_cast<GLenum>(c.subscription);
...
error::Error GLES2DecoderImpl::HandleBindTexImage2DCHROMIUM(
    ...
    const void* cmd_data)
{
    const gles2::cmds::BindTexImage2DCHROMIUM& c = *static_cast<const gles2::cmds::BindTexImage2DCHROMIUM*>(cmd_data);
    (void)c;
    GLenum target = static_cast<GLenum>(c.target);
...
error::Error GLES2DecoderImpl::HandleReleaseTexImage2DCHROMIUM(
    ...
    const void* cmd_data)
{
    const gles2::cmds::ReleaseTexImage2DCHROMIUM& c = *static_cast<const gles2::cmds::ReleaseTexImage2DCHROMIUM*>(cmd_data);
    (void)c;
    GLenum target = static_cast<GLenum>(c.target);
    GLint imageId = static_cast<GLint>(c.imageId);
    if (!validators_->texture_bind_target.IsValid(target)) {
...
error::Error GLES2DecoderImpl::HandleTraceEndCHROMIUM(
    ...
    const void* cmd_data)
{
    const gles2::cmds::TraceEndCHROMIUM& c = *static_cast<const gles2::cmds::TraceEndCHROMIUM*>(cmd_data);
    (void)c;
    DoTraceEndCHROMIUM();
    return error::kNoError;
}
...
error::Error GLES2DecoderImpl::HandleDiscardFramebufferEXTImmediate(
    ...
    const void* cmd_data)
{
    const gles2::cmds::DiscardFramebufferEXTImmediate& c = *static_cast<const gles2::cmds::DiscardFramebufferEXTImmediate*>(
        cmd_data);
    (void)c;
...
error::Error GLES2DecoderImpl::HandleLoseContextCHROMIUM(
    ...
    const void* cmd_data)
{
    const gles2::cmds::LoseContextCHROMIUM& c = *static_cast<const gles2::cmds::LoseContextCHROMIUM*>(cmd_data);
    (void)c;
...
error::Error GLES2DecoderImpl::HandleDrawBuffersEXTImmediate(
    ...
    const void* cmd_data)
{
    const gles2::cmds::DrawBuffersEXTImmediate& c = *static_cast<const gles2::cmds::DrawBuffersEXTImmediate*>(cmd_data);
    (void)c;
    GLsizei count = static_cast<GLsizei>(c.count);
    uint32_t data_size;
    if (!ComputeDataSize(count, sizeof(GLenum), 1, &data_size)) {
    ...
    const GLenum* bufs = GetImmediateDataAs<const GLenum*>(c, data_size, immediate_data_size);
    if (count < 0) {
...
error::Error GLES2DecoderImpl::HandleSwapInterval(uint32_t immediate_data_size,
    const void* cmd_data)
{
    const gles2::cmds::SwapInterval& c = *static_cast<const gles2::cmds::SwapInterval*>(cmd_data);
    (void)c;
...
error::Error GLES2DecoderImpl::HandleFlushDriverCachesCHROMIUM(
    ...
    const void* cmd_data)
{
    const gles2::cmds::FlushDriverCachesCHROMIUM& c = *static_cast<const gles2::cmds::FlushDriverCachesCHROMIUM*>(cmd_data);
    (void)c;
...
error::Error GLES2DecoderImpl::HandleMatrixLoadfCHROMIUMImmediate(
    ...
    const void* cmd_data)
{
    const gles2::cmds::MatrixLoadfCHROMIUMImmediate& c = *static_cast<const gles2::cmds::MatrixLoadfCHROMIUMImmediate*>(cmd_data);
    (void)c;
...
error::Error GLES2DecoderImpl::HandleMatrixLoadIdentityCHROMIUM(
    ...
    const void* cmd_data)
{
    const gles2::cmds::MatrixLoadIdentityCHROMIUM& c = *static_cast<const gles2::cmds::MatrixLoadIdentityCHROMIUM*>(cmd_data);
    (void)c;
    if (!features().chromium_path_rendering) {
...
error::Error GLES2DecoderImpl::HandleIsPathCHROMIUM(
    ...
    const void* cmd_data)
{
    const gles2::cmds::IsPathCHROMIUM& c = *static_cast<const gles2::cmds::IsPathCHROMIUM*>(cmd_data);
    (void)c;
    if (!features().chromium_path_rendering) {
...
error::Error GLES2DecoderImpl::HandlePathStencilFuncCHROMIUM(
    ...
    const void* cmd_data)
{
    const gles2::cmds::PathStencilFuncCHROMIUM& c = *static_cast<const gles2::cmds::PathStencilFuncCHROMIUM*>(cmd_data);
    (void)c;
    if (!features().chromium_path_rendering) {
    ...
    if (state_.stencil_path_func != func || state_.stencil_path_ref != ref || state_.stencil_path_mask != mask) {
...
error::Error GLES2DecoderImpl::HandleBlendBarrierKHR(
    ...
    const void* cmd_data)
{
    const gles2::cmds::BlendBarrierKHR& c = *static_cast<const gles2::cmds::BlendBarrierKHR*>(cmd_data);
    (void)c;
...
error::Error GLES2DecoderImpl::HandleApplyScreenSpaceAntialiasingCHROMIUM(
    ...
    const void* cmd_data)
{
    const gles2::cmds::ApplyScreenSpaceAntialiasingCHROMIUM& c = *static_cast<const gles2::cmds::ApplyScreenSpaceAntialiasingCHROMIUM*>(
        cmd_data);
    (void)c;
...
bool GLES2DecoderImpl::SetCapabilityState(GLenum cap, bool enabled)
{
    ...
    case GL_BLEND:
        ...
        if (state_.enable_flags.cached_blend != enabled || state_.ignore_cached_state) {
    ...
    case GL_CULL_FACE:
        ...
        if (state_.enable_flags.cached_cull_face != enabled || state_.ignore_cached_state) {
    ...
    case GL_DEPTH_TEST:
        ...
        if (state_.enable_flags.cached_depth_test != enabled || state_.ignore_cached_state) {
            framebuffer_state_.clear_state_dirty = true;
        }
        return false;
    case GL_DITHER:
        state_.enable_flags.dither = enabled;
        if (state_.enable_flags.cached_dither != enabled || state_.ignore_cached_state) {
    ...
    case GL_POLYGON_OFFSET_FILL:
        ...
        if (state_.enable_flags.cached_polygon_offset_fill != enabled || state_.ignore_cached_state) {
    ...
    case GL_SAMPLE_ALPHA_TO_COVERAGE:
        ...
        if (state_.enable_flags.cached_sample_alpha_to_coverage != enabled || state_.ignore_cached_state) {
    ...
    case GL_SAMPLE_COVERAGE:
        ...
        if (state_.enable_flags.cached_sample_coverage != enabled || state_.ignore_cached_state) {
    ...
    case GL_SCISSOR_TEST:
        ...
        if (state_.enable_flags.cached_scissor_test != enabled || state_.ignore_cached_state) {
    ...
    case GL_STENCIL_TEST:
        ...
        if (state_.enable_flags.cached_stencil_test != enabled || state_.ignore_cached_state) {
            framebuffer_state_.clear_state_dirty = true;
        }
        return false;
    case GL_RASTERIZER_DISCARD:
        state_.enable_flags.rasterizer_discard = enabled;
        if (state_.enable_flags.cached_rasterizer_discard != enabled || state_.ignore_cached_state) {
    ...
    case GL_PRIMITIVE_RESTART_FIXED_INDEX:
        ...
        if (state_.enable_flags.cached_primitive_restart_fixed_index != enabled || state_.ignore_cached_state) {
