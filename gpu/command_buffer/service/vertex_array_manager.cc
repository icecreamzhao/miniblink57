...
namespace gles2 {
        ...
        bool client_visible)
    {
        ...
        if (client_visible) {
            std::pair<VertexAttribManagerMap::iterator, bool> result = vertex_attrib_managers_.insert(
        ...
        GLuint service_id, GLuint* client_id) const
    {
        ...
        for (VertexAttribManagerMap::const_iterator it = vertex_attrib_managers_.begin();
