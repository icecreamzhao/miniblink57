...
int main(int argc, char** argv)
{
    ...
    std::vector<std::pair<base::FilePath, base::FilePath>> files = GetSkpsToRasterize(input_path, output_path);
    ...
    int repeat_raster_count = std::max(1, GetSwitchInt(command_line, "repeat-raster-count", 1));
