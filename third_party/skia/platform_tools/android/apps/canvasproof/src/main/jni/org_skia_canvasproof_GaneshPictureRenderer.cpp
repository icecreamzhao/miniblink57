    ...
    JNIEnv*, jclass, jint width, jint height, jfloat scale, jlong ptr, jlong pic)
{
    ...
    GaneshPictureRendererImpl* impl = reinterpret_cast<GaneshPictureRendererImpl*>(ptr);
 ...
 * Signature: ()J
 */
JNIEXPORT jlong JNICALL Java_org_skia_canvasproof_GaneshPictureRenderer_Ctor(JNIEnv*, jclass)
{
 ...
 * Signature: (J)V
 */
JNIEXPORT void JNICALL Java_org_skia_canvasproof_GaneshPictureRenderer_CleanUp(JNIEnv*, jclass, jlong ptr)
{
 ...
 */
JNIEXPORT void JNICALL Java_org_skia_canvasproof_GaneshPictureRenderer_GetCullRect(JNIEnv* env, jclass, jobject androidGraphicsRect, jlong picturePtr)
{
