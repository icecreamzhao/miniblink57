 ...
 * Signature: (J)V
 */
JNIEXPORT void JNICALL Java_org_skia_canvasproof_CreateSkiaPicture_deleteImpl(JNIEnv*, jclass, jlong);
 ...
 */
JNIEXPORT jlong JNICALL Java_org_skia_canvasproof_CreateSkiaPicture_createImpl(JNIEnv*, jclass, jobject, jbyteArray);
