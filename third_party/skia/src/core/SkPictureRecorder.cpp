...
sk_sp<SkPicture> SkPictureRecorder::finishRecordingAsPicture()
{
    ...
    SkBigPicture::SnapshotArray* pictList = drawableList ? drawableList->newDrawableSnapshot() : nullptr;
...
sk_sp<SkDrawable> SkPictureRecorder::finishRecordingAsDrawable()
{
    ...
    sk_sp<SkDrawable> drawable = sk_make_sp<SkRecordedDrawable>(fRecord, fBBH, fRecorder->detachDrawableList(), fCullRect,
