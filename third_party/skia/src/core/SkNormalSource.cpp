    ...
    int count) const
{
    ...
    do {
        ...
        for (int i = 0; i < n; i++) {
            ...
            output[i].fX = fSource.fNormRotation.fX * tempNorm.fX + fSource.fNormRotation.fY * tempNorm.fY;
            output[i].fY = -fSource.fNormRotation.fY * tempNorm.fX + fSource.fNormRotation.fX * tempNorm.fY;
