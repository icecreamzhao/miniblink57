...
template <DstType D>
uint32_t store_dst(const Sk4f& x4)
{
...
template <DstType D>
void general_1(const SkXfermode* xfer, uint32_t dst[],
...
template <DstType D>
void general_n(const SkXfermode* xfer, uint32_t dst[],
    const SkPM4f src[], int count, const SkAlpha aa[])
{
    SkXfermodeProc4f proc = xfer->getProc4f();
    SkPM4f d;
...
const SkXfermode::D32Proc gProcs_General[] = {
    general_n<kLinear_Dst>,
    general_n<kLinear_Dst>,
    general_1<kLinear_Dst>,
    general_1<kLinear_Dst>,
    general_n<kSRGB_Dst>,
    general_n<kSRGB_Dst>,
    general_1<kSRGB_Dst>,
...
template <DstType D>
void src_n(const SkXfermode*, uint32_t dst[],
    const SkPM4f src[], int count, const SkAlpha aa[])
{
    for (int i = 0; i < count; ++i) {
        unsigned a = 0xFF;
...
template <DstType D>
void src_1(const SkXfermode*, uint32_t dst[],
    const SkPM4f* src, int count, const SkAlpha aa[])
{
...
template <DstType D>
void srcover_n(const SkXfermode*, uint32_t dst[],
    const SkPM4f src[], int count, const SkAlpha aa[])
{
    if (aa) {
        for (int i = 0; i < count; ++i) {
...
const SkXfermode::D32Proc gProcs_SrcOver[] = {
    srcover_n<kLinear_Dst>,
    src_n<kLinear_Dst>,
    srcover_linear_dst_1,
    src_1<kLinear_Dst>,
...
static SkXfermode::D32Proc find_proc(SkXfermode::Mode mode, uint32_t flags)
{
    ...
    case SkXfermode::kClear_Mode:
        return gProcs_Clear[flags];
    case SkXfermode::kSrc_Mode:
        return gProcs_Src[flags];
    case SkXfermode::kDst_Mode:
        return gProcs_Dst[flags];
    case SkXfermode::kSrcOver_Mode:
        return gProcs_SrcOver[flags];
    default:
        break;
    }
...
SkXfermode::LCD32Proc SkXfermode::GetLCD32Proc(uint32_t flags)
{
    ...
    const LCD32Proc procs[] = {
        srcover_n_lcd<kSRGB_Dst>,
        src_n_lcd<kSRGB_Dst>,
        srcover_1_lcd<kSRGB_Dst>,
        src_1_lcd<kSRGB_Dst>,

        srcover_n_lcd<kLinear_Dst>,
        src_n_lcd<kLinear_Dst>,
        srcover_1_lcd<kLinear_Dst>,
        src_1_lcd<kLinear_Dst>,
    };
    return procs[flags];
}
