...
struct SkOTTableName {
    ...
    struct Record {
        ...
        struct PlatformID {
            SK_TYPED_ENUM(Value, SK_OT_USHORT,
                ((Unicode, SkTEndian_SwapBE16(0)))((Macintosh, SkTEndian_SwapBE16(1)))((ISO, SkTEndian_SwapBE16(2))) // Deprecated, use Unicode instead.
                ((Windows, SkTEndian_SwapBE16(3)))((Custom, SkTEndian_SwapBE16(4)))
                    SK_SEQ_END,
                (value)SK_SEQ_END)
        } platformID;
        ...
        union EncodingID {
            ...
            struct Unicode {
                SK_TYPED_ENUM(Value, SK_OT_USHORT,
                    ((Unicode10, SkTEndian_SwapBE16(0)))((Unicode11, SkTEndian_SwapBE16(1)))((ISO10646, SkTEndian_SwapBE16(2))) //deprecated, use Unicode11
                    ((Unicode20BMP, SkTEndian_SwapBE16(3)))((Unicode20, SkTEndian_SwapBE16(4)))((UnicodeVariationSequences, SkTEndian_SwapBE16(5)))((UnicodeFull, SkTEndian_SwapBE16(6)))
                        SK_SEQ_END,
                    (value)SK_SEQ_END)
            } unicode;
            ...
            struct ISO {
                SK_TYPED_ENUM(Value, SK_OT_USHORT,
                    ((ASCII7, SkTEndian_SwapBE16(0)))((ISO10646, SkTEndian_SwapBE16(1)))((ISO88591, SkTEndian_SwapBE16(2)))
                        SK_SEQ_END,
                    (value)SK_SEQ_END)
            } iso;
            ...
            struct Windows {
                SK_TYPED_ENUM(Value, SK_OT_USHORT,
                    ...
                    ((ShiftJIS, SkTEndian_SwapBE16(2)))((PRC, SkTEndian_SwapBE16(3)))((Big5, SkTEndian_SwapBE16(4)))((Wansung, SkTEndian_SwapBE16(5)))((Johab, SkTEndian_SwapBE16(6)))((UnicodeUCS4, SkTEndian_SwapBE16(10))) // UTF-16BE. It means UCS4 in charmaps.
                    SK_SEQ_END,
                    (value)SK_SEQ_END)
            } windows;
        } encodingID;
    ...
    class Iterator {
    public:
        Iterator(const SkOTTableName& name)
            : fName(name)
            , fIndex(0)
            , fType(-1)
        {
