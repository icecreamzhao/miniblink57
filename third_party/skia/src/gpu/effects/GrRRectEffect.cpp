...
public:
    enum CornerFlags {
        ...
        kAll_CornerFlags = kTopLeft_CornerFlag | kTopRight_CornerFlag | kBottomLeft_CornerFlag | kBottomRight_CornerFlag,
...
sk_sp<GrFragmentProcessor> CircularRRectEffect::TestCreate(GrProcessorTestData* d)
{
    ...
    do {
        GrPrimitiveEdgeType et = (GrPrimitiveEdgeType)d->fRandom->nextULessThan(kGrProcessorEdgeTypeCnt);
