...
void GrGLSLCaps::initSamplerPrecisionTable()
{
    ...
    for (int s = 0; s < kGrShaderTypeCount; ++s) {
        ...
        effectiveMediumP[s] = info[kHigh_GrSLPrecision] == info[kMedium_GrSLPrecision] ? kHigh_GrSLPrecision : kMedium_GrSLPrecision;
        effectiveLowP[s] = info[kMedium_GrSLPrecision] == info[kLow_GrSLPrecision] ? effectiveMediumP[s] : kLow_GrSLPrecision;
    }
