...
public:
    ...
    {
        GrColorComponentFlags flags = (in.fFlags & kA_GrColorComponentFlag) ? kRGBA_GrColorComponentFlags : kNone_GrColorComponentFlags;
    ...
    {
        GrColorComponentFlags outFlags = (a.fFlags & b.fFlags) | a.componentsWithValue(0) | b.componentsWithValue(0);
    ...
    {
        GrColorComponentFlags outFlags = (a.fFlags & b.fFlags) | a.componentsWithValue(0xFF) | b.componentsWithValue(0xFF);
