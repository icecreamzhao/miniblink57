...
private:
    void onPrepareDraws(Target* target) const override
    {
        ...
        for (int i = 0; i < instanceCount; i++) {
            intptr_t verts = reinterpret_cast<intptr_t>(vertices) + i * kRectsPerInstance * kVertsPerRect * vertexStride;
    ...
    bool onCombineIfPossible(GrBatch* t, const GrCaps& caps) override
    {
        ...
        SkASSERT(this->fImageWidth == that->fImageWidth && this->fImageHeight == that->fImageHeight);
