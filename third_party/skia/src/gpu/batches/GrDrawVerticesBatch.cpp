    ...
    bool coverageIgnored)
{
    ...
    *colorOffset = -1;
    ...
    LocalCoords localCoords(hasLocalCoords ? LocalCoords::kHasExplicit_Type : LocalCoords::kUsePosition_Type);
...
void GrDrawVerticesBatch::onPrepareDraws(Target* target) const
{
    ...
    SkASSERT(vertexStride == sizeof(SkPoint) + (hasLocalCoords ? sizeof(SkPoint) : 0) + sizeof(GrColor));
