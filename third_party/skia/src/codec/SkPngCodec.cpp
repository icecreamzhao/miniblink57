...
public:
        ...
        SkPMColor ctable[], int* ctableCount) override
    {
        ...
        fStorage.reset(this->getInfo().width() * (bytes_per_pixel(this->getEncodedInfo().bitsPerPixel())));
...
public:
        ...
        SkPMColor ctable[], int* ctableCount) override
    {
        ...
        fSrcRowBytes = this->getInfo().width() * (bytes_per_pixel(this->getEncodedInfo().bitsPerPixel()));
    ...
    png_structp* png_ptrp, png_infop* info_ptrp)
{
    ...
    case PNG_COLOR_TYPE_PALETTE:
        ...
        alpha = png_get_valid(png_ptr, info_ptr, PNG_INFO_tRNS) ? SkEncodedInfo::kUnpremul_Alpha : SkEncodedInfo::kOpaque_Alpha;
        break;
