...
struct SkMemberInfo {
    ...
    int getCount() const
    {
        return fType == SkType_MemberProperty || fType == SkType_Array || fType == SkType_MemberFunction ? 1 : fCount;
    }
    ...
    {
        return fType == SkType_MemberProperty || fType == SkType_Array || fType == SkType_MemberFunction ? (SkDisplayTypes)fCount : (SkDisplayTypes)fType;
    }
