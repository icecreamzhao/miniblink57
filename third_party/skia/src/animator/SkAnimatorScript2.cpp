...
public:
    SkAnimatorScript_Enum(const char* tokens)
        : fTokens(tokens)
    {
    }
...
public:
    SkAnimatorScript_Eval(SkAnimatorScript2* engine)
        : fEngine(engine)
    {
    }
...
public:
    SkAnimatorScript_ID(SkAnimatorScript2* engine)
        : fEngine(engine)
    {
    }
...
public:
    SkAnimatorScript_Member(SkAnimatorScript2* engine)
        : fEngine(engine)
    {
    }
...
public:
    SkAnimatorScript_MemberFunction(SkAnimatorScript2* engine)
        : fEngine(engine)
    {
    }
...
public:
    SkAnimatorScript_Unbox(SkAnimatorScript2* engine)
        : fEngine(engine)
    {
    }
...
static const char scriptTestSetup[] = "<screenplay>"
                                      "<apply>"
                                      "<paint>"
