...
public:
    ...
    SkNx(float a, float b)
        : fVec(_mm_setr_ps(a, b, 0, 0))
    {
    }
...
template <>
/*static*/ inline Sk4f SkNx_cast<float, int>(const Sk4i& src)
{
    return _mm_cvtepi32_ps(src.fVec);
}

template <>
/*static*/ inline Sk4i SkNx_cast<int, float>(const Sk4f& src)
{
    return _mm_cvttps_epi32(src.fVec);
}

template <>
/*static*/ inline Sk4h SkNx_cast<uint16_t, float>(const Sk4f& src)
{
...
template <>
/*static*/ inline Sk4b SkNx_cast<uint8_t, float>(const Sk4f& src)
{
    auto _32 = _mm_cvttps_epi32(src.fVec);
#if SK_CPU_SSE_LEVEL >= SK_CPU_SSE_LEVEL_SSSE3
    const int _ = ~0;
...
template <>
/*static*/ inline Sk4f SkNx_cast<float, uint8_t>(const Sk4b& src)
{
#if SK_CPU_SSE_LEVEL >= SK_CPU_SSE_LEVEL_SSSE3
    const int _ = ~0;
...
template <>
/*static*/ inline Sk4f SkNx_cast<float, uint16_t>(const Sk4h& src)
{
...
template <>
/*static*/ inline Sk16b SkNx_cast<uint8_t, float>(const Sk16f& src)
{
    Sk8f ab, cd;
...
template <>
/*static*/ inline Sk4h SkNx_cast<uint16_t, uint8_t>(const Sk4b& src)
{
    return _mm_unpacklo_epi8(src.fVec, _mm_setzero_si128());
}

template <>
/*static*/ inline Sk4b SkNx_cast<uint8_t, uint16_t>(const Sk4h& src)
{
