...
protected:
    ...
    void onOnceBeforeDraw() override
    {
        ...
        SkPaint paint;
        static const SkColor kColors[] = { SK_ColorBLUE, SK_ColorYELLOW, SK_ColorGREEN, SK_ColorWHITE };
        ...
        for (int i = 0; i < kBmpSize * kBmpSize; ++i) {
            yPixels[i] = static_cast<unsigned char>(0.299f * SkGetPackedR32(rgbColors[i]) + 0.587f * SkGetPackedG32(rgbColors[i]) + 0.114f * SkGetPackedB32(rgbColors[i]));
        }
