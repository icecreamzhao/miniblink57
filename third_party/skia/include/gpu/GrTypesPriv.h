...
{
    return (kInverseFillAA_GrProcessorEdgeType == edgeType || kInverseFillBW_GrProcessorEdgeType == edgeType);
}
...
template <typename T>
T* const* sk_sp_address_as_pointer_address(sk_sp<T> const* sp)
{
