...
{
    SkASSERT(mo == sk_memory_order_relaxed || mo == sk_memory_order_seq_cst || mo == sk_memory_order_acquire || mo == sk_memory_order_consume);
...
{
    SkASSERT(mo == sk_memory_order_relaxed || mo == sk_memory_order_seq_cst || mo == sk_memory_order_release);
    ...
    sk_memory_order failure)
{
    ...
    SkASSERT(failure == sk_memory_order_relaxed || failure == sk_memory_order_seq_cst || failure == sk_memory_order_acquire || failure == sk_memory_order_consume);
