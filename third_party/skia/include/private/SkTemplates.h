...
public:
    SkAutoTCallVProc(T* obj)
        : std::unique_ptr<T, SkFunctionWrapper<void, T, P>>(obj)
    {
    }
...
public:
    SkAutoTCallIProc(T* obj)
        : std::unique_ptr<T, SkFunctionWrapper<int, T, P>>(obj)
    {
    }
...
*/
template <typename T>
class SkAutoTDelete : public std::unique_ptr<T> {
public:
    SkAutoTDelete(T* obj = NULL)
...
template <typename T>
class SkAutoTDeleteArray : public std::unique_ptr<T[]> {
public:
    SkAutoTDeleteArray(T array[])
 ...
 */
template <typename T>
class SkAutoTArray : SkNoncopyable {
public:
    SkAutoTArray()
    {
        fArray = NULL;
...
class SkAutoSTArray : SkNoncopyable {
public:
 ...
 */
template <typename T>
class SkAutoTMalloc : SkNoncopyable {
public:
...
class SkAutoSTMalloc : SkNoncopyable {
public:
    SkAutoSTMalloc()
        : fPtr(fTStorage)
    {
 ...
 */
template <size_t N>
class SkAlignedSStorage : SkNoncopyable {
public:
...
class SkAlignedSTStorage : SkNoncopyable {
public:
    /**
