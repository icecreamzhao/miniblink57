 ...
 */
    template <typename OutOfRange_Low, typename OutOfRange_High>
    struct SkTOutOfRange_Either {
        using can_be_true = std::true_type;
 ...
 */
    template <typename D, typename S>
    struct SkTFitsIn_Unsigned2Unsiged {
 ...
 */
    template <typename D, typename S>
    struct SkTFitsIn_Signed2Signed {
 ...
 */
    template <typename D, typename S>
    struct SkTFitsIn_Signed2Unsigned {
 ...
 */
    template <typename D, typename S>
    struct SkTFitsIn_Unsigned2Signed {
        using OutOfRange_Low = SkTOutOfRange_False<S>;
        using OutOfRange_High = SkTOutOfRange_GT_MaxD<D, S>;
