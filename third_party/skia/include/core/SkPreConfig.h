...
#elif defined(linux) || defined(__linux) || defined(__FreeBSD__) || defined(__OpenBSD__) || defined(__sun) || defined(__NetBSD__) || defined(__DragonFly__) || defined(__GLIBC__) || defined(__GNU__) || defined(__unix__)
...
#if defined(__sparc) || defined(__sparc__) || defined(_POWER) || defined(__powerpc__) || defined(__ppc__) || defined(__hppa) || defined(__PPC__) || defined(__PPC64__) || defined(_MIPSEB) || defined(__ARMEB__) || defined(__s390__) || (defined(__sh__) && defined(__BIG_ENDIAN__)) || (defined(__ia64) && defined(__BIG_ENDIAN__))
