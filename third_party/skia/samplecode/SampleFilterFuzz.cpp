...
static SkString make_font_name()
{
    ...
    switch (sel) {
    case 0:
        return SkString("Courier New");
    case 1:
        return SkString("Helvetica");
    case 2:
        return SkString("monospace");
    case 3:
        return SkString("sans-serif");
    case 4:
        return SkString("serif");
    case 5:
        return SkString("Times");
    case 6:
        return SkString("Times New Roman");
    case 7:
    default:
        return make_string();
    }
...
{
    return (R(2) == 1) ? SkDropShadowImageFilter::kDrawShadowAndForeground_ShadowMode : SkDropShadowImageFilter::kDrawShadowOnly_ShadowMode;
}
...
static bool valid_for_raster_canvas(const SkImageInfo& info)
{
    ...
    case kN32_SkColorType:
        return kPremul_SkAlphaType == info.alphaType() || kOpaque_SkAlphaType == info.alphaType();
    default:
        break;
    }
    return false;
