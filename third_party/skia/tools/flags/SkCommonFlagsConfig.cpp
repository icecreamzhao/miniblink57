...
static const char defaultConfigs[] = "565 8888 gpu nonrendering"
#if SK_ANGLE
...
static const char configHelp[] = "Options: 565 8888 debug gpu gl gpudebug gpudft gpunull "
...
#ifdef SK_VULKAN
    ,
    { "vk", "gpu", "api=vulkan" }, { "vksrgb", "gpu", "api=vulkan,color=srgb" }
#endif
    ...
    SkCommandLineConfigArray* outResult)
{
    ...
    for (int i = 0; i < configs.count(); ++i) {
        ...
        if (extendedBackend.isEmpty()) {
            ...
            if (vias.count() && simpleBackend.equals("gl") && vias[vias.count() - 1].equals("angle")) {
