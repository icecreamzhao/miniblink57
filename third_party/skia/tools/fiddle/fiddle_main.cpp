...
{
    OSMesaContext osMesaContext = OSMesaCreateContextExt(OSMESA_BGRA, 0, 0, 0, nullptr);
...
int main()
{
    ...
    if (options.raster) {
        auto rasterSurface = SkSurface::MakeRaster(SkImageInfo::MakeN32Premul(options.size));
        srand(0);
