...
void CheckShader(SkPaint* paint)
{
    ...
    if (gtype == SkShader::kLinear_GradientType || gtype == SkShader::kRadial_GradientType || gtype == SkShader::kSweep_GradientType) {
        return;
    }
...
SkAndroidSDKCanvas::SkAndroidSDKCanvas()
    : fProxyTarget(nullptr)
{
}
