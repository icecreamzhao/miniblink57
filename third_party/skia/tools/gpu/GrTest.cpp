...
void GrGpu::Stats::dumpKeyValuePairs(SkTArray<SkString>* keys, SkTArray<double>* values)
{
    ...
    keys->push_back(SkString("texture_uploads"));
    values->push_back(fTextureUploads);
    keys->push_back(SkString("number_of_draws"));
    values->push_back(fNumDraws);
    keys->push_back(SkString("number_of_failed_draws"));
    values->push_back(fNumFailedDraws);
}
    ...
    SkTArray<double>* values) const
{
    ...
    keys->push_back(SkString("gpu_cache_purgable_entries"));
    values->push_back(stats.fNumPurgeable);
}
...
public:
    explicit MockCaps(const GrContextOptions& options)
        : INHERITED(options)
    {
    }
...
public:
    MockGpu(GrContext* context, const GrContextOptions& options)
        : INHERITED(context)
    {
