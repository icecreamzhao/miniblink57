...
public:
    ...
    SkPlatformGpuFence SK_WARN_UNUSED_RESULT insertFence() const override
    {
        ...
        SkDEBUGCODE(++fUnfinishedSyncs;) return reinterpret_cast<SkPlatformGpuFence>(fence);
    }
...
private:
    ...
    SkDEBUGCODE(mutable int fUnfinishedSyncs;) typedef SkGpuFenceSync INHERITED;
};
