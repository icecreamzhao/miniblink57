...
VkSurfaceKHR VulkanWindowContext::createVkSurface(VkInstance instance, void* platformData)
{
    ...
    ContextPlatformData_win* winPlatformData = reinterpret_cast<ContextPlatformData_win*>(platformData);
    ...
    uint32_t queueFamilyIndex, void*)
{
    ...
    if (!getPhysicalDeviceWin32PresentationSupportKHR) {
        getPhysicalDeviceWin32PresentationSupportKHR = (PFN_vkGetPhysicalDeviceWin32PresentationSupportKHR)vkGetInstanceProcAddr(instance,
