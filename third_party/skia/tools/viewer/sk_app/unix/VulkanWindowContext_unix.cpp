...
VkSurfaceKHR VulkanWindowContext::createVkSurface(VkInstance instance, void* platformData)
{
    ...
    ContextPlatformData_unix* unixPlatformData = reinterpret_cast<ContextPlatformData_unix*>(platformData);
    ...
    uint32_t queueFamilyIndex, void* platformData)
{
    ...
    if (!getPhysicalDeviceXcbPresentationSupportKHR) {
        getPhysicalDeviceXcbPresentationSupportKHR = (PFN_vkGetPhysicalDeviceXcbPresentationSupportKHR)vkGetInstanceProcAddr(instance,
