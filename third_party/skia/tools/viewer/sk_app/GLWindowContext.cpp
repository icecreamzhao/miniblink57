...
void GLWindowContext::initializeContext(void* platformData, const DisplayParams& params)
{
    ...
    fPixelConfig = fContext->caps()->srgbSupport() && SkColorAndColorSpaceAreGammaCorrect(fDisplayParams.fColorType, fDisplayParams.fColorSpace.get()) && (fColorBits != 30) ? kSkiaGamma8888_GrPixelConfig : kSkia8888_GrPixelConfig;
}
