...
DEF_TEST(ToUnicode, reporter)
{
    ...
    char expectedResult[] = "4 beginbfchar\n\
<0003> <0020>\n\
<0004> <0025>\n\
<0008> <002F>\n\
<0009> <0033>\n\
...
endbfrange\n";
    ...
    REPORTER_ASSERT(reporter, stream_equals(buffer, 0, expectedResult, buffer.getOffset()));
    ...
    char expectedResultChop1[] = "2 beginbfchar\n\
<0008> <002F>\n\
<0009> <0033>\n\
endbfchar\n\
2 beginbfrange\n\
...
endbfrange\n";
    ...
    REPORTER_ASSERT(reporter, stream_equals(buffer, 0, expectedResultChop1, buffer.getOffset()));
    ...
    char expectedResultChop2[] = "2 beginbfchar\n\
<000D> <0037>\n\
<00FE> <1010>\n\
endbfchar\n";

    REPORTER_ASSERT(reporter, stream_equals(buffer, 0, expectedResultChop2, buffer.getOffset()));
...
endbfrange\n";
    ...
    REPORTER_ASSERT(reporter, stream_equals(buffer, 0, expectedResultSingleBytes, buffer.getOffset()));
    ...
    char expectedResult2[] = "4 beginbfchar\n\
<002C> <0049>\n\
<0044> <0061>\n\
<004F> <006C>\n\
<0051> <006E>\n\
