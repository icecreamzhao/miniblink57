...
private:
    void clampShapeSize()
    {
        ...
        float diagonal = sqrtf(static_cast<float>(fShapesSize.width() * fShapesSize.width()) + static_cast<float>(fShapesSize.height() * fShapesSize.height()));
    ...
    void onDelayedSetup() override
    {
        ...
        for (int i = 0; i < fNumShapes; i++) {
            float pad = sqrtf(static_cast<float>(fShapesSize.width() * fShapesSize.width()) + static_cast<float>(fShapesSize.height() * fShapesSize.height()));
