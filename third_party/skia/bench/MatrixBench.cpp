...
DEF_BENCH(return new InvertMapRectMatrixBench(
    ...
    InvertMapRectMatrixBench::kScale_Flag | InvertMapRectMatrixBench::kTranslate_Flag);)
...
DEF_BENCH(return new InvertMapRectMatrixBench(
    ...
    InvertMapRectMatrixBench::kScale_Flag | InvertMapRectMatrixBench::kRotate_Flag | InvertMapRectMatrixBench::kTranslate_Flag);)
...
DEF_BENCH(return new InvertMapRectMatrixBench(
    ...
    InvertMapRectMatrixBench::kUncachedTypeMask_Flag | InvertMapRectMatrixBench::kScale_Flag | InvertMapRectMatrixBench::kTranslate_Flag);)
