...
public:
    ...
    {
        std::unique_ptr<AudioWorkletThread> thread = AudioWorkletThread::create(nullptr, *m_reportingProxy);
...
TEST_F(AudioWorkletThreadTest, CreateSecondAndTerminateFirst)
{
    ...
    std::unique_ptr<AudioWorkletThread> secondWorklet = createAudioWorkletThread();
