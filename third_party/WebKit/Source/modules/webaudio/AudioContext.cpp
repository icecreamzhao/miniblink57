    ...
    ExceptionState& exceptionState)
{
    ...
    if (s_hardwareContextCount >= MaxHardwareContexts) {
        exceptionState.throwDOMException(
            NotSupportedError, ExceptionMessages::indexExceedsMaximumBound("number of hardware contexts", s_hardwareContextCount, MaxHardwareContexts));
        return nullptr;
    }
    ...
    AudioTimestamp& result)
{
    ...
    double performanceTime = performance->monotonicTimeToDOMHighResTimeStamp(position.timestamp);
