...
{
    HTMLIFrameElementPayments* supplement = static_cast<HTMLIFrameElementPayments*>(
...
bool HTMLIFrameElementPayments::allowPaymentRequest(
    HTMLIFrameElement& element)
{
    return RuntimeEnabledFeatures::paymentRequestEnabled() && element.fastHasAttribute(HTMLNames::allowpaymentrequestAttr);
}
