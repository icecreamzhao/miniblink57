...
namespace {
    ...
    TEST(PaymentRequestTest, NullShippingOptionWhenNoOptionsAvailable)
    {
        ...
        PaymentRequest* request = PaymentRequest::create(scope.document(), buildPaymentMethodDataForTest(),
    ...
    TEST(PaymentRequestTest, DontSelectSingleAvailableShippingOptionByDefault)
    {
        ...
        details.setShippingOptions(HeapVector<PaymentShippingOption>(
            1, buildShippingOptionForTest(PaymentTestDataId, PaymentTestOverwriteValue, "standard")));
    ...
    TEST(PaymentRequestTest, RejectShowPromiseOnInvalidPaymentDetailsUpdate)
    {
        ...
        request->onUpdatePaymentDetails(ScriptValue::from(
            scope.getScriptState(), fromJSONString(scope.getScriptState()->isolate(), "{}", scope.getExceptionState())));
        EXPECT_FALSE(scope.getExceptionState().hadException());
    }
        ...
        ClearShippingOptionOnPaymentDetailsUpdateWithoutShippingOptions)
    {
        ...
        request->show(scope.getScriptState())
            .then(funcs.expectNoCall(), funcs.expectNoCall());
        String detailWithShippingOptions = "{\"total\": {\"label\": \"Total\", \"amount\": {\"currency\": \"USD\", "
                                           "\"value\": \"5.00\"}},"
        ...
        String detailWithoutShippingOptions = "{\"total\": {\"label\": \"Total\", \"amount\": {\"currency\": \"USD\", "
                                              "\"value\": \"5.00\"}}}";
        ...
        ClearShippingOptionOnPaymentDetailsUpdateWithMultipleUnselectedShippingOptions)
    {
        ...
        request->show(scope.getScriptState())
            .then(funcs.expectNoCall(), funcs.expectNoCall());
        String detail = "{\"total\": {\"label\": \"Total\", \"amount\": {\"currency\": \"USD\", "
                        "\"value\": \"5.00\"}},"
    ...
    TEST(PaymentRequestTest, NoExceptionWithErrorMessageInUpdate)
    {
        ...
        request->show(scope.getScriptState())
            .then(funcs.expectNoCall(), funcs.expectNoCall());
        String detailWithErrorMsg = "{\"total\": {\"label\": \"Total\", \"amount\": {\"currency\": \"USD\", "
                                    "\"value\": \"5.00\"}},"
