    ...
    String* optionalErrorMessage)
{
    if (system == "urn:iso:std:iso:4217") {
        ...
        if (optionalErrorMessage)
            *optionalErrorMessage = "'" + code + "' is not a valid ISO 4217 currency code, should "
    ...
    String* optionalErrorMessage)
{
    ...
    if (optionalErrorMessage)
        *optionalErrorMessage = "'" + code + "' is not a valid CLDR country code, should be 2 "
    ...
    String* optionalErrorMessage)
{
    ...
    if (optionalErrorMessage)
        *optionalErrorMessage = "'" + code + "' is not a valid BCP-47 language code, should be "
    ...
    String* optionalErrorMessage)
{
    ...
    if (optionalErrorMessage)
        *optionalErrorMessage = "'" + code + "' is not a valid ISO 15924 script code, should be "
