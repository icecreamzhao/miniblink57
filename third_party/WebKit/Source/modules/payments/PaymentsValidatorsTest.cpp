...
namespace {
    ...
    {
        String errorMessage;
        EXPECT_EQ(GetParam().expectedValid, PaymentsValidators::isValidAmountFormat(GetParam().input, &errorMessage))
            << errorMessage;
        EXPECT_EQ(GetParam().expectedValid, errorMessage.isEmpty()) << errorMessage;
    ...
    {
        payments::mojom::blink::PaymentAddressPtr address = payments::mojom::blink::PaymentAddress::New();
