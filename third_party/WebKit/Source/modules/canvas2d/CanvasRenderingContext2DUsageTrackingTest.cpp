...
namespace UsageTrackingTests {
    ...
    TEST_F(CanvasRenderingContextUsageTrackingTest, FillTracking)
    {
        ...
        EXPECT_TRUE(
            static_cast<double>(numReps * (100 * 100) * 2) < context2d()
                                                                 ->getUsage()
                                                                 .boundingBoxAreaFillType[BaseRenderingContext2D::ColorFillType]);
        EXPECT_TRUE(
            static_cast<double>(numReps * (100 * 100) * 2) * 1.1 > context2d()
                                                                       ->getUsage()
                                                                       .boundingBoxAreaFillType[BaseRenderingContext2D::ColorFillType]);
        ...
        EXPECT_NEAR(100 * 20, context2d()->getUsage().boundingBoxAreaFillType[BaseRenderingContext2D::LinearGradientFillType],
            1.0);
        ...
        EXPECT_NEAR(100 * 20, context2d()->getUsage().boundingBoxAreaFillType[BaseRenderingContext2D::RadialGradientFillType],
            1.0);
    ...
    TEST_F(CanvasRenderingContextUsageTrackingTest, StrokeTracking)
    {
        ...
        context2d()->strokeRect(10, 10, 100, 100);
        EXPECT_EQ(1, context2d()->getUsage().numLinearGradients);
        EXPECT_NEAR(100 * 100, context2d()->getUsage().boundingBoxAreaFillType[BaseRenderingContext2D::LinearGradientFillType],
            1.0);
    ...
    TEST_F(CanvasRenderingContextUsageTrackingTest, ImageTracking)
    {
        ...
        EXPECT_NEAR(
            ...
            0.1);
        EXPECT_NEAR(0.0, context2d()->getUsage().boundingBoxPerimeterDrawCalls[BaseRenderingContext2D::DrawVectorImage],
            0.1);
        ...
        EXPECT_NEAR(numReps * m_fullImageData.get()->width() * m_fullImageData.get()->height(),
