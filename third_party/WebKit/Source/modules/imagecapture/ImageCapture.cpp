    ...
    ExceptionState& exceptionState)
{
    ...
    if (!m_frameGrabber) {
        m_frameGrabber = WTF::wrapUnique(Platform::current()->createImageCaptureFrameGrabber());
    }
    ...
    media::mojom::blink::PhotoCapabilitiesPtr capabilities)
{
    ...
    if (capabilities.is_null()) {
        ...
        MediaSettingsRange* exposureCompensation = MediaSettingsRange::create(capabilities->exposure_compensation->max,
            capabilities->exposure_compensation->min,
            capabilities->exposure_compensation->current,
            capabilities->exposure_compensation->step);
        MediaSettingsRange* colorTemperature = MediaSettingsRange::create(capabilities->color_temperature->max,
