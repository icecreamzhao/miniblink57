...
namespace {
    ...
    void SetSinkIdResolver::timerFired(TimerBase* timer)
    {
        ...
        std::unique_ptr<SetSinkIdCallbacks> callbacks = WTF::wrapUnique(new SetSinkIdCallbacks(this, *m_element, m_sinkId));
...
HTMLMediaElementAudioOutputDevice& HTMLMediaElementAudioOutputDevice::from(
    HTMLMediaElement& element)
{
    HTMLMediaElementAudioOutputDevice* supplement = static_cast<HTMLMediaElementAudioOutputDevice*>(
