...
TEST_F(RemotePlaybackTest, PromptCancelledRejectsWithNotAllowedError)
{
    ...
    RemotePlayback* remotePlayback = HTMLMediaElementRemotePlayback::remote(*element);
...
TEST_F(RemotePlaybackTest, DisableRemotePlaybackCancelsAvailabilityCallbacks)
{
    ...
    RemotePlaybackAvailabilityCallback* availabilityCallback = RemotePlaybackAvailabilityCallback::create(scope.getScriptState(),
