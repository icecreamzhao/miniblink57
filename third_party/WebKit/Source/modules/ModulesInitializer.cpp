...
void ModulesInitializer::initialize()
{
    ...
    const unsigned modulesStaticStringsCount = EventNames::EventModulesNamesCount + EventTargetNames::EventTargetModulesNamesCount + 0; // IndexedDBNames::IndexedDBNamesCount;
