    ...
    const String& deviceInstanceId)
{
    ...
    BluetoothRemoteGATTService* service = m_serviceIdToObject.get(serviceInstanceId);
    ...
    BluetoothRemoteGATTService* service)
{
    ...
    BluetoothRemoteGATTCharacteristic* characteristic = m_characteristicIdToObject.get(instanceId);
    ...
    BluetoothRemoteGATTCharacteristic* characteristic)
{
    ...
    BluetoothRemoteGATTDescriptor* result = m_descriptorIdToObject.get(instanceId);

    if (result)
        return result;

    result = new BluetoothRemoteGATTDescriptor(std::move(descriptor), characteristic);
