...
namespace {
    ...
    const char kGATTServerDisconnected[] = "GATT Server disconnected while retrieving characteristics.";
    const char kGATTServerNotConnected[] = "GATT Server is disconnected. Cannot retrieve characteristics.";
    const char kInvalidService[] = "Service is no longer valid. Remember to retrieve the service again after "
                                   "reconnecting.";
