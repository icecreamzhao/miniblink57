    ...
    , m_currentElapsedQuery(this, nullptr)
{
    m_supportedInternalFormatsStorage.insert(
        ...
        kSupportedInternalFormatsStorage + WTF_ARRAY_LENGTH(kSupportedInternalFormatsStorage));
}
    ...
    long long size)
{
    ...
    if ((writeBuffer->getInitialTarget() == GL_ELEMENT_ARRAY_BUFFER && readBuffer->getInitialTarget() != GL_ELEMENT_ARRAY_BUFFER) || (writeBuffer->getInitialTarget() != GL_ELEMENT_ARRAY_BUFFER && readBuffer->getInitialTarget() == GL_ELEMENT_ARRAY_BUFFER)) {
    ...
    GLuint length)
{
    ...
    void* mappedData = contextGL()->MapBufferRange(target, static_cast<GLintptr>(srcByteOffset),
...
void WebGL2RenderingContextBase::readBuffer(GLenum mode)
{
    ...
    case GL_COLOR_ATTACHMENT0:
        break;
    default:
        if (mode > GL_COLOR_ATTACHMENT0 && mode < static_cast<GLenum>(GL_COLOR_ATTACHMENT0 + maxColorAttachments()))
            break;
    ...
    TexStorageType functionType)
{
    ...
    if (m_supportedInternalFormatsStorage.find(internalformat) == m_supportedInternalFormatsStorage.end() && (functionType == TexStorageType2D && !m_compressedTextureFormats.contains(internalformat))) {
...
void WebGL2RenderingContextBase::uniform1fv(
    ...
    GLuint srcLength)
{
    if (isContextLost() || !validateUniformParameters<WTF::Float32Array>("uniform1fv", location, v, 1, srcOffset, srcLength))
        return;
...
void WebGL2RenderingContextBase::uniform1fv(
    ...
    GLuint srcLength)
{
    if (isContextLost() || !validateUniformParameters("uniform1fv", location, v.data(), v.size(), 1, srcOffset, srcLength))
        return;
...
void WebGL2RenderingContextBase::uniform2fv(
    ...
    GLuint srcLength)
{
    if (isContextLost() || !validateUniformParameters<WTF::Float32Array>("uniform2fv", location, v, 2, srcOffset, srcLength))
        return;
...
void WebGL2RenderingContextBase::uniform2fv(
    ...
    GLuint srcLength)
{
    if (isContextLost() || !validateUniformParameters("uniform2fv", location, v.data(), v.size(), 2, srcOffset, srcLength))
        return;
...
void WebGL2RenderingContextBase::uniform3fv(
    ...
    GLuint srcLength)
{
    if (isContextLost() || !validateUniformParameters<WTF::Float32Array>("uniform3fv", location, v, 3, srcOffset, srcLength))
        return;
...
void WebGL2RenderingContextBase::uniform3fv(
    ...
    GLuint srcLength)
{
    if (isContextLost() || !validateUniformParameters("uniform3fv", location, v.data(), v.size(), 3, srcOffset, srcLength))
        return;
...
void WebGL2RenderingContextBase::uniform4fv(
    ...
    GLuint srcLength)
{
    if (isContextLost() || !validateUniformParameters<WTF::Float32Array>("uniform4fv", location, v, 4, srcOffset, srcLength))
        return;
...
void WebGL2RenderingContextBase::uniform4fv(
    ...
    GLuint srcLength)
{
    if (isContextLost() || !validateUniformParameters("uniform4fv", location, v.data(), v.size(), 4, srcOffset, srcLength))
        return;
...
void WebGL2RenderingContextBase::uniform1iv(
    ...
    GLuint srcLength)
{
    if (isContextLost() || !validateUniformParameters<WTF::Int32Array>("uniform1iv", location, v, 1, srcOffset, srcLength))
        return;
...
void WebGL2RenderingContextBase::uniform1iv(
    ...
    GLuint srcLength)
{
    if (isContextLost() || !validateUniformParameters("uniform1iv", location, v.data(), v.size(), 1, srcOffset, srcLength))
        return;
...
void WebGL2RenderingContextBase::uniform2iv(
    ...
    GLuint srcLength)
{
    if (isContextLost() || !validateUniformParameters<WTF::Int32Array>("uniform2iv", location, v, 2, srcOffset, srcLength))
        return;
...
void WebGL2RenderingContextBase::uniform2iv(
    ...
    GLuint srcLength)
{
    if (isContextLost() || !validateUniformParameters("uniform2iv", location, v.data(), v.size(), 2, srcOffset, srcLength))
        return;
...
void WebGL2RenderingContextBase::uniform3iv(
    ...
    GLuint srcLength)
{
    if (isContextLost() || !validateUniformParameters<WTF::Int32Array>("uniform3iv", location, v, 3, srcOffset, srcLength))
        return;
...
void WebGL2RenderingContextBase::uniform3iv(
    ...
    GLuint srcLength)
{
    if (isContextLost() || !validateUniformParameters("uniform3iv", location, v.data(), v.size(), 3, srcOffset, srcLength))
        return;
...
void WebGL2RenderingContextBase::uniform4iv(
    ...
    GLuint srcLength)
{
    if (isContextLost() || !validateUniformParameters<WTF::Int32Array>("uniform4iv", location, v, 4, srcOffset, srcLength))
        return;
...
void WebGL2RenderingContextBase::uniform4iv(
    ...
    GLuint srcLength)
{
    if (isContextLost() || !validateUniformParameters("uniform4iv", location, v.data(), v.size(), 4, srcOffset, srcLength))
        return;
...
void WebGL2RenderingContextBase::uniform1uiv(
    ...
    GLuint srcLength)
{
    if (isContextLost() || !validateUniformParameters<WTF::Uint32Array>("uniform1uiv", location, v, 1, srcOffset, srcLength))
        return;
...
void WebGL2RenderingContextBase::uniform1uiv(
    ...
    GLuint srcLength)
{
    if (isContextLost() || !validateUniformParameters("uniform1uiv", location, value.data(), value.size(), 1, srcOffset, srcLength))
        return;
...
void WebGL2RenderingContextBase::uniform2uiv(
    ...
    GLuint srcLength)
{
    if (isContextLost() || !validateUniformParameters<WTF::Uint32Array>("uniform2uiv", location, v, 2, srcOffset, srcLength))
        return;
...
void WebGL2RenderingContextBase::uniform2uiv(
    ...
    GLuint srcLength)
{
    if (isContextLost() || !validateUniformParameters("uniform2uiv", location, value.data(), value.size(), 2, srcOffset, srcLength))
        return;
...
void WebGL2RenderingContextBase::uniform3uiv(
    ...
    GLuint srcLength)
{
    if (isContextLost() || !validateUniformParameters<WTF::Uint32Array>("uniform3uiv", location, v, 3, srcOffset, srcLength))
        return;
...
void WebGL2RenderingContextBase::uniform3uiv(
    ...
    GLuint srcLength)
{
    if (isContextLost() || !validateUniformParameters("uniform3uiv", location, value.data(), value.size(), 3, srcOffset, srcLength))
        return;
...
void WebGL2RenderingContextBase::uniform4uiv(
    ...
    GLuint srcLength)
{
    if (isContextLost() || !validateUniformParameters<WTF::Uint32Array>("uniform4uiv", location, v, 4, srcOffset, srcLength))
        return;
...
void WebGL2RenderingContextBase::uniform4uiv(
    ...
    GLuint srcLength)
{
    if (isContextLost() || !validateUniformParameters("uniform4uiv", location, value.data(), value.size(), 4, srcOffset, srcLength))
        return;
...
void WebGL2RenderingContextBase::uniformMatrix2fv(
    ...
    GLuint srcLength)
{
    if (isContextLost() || !validateUniformMatrixParameters("uniformMatrix2fv", location, transpose, v, 4, srcOffset, srcLength))
        return;
...
void WebGL2RenderingContextBase::uniformMatrix2fv(
    ...
    GLuint srcLength)
{
    if (isContextLost() || !validateUniformMatrixParameters("uniformMatrix2fv", location, transpose, v.data(), v.size(), 4, srcOffset, srcLength))
        return;
    contextGL()->UniformMatrix2fv(
        location->location(),
...
void WebGL2RenderingContextBase::uniformMatrix3fv(
    ...
    GLuint srcLength)
{
    if (isContextLost() || !validateUniformMatrixParameters("uniformMatrix3fv", location, transpose, v, 9, srcOffset, srcLength))
        return;
...
void WebGL2RenderingContextBase::uniformMatrix3fv(
    ...
    GLuint srcLength)
{
    if (isContextLost() || !validateUniformMatrixParameters("uniformMatrix3fv", location, transpose, v.data(), v.size(), 9, srcOffset, srcLength))
        return;
    contextGL()->UniformMatrix3fv(
        location->location(),
...
void WebGL2RenderingContextBase::uniformMatrix4fv(
    ...
    GLuint srcLength)
{
    if (isContextLost() || !validateUniformMatrixParameters("uniformMatrix4fv", location, transpose, v, 16, srcOffset, srcLength))
        return;
...
void WebGL2RenderingContextBase::uniformMatrix4fv(
    ...
    GLuint srcLength)
{
    if (isContextLost() || !validateUniformMatrixParameters("uniformMatrix4fv", location, transpose, v.data(), v.size(), 16, srcOffset, srcLength))
        return;
    contextGL()->UniformMatrix4fv(
        location->location(),
...
void WebGL2RenderingContextBase::uniformMatrix2x3fv(
    ...
    GLuint srcLength)
{
    if (isContextLost() || !validateUniformMatrixParameters("uniformMatrix2x3fv", location, transpose, value, 6, srcOffset, srcLength))
        return;
...
void WebGL2RenderingContextBase::uniformMatrix2x3fv(
    ...
    GLuint srcLength)
{
    if (isContextLost() || !validateUniformMatrixParameters("uniformMatrix2x3fv", location, transpose, value.data(), value.size(), 6, srcOffset, srcLength))
        return;
    contextGL()->UniformMatrix2x3fv(
        location->location(),
...
void WebGL2RenderingContextBase::uniformMatrix3x2fv(
    ...
    GLuint srcLength)
{
    if (isContextLost() || !validateUniformMatrixParameters("uniformMatrix3x2fv", location, transpose, value, 6, srcOffset, srcLength))
        return;
...
void WebGL2RenderingContextBase::uniformMatrix3x2fv(
    ...
    GLuint srcLength)
{
    if (isContextLost() || !validateUniformMatrixParameters("uniformMatrix3x2fv", location, transpose, value.data(), value.size(), 6, srcOffset, srcLength))
        return;
    contextGL()->UniformMatrix3x2fv(
        location->location(),
        (srcLength ? srcLength : (value.size() - srcOffset)) / 6, transpose,
...
void WebGL2RenderingContextBase::uniformMatrix2x4fv(
    ...
    GLuint srcLength)
{
    if (isContextLost() || !validateUniformMatrixParameters("uniformMatrix2x4fv", location, transpose, value, 8, srcOffset, srcLength))
        return;
...
void WebGL2RenderingContextBase::uniformMatrix2x4fv(
    ...
    GLuint srcLength)
{
    if (isContextLost() || !validateUniformMatrixParameters("uniformMatrix2x4fv", location, transpose, value.data(), value.size(), 8, srcOffset, srcLength))
        return;
    contextGL()->UniformMatrix2x4fv(
        location->location(),
...
void WebGL2RenderingContextBase::uniformMatrix4x2fv(
    ...
    GLuint srcLength)
{
    if (isContextLost() || !validateUniformMatrixParameters("uniformMatrix4x2fv", location, transpose, value, 8, srcOffset, srcLength))
        return;
...
void WebGL2RenderingContextBase::uniformMatrix4x2fv(
    ...
    GLuint srcLength)
{
    if (isContextLost() || !validateUniformMatrixParameters("uniformMatrix4x2fv", location, transpose, value.data(), value.size(), 8, srcOffset, srcLength))
        return;
    contextGL()->UniformMatrix4x2fv(
        location->location(),
        (srcLength ? srcLength : (value.size() - srcOffset)) >> 3, transpose,
...
void WebGL2RenderingContextBase::uniformMatrix3x4fv(
    ...
    GLuint srcLength)
{
    if (isContextLost() || !validateUniformMatrixParameters("uniformMatrix3x4fv", location, transpose, value, 12, srcOffset, srcLength))
        return;
...
void WebGL2RenderingContextBase::uniformMatrix3x4fv(
    ...
    GLuint srcLength)
{
    if (isContextLost() || !validateUniformMatrixParameters("uniformMatrix3x4fv", location, transpose, value.data(), value.size(), 12, srcOffset, srcLength))
        return;
    contextGL()->UniformMatrix3x4fv(
        location->location(),
...
void WebGL2RenderingContextBase::uniformMatrix4x3fv(
    ...
    GLuint srcLength)
{
    if (isContextLost() || !validateUniformMatrixParameters("uniformMatrix4x3fv", location, transpose, value, 12, srcOffset, srcLength))
        return;
...
void WebGL2RenderingContextBase::uniformMatrix4x3fv(
    ...
    GLuint srcLength)
{
    if (isContextLost() || !validateUniformMatrixParameters("uniformMatrix4x3fv", location, transpose, value.data(), value.size(), 12, srcOffset, srcLength))
        return;
    contextGL()->UniformMatrix4x3fv(
        location->location(),
        (srcLength ? srcLength : (value.size() - srcOffset)) / 12, transpose,
...
void WebGL2RenderingContextBase::drawBuffers(const Vector<GLenum>& buffers)
{
    ...
    for (GLsizei i = 0; i < n; ++i) {
        ...
        case GL_COLOR_ATTACHMENT0:
            break;
        default:
            if (bufs[i] > GL_COLOR_ATTACHMENT0 && bufs[i] < static_cast<GLenum>(GL_COLOR_ATTACHMENT0 + maxColorAttachments()))
                break;
    ...
    GLenum pname)
{
    ...
    if (query == m_currentBooleanOcclusionQuery || query == m_currentTransformFeedbackPrimitivesWrittenQuery || query == m_currentElapsedQuery) {
        synthesizeGLError(GL_INVALID_OPERATION, "getQueryParameter",
    ...
    long long size)
{
    ...
    if (!validateValueFitNonNegInt32("bindBufferRange", "offset", offset) || !validateValueFitNonNegInt32("bindBufferRange", "size", size)) {
        return;
    }
    ...
    GLenum pname)
{
    ...
    case GL_SHADING_LANGUAGE_VERSION: {
        return WebGLAny(
            scriptState,
            "WebGL GLSL ES 3.00 (" + String(contextGL()->GetString(GL_SHADING_LANGUAGE_VERSION)) + ")");
    }
    case GL_VERSION:
        return WebGLAny(
            scriptState,
    ...
    WebGLBuffer* buffer)
{
    ...
    if (m_boundArrayBuffer == buffer || m_boundVertexArrayObject->boundElementArrayBuffer() == buffer || m_boundCopyReadBuffer == buffer || m_boundCopyWriteBuffer == buffer || m_boundPixelPackBuffer == buffer || m_boundPixelUnpackBuffer == buffer || m_boundUniformBuffer == buffer) {
        return true;
    }
    ...
    WebGLBuffer* buffer)
{
    ...
    case GL_TRANSFORM_FEEDBACK_BUFFER:
        ...
        m_boundIndexedTransformFeedbackBuffers[index] = TraceWrapperMember<WebGLBuffer>(this, buffer);
        m_boundTransformFeedbackBuffer = buffer;
        break;
    case GL_UNIFORM_BUFFER:
        if (index >= m_boundIndexedUniformBuffers.size()) {
        ...
        m_boundIndexedUniformBuffers[index] = TraceWrapperMember<WebGLBuffer>(this, buffer);
        m_boundUniformBuffer = buffer;
    ...
    GLenum attachment)
{
    ...
    if (!framebufferBinding) {
        ...
        case GL_DEPTH_STENCIL_ATTACHMENT:
            ...
            break;
        default:
            if (attachment > GL_COLOR_ATTACHMENT0 && attachment < static_cast<GLenum>(GL_COLOR_ATTACHMENT0 + maxColorAttachments()))
                break;
            synthesizeGLError(GL_INVALID_ENUM, functionName, "invalid attachment");
            return false;
        }
    ...
    GLenum pname)
{
    ...
    if (!framebufferBinding) {
        ...
        bool missingImage = (attachment == GL_DEPTH && !hasDepth) || (attachment == GL_STENCIL && !hasStencil);
        if (missingImage) {
            switch (pname) {
    ...
    long long* outDestinationByteLength)
{
    ...
    if (target == GL_TRANSFORM_FEEDBACK_BUFFER && m_currentProgram && m_currentProgram->activeTransformFeedbackCount()) {
        synthesizeGLError(GL_INVALID_OPERATION, functionName,
