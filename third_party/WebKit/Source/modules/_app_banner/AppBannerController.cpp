...
AppBannerController::AppBannerController(LocalFrame& frame)
    : m_frame(frame)
{
}
    ...
    const BannerPromptRequestCallback& callback)
{
    ...
    mojom::AppBannerPromptReply reply = m_frame->domWindow()->dispatchEvent(BeforeInstallPromptEvent::create(
