...
namespace {
    ...
    TEST(V8BindingTest, toImplArray)
    {
        ...
        }
        {
            ...
            NonThrowableExceptionState exceptionState;
            Vector<v8::Local<v8::Value>> v8HandleVector = toImplArray<Vector<v8::Local<v8::Value>>>(v8Array, 0, scope.isolate(),
                exceptionState);
        ...
        }
        {
            ...
            NonThrowableExceptionState exceptionState;
            Vector<Vector<String>> stringVectorVector = toImplArray<Vector<Vector<String>>>(v8StringArrayArray, 0,
