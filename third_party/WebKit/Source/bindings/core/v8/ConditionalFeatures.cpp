...
{
    InstallPendingConditionalFeatureFunction originalFunction = s_installPendingConditionalFeatureFunction;
    s_installPendingConditionalFeatureFunction = newInstallPendingConditionalFeatureFunction;
    return originalFunction;
}
    ...
    const LocalFrame* frame)
{
    ...
    bool enabledByDefault = (feature.defaultPolicy == FeaturePolicy::FeatureDefault::EnableForAll || (feature.defaultPolicy == FeaturePolicy::FeatureDefault::EnableForSelf && !frame->isCrossOriginSubframe()));
