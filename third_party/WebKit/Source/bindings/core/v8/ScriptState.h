...
public:
    ...
    static ScriptState* from(v8::Local<v8::Context> context)
    {
        ...
        ScriptState* scriptState = static_cast<ScriptState*>(context->GetAlignedPointerFromEmbedderData(
...
#if DCHECK_IS_ON()
    bool isGlobalObjectDetached() const
    {
        return m_globalObjectDetached;
    }
#endif

    V8PerContextData* perContextData() const
    {
        return m_perContextData.get();
    }
