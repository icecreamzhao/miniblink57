...
TEST(ScriptWrappableVisitorTest, ScriptWrappableVisitorTracesWrappers)
{
    ...
    ScriptWrappableVisitor* visitor = V8PerIsolateData::from(scope.isolate())->scriptWrappableVisitor();
    ...
    HeapObjectHeader* dependencyHeader = HeapObjectHeader::fromPayload(dependency);
    ...
    visitor->AdvanceTracing(
        0, v8::EmbedderHeapTracer::AdvanceTracingActions(v8::EmbedderHeapTracer::ForceCompletionAction::FORCE_COMPLETION));
...
TEST(ScriptWrappableVisitorTest, V8ReportsLiveObjectsDuringScavenger)
{
    ...
    v8::Local<v8::Value> wrapper = ToV8(object, scope.context()->Global(), isolate);
...
TEST(ScriptWrappableVisitorTest, NoWriteBarrierOnUnmarkedContainer)
{
    ...
    v8::Local<v8::String> str = v8::String::NewFromUtf8(scope.isolate(), "teststring",
