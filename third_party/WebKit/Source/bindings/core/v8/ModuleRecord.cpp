...
//     sprintf_s(output, 0x99, "ModuleRecord::ModuleRecord: this:%p, ScriptPromiseResolver:%p, %p\n", 
//         this, m_parentResolver.get(), m_parentResolver.get() ? m_parentResolver->getScriptState() : nullptr);
...
ModuleRecord::~ModuleRecord()
{
    ...
    if (m_parentResolver && m_parentResolver->getScriptState())
