    ...
    v8::ScriptCompiler::StreamedSource::Encoding* encoding)
{
    ...
    // the canonical names.
    if (strcmp(encodingName, "windows-1252") == 0 || strcmp(encodingName, "ISO-8859-1") == 0 || strcmp(encodingName, "US-ASCII") == 0) {
...
void ScriptStreamer::streamingCompleteOnBackgroundThread()
{
    ...
    m_loadingTaskRunner->postTask(
        BLINK_FROM_HERE, crossThreadBind(&ScriptStreamer::streamingComplete, wrapCrossThreadPersistent(this)));
...
void ScriptStreamer::notifyAppendData(ScriptResource* resource)
{
    ...
    if (!m_haveEnoughDataForStreaming) {
...

        {
            ...
            const size_t maximumLengthOfBOM = 4;
