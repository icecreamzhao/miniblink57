...
ScriptCustomElementDefinitionBuilder*
    ScriptCustomElementDefinitionBuilder::s_stack
    = nullptr;
...
bool ScriptCustomElementDefinitionBuilder::checkConstructorNotRegistered()
{
    ...
    for (auto builder = m_prev; builder; builder = builder->m_prev) {
        ...
        if (m_registry != builder->m_registry || m_constructor != builder->m_constructor) {
            continue;
        }
        m_exceptionState.throwDOMException(
            NotSupportedError,
...
bool ScriptCustomElementDefinitionBuilder::rememberOriginalProperties()
{
    ...
    return callableForName("connectedCallback", m_connectedCallback) && callableForName("disconnectedCallback", m_disconnectedCallback) && callableForName("adoptedCallback", m_adoptedCallback) && callableForName("attributeChangedCallback", m_attributeChangedCallback) && (m_attributeChangedCallback.IsEmpty() || retrieveObservedAttributes());
}
