...
TEST_F(ActivityLoggerTest, EventHandler)
{
    ...
    const char* expectedActivities = "blinkAddEventListener | A | click\n"
                                     "blinkAddElement | a | \n"
...
TEST_F(ActivityLoggerTest, ScriptElement)
{
    const char* code = "document.body.innerHTML = '<script "
                       ...
                       "document.close();";
    const char* expectedActivities = "blinkAddElement | script | data:text/javascript;charset=utf-8,\n"
...
TEST_F(ActivityLoggerTest, IFrameElement)
{
    const char* code = "document.body.innerHTML = '<iframe "
                       ...
                       "document.close();";
    const char* expectedActivities = "blinkAddElement | iframe | data:text/html;charset=utf-8,\n"
...
TEST_F(ActivityLoggerTest, AnchorElement)
{
    const char* code = "document.body.innerHTML = '<a "
                       ...
                       "document.close();";
    const char* expectedActivities = "blinkAddElement | a | data:text/css;charset=utf-8,\n"
                                     "blinkAddElement | a | \n"
                                     "blinkAddElement | a | \n"
...
TEST_F(ActivityLoggerTest, LinkElement)
{
    const char* code = "document.body.innerHTML = '<link rel=\\\'stylesheet\\\' "
                       ...
                       "document.close();";
    const char* expectedActivities = "blinkAddElement | link | stylesheet | data:text/css;charset=utf-8,\n"
...
TEST_F(ActivityLoggerTest, InputElement)
{
    const char* code = "document.body.innerHTML = '<input type=\\\'submit\\\' "
                       ...
                       "document.close();";
    const char* expectedActivities = "blinkAddElement | input | submit | data:text/html;charset=utf-8,\n"
...
TEST_F(ActivityLoggerTest, ButtonElement)
{
    const char* code = "document.body.innerHTML = '<button type=\\\'submit\\\' "
                       ...
                       "document.close();";
    const char* expectedActivities = "blinkAddElement | button | submit | post | "
...
TEST_F(ActivityLoggerTest, FormElement)
{
    const char* code = "document.body.innerHTML = '<form method=\\\'post\\\' "
                       ...
                       "document.close();";
    const char* expectedActivities = "blinkAddElement | form | post | data:text/html;charset=utf-8,\n"
...
TEST_F(ActivityLoggerTest, ScriptSrcAttribute)
{
    ...
    const char* expectedActivities = "blinkAddElement | script | data:text/javascript;charset=utf-8,A\n"
...
TEST_F(ActivityLoggerTest, IFrameSrcAttribute)
{
    ...
    const char* expectedActivities = "blinkAddElement | iframe | data:text/html;charset=utf-8,A\n"
...
TEST_F(ActivityLoggerTest, AnchorHrefAttribute)
{
    ...
    const char* expectedActivities = "blinkAddElement | a | data:text/html;charset=utf-8,A\n"
...
TEST_F(ActivityLoggerTest, LinkHrefAttribute)
{
    ...
    const char* expectedActivities = "blinkAddElement | link | stylesheet | data:text/css;charset=utf-8,A\n"
...
TEST_F(ActivityLoggerTest, InputFormActionAttribute)
{
    ...
    const char* expectedActivities = "blinkAddElement | input | button | data:text/html;charset=utf-8,A\n"
...
TEST_F(ActivityLoggerTest, FormActionAttribute)
{
    ...
    const char* expectedActivities = "blinkAddElement | form |  | data:text/html;charset=utf-8,A\n"
...
TEST_F(ActivityLoggerTest, LocalDOMWindowAttribute)
{
    ...
    const char* expectedActivities = "blinkSetAttribute | LocalDOMWindow | url | about:blank | "
                                     "data:text/html;charset=utf-8,A\n"
