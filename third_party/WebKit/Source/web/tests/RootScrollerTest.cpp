...
namespace {
    ...
    TEST_F(RootScrollerTest, TestDefaultRootScroller)
    {
        ...
        RootScrollerController& controller = mainFrame()->document()->rootScrollerController();
    ...
    TEST_F(RootScrollerTest, TestSetRootScroller)
    {
...

        {
            ...
            EXPECT_CALL(client, didOverscroll(WebFloatSize(0, 20), WebFloatSize(0, 70), WebFloatPoint(100, 100), WebFloatSize()));
            webViewImpl()->handleInputEvent(
...

        {
            ...
            EXPECT_CALL(client, didOverscroll(WebFloatSize(0, 30), WebFloatSize(0, 30), WebFloatPoint(100, 100), WebFloatSize()));
            webViewImpl()->handleInputEvent(
    ...
    TEST_F(RootScrollerTest, TestSetRootScrollerOnElementInIframe)
    {
...

        {
            ...
            Element* innerContainer = iframe->contentDocument()->getElementById("container");
    ...
    TEST_F(RootScrollerTest, SetRootScrollerIframeUsesCorrectLayerAndCallback)
    {
        ...
        const TopDocumentRootScrollerController& mainController = mainFrame()->document()->frameHost()->globalRootScrollerController();
        ...
        // scroller.
        {
            ...
            ScrollableArea* containerScroller = static_cast<PaintInvalidationCapableScrollableArea*>(
    ...
    TEST_F(RootScrollerTest, RemoveClippingOnCompositorLayers)
    {
        ...
        RootScrollerController& mainController = mainFrame()->document()->rootScrollerController();
        RootScrollerController& childController = iframe->contentDocument()->rootScrollerController();
        TopDocumentRootScrollerController& globalController = frameHost().globalRootScrollerController();
    ...
    TEST_F(RootScrollerTest, BrowserControlsResizeClippingLayerIFrame)
    {
        ...
        Element* iframe = mainFrame()->document()->getElementById("iframe");
        LocalFrame* childFrame = toLocalFrame(toHTMLFrameOwnerElement(iframe)->contentFrame());

        PaintLayerCompositor* childPLC = childFrame->view()->layoutViewItem().compositor();
        ...
        // Give the iframe itself scrollable content and make it the root scroller.
        {
            ...
            WebLocalFrame* childWebFrame = mainWebFrame()->firstChild()->toWebLocalFrame();
            executeScript(
    ...
    TEST_F(RootScrollerTest, DocumentElementHasNoLayoutObject)
    {
        ...
        const TopDocumentRootScrollerController& globalController = mainFrame()->document()->frameHost()->globalRootScrollerController();
