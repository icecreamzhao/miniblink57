...
public:
    ...
    void clearUnusedSlots(T* from, T* to)
    {
        ...
        VectorUnusedSlotClearer<
            Allocator::isGarbageCollected && (VectorTraits<T>::needsDestruction || IsTraceableInCollectionTrait<VectorTraits<T>>::value),
            T>::clear(from, to);
    }
    ...
    struct OffsetRange final {
        ...
        explicit OffsetRange(size_t begin, size_t end)
            : begin(begin)
            , end(end)
        {
            DCHECK_LE(begin, end);
