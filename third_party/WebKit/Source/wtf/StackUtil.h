...
namespace internal {
    ...
    inline WTF_EXPORT bool mayNotBeMainThread()
    {
        ...
        static uintptr_t s_mainThreadStackStart = reinterpret_cast<uintptr_t>(getStackStart()) - sizeof(void*);
        static uintptr_t s_mainThreadUnderestimatedStackSize = mainThreadUnderestimatedStackSize();
        uintptr_t dummy;
