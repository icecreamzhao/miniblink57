...
namespace Unicode {
    ...
    {
        const uint test = U_MASK(QChar::Other_Control) | U_MASK(QChar::Other_NotAssigned);
    ...
    {
        const uint test = U_MASK(QChar::Punctuation_Connector) | U_MASK(QChar::Punctuation_Dash) | U_MASK(QChar::Punctuation_Open) | U_MASK(QChar::Punctuation_Close) | U_MASK(QChar::Punctuation_InitialQuote) | U_MASK(QChar::Punctuation_FinalQuote) | U_MASK(QChar::Punctuation_Other);
        return U_MASK(QChar::category(uint32_t(c))) & test;
    }
    ...
    {
        return (CharDecompositionType)QChar::decompositionTag(c);
    }
    ...
    {
        return (CharDirection)QChar::direction(uint32_t(c));
    }
