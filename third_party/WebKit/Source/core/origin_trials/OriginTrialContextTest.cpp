...
TEST_F(OriginTrialContextTest, EnabledNonExistingTrial)
{
    tokenValidator()->setResponse(WebOriginTrialTokenStatus::Success,
        kFrobulateTrialName);
    bool isNonExistingTrialEnabled = isTrialEnabled(kFrobulateEnabledOrigin, kNonExistingTrialName);
...
TEST_F(OriginTrialContextTest, EnabledSecureRegisteredOrigin)
{
    tokenValidator()->setResponse(WebOriginTrialTokenStatus::Success,
        kFrobulateTrialName);
    bool isOriginEnabled = isTrialEnabled(kFrobulateEnabledOrigin, kFrobulateTrialName);
...
TEST_F(OriginTrialContextTest, EnabledNonSecureRegisteredOrigin)
{
    tokenValidator()->setResponse(WebOriginTrialTokenStatus::Success,
        kFrobulateTrialName);
    bool isOriginEnabled = isTrialEnabled(kFrobulateEnabledOriginUnsecure, kFrobulateTrialName);
    EXPECT_FALSE(isOriginEnabled);
