...
#define CHECK_VISUAL_RECT(expected, sourceLayoutObject, ancestorLayoutObject,                              \
    ...
    do {                                                                                                   \
        ...
        const auto& contentsProperties = *(ancestorLayoutObject)->paintProperties()->contentsProperties(); \
        LayoutRect actual = LayoutRect(geometryMapper.sourceToDestinationVisualRect(                       \
            FloatRect(source), *(sourceLayoutObject)->paintProperties()->localBorderBoxProperties(),       \
            contentsProperties));                                                                          \
...
TEST_P(PaintPropertyTreeBuilderTest, FixedPosition)
{
    ...
    const ObjectPaintProperties* target1Properties = target1->layoutObject()->paintProperties();
    ...
    // positionedScroll's.
    const ObjectPaintProperties* positionedScrollProperties = positionedScroll->layoutObject()->paintProperties();
    ...
    const ObjectPaintProperties* target2Properties = target2->layoutObject()->paintProperties();
    Element* scroller = document().getElementById("transformedScroll");
    const ObjectPaintProperties* scrollerProperties = scroller->layoutObject()->paintProperties();
    EXPECT_EQ(FloatRoundedRect(200, 150, 100, 100),
    ...
    // transformedScroll's.
    const ObjectPaintProperties* transformedScrollProperties = transformedScroll->layoutObject()->paintProperties();
...
TEST_P(PaintPropertyTreeBuilderTest, PositionAndScroll)
{
    ...
    const ObjectPaintProperties* relPosProperties = relPos->layoutObject()->paintProperties();
    ...
    const ObjectPaintProperties* absPosProperties = absPos->layoutObject()->paintProperties();
...
TEST_P(PaintPropertyTreeBuilderTest, Perspective)
{
    ...
    const ObjectPaintProperties* perspectiveProperties = perspective->layoutObject()->paintProperties();
    ...
    const ObjectPaintProperties* innerProperties = inner->layoutObject()->paintProperties();
...
TEST_P(PaintPropertyTreeBuilderTest, Transform)
{
    ...
    const ObjectPaintProperties* transformProperties = transform->layoutObject()->paintProperties();
...
TEST_P(PaintPropertyTreeBuilderTest, Preserve3D3DTransformedDescendant)
{
    ...
    const ObjectPaintProperties* preserveProperties = preserve->layoutObject()->paintProperties();
...
TEST_P(PaintPropertyTreeBuilderTest, RelativePositionInline)
{
    ...
    const ObjectPaintProperties* inlineBlockProperties = inlineBlock->layoutObject()->paintProperties();
...
TEST_P(PaintPropertyTreeBuilderTest, NestedOpacityEffect)
{
    ...
    const ObjectPaintProperties* nodeWithoutOpacityProperties = nodeWithoutOpacity->paintProperties();
    ...
    const ObjectPaintProperties* childWithOpacityProperties = childWithOpacity->paintProperties();
    ...
    const ObjectPaintProperties* greatGrandChildWithOpacityProperties = greatGrandChildWithOpacity->paintProperties();
...
TEST_P(PaintPropertyTreeBuilderTest, TransformNodeDoesNotAffectEffectNodes)
{
    ...
    const ObjectPaintProperties* nodeWithOpacityProperties = nodeWithOpacity->paintProperties();
    ...
    const ObjectPaintProperties* childWithTransformProperties = childWithTransform->paintProperties();
    ...
    const ObjectPaintProperties* grandChildWithOpacityProperties = grandChildWithOpacity->paintProperties();
...
TEST_P(PaintPropertyTreeBuilderTest, EffectNodesAcrossStackingContext)
{
    ...
    const ObjectPaintProperties* childWithStackingContextProperties = childWithStackingContext->paintProperties();
...
TEST_P(PaintPropertyTreeBuilderTest, EffectNodesInSVG)
{
    ...
    const ObjectPaintProperties* groupWithOpacityProperties = groupWithOpacity->paintProperties();
    ...
    const ObjectPaintProperties* rectWithoutOpacityProperties = rectWithoutOpacity.paintProperties();
    ...
    const ObjectPaintProperties* rectWithOpacityProperties = rectWithOpacity.paintProperties();
    ...
    const ObjectPaintProperties* textWithOpacityProperties = textWithOpacity.paintProperties();
    ...
    const ObjectPaintProperties* tspanWithOpacityProperties = tspanWithOpacity.paintProperties();
...
TEST_P(PaintPropertyTreeBuilderTest, EffectNodesAcrossHTMLSVGBoundary)
{
    ...
    const ObjectPaintProperties* divWithOpacityProperties = divWithOpacity.paintProperties();
    ...
    const ObjectPaintProperties* svgRootWithOpacityProperties = svgRootWithOpacity.paintProperties();
...
TEST_P(PaintPropertyTreeBuilderTest, EffectNodesAcrossSVGHTMLBoundary)
{
    ...
    const ObjectPaintProperties* foreignObjectWithOpacityProperties = foreignObjectWithOpacity.paintProperties();
    ...
    const ObjectPaintProperties* spanWithOpacityProperties = spanWithOpacity.paintProperties();
...
TEST_P(PaintPropertyTreeBuilderTest, TransformNodesInSVG)
{
    ...
    const ObjectPaintProperties* svgRootWith3dTransformProperties = svgRootWith3dTransform.paintProperties();
    ...
    const ObjectPaintProperties* rectWith2dTransformProperties = rectWith2dTransform.paintProperties();
...
TEST_P(PaintPropertyTreeBuilderTest, SVGViewBoxTransform)
{
    ...
    const ObjectPaintProperties* svgWithViewBoxProperties = svgWithViewBox.paintProperties();
    EXPECT_EQ(TransformationMatrix().translate3d(1, 2, 3),
...
TEST_P(PaintPropertyTreeBuilderTest, SVGNestedViewboxTransforms)
{
    ...
    const ObjectPaintProperties* nestedSvgProperties = nestedSvg.paintProperties();
...
TEST_P(PaintPropertyTreeBuilderTest, TransformNodesAcrossSVGHTMLBoundary)
{
    ...
    const ObjectPaintProperties* svgWithTransformProperties = svgWithTransform.paintProperties();
    EXPECT_EQ(TransformationMatrix().translate3d(1, 2, 3),
    ...
    const ObjectPaintProperties* divWithTransformProperties = divWithTransform.paintProperties();
    ...
    FixedTransformAncestorAcrossSVGHTMLBoundary)
{
    ...
    const ObjectPaintProperties* containerProperties = container.paintProperties();
    ...
    const ObjectPaintProperties* fixedProperties = fixed->layoutObject()->paintProperties();
...
TEST_P(PaintPropertyTreeBuilderTest, TransformNodesAcrossSubframes)
{
    ...
    LayoutObject* innerDivWithTransform = childDocument().getElementById("innerDivWithTransform")->layoutObject();
    const ObjectPaintProperties* innerDivWithTransformProperties = innerDivWithTransform->paintProperties();
...
TEST_P(PaintPropertyTreeBuilderTest, TransformNodesInTransformedSubframes)
{
    ...
    LayoutObject* innerDivWithTransform = childDocument().getElementById("transform")->layoutObject();
    auto* innerDivTransform = innerDivWithTransform->paintProperties()->transform();
...
TEST_P(PaintPropertyTreeBuilderTest, SvgPixelSnappingShouldResetPaintOffset)
{
    ...
    const ObjectPaintProperties* rectWithTransformProperties = rectWithTransform.paintProperties();
    EXPECT_EQ(TransformationMatrix().translate(1, 1),
...
TEST_P(PaintPropertyTreeBuilderTest, NoRenderingContextByDefault)
{
    ...
    const ObjectPaintProperties* properties = document().body()->firstChild()->layoutObject()->paintProperties();
...
TEST_P(PaintPropertyTreeBuilderTest, CachedProperties)
{
    ...
    const ObjectPaintProperties* aProperties = a->layoutObject()->paintProperties();
    ...
    const ObjectPaintProperties* bProperties = b->layoutObject()->paintProperties();
    ...
    const ObjectPaintProperties* cProperties = c->layoutObject()->paintProperties();
...
TEST_P(PaintPropertyTreeBuilderTest, OverflowScrollWithRoundedRect)
{
    ...
    const ObjectPaintProperties* roundedBoxProperties = roundedBox.paintProperties();
    EXPECT_EQ(
    ...
    SvgLocalToBorderBoxTransformContentsTreeState)
{
    ...
    const auto& contentsProperties = *svgWithViewBoxProperties->contentsProperties();
...
TEST_P(PaintPropertyTreeBuilderTest, OverflowHiddenScrollProperties)
{
    ...
    const ObjectPaintProperties* overflowHiddenScrollProperties = overflowHidden->layoutObject()->paintProperties();
...
TEST_P(PaintPropertyTreeBuilderTest, NestedScrollProperties)
{
    ...
    const ObjectPaintProperties* overflowAScrollProperties = overflowA->layoutObject()->paintProperties();
    ...
    const ObjectPaintProperties* overflowBScrollProperties = overflowB->layoutObject()->paintProperties();
...
TEST_P(PaintPropertyTreeBuilderTest, PositionedScrollerIsNotNested)
{
    ...
    const ObjectPaintProperties* overflowScrollProperties = overflow->layoutObject()->paintProperties();
    ...
    const ObjectPaintProperties* absposOverflowScrollProperties = absposOverflow->layoutObject()->paintProperties();
    ...
    const ObjectPaintProperties* fixedOverflowScrollProperties = fixedOverflow->layoutObject()->paintProperties();
...
TEST_P(PaintPropertyTreeBuilderTest, SVGRootClip)
{
    ...
    const ClipPaintPropertyNode* clip = getLayoutObjectByElementId("svg")->paintProperties()->overflowClip();
...
TEST_P(PaintPropertyTreeBuilderTest, SimpleFilter)
{
    setBodyInnerHTML(
        ...
        "</div>");
    const ObjectPaintProperties* filterProperties = getLayoutObjectByElementId("filter")->paintProperties();
...
TEST_P(PaintPropertyTreeBuilderTest, FilterReparentClips)
{
    setBodyInnerHTML(
        ...
        "  </div>"
        "</div>");
    const ObjectPaintProperties* clipProperties = getLayoutObjectByElementId("clip")->paintProperties();
    const ObjectPaintProperties* filterProperties = getLayoutObjectByElementId("filter")->paintProperties();
    EXPECT_TRUE(filterProperties->effect()->parent()->isRoot());
    EXPECT_EQ(frameScrollTranslation(),
        filterProperties->effect()->localTransformSpace());
    ...
    const PropertyTreeState& childPaintState = *getLayoutObjectByElementId("child")
                                                    ->paintProperties()
...
TEST_P(PaintPropertyTreeBuilderTest, FloatUnderInline)
{
    ...
    const auto* localBorderBoxProperties = target->paintProperties()->localBorderBoxProperties();
