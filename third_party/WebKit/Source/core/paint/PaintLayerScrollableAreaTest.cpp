...
public:
    ...
    {
        PaintLayer* paintLayer = toLayoutBoxModelObject(getLayoutObjectByElementId(elementId))->layer();
...
TEST_F(PaintLayerScrollableAreaTest, OverlayScrollbarColorThemeUpdated)
{
    ...
    PaintLayer* whiteLayer = toLayoutBoxModelObject(white->layoutObject())->layer();
    PaintLayer* blackLayer = toLayoutBoxModelObject(black->layoutObject())->layer();
...
TEST_F(PaintLayerScrollableAreaTest, HideTooltipWhenScrollPositionChanges)
{
    ...
    Element* scroller = document().getElementById("scroller");
    PaintLayerScrollableArea* scrollableArea = toLayoutBoxModelObject(scroller->layoutObject())->getScrollableArea();
