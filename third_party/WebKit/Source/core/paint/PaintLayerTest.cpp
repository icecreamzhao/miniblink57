...
TEST_P(PaintLayerTest, CompositedBoundsAbsPosGrandchild)
{
    ...
    PaintLayer* parentLayer = toLayoutBoxModelObject(getLayoutObjectByElementId("parent"))->layer();
...
TEST_P(PaintLayerTest, PaintingExtentReflection)
{
    ...
    PaintLayer* layer = toLayoutBoxModelObject(getLayoutObjectByElementId("target"))->layer();
    EXPECT_EQ(
...
TEST_P(PaintLayerTest, ScrollsWithViewportFixedPositionInsideTransform)
{
    ...
    if (RuntimeEnabledFeatures::slimmingPaintV2Enabled() && !RuntimeEnabledFeatures::rootLayerScrollingEnabled())
        return;
    setBodyInnerHTML(
...
TEST_P(PaintLayerTest, CompositedScrollingNoNeedsRepaint)
{
    ...
    PaintLayer* scrollLayer = toLayoutBoxModelObject(getLayoutObjectByElementId("scroll"))->layer();
    EXPECT_EQ(PaintsIntoOwnBacking, scrollLayer->compositingState());

    PaintLayer* contentLayer = toLayoutBoxModelObject(getLayoutObjectByElementId("content"))->layer();
...
TEST_P(PaintLayerTest, HasNonIsolatedDescendantWithBlendMode)
{
    setBodyInnerHTML(
        ...
        "  </div>"
        "</div>");
    PaintLayer* stackingGrandparent = toLayoutBoxModelObject(getLayoutObjectByElementId("stacking-grandparent"))
                                          ->layer();
    PaintLayer* stackingParent = toLayoutBoxModelObject(getLayoutObjectByElementId("stacking-parent"))
                                     ->layer();
    PaintLayer* parent = toLayoutBoxModelObject(getLayoutObjectByElementId("non-stacking-parent"))
                             ->layer();
...
TEST_P(PaintLayerTest, HasDescendantWithClipPath)
{
    setBodyInnerHTML(
        ...
        "  </div>"
        "</div>");
    PaintLayer* parent = toLayoutBoxModelObject(getLayoutObjectByElementId("parent"))->layer();
    PaintLayer* clipPath = toLayoutBoxModelObject(getLayoutObjectByElementId("clip-path"))->layer();
...
TEST_P(PaintLayerTest, HasVisibleDescendant)
{
    ...
    setBodyInnerHTML(
        ...
        "  </div>"
        "</div>");
    PaintLayer* invisible = toLayoutBoxModelObject(getLayoutObjectByElementId("invisible"))->layer();
    PaintLayer* visible = toLayoutBoxModelObject(getLayoutObjectByElementId("visible"))->layer();
...
TEST_P(PaintLayerTest, Has3DTransformedDescendant)
{
    ...
    setBodyInnerHTML(
        ...
        "</div>");
    PaintLayer* parent = toLayoutBoxModelObject(getLayoutObjectByElementId("parent"))->layer();
    PaintLayer* child = toLayoutBoxModelObject(getLayoutObjectByElementId("child"))->layer();
...
TEST_P(PaintLayerTest, Has3DTransformedGrandchildWithPreserve3d)
{
    ...
    PaintLayer* parent = toLayoutBoxModelObject(getLayoutObjectByElementId("parent"))->layer();
    PaintLayer* child = toLayoutBoxModelObject(getLayoutObjectByElementId("child"))->layer();
    PaintLayer* grandchild = toLayoutBoxModelObject(getLayoutObjectByElementId("grandchild"))->layer();
...
TEST_P(PaintLayerTest, CompositingContainerFloat)
{
    ...
    PaintLayer* target = toLayoutBoxModelObject(getLayoutObjectByElementId("target"))->layer();
    PaintLayer* span = toLayoutBoxModelObject(getLayoutObjectByElementId("span"))->layer();
    EXPECT_EQ(span, target->compositingContainer());
    PaintLayer* compositedContainer = toLayoutBoxModelObject(getLayoutObjectByElementId("compositedContainer"))
                                          ->layer();
...
TEST_P(PaintLayerTest, FloatLayerAndAbsoluteUnderInlineLayer)
{
    ...
    PaintLayer* floating = toLayoutBoxModelObject(getLayoutObjectByElementId("floating"))->layer();
    PaintLayer* absolute = toLayoutBoxModelObject(getLayoutObjectByElementId("absolute"))->layer();
    PaintLayer* span = toLayoutBoxModelObject(getLayoutObjectByElementId("span"))->layer();
    PaintLayer* container = toLayoutBoxModelObject(getLayoutObjectByElementId("container"))->layer();
...
TEST_P(PaintLayerTest, FloatLayerUnderBlockUnderInlineLayer)
{
    ...
    EXPECT_EQ(LayoutPoint(183, 183), floating->visualOffsetFromAncestor(document().layoutView()->layer()));
}
...
TEST_P(PaintLayerTest, FloatLayerUnderFloatUnderInlineLayer)
{
    ...
    EXPECT_EQ(LayoutPoint(83, 83), floating->visualOffsetFromAncestor(document().layoutView()->layer()));
}
...
TEST_P(PaintLayerTest, FloatLayerUnderFloatLayerUnderInlineLayer)
{
    ...
    PaintLayer* floating = toLayoutBoxModelObject(getLayoutObjectByElementId("floating"))->layer();
    PaintLayer* floatingParent = toLayoutBoxModelObject(getLayoutObjectByElementId("floatingParent"))
                                     ->layer();
    PaintLayer* span = toLayoutBoxModelObject(getLayoutObjectByElementId("span"))->layer();
...
TEST_P(PaintLayerTest, CompositingContainerFloatingIframe)
{
    ...
    // stacked.
    PaintLayer* containingBlock = toLayoutBoxModelObject(getLayoutObjectByElementId("containingBlock"))
                                      ->layer();
