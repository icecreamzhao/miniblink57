...
enum IncludeSelfOrNot { IncludeSelf,
    ExcludeSelf };
...
public:
    ...
    {
        return layoutObject()->isTransparent() || layoutObject()->style()->hasBlendMode() || layoutObject()->hasMask();
    }
    ...
    {
        return m_rareData && m_rareData->transform && !m_rareData->transform->isAffine();
    }
    ...
    {
        return !layoutObject()->hasReflection() && layoutObject()->style()->preserves3D();
    }
    ...
    {
        DCHECK(reasons == (reasons & CompositingReasonComboAllStyleDeterminedReasons));
    ...
    {
        return potentialCompositingReasonsFromStyle() & CompositingReasonComboAllDirectStyleDeterminedReasons;
    }
    ...
    {
        return m_needsPaintPhaseDescendantOutlines && !m_previousPaintPhaseDescendantOutlinesWasEmpty;
    }
    ...
    {
        return m_needsPaintPhaseDescendantBlockBackgrounds && !m_previousPaintPhaseDescendantBlockBackgroundsWasEmpty;
    }
