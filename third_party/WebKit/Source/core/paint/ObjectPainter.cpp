    ...
    const LayoutPoint& paintOffset)
{
    ...
    if (!styleToUse.hasOutline() || styleToUse.visibility() != EVisibility::kVisible)
        return;
    ...
    const LayoutPoint& paintOffset)
{
    ...
    if (m_layoutObject.isElementContinuation() || !m_layoutObject.node() || !m_layoutObject.node()->isLink() || m_layoutObject.styleRef().visibility() != EVisibility::kVisible)
        return;
