...
enum PaintLayerFlag {
    ...
    PaintLayerPaintingCompositingAllPhases = (PaintLayerPaintingCompositingBackgroundPhase | PaintLayerPaintingCompositingForegroundPhase | PaintLayerPaintingCompositingMaskPhase | PaintLayerPaintingCompositingDecorationPhase)
};
