...
public:
    ...
    struct Style {
        ...
        {
            return currentColor == other.currentColor && fillColor == other.fillColor && strokeColor == other.strokeColor && emphasisMarkColor == other.emphasisMarkColor && strokeWidth == other.strokeWidth && shadow == other.shadow;
        }
    ...
    enum RotationDirection { Counterclockwise,
        Clockwise };
...
private:
    ...
    enum PaintInternalStep { PaintText,
        PaintEmphasisMark };
