    ...
    const LayoutPoint& paintOffset)
{
    ...
    const SimpleFontData* fontData = m_layoutListMarker.style()->font().primaryFont();
    ...
    TextRun suffixRun = constructTextRun(font, suffixStr, 2, m_layoutListMarker.styleRef(),
