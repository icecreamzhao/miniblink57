    ...
    const LayoutPoint& paintOffset)
{
    ...
    if (RuntimeEnabledFeatures::slimmingPaintV2Enabled() && canvas->renderingContext() && canvas->renderingContext()->isAccelerated()) {
    ...
    InterpolationQuality interpolationQuality = m_layoutHTMLCanvas.style()->imageRendering() == ImageRenderingOptimizeContrast
        ? InterpolationLow
