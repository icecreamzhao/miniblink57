    ...
    ExceptionState& exceptionState)
{
    ...
    if (other.hasIs2D() && other.is2D() && (other.m31() || other.m32() || other.m13() || other.m23() || other.m43() || other.m14() || other.m24() || other.m34() || other.m33() != 1 || other.m44() != 1)) {
    ...
    if (!other.hasIs2D()) {
        bool is2D = !(other.m31() || other.m32() || other.m13() || other.m23() || other.m43() || other.m14() || other.m24() || other.m34() || other.m33() != 1 || other.m44() != 1);
        other.setIs2D(is2D);
    }
    return true;
}
...
DOMPoint* DOMMatrixReadOnly::transformPoint(const DOMPointInit& point)
{
    ...
    double x = point.x() * m11() + point.y() * m21() + point.z() * m31() + point.w() * m41();
    double y = point.x() * m12() + point.y() * m22() + point.z() * m32() + point.w() * m42();
    double z = point.x() * m13() + point.y() * m23() + point.z() * m33() + point.w() * m43();
    double w = point.x() * m14() + point.y() * m24() + point.z() * m34() + point.w() * m44();
    ...
    ExceptionState& exceptionState)
{
    ...
    const CSSValue* value = CSSParser::parseSingleValue(CSSPropertyTransform, string);
    ...
    TransformOperations operations = TransformBuilder::createTransformOperations(
        *value, CSSToLengthConversionData(&initialStyle, &initialStyle, LayoutViewItem(nullptr), 1.0f));
