    ...
    Document& document)
{
    ...
    HTMLElement* element = HTMLElement::create(QualifiedName(nullAtom, descriptor().localName(),
...
CustomElementDefinition::ConstructionStackScope::~ConstructionStackScope()
{
    ...
    DCHECK(!m_constructionStack.back() || m_constructionStack.back() == m_element);
...
{
    CustomElementReaction* reaction = new CustomElementAdoptedCallbackReaction(this, oldDocument, newDocument);
