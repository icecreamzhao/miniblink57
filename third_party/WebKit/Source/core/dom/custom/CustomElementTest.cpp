    ...
    CreateElement_TagNameCaseHandlingCreatingCustomElement)
{
    ...
    CustomElementRegistry* registry = holder->frame().domWindow()->customElements();
    ...
    CustomElementDefinition* definition = registry->definitionFor(CustomElementDescriptor("a-a", "a-a"));
