...
{
    IdleDeadline* deadline = IdleDeadline::create(1.25, IdleDeadline::CallbackType::CalledWhenIdle);
...
{
    IdleDeadline* deadline = IdleDeadline::create(0.75, IdleDeadline::CallbackType::CalledWhenIdle);
