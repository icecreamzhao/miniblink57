...
{
    const char* mainHTML = "<div id='m0'>"
                           "<span id='m00'>m00</span>"
                           "<span id='m01'>m01</span>"
                           "</div>";
    const char* shadowHTML = "<a id='s00'>s00</a>"
...
TEST_F(FlatTreeTraversalTest, commonAncestor)
{
    ...
    const char* mainHTML = "<a id='m0'><b id='m00'>m00</b><b id='m01'>m01</b></a>"
                           "<a id='m1'>"
                           "<b id='m10'>m10</b>"
                           "<b id='m11'>m11</b>"
                           "<b id='m12'>m12</b>"
    ...
    const char* shadowHTML = "<a id='s10'>s10</a>"
...
{
    const char* mainHTML = "<div id='m0'>m0</div>"
                           "<div id='m1'>"
...
TEST_F(FlatTreeTraversalTest, redistribution)
{
    const char* mainHTML = "<div id='m0'>m0</div>"
                           ...
                           "</div>"
                           "<div id='m2'>m2</div>";
    const char* shadowHTML1 = "<div id='s1'>"
                              "<content></content>"
                              "</div>";

    setupSampleHTML(mainHTML, shadowHTML1, 1);

    const char* shadowHTML2 = "<div id='s2'>"
                              "<content select='#m10'></content>"
...
{
    const char* mainHTML = "<div id='host'>"
                           "<div id='child1' slot='slot1'></div>"
                           "<div id='child2' slot='slot2'></div>"
                           "</div>";
    const char* shadowHTML = "<div id='shadow-child1'></div>"
...
TEST_F(FlatTreeTraversalTest, v1Redistribution)
{
    const char* mainHTML = "<div id='d1'>"
                           ...
                           "</div>"
                           "<div id='d6'></div>";
    const char* shadowHTML1 = "<div id='d1-1'>"
                              "<div id='d1-2'></div>"
                              "<slot id='d1-s0'></slot>"
                              ...
                              "</div>";
    const char* shadowHTML2 = "<div id='d1-1-1'></div>"
...
{
    const char* mainHTML = "<div id='parent'>"
                           "<slot>"
                           "<div id='child1'></div>"
                           "<div id='child2'></div>"
                           "</slot>"
