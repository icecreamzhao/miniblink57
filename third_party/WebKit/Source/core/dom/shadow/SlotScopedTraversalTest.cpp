...
TEST_F(SlotScopedTraversalTest, simpleSlot)
{
    ...
    EXPECT_EQ(inner1, SlotScopedTraversal::nearestInclusiveAncestorAssignedToSlot(*inner1));
    EXPECT_EQ(inner2, SlotScopedTraversal::nearestInclusiveAncestorAssignedToSlot(*inner2));
...
TEST_F(SlotScopedTraversalTest, multipleSlots)
{
    ...
    const char* shadowHTML = "<slot id='unnamedslot'></slot>"
