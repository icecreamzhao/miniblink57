...
public:
    ...
    bool isDefaultInlineNode() const;
#endif
    ...
    enum class AttributeModificationReason { kDirectly,
        kByParser,
        kByCloning };
...
#endif
        void
        recalcStyle(StyleRecalcChange, Text* nextTextSibling = nullptr);
    ...
    {
        return !(static_cast<int>(getCustomElementState()) & static_cast<int>(CustomElementState::NotDefinedFlag));
    }
