...
enum DynamicRestyleFlags {
    ...
    ChildrenAffectedByStructuralRules = ChildrenAffectedByFirstChildRules | ChildrenAffectedByLastChildRules | ChildrenAffectedByDirectAdjacentRules | ChildrenAffectedByIndirectAdjacentRules | ChildrenAffectedByForwardPositionalRules | ChildrenAffectedByBackwardPositionalRules
};
