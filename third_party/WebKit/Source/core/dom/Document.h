...
enum ShadowCascadeOrder { ShadowCascadeNone,
    ShadowCascadeV0,
    ShadowCascadeV1 };
...
public:
    ...
    {
        return m_documentClasses & WMLDocumentClass;
    }
    ...
    enum StandaloneStatus { StandaloneUnspecified,
        Standalone,
        NotStandalone };
    ...
    // restored.
    enum PrintingState { NotPrinting,
        Printing,
        FinishingPrinting };
    ...
    enum CompatibilityMode { QuirksMode,
        LimitedQuirksMode,
        NoQuirksMode };
    ...
    enum DocumentReadyState { Loading,
        Interactive,
        Complete };
    ...
    */
    ...
    enum HttpRefreshType { HttpRefreshFromHeader,
    ...
    bool needFitScreenLayout() const
    {
        return m_needFitScreenLayout;
    }

    void setNeedFitScreenLayout(bool b)
    {
        if (m_needFitScreenLayout != b && !b)
            initialIframeIntrinsicSize();
        m_needFitScreenLayout = b;
    }

    bool isSpecialSite() const { return m_isSpecialSite; }
    void setIsSpecialSite(bool b) { m_isSpecialSite = b; }

    void initialIframeIntrinsicSize();
#endif
...
#ifdef TENCENT_FITSCREEN
    bool m_needFitScreenLayout = false;
    bool m_X5NightModeEnabled = false;
    bool m_isSpecialSite = false;
#endif

#if ENABLE_WML
    bool m_containsWMLContent = false;
#endif
};
