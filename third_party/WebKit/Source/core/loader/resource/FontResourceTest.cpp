...
TEST_F(FontResourceTest, CacheAwareFontLoading)
{
    ...
    Persistent<MockFontResourceClient> client = new MockFontResourceClient(resource);
    ...
    Persistent<MockFontResourceClient> client2 = new MockFontResourceClient(resource);
    ...
    Persistent<MockFontResourceClient> client3 = new MockFontResourceClient(resource);
