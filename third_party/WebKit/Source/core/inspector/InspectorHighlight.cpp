...
namespace {
    ...
    public:
        PathBuilder()
            : m_path(protocol::ListValue::create())
        {
        }
        virtual ~PathBuilder() { }
    ...
    FloatQuad* margin)
{
    ...
    if (layoutObject->isBox()) {
        ...
        paddingBox = LayoutRect(borderBox.x() + layoutInline->borderLeft(),
            ...
            borderBox.width() - layoutInline->borderLeft() - layoutInline->borderRight(),
            borderBox.height() - layoutInline->borderTop() - layoutInline->borderBottom());
        contentBox = LayoutRect(paddingBox.x() + layoutInline->paddingLeft(),
            paddingBox.y() + layoutInline->paddingTop(),
            paddingBox.width() - layoutInline->paddingLeft() - layoutInline->paddingRight(),
            paddingBox.height() - layoutInline->paddingTop() - layoutInline->paddingBottom());
