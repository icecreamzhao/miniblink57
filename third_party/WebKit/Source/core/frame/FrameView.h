...
public:
    ...
    bool doLayoutWithFrameFlattening();
#endif
    ...
    {
        return m_viewportConstrainedObjects && m_viewportConstrainedObjects->size() > 0;
    }
    ...
    enum UrlFragmentBehavior { UrlFragmentScroll,
    ...
    enum ScrollbarModesCalculationStrategy { RulesFromWebContentOnly,
        AnyRule };
    ...
    {
        return horizontalScrollbarMode() != ScrollbarAlwaysOff || verticalScrollbarMode() != ScrollbarAlwaysOff;
    }
...
protected:
    ...
    enum ComputeScrollbarExistenceOption { FirstPass,
        Incremental };
...
private:
    ...
    public:
        ScrollbarManager(FrameView& scroller)
    ...
    void checkTextAutosizerTimerFired(TimerBase*);
#endif
...
#ifdef TENCENT_CHANGES
    Timer<FrameView> m_textAutosizerCheckTimer;
#endif
