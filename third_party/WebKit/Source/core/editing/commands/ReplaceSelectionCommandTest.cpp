...
TEST_F(ReplaceSelectionCommandTest, pastingEmptySpan)
{
    ...
    ReplaceSelectionCommand::CommandOptions options = ReplaceSelectionCommand::PreventNesting | ReplaceSelectionCommand::SanitizeFragment | ReplaceSelectionCommand::SelectReplacement | ReplaceSelectionCommand::SmartReplace;
    ReplaceSelectionCommand* command = ReplaceSelectionCommand::create(document(), fragment, options);
