...
TEST_F(ApplyBlockElementCommandTest, selectionCrossingOverBody)
{
    ...
    FormatBlockCommand* command = FormatBlockCommand::create(document(), HTMLNames::footerTag);
    command->apply();
...
TEST_F(ApplyBlockElementCommandTest, visibilityChangeDuringCommand)
{
    ...
    IndentOutdentCommand* command = IndentOutdentCommand::create(document(), IndentOutdentCommand::Indent);
    command->apply();
