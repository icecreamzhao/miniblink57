...
TEST_F(VisibleSelectionTest, expandUsingGranularity)
{
    ...
    const char* shadowContent = "<p><b id=three>333</b><content select=#two></content><b "
    ...
    selectionInFlatTree = createVisibleSelection(SelectionInFlatTree::Builder()
                                                     .collapse(PositionInFlatTree(one, 1))
                                                     .build());
    selectionInFlatTree = expandUsingGranularity(selectionInFlatTree, WordGranularity);
...
TEST_F(VisibleSelectionTest, Initialisation)
{
    ...
    const VisibleSelection noSelection = createVisibleSelection(SelectionInDOMTree::Builder().build());
...
TEST_F(VisibleSelectionTest, ShadowCrossing)
{
    ...
    const char* shadowContent = "<a><span id='s4'>44</span><content select=#two></content><span "
...
TEST_F(VisibleSelectionTest, ShadowV0DistributedNodes)
{
    ...
    VisibleSelection selection = createVisibleSelection(SelectionInDOMTree::Builder()
                                                            .collapse(Position::firstPositionInNode(one))
