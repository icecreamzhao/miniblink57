...
TEST_F(StyledMarkupSerializerTest, TextOnly)
{
    ...
    const char* expectedResult = "<span style=\"display: inline !important; float: none;\">Hello "
                                 "world!</span>";
...
{
    const char* bodyContent = "<select><option value=\"1\">one</option><option "
...
{
    const char* bodyContent = "<p id=\"host\">00<b id=\"one\">11</b><b id=\"two\"><input "
                              "value=\"22\"></b>33</p>";
    const char* shadowContent = "<a><content select=#two></content><content select=#one></content></a>";
    setBodyContent(bodyContent);
    setShadowContent(shadowContent, "host");
...
{
    const char* bodyContent = "<p id=\"host\">00<b id=\"one\">11</b><b id=\"two\">22</b>33</p>";
    const char* shadowContent1 = "<a><content select=#two></content><b id=host2></b><content "
...
{
    const char* bodyContent = "<p id='host' style='color: red'><span style='font-weight: bold;'><span "
...
{
    const char* bodyContent = "<p id='host1'>[<span id='one'>11</span>]</p><p id='host2'>[<span "
                              "id='two'>22</span>]</p>";
    setBodyContent(bodyContent);
    Element* one = document().getElementById("one");
    ...
    bodyContent = "<p id='host1'><span id='one'>11</span></p><p id='host2'><span "
                  "id='two'>22</span></p>";
...
{
    const char* bodyContent = "<span id='span1' style='display: none'>11</span><span id='span2' "
