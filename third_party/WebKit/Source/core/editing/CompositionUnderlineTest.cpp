...
namespace {
    ...
    {
        CompositionUnderline underline = createCompositionUnderline(std::numeric_limits<unsigned>::max() - 1,
    ...
    {
        CompositionUnderline underline = createCompositionUnderline(std::numeric_limits<unsigned>::max(),
    ...
    {
        CompositionUnderline underline = createCompositionUnderline(std::numeric_limits<unsigned>::max(), 0);
        EXPECT_EQ(std::numeric_limits<unsigned>::max() - 1, underline.startOffset());
        EXPECT_EQ(std::numeric_limits<unsigned>::max(), underline.endOffset());
    }
