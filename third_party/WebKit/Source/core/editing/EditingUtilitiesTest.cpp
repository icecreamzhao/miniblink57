...
TEST_F(EditingUtilitiesTest, directionOfEnclosingBlock)
{
    ...
    const char* shadowContent = "<content select=#two></content><p dir=rtl><content "
...
TEST_F(EditingUtilitiesTest, firstEditablePositionAfterPositionInRoot)
{
    ...
    const char* shadowContent = "<content select=#two></content><content select=#one></content><b "
                                "id='three'>333</b>";
    setBodyContent(bodyContent);
...
TEST_F(EditingUtilitiesTest, enclosingBlock)
{
    ...
    const char* shadowContent = "<content select=#two></content><div id='three'><content "
...
{
    const char* bodyContent = "<div contenteditable id=host><table "
...
{
    const char* bodyContent = "<p id='host'>00<b id='one'>11</b><b id='two'>22</b><b "
                              "id='three'>33</b></p>";
    const char* shadowContent = "<content select=#two></content><content select=#one></content><content "
