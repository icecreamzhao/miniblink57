...
TEST_F(PerformanceBaseTest, GetNavigationType)
{
    ...
    PerformanceNavigationTiming::NavigationType returnedType = getNavigationType(NavigationTypeBackForward, &m_pageHolder->document());
    ...
    returnedType = getNavigationType(NavigationTypeBackForward, &m_pageHolder->document());
    EXPECT_EQ(returnedType,
