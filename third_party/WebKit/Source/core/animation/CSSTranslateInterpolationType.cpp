...
namespace {
    ...
    public:
        ...
        {
            const TransformOperation* inheritedTranslate = environment.state().parentStyle()->translate();
...
{
    TranslateTransformOperation* inheritedTranslate = state.parentStyle()->translate();
