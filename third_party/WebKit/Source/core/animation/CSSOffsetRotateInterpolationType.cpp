...
{
    OffsetRotationType underlyingRotationType = toCSSOffsetRotationNonInterpolableValue(*underlying.nonInterpolableValue)
                                                    .rotationType();
...
{
    const OffsetRotationType& startType = toCSSOffsetRotationNonInterpolableValue(*start.nonInterpolableValue)
                                              .rotationType();
    const OffsetRotationType& endType = toCSSOffsetRotationNonInterpolableValue(*end.nonInterpolableValue)
                                            .rotationType();
...
{
    const OffsetRotationType& underlyingType = toCSSOffsetRotationNonInterpolableValue(
        *underlyingValueOwner.value().nonInterpolableValue)
                                                   .rotationType();
    const OffsetRotationType& rotationType = toCSSOffsetRotationNonInterpolableValue(*value.nonInterpolableValue)
                                                 .rotationType();
