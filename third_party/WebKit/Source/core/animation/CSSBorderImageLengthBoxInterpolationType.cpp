...
namespace {
        ...
        double zoom)
    {
        ...
        return InterpolationValue(
            std::move(list), CSSBorderImageLengthBoxNonInterpolableValue::create(SideNumbers(box), std::move(nonInterpolableValues)));
    }
...
CSSBorderImageLengthBoxInterpolationType::maybeConvertInherit(
    ...
    ConversionCheckers& conversionCheckers) const
{
    const BorderImageLengthBox& inherited = BorderImageLengthBoxPropertyFunctions::getBorderImageLengthBox(
...
{
    const SideNumbers& startSideNumbers = toCSSBorderImageLengthBoxNonInterpolableValue(*start.nonInterpolableValue)
                                              .sideNumbers();
    const SideNumbers& endSideNumbers = toCSSBorderImageLengthBoxNonInterpolableValue(*end.nonInterpolableValue)
                                            .sideNumbers();
...
{
    const SideNumbers& underlyingSideNumbers = toCSSBorderImageLengthBoxNonInterpolableValue(
        *underlyingValueOwner.value().nonInterpolableValue)
                                                   .sideNumbers();
    const auto& nonInterpolableValue = toCSSBorderImageLengthBoxNonInterpolableValue(
    ...
    Vector<RefPtr<NonInterpolableValue>>& underlyingSideNonInterpolableValues = toCSSBorderImageLengthBoxNonInterpolableValue(
...
{
    const SideNumbers& sideNumbers = toCSSBorderImageLengthBoxNonInterpolableValue(nonInterpolableValue)
                                         ->sideNumbers();
    const Vector<RefPtr<NonInterpolableValue>>& nonInterpolableValues = toCSSBorderImageLengthBoxNonInterpolableValue(nonInterpolableValue)
                                                                            ->sideNonInterpolableValues();
