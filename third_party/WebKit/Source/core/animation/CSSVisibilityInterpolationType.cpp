...
private:
        ...
        const InterpolationValue& underlying) const final
    {
        ...
        EVisibility underlyingVisibility = toCSSVisibilityNonInterpolableValue(*underlying.nonInterpolableValue)
    ...
    StyleResolverState& state) const
{
    ...
    EVisibility visibility = toCSSVisibilityNonInterpolableValue(nonInterpolableValue)
                                 ->visibility(fraction);
