...
namespace {
    ...
    public:
            ...
            const InterpolationValue& underlying) const final
        {
            ...
            return m_inheritedRotation.axis == inheritedRotation.axis && m_inheritedRotation.angle == inheritedRotation.angle;
        }
...
{
    CSSRotateNonInterpolableValue& underlyingNonInterpolableValue = toCSSRotateNonInterpolableValue(
