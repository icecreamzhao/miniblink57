...
struct ClipAutos {
    ...
    {
        return isAuto == other.isAuto && isTopAuto == other.isTopAuto && isRightAuto == other.isRightAuto && isBottomAuto == other.isBottomAuto && isLeftAuto == other.isLeftAuto;
    }
...
{
    const ClipAutos& underlyingAutos = toCSSClipNonInterpolableValue(
