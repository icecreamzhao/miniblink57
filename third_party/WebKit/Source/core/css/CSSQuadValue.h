...
public:
    enum TypeForSerialization { SerializeAsRect,
        SerializeAsQuad };
    ...
    {
        return compareCSSValuePtr(m_top, other.m_top) && compareCSSValuePtr(m_right, other.m_right) && compareCSSValuePtr(m_left, other.m_left) && compareCSSValuePtr(m_bottom, other.m_bottom);
    }
