...
TEST_F(FilteredComputedStylePropertyMapTest, GetProperties)
{
    ...
    FilteredComputedStylePropertyMap* map = FilteredComputedStylePropertyMap::create(declaration(), nativeProperties,
        customProperties);
...
TEST_F(FilteredComputedStylePropertyMapTest, CustomPropertyAccessors)
{
    Vector<CSSPropertyID> emptyNativeProperties;
    Vector<AtomicString> customProperties({ "--foo", "--bar" });
    FilteredComputedStylePropertyMap* map = FilteredComputedStylePropertyMap::create(
        declaration(), emptyNativeProperties, customProperties);
