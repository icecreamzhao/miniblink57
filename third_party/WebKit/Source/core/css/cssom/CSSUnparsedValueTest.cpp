...
{
    CSSStyleVariableReferenceValue* variableReferenceValue = CSSStyleVariableReferenceValue::create(
        "Ref", CSSUnparsedValue::fromString("string"));

    CSSUnparsedValue* unparsedValue = unparsedValueFromCSSVariableReferenceValue(variableReferenceValue);
