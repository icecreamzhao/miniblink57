    ...
    const CSSParserContext* context)
{
    ...
    if (CSSValue* textEmphasisStyle = CSSPropertyParserHelpers::consumeString(range))
        return textEmphasisStyle;

    CSSIdentifierValue* fill = CSSPropertyParserHelpers::consumeIdent<CSSValueFilled, CSSValueOpen>(
        range);
    CSSIdentifierValue* shape = CSSPropertyParserHelpers::consumeIdent<CSSValueDot, CSSValueCircle,
