    ...
    const CSSParserContext* context)
{
    ...
    CSSIdentifierValue* rowOrColumnValue = CSSPropertyParserHelpers::consumeIdent<CSSValueRow, CSSValueColumn>(
        range);
    CSSIdentifierValue* denseAlgorithm = CSSPropertyParserHelpers::consumeIdent<CSSValueDense>(range);
    if (!rowOrColumnValue) {
        rowOrColumnValue = CSSPropertyParserHelpers::consumeIdent<CSSValueRow, CSSValueColumn>(
            range);
