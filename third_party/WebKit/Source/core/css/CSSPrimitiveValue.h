...
public:
    ...
    {
        return unit == UnitType::Degrees || unit == UnitType::Radians || unit == UnitType::Gradians || unit == UnitType::Turns;
    }
    bool isAngle() const { return isAngle(type()); }
    bool isFontRelativeLength() const
    {
        return type() == UnitType::QuirkyEms || type() == UnitType::Ems || type() == UnitType::Exs || type() == UnitType::Rems || type() == UnitType::Chs;
    }
    ...
    {
        return (type >= UnitType::Ems && type <= UnitType::UserUnits) || type == UnitType::QuirkyEms;
    }
    static inline bool isRelativeUnit(UnitType type)
    {
        return type == UnitType::Percentage || type == UnitType::Ems || type == UnitType::Exs || type == UnitType::Rems || type == UnitType::Chs || isViewportPercentageLength(type);
    }
    bool isLength() const { return isLength(typeWithCalcResolved()); }
    bool isNumber() const
    {
        return typeWithCalcResolved() == UnitType::Number || typeWithCalcResolved() == UnitType::Integer;
    }
    ...
    {
        return type >= UnitType::DotsPerPixel && type <= UnitType::DotsPerCentimeter;
    }
