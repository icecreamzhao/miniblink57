...
public:
    ...
    {
        return m_classType >= BasicShapeCircleClass && m_classType <= BasicShapeInsetClass;
    }
    bool isBasicShapeCircleValue() const
    {
        return m_classType == BasicShapeCircleClass;
    }
    bool isBasicShapeEllipseValue() const
    {
        return m_classType == BasicShapeEllipseClass;
    }
    bool isBasicShapePolygonValue() const
    {
        return m_classType == BasicShapePolygonClass;
    }
    bool isBasicShapeInsetValue() const
    {
        return m_classType == BasicShapeInsetClass;
    }

    bool isBorderImageSliceValue() const
    {
        return m_classType == BorderImageSliceClass;
    }
    ...
    {
        return m_classType >= LinearGradientClass && m_classType <= RadialGradientClass;
    }
    ...
    {
        return m_classType >= InheritedClass && m_classType <= UnsetClass;
    }
    ...
    {
        return m_classType == CubicBezierTimingFunctionClass;
    }
    bool isStepsTimingFunctionValue() const
    {
        return m_classType == StepsTimingFunctionClass;
    }
    bool isGridTemplateAreasValue() const
    {
        return m_classType == GridTemplateAreasClass;
    }
    bool isContentDistributionValue() const
    {
        return m_classType == CSSContentDistributionClass;
    }
    bool isUnicodeRangeValue() const { return m_classType == UnicodeRangeClass; }
    bool isGridLineNamesValue() const
    {
        return m_classType == GridLineNamesClass;
    }
    bool isCustomPropertyDeclaration() const
    {
        return m_classType == CustomPropertyDeclarationClass;
    }
    bool isVariableReferenceValue() const
    {
        return m_classType == VariableReferenceClass;
    }
    bool isGridAutoRepeatValue() const
    {
        return m_classType == GridAutoRepeatClass;
    }
    bool isPendingSubstitutionValue() const
    {
        return m_classType == PendingSubstitutionValueClass;
    }
...
protected:
    ...
    enum ValueListSeparator { SpaceSeparator,
        CommaSeparator,
        SlashSeparator };
