...
CSSParserContext* CSSParserContext::create(const Document& document,
    ...
    UseCounter* useCounter)
{
    const KURL baseURL = baseURLOverride.isNull() ? document.baseURL() : baseURLOverride;

    CSSParserMode mode = document.inQuirksMode() ? HTMLQuirksMode : HTMLStandardMode;
    ...
    bool useLegacyBackgroundSizeShorthandBehavior = document.settings()
...
{
    return m_baseURL == other.m_baseURL && m_charset == other.m_charset && m_mode == other.m_mode && m_matchMode == other.m_matchMode && m_profile == other.m_profile && m_isHTMLDocument == other.m_isHTMLDocument && m_useLegacyBackgroundSizeShorthandBehavior == other.m_useLegacyBackgroundSizeShorthandBehavior;
}
