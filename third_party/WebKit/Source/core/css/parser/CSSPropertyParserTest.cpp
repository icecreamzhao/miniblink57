...
{
    const CSSValue* value = CSSParser::parseSingleValue(CSSPropertyGridColumnStart, "999");
    DCHECK(value);
...
{
    const CSSValue* value = CSSParser::parseSingleValue(CSSPropertyGridColumnEnd, "1000000");
    DCHECK(value);
...
{
    const CSSValue* value = CSSParser::parseSingleValue(CSSPropertyGridRowEnd, "5000000000");
    DCHECK(value);
    EXPECT_EQ(getGridPositionInteger(*value), 1000);
}
