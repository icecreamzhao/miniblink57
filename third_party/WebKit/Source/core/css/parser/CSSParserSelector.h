...
public:
    ...
    {
        return WTF::makeUnique<CSSParserSelector>(name, isImplicit);
    }
    ...
    {
        return pseudoType() == CSSSelector::PseudoWebKitCustomElement || pseudoType() == CSSSelector::PseudoBlinkInternalElement || pseudoType() == CSSSelector::PseudoCue || pseudoType() == CSSSelector::PseudoPlaceholder || pseudoType() == CSSSelector::PseudoShadow || pseudoType() == CSSSelector::PseudoSlotted;
    }
