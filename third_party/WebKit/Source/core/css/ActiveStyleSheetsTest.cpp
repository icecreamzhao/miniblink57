...
protected:
    ...
    {
        StyleSheetContents* contents = StyleSheetContents::create(CSSParserContext::create(HTMLStandardMode));
...
TEST_F(ApplyRulesetsTest, AddFontFaceRuleToDocument)
{
    ...
    CSSStyleSheet* sheet = createSheet("@font-face { font-family: ahum; src: url(ahum.ttf) }");
