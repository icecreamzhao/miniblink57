...
TEST_F(LayoutInlineTest, RegionHitTest)
{
    ...
    LayoutInline* lotsOfBoxes = toLayoutInline(getLayoutObjectByElementId("lotsOfBoxes"));
    ASSERT_TRUE(lotsOfBoxes);

    HitTestRequest hitRequest(HitTestRequest::TouchEvent | HitTestRequest::ListBased);
