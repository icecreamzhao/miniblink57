...
TEST_P(MapCoordinatesTest, FixedPosInFixedPosScrollView)
{
    ...
    EXPECT_EQ(50, document().view()->layoutViewportScrollableArea()->scrollOffsetInt().height());
...
TEST_P(MapCoordinatesTest, FixedPosInIFrameWhenMainFrameScrolled)
{
    ...
    ASSERT_TRUE(target);
    FloatPoint mappedPoint = mapAncestorToLocal(target->layoutObject(), nullptr, FloatPoint(10, 70),
...
TEST_P(MapCoordinatesTest, IFrameTransformed)
{
    ...
    Element* target = childDocument().getElementById("target");
    ASSERT_TRUE(target);
    FloatPoint mappedPoint = mapAncestorToLocal(target->layoutObject(), nullptr, FloatPoint(200, 200),
...
TEST_P(MapCoordinatesTest, FixedPosInScrolledIFrameWithTransform)
{
    ...
    Element* target = childDocument().getElementById("target");
    ASSERT_TRUE(target);
    FloatPoint mappedPoint = mapAncestorToLocal(target->layoutObject(), nullptr, FloatPoint(0, 0),
...
TEST_P(MapCoordinatesTest, FlippedBlocksWritingModeWithText)
{
    ...
    mappedPoint = mapLocalToAncestor(text, text->containingBlock()->containingBlock(),
        FloatPoint(75, 10), ApplyContainerFlip);
    EXPECT_EQ(FloatPoint(130, 10), mappedPoint);
    mappedPoint = mapAncestorToLocal(text, text->containingBlock()->containingBlock(),
...
TEST_P(MapCoordinatesTest, FlippedBlocksWritingModeWithInline)
{
    ...
    FloatPoint mappedPoint = mapLocalToAncestor(target, toLayoutBoxModelObject(target->parent()),
        FloatPoint(75, 10), ApplyContainerFlip);
    EXPECT_EQ(FloatPoint(75, 10), mappedPoint);
    mappedPoint = mapAncestorToLocal(target, toLayoutBoxModelObject(target->parent()),
        mappedPoint, ApplyContainerFlip);
    EXPECT_EQ(FloatPoint(75, 10), mappedPoint);
    ...
    mappedPoint = mapLocalToAncestor(target, target->containingBlock()->containingBlock(),
        FloatPoint(75, 10), ApplyContainerFlip);
    EXPECT_EQ(FloatPoint(132, 10), mappedPoint);
    mappedPoint = mapAncestorToLocal(target, target->containingBlock()->containingBlock(),
        mappedPoint, ApplyContainerFlip);
    EXPECT_EQ(FloatPoint(75, 10), mappedPoint);
