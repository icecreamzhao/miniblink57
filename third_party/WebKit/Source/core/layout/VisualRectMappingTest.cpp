...
protected:
    ...
    void checkPaintInvalidationVisualRect(const LayoutObject& object)
    {
        ...
        const LayoutBoxModelObject& paintInvalidationContainer = object.containerForPaintInvalidation();
...
TEST_F(VisualRectMappingTest, LayoutView)
{
    ...
    LayoutBlock* frameBody = toLayoutBlock(childDocument().body()->layoutObject());
...
TEST_F(VisualRectMappingTest, LayoutViewSubpixelRounding)
{
    ...
    LayoutBlock* frameContainer = toLayoutBlock(getLayoutObjectByElementId("frameContainer"));
    LayoutObject* target = childDocument().getElementById("target")->layoutObject();
...
TEST_F(VisualRectMappingTest, FloatUnderInline)
{
    ...
    LayoutBoxModelObject* span = toLayoutBoxModelObject(getLayoutObjectByElementId("span"));
    LayoutBox* target = toLayoutBox(getLayoutObjectByElementId("target"));
