...
{
    is_inline_direction_triggers_scrollbar_ = is_inline_direction_triggers_scrollbar;
    return *this;
}
...
{
    is_block_direction_triggers_scrollbar_ = is_block_direction_triggers_scrollbar;
    return *this;
}
...
NGConstraintSpace* NGConstraintSpaceBuilder::ToConstraintSpace()
{
    ...
    bool is_in_parallel_flow = (parent_writing_mode_ == kHorizontalTopBottom) == (writing_mode_ == kHorizontalTopBottom);
