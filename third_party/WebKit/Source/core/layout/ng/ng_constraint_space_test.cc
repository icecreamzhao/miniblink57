...
namespace {
    ...
    TEST(NGConstraintSpaceTest, LayoutOpportunitiesNoExclusions)
    {
        ...
        auto* space = ConstructConstraintSpace(kHorizontalTopBottom, TextDirection::kLtr, size);
    ...
    TEST(NGConstraintSpaceTest, LayoutOpportunitiesTwoInMiddleWithOriginAndLeader)
    {
        ...
        auto* iterator = new NGLayoutOpportunityIterator(space, origin_point, leader_point);
        // 1st Start Point
