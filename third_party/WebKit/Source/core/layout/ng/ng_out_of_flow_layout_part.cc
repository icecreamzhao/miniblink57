    ...
    NGLogicalSize container_size)
{
    ...
    parent_border_offset_ = NGLogicalOffset { borders.inline_start, borders.block_start };
    ...
    NGLogicalOffset* offset)
{
    ...
    NGAbsolutePhysicalPosition node_position = ComputePartialAbsoluteWithChildInlineSize(
    ...
    if (!fragment) {
        block_estimate = node_position.size.ConvertToLogical(parent_space_->WritingMode())
                             .block_size;
        fragment = GenerateFragment(node, block_estimate, node_position);
    }
    ...
    *fragment_out = fragment;
    ...
    offset->inline_offset = inset.inline_start + parent_border_offset_.inline_offset;
    ...
    const NGAbsolutePhysicalPosition node_position)
{
    ...
    LayoutUnit inline_size = node_position.size.ConvertToLogical(parent_space_->WritingMode())
                                 .inline_size;
