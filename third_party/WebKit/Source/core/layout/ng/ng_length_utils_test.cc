...
namespace {
    ...
    TEST_F(NGLengthUtilsTest, testResolveInlineLength)
    {
        ...
        EXPECT_EQ(LayoutUnit(200), ResolveInlineLength(Length(FillAvailable), LengthResolveType::kMaxSize));
    ...
    TEST_F(NGLengthUtilsTest, testComputeContentContribution)
    {
        ...
        expected.min_content = expected.max_content = sizes.min_content + LayoutUnit(400);
    ...
    TEST_F(NGLengthUtilsTest, testComputeInlineSizeForFragment)
    {
        ...
        NGConstraintSpace* constraintSpace = ConstructConstraintSpace(120, 120, true, true);
        style_->setLogicalWidth(Length(150, Fixed));
    ...
    TEST_F(NGLengthUtilsTest, testComputeBlockSizeForFragment)
    {
        ...
        NGConstraintSpace* constraintSpace = ConstructConstraintSpace(200, 200, true, true);
        style_->setLogicalHeight(Length(150, Fixed));
