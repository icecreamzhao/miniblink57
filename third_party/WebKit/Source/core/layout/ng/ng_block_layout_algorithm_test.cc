...
namespace {
    ...
    protected:
        ...
        MinAndMaxContentSizes RunComputeMinAndMax(NGBlockNode* first_child)
        {
            ...
            NGConstraintSpace* space = ConstructConstraintSpace(kHorizontalTopBottom, TextDirection::kLtr,
    ...
    TEST_F(NGBlockLayoutAlgorithmTest, LayoutBlockChildrenWithWritingMode)
    {
        ...
        auto* space = ConstructConstraintSpace(kHorizontalTopBottom, TextDirection::kLtr,
    ...
    TEST_F(NGBlockLayoutAlgorithmTest, CollapsingMarginsCase1)
    {
        ...
        auto* space = NGConstraintSpaceBuilder(kHorizontalTopBottom)
        ...
        const NGPhysicalBoxFragment* div2_fragment = static_cast<const NGPhysicalBoxFragment*>(frag->Children()[0].get());
    ...
    TEST_F(NGBlockLayoutAlgorithmTest, CollapsingMarginsCase5)
    {
        ...
        auto* space = ConstructConstraintSpace(kVerticalLeftRight, TextDirection::kLtr,
            NGLogicalSize(LayoutUnit(500), LayoutUnit(500)));
    ...
    public:
        ...
        const NGPhysicalBoxFragment* NextChild()
        {
            ...
            if (index_ >= parent_->Children().size())
                return nullptr;
            while (parent_->Children()[index_]->Type() != NGPhysicalFragment::kFragmentBox) {
                ++index_;
                if (index_ >= parent_->Children().size())
                    return nullptr;
            }
