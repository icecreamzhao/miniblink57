...
namespace ListMarkerText {
    ...
    enum SequenceType { NumericSequence,
        AlphabeticSequence };
    ...
    {
        return toAlphabeticOrNumeric(number, alphabet, alphabetSize,
            AlphabeticSequence);
    }
    ...
    enum CJKLang { Chinese = 1,
        Korean,
        Japanese };

    enum CJKStyle { Formal,
        Informal };
