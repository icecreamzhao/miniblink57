...
TEST_F(LayoutObjectTest, FloatUnderBlock)
{
    ...
    LayoutBoxModelObject* layeredDiv = toLayoutBoxModelObject(getLayoutObjectByElementId("layered-div"));
...
TEST_F(LayoutObjectTest, FloatUnderInline)
{
    ...
    LayoutBoxModelObject* layeredDiv = toLayoutBoxModelObject(getLayoutObjectByElementId("layered-div"));
    LayoutBoxModelObject* container = toLayoutBoxModelObject(getLayoutObjectByElementId("container"));
    LayoutBoxModelObject* layeredSpan = toLayoutBoxModelObject(getLayoutObjectByElementId("layered-span"));
    LayoutObject* floating = getLayoutObjectByElementId("floating");
