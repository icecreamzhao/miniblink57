...
enum MarkLineBoxes { MarkLineBoxesDirty,
    DontMarkLineBoxes };
...
public:
    ...
    {
        return getLineLayoutItem().isText() && getLineLayoutItem().parent() && getLineLayoutItem().parent().isBox();
    }
