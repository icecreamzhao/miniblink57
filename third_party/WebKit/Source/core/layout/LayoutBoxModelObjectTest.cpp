...
TEST_F(LayoutBoxModelObjectTest, StickyPositionConstraints)
{
    ...
    const StickyPositionScrollingConstraints& constraints = scrollableArea->stickyConstraintsMap().get(sticky->layer());
...
TEST_F(LayoutBoxModelObjectTest, StickyPositionConstraintInvalidation)
{
    ...
    PaintLayerScrollableArea* scrollableArea = scroller->getScrollableArea();
    LayoutBoxModelObject* sticky = toLayoutBoxModelObject(getLayoutObjectByElementId("sticky"));
    LayoutBoxModelObject* target = toLayoutBoxModelObject(getLayoutObjectByElementId("target"));
