...
namespace {
    ...
    public:
        ...
        {
            return m_fixedNames.contains(name) || name.startsWith(m_proxyHeaderPrefix, TextCaseASCIIInsensitive) || name.startsWith(m_secHeaderPrefix, TextCaseASCIIInsensitive);
        }
    ...
    const AtomicString& value)
{
    ...
    if (equalIgnoringCase(name, "accept") || equalIgnoringCase(name, "accept-language") || equalIgnoringCase(name, "content-language") || equalIgnoringCase(name, HTTPNames::X_DevTools_Emulate_Network_Conditions_Client_Id) || equalIgnoringCase(name, "save-data"))
        return true;
...
bool FetchUtils::isSimpleContentType(const AtomicString& mediaType)
{
    ...
    return equalIgnoringCase(mimeType, "application/x-www-form-urlencoded") || equalIgnoringCase(mimeType, "multipart/form-data") || equalIgnoringCase(mimeType, "text/plain");
}
...
bool FetchUtils::isForbiddenMethod(const String& method)
{
    ...
    return equalIgnoringCase(method, "TRACE") || equalIgnoringCase(method, "TRACK") || equalIgnoringCase(method, "CONNECT");
}
