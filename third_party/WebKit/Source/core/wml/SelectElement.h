...
protected:
    ...
    static void parseMultipleAttribute(SelectElementData&, Element*, const QualifiedName& name, const AtomicString& value);
...
#if ENABLE(DATALIST)
	const Vector<Element*>& rawListItems() const { return m_listItems; }
#endif
