...
class WMLInputElement : public HTMLInputElement {
public:
    DECLARE_NODE_FACTORY(WMLInputElement);

    WMLInputElement(Document&, bool createdByParser = true);
    virtual ~WMLInputElement() override;
