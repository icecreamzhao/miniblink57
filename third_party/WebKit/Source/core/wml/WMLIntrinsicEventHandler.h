...
class WMLIntrinsicEventHandler : public GarbageCollectedFinalized<WMLIntrinsicEventHandler> {
public:
    WMLIntrinsicEventHandler();

    bool registerIntrinsicEvent(WMLIntrinsicEventType, WMLIntrinsicEvent*);
...
private:
    typedef HeapHashMap<int, Member<WMLIntrinsicEvent>> EventMap;
    EventMap m_events;
};
