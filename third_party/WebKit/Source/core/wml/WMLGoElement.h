...
public:
    DECLARE_NODE_FACTORY(WMLGoElement);
...
private:
    ...
    PassRefPtr<EncodedFormData> createFormData(const CString& boundary);

    HeapVector<Member<WMLPostfieldElement>> m_postfieldElements;
