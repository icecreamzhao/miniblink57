...
bool WMLIntrinsicEventHandler::registerIntrinsicEvent(WMLIntrinsicEventType type, WMLIntrinsicEvent* event)
{
...
{
    WMLIntrinsicEvent* event = m_events.get(type);
...
DEFINE_TRACE(WMLIntrinsicEventHandler)
{
