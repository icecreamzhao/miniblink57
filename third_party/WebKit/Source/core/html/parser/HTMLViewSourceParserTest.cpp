...
TEST(HTMLViewSourceParserTest, DetachThenFinish_ShouldNotCrash)
{
    ...
    HTMLViewSourceDocument* document = HTMLViewSourceDocument::create(DocumentInit(), mimeType);
    HTMLViewSourceParser* parser = HTMLViewSourceParser::create(*document, mimeType);
