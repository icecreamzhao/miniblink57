...
TEST_F(CSSPreloadScannerTest, ScanFromResourceClient)
{
    ...
    MockHTMLResourcePreloader* preloader = new MockHTMLResourcePreloader(dummyPageHolder->document());
    ...
    PreloadRecordingCSSPreloaderResourceClient* resourceClient = new PreloadRecordingCSSPreloaderResourceClient(resource, preloader);
...
TEST_F(CSSPreloadScannerTest, DestroyClientBeforeDataSent)
{
    ...
    Persistent<MockHTMLResourcePreloader> preloader = new MockHTMLResourcePreloader(dummyPageHolder->document());
