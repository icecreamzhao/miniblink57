...
namespace {
    ...
    protected:
        ...
        {
            HTMLDocumentParser* parser = HTMLDocumentParser::create(document, ForceSynchronousParsing);
...
TEST_F(HTMLDocumentParserTest, AppendPrefetch)
{
    ...
    HTMLParserScriptRunnerHost* scriptRunnerHost = parser->asHTMLParserScriptRunnerHostForTesting();
