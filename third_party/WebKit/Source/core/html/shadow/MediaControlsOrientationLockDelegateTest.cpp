...
namespace {
    ...
    public:
        ...
        {
            MockScreenOrientationController* controller = new MockScreenOrientationController(frame);
...
protected:
    void SetUp() override
    {
        m_previousVideoFullscreenOrientationLockValue = RuntimeEnabledFeatures::videoFullscreenOrientationLockEnabled();
        ...
        m_screenOrientationController = MockScreenOrientationController::provideTo(m_pageHolder->frame());
    }
    ...
    {
        ScreenOrientationController* controller = ScreenOrientationController::from(*document().frame());
