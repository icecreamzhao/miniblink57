...
public:
    ...
    {
        return m_leftOffset == other.m_leftOffset && m_rightOffset == other.m_rightOffset && m_topOffset == other.m_topOffset && m_bottomOffset == other.m_bottomOffset && m_scrollContainerRelativeContainingBlockRect == other.m_scrollContainerRelativeContainingBlockRect && m_scrollContainerRelativeStickyBoxRect == other.m_scrollContainerRelativeStickyBoxRect;
    }
