    ...
    const FloatSize& velocityInRootFrame)
{
    ...
    FloatSize velocityInViewport = velocityInRootFrame.scaledBy(m_visualViewport->scale());
    FloatPoint positionInViewport = m_visualViewport->rootFrameToViewport(positionInRootFrame);
