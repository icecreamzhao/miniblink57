...
void AcceptLanguagesResolver::acceptLanguagesChanged(const String& acceptLanguages)
{
    ...
    m_preferredHanScript = scriptCodeForHanFromLocale(icu::Locale::getDefault().getName(), '_');
#else
