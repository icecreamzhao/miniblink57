...
TestPaintArtifact& TestPaintArtifact::rectDrawing(const FloatRect& bounds,
    Color color)
{
    std::unique_ptr<DummyRectClient> client = WTF::makeUnique<DummyRectClient>(bounds, color);
    ...
    scoped_refptr<cc::Layer> layer)
{
    ...
    std::unique_ptr<DummyRectClient> client = WTF::wrapUnique(new DummyRectClient(floatBounds, Color::transparent));
