...
namespace {
        ...
        size_t offsetMidFirstFrame)
    {
        ...
        auto decoder = createDecoder();
        RefPtr<SharedBuffer> partialData = SharedBuffer::create(fullData->data(), offsetMidFirstFrame);
        ...
        size_t expectedFrameCountAfter = 0u)
    {
        ...
        RefPtr<SharedBuffer> data = SharedBuffer::create(fullData->data(), idatOffset + 8u);
...
TEST(StaticPNGTests, MetaDataTest)
{
    ...
    auto decoder = createDecoderWithPngData("/LayoutTests/images/resources/png-simple.png");
