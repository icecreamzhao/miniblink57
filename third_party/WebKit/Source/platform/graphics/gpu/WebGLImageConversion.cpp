...
*/
...
#endif
        for (unsigned i = 0; i < pixelsPerRow; ++i) {
            *destination = (((source[0] & 0xF0) << 8) | ((source[1] & 0xF0) << 4) | (source[2] & 0xF0) | (source[3] >> 4));
            source += 4;
            destination += 1;
        }
    }
        ...
        unsigned pixelsPerRow)
    {
        for (unsigned i = 0; i < pixelsPerRow; ++i) {
            ...
            uint8_t sourceG = static_cast<uint8_t>(static_cast<float>(source[1]) * scaleFactor);
            uint8_t sourceB = static_cast<uint8_t>(static_cast<float>(source[2]) * scaleFactor);
            *destination = (((sourceR & 0xF0) << 8) | ((sourceG & 0xF0) << 4) | (sourceB & 0xF0) | (source[3] >> 4));
            source += 4;
            destination += 1;
        }
    }
...
#endif
        for (unsigned i = 0; i < pixelsPerRow; ++i) {
            *destination = (((source[0] & 0xF8) << 8) | ((source[1] & 0xF8) << 3) | ((source[2] & 0xF8) >> 2) | (source[3] >> 7));
            source += 4;
            destination += 1;
        }
    }
        ...
        unsigned pixelsPerRow)
    {
        for (unsigned i = 0; i < pixelsPerRow; ++i) {
            ...
            uint8_t sourceG = static_cast<uint8_t>(static_cast<float>(source[1]) * scaleFactor);
            uint8_t sourceB = static_cast<uint8_t>(static_cast<float>(source[2]) * scaleFactor);
            *destination = (((sourceR & 0xF8) << 8) | ((sourceG & 0xF8) << 3) | ((sourceB & 0xF8) >> 2) | (source[3] >> 7));
            source += 4;
            destination += 1;
        }
    }
...
#endif
        for (unsigned i = 0; i < pixelsPerRow; ++i) {
            *destination = (((source[0] & 0xF8) << 8) | ((source[1] & 0xFC) << 3) | ((source[2] & 0xF8) >> 3));
            source += 4;
            destination += 1;
        }
    }
        ...
        unsigned pixelsPerRow)
    {
        for (unsigned i = 0; i < pixelsPerRow; ++i) {
            ...
            uint8_t sourceG = static_cast<uint8_t>(static_cast<float>(source[1]) * scaleFactor);
            uint8_t sourceB = static_cast<uint8_t>(static_cast<float>(source[2]) * scaleFactor);
            *destination = (((sourceR & 0xF8) << 8) | ((sourceG & 0xFC) << 3) | ((sourceB & 0xF8) >> 3));
            source += 4;
            destination += 1;
        }
    }
    ...
    {
        return format == WebGLImageConversion::DataFormatA8 || format == WebGLImageConversion::DataFormatA16F || format == WebGLImageConversion::DataFormatA32F || format == WebGLImageConversion::DataFormatRA8 || format == WebGLImageConversion::DataFormatAR8 || format == WebGLImageConversion::DataFormatRA16F || format == WebGLImageConversion::DataFormatRA32F || format == WebGLImageConversion::DataFormatRGBA8 || format == WebGLImageConversion::DataFormatBGRA8 || format == WebGLImageConversion::DataFormatARGB8 || format == WebGLImageConversion::DataFormatABGR8 || format == WebGLImageConversion::DataFormatRGBA16F || format == WebGLImageConversion::DataFormatRGBA32F || format == WebGLImageConversion::DataFormatRGBA4444 || format == WebGLImageConversion::DataFormatRGBA5551 || format == WebGLImageConversion::DataFormatRGBA8_S || format == WebGLImageConversion::DataFormatRGBA16 || format == WebGLImageConversion::DataFormatRGBA16_S || format == WebGLImageConversion::DataFormatRGBA32 || format == WebGLImageConversion::DataFormatRGBA32_S || format == WebGLImageConversion::DataFormatRGBA2_10_10_10;
    }

    bool HasColor(int format)
    {
        return format == WebGLImageConversion::DataFormatRGBA8 || format == WebGLImageConversion::DataFormatRGBA16F || format == WebGLImageConversion::DataFormatRGBA32F || format == WebGLImageConversion::DataFormatRGB8 || format == WebGLImageConversion::DataFormatRGB16F || format == WebGLImageConversion::DataFormatRGB32F || format == WebGLImageConversion::DataFormatBGR8 || format == WebGLImageConversion::DataFormatBGRA8 || format == WebGLImageConversion::DataFormatARGB8 || format == WebGLImageConversion::DataFormatABGR8 || format == WebGLImageConversion::DataFormatRGBA5551 || format == WebGLImageConversion::DataFormatRGBA4444 || format == WebGLImageConversion::DataFormatRGB565 || format == WebGLImageConversion::DataFormatR8 || format == WebGLImageConversion::DataFormatR16F || format == WebGLImageConversion::DataFormatR32F || format == WebGLImageConversion::DataFormatRA8 || format == WebGLImageConversion::DataFormatRA16F || format == WebGLImageConversion::DataFormatRA32F || format == WebGLImageConversion::DataFormatAR8 || format == WebGLImageConversion::DataFormatRGBA8_S || format == WebGLImageConversion::DataFormatRGBA16 || format == WebGLImageConversion::DataFormatRGBA16_S || format == WebGLImageConversion::DataFormatRGBA32 || format == WebGLImageConversion::DataFormatRGBA32_S || format == WebGLImageConversion::DataFormatRGBA2_10_10_10 || format == WebGLImageConversion::DataFormatRGB8_S || format == WebGLImageConversion::DataFormatRGB16 || format == WebGLImageConversion::DataFormatRGB16_S || format == WebGLImageConversion::DataFormatRGB32 || format == WebGLImageConversion::DataFormatRGB32_S || format == WebGLImageConversion::DataFormatRGB10F11F11F || format == WebGLImageConversion::DataFormatRGB5999 || format == WebGLImageConversion::DataFormatRG8 || format == WebGLImageConversion::DataFormatRG8_S || format == WebGLImageConversion::DataFormatRG16 || format == WebGLImageConversion::DataFormatRG16_S || format == WebGLImageConversion::DataFormatRG32 || format == WebGLImageConversion::DataFormatRG32_S || format == WebGLImageConversion::DataFormatRG16F || format == WebGLImageConversion::DataFormatRG32F || format == WebGLImageConversion::DataFormatR8_S || format == WebGLImageConversion::DataFormatR16 || format == WebGLImageConversion::DataFormatR16_S || format == WebGLImageConversion::DataFormatR32 || format == WebGLImageConversion::DataFormatR32_S;
    }

    template <int Format>
    struct IsInt8Format {
        STATIC_ONLY(IsInt8Format);
        static const bool value = Format == WebGLImageConversion::DataFormatRGBA8_S || Format == WebGLImageConversion::DataFormatRGB8_S || Format == WebGLImageConversion::DataFormatRG8_S || Format == WebGLImageConversion::DataFormatR8_S;
    };

    template <int Format>
    struct IsInt16Format {
        STATIC_ONLY(IsInt16Format);
        static const bool value = Format == WebGLImageConversion::DataFormatRGBA16_S || Format == WebGLImageConversion::DataFormatRGB16_S || Format == WebGLImageConversion::DataFormatRG16_S || Format == WebGLImageConversion::DataFormatR16_S;
    };

    template <int Format>
    struct IsInt32Format {
        STATIC_ONLY(IsInt32Format);
        static const bool value = Format == WebGLImageConversion::DataFormatRGBA32_S || Format == WebGLImageConversion::DataFormatRGB32_S || Format == WebGLImageConversion::DataFormatRG32_S || Format == WebGLImageConversion::DataFormatR32_S;
    };

    template <int Format>
    struct IsUInt8Format {
        STATIC_ONLY(IsUInt8Format);
        static const bool value = Format == WebGLImageConversion::DataFormatRGBA8 || Format == WebGLImageConversion::DataFormatRGB8 || Format == WebGLImageConversion::DataFormatRG8 || Format == WebGLImageConversion::DataFormatR8 || Format == WebGLImageConversion::DataFormatBGRA8 || Format == WebGLImageConversion::DataFormatBGR8 || Format == WebGLImageConversion::DataFormatARGB8 || Format == WebGLImageConversion::DataFormatABGR8 || Format == WebGLImageConversion::DataFormatRA8 || Format == WebGLImageConversion::DataFormatAR8 || Format == WebGLImageConversion::DataFormatA8;
    };

    template <int Format>
    struct IsUInt16Format {
        STATIC_ONLY(IsUInt16Format);
        static const bool value = Format == WebGLImageConversion::DataFormatRGBA16 || Format == WebGLImageConversion::DataFormatRGB16 || Format == WebGLImageConversion::DataFormatRG16 || Format == WebGLImageConversion::DataFormatR16;
    };

    template <int Format>
    struct IsUInt32Format {
        STATIC_ONLY(IsUInt32Format);
        static const bool value = Format == WebGLImageConversion::DataFormatRGBA32 || Format == WebGLImageConversion::DataFormatRGB32 || Format == WebGLImageConversion::DataFormatRG32 || Format == WebGLImageConversion::DataFormatR32;
    };

    template <int Format>
    struct IsFloatFormat {
        STATIC_ONLY(IsFloatFormat);
        static const bool value = Format == WebGLImageConversion::DataFormatRGBA32F || Format == WebGLImageConversion::DataFormatRGB32F || Format == WebGLImageConversion::DataFormatRA32F || Format == WebGLImageConversion::DataFormatR32F || Format == WebGLImageConversion::DataFormatA32F || Format == WebGLImageConversion::DataFormatRG32F;
    };

    template <int Format>
    struct IsHalfFloatFormat {
        STATIC_ONLY(IsHalfFloatFormat);
        static const bool value = Format == WebGLImageConversion::DataFormatRGBA16F || Format == WebGLImageConversion::DataFormatRGB16F || Format == WebGLImageConversion::DataFormatRA16F || Format == WebGLImageConversion::DataFormatR16F || Format == WebGLImageConversion::DataFormatA16F || Format == WebGLImageConversion::DataFormatRG16F;
    };

    template <int Format>
    struct Is32bppFormat {
        STATIC_ONLY(Is32bppFormat);
        static const bool value = Format == WebGLImageConversion::DataFormatRGBA2_10_10_10 || Format == WebGLImageConversion::DataFormatRGB5999 || Format == WebGLImageConversion::DataFormatRGB10F11F11F;
    };

    template <int Format>
    struct Is16bppFormat {
        STATIC_ONLY(Is16bppFormat);
        static const bool value = Format == WebGLImageConversion::DataFormatRGBA5551 || Format == WebGLImageConversion::DataFormatRGBA4444 || Format == WebGLImageConversion::DataFormatRGB565;
    };
    ...
    struct UsesFloatIntermediateFormat {
        ...
        static const bool value = IsFloatFormat<Format>::value || IsHalfFloatFormat<Format>::value || Format == WebGLImageConversion::DataFormatRGBA2_10_10_10 || Format == WebGLImageConversion::DataFormatRGB10F11F11F || Format == WebGLImageConversion::DataFormatRGB5999;
    };

    template <int Format>
    struct IntermediateFormat {
        STATIC_ONLY(IntermediateFormat);
        static const int value = UsesFloatIntermediateFormat<Format>::value
    ...
    public:
            ...
            , m_success(false)
        {
            ...
            m_unpackedIntermediateSrcData = wrapArrayUnique(
                new uint8_t[m_srcSubRectangle.width() * MaxNumberOfComponents * MaxBytesPerComponent]);
...
#undef FORMATCONVERTER_CASE_ALPHAOP
    ...
    struct SupportsConversionFromDomElements {
        ...
        static const bool value = Format == WebGLImageConversion::DataFormatRGBA8 || Format == WebGLImageConversion::DataFormatRGB8 || Format == WebGLImageConversion::DataFormatRG8 || Format == WebGLImageConversion::DataFormatRA8 || Format == WebGLImageConversion::DataFormatR8 || Format == WebGLImageConversion::DataFormatRGBA32F || Format == WebGLImageConversion::DataFormatRGB32F || Format == WebGLImageConversion::DataFormatRG32F || Format == WebGLImageConversion::DataFormatRA32F || Format == WebGLImageConversion::DataFormatR32F || Format == WebGLImageConversion::DataFormatRGBA16F || Format == WebGLImageConversion::DataFormatRGB16F || Format == WebGLImageConversion::DataFormatRG16F || Format == WebGLImageConversion::DataFormatRA16F || Format == WebGLImageConversion::DataFormatR16F || Format == WebGLImageConversion::DataFormatRGBA5551 || Format == WebGLImageConversion::DataFormatRGBA4444 || Format == WebGLImageConversion::DataFormatRGB565;
    };
    ...
    void FormatConverter::convert()
    {
        ...
        if (srcFormatComesFromDOMElementOrImageData && SrcFormat != DstFormat && (DstFormat == WebGLImageConversion::DataFormatRGB5999 || DstFormat == WebGLImageConversion::DataFormatRGB10F11F11F)) {
            ASSERT_NOT_REACHED();
            return;
        }
        ...
        const SrcType* srcRowStart = static_cast<const SrcType*>(static_cast<const void*>(
            static_cast<const uint8_t*>(m_srcStart) + ((m_srcStride * m_srcSubRectangle.y()) + m_srcRowOffset)));
        ...
        if (trivialUnpack) {
            ...
            for (int d = 0; d < m_depth; ++d) {
                for (int i = 0; i < m_srcSubRectangle.height(); ++i) {
                    unpack<SrcFormat>(srcRowStart, reinterpret_cast<IntermType*>(m_unpackedIntermediateSrcData.get()),
                        m_srcSubRectangle.width());
    ...
    {
        return !frameBitmap.isNull() && !frameBitmap.empty() && frameBitmap.colorType() == kN32_SkColorType;
    }
    ...
    bool ignoreColorSpace)
{
    ...
    sk_sp<SkImage> skiaImage = m_image->imageForCurrentFrame(ColorBehavior::transformToGlobalTarget());
    ...
    if ((!skiaImage || ignoreColorSpace || (hasAlpha && !premultiplyAlpha)) && m_image->data()) {
