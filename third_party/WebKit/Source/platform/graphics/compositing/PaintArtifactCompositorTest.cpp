...
protected:
    ...
    void SetUp() override
    {
        ...
        m_webLayerTreeView = WTF::makeUnique<WebLayerTreeViewWithCompositorFrameSink>(settings);
    ...
    FlattensInheritedTransform)
{
    for (bool transformIsFlattened : { true, false }) {
        ...
        RefPtr<TransformPaintPropertyNode> transform1 = TransformPaintPropertyNode::create(TransformPaintPropertyNode::root(),
...
TEST_F(PaintArtifactCompositorTestWithPropertyTrees, SortingContextID)
{
    ...
    RefPtr<TransformPaintPropertyNode> transform2 = TransformPaintPropertyNode::create(transform1, TransformationMatrix(),
        FloatPoint3D(), false, 1,
        CompositingReason3DTransform);
    // Extends the 3D rendering context of transform2.
    RefPtr<TransformPaintPropertyNode> transform3 = TransformPaintPropertyNode::create(transform2, TransformationMatrix(),
        FloatPoint3D(), false, 1,
        CompositingReason3DTransform);
    // Establishes a 3D rendering context distinct from transform2.
    RefPtr<TransformPaintPropertyNode> transform4 = TransformPaintPropertyNode::create(transform2, TransformationMatrix(),
...
TEST_F(PaintArtifactCompositorTestWithPropertyTrees, NestedClips)
{
    ...
    RefPtr<ClipPaintPropertyNode> clip2 = ClipPaintPropertyNode::create(clip1, TransformPaintPropertyNode::root(),
...
{
    RefPtr<EffectPaintPropertyNode> effect1 = createOpacityOnlyEffect(EffectPaintPropertyNode::root(), 0.5);
    RefPtr<EffectPaintPropertyNode> effect2 = createOpacityOnlyEffect(effect1, 0.3);
    RefPtr<EffectPaintPropertyNode> effect3 = createOpacityOnlyEffect(EffectPaintPropertyNode::root(), 0.2);
...
{
    RefPtr<TransformPaintPropertyNode> scrollTranslation = TransformPaintPropertyNode::create(TransformPaintPropertyNode::root(),
...
{
    RefPtr<EffectPaintPropertyNode> effect = createOpacityOnlyEffect(EffectPaintPropertyNode::root(), 0.5);
...
{
    RefPtr<TransformPaintPropertyNode> transform = TransformPaintPropertyNode::create(TransformPaintPropertyNode::root(),
