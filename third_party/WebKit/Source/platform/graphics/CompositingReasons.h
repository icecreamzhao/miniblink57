...
const uint64_t CompositingReasonComboAllDirectReasons = CompositingReason3DTransform | CompositingReasonVideo | CompositingReasonCanvas | CompositingReasonPlugin | CompositingReasonIFrame | CompositingReasonBackfaceVisibilityHidden | CompositingReasonActiveAnimation | CompositingReasonTransitionProperty | CompositingReasonScrollDependentPosition | CompositingReasonOverflowScrollingTouch | CompositingReasonOverflowScrollingParent | CompositingReasonOutOfFlowClipping | CompositingReasonVideoOverlay | CompositingReasonWillChangeCompositingHint | CompositingReasonCompositorProxy | CompositingReasonBackdropFilter;

const uint64_t CompositingReasonComboAllDirectStyleDeterminedReasons = CompositingReason3DTransform | CompositingReasonBackfaceVisibilityHidden | CompositingReasonActiveAnimation | CompositingReasonTransitionProperty | CompositingReasonWillChangeCompositingHint | CompositingReasonCompositorProxy | CompositingReasonBackdropFilter;

const uint64_t CompositingReasonComboCompositedDescendants = CompositingReasonTransformWithCompositedDescendants | CompositingReasonIsolateCompositedDescendants | CompositingReasonOpacityWithCompositedDescendants | CompositingReasonMaskWithCompositedDescendants | CompositingReasonFilterWithCompositedDescendants | CompositingReasonBlendingWithCompositedDescendants | CompositingReasonReflectionWithCompositedDescendants | CompositingReasonClipsCompositingDescendants | CompositingReasonPositionFixedWithCompositedDescendants;

const uint64_t CompositingReasonCombo3DDescendants = CompositingReasonPreserve3DWith3DDescendants | CompositingReasonPerspectiveWith3DDescendants;

const uint64_t CompositingReasonComboAllStyleDeterminedReasons = CompositingReasonComboAllDirectStyleDeterminedReasons | CompositingReasonComboCompositedDescendants | CompositingReasonCombo3DDescendants | CompositingReasonInlineTransform;

const uint64_t CompositingReasonComboReasonsThatRequireOwnBacking = CompositingReasonComboAllDirectReasons | CompositingReasonOverlap | CompositingReasonAssumedOverlap | CompositingReasonNegativeZIndexChildren | CompositingReasonSquashingDisallowed | CompositingReasonTransformWithCompositedDescendants | CompositingReasonOpacityWithCompositedDescendants | CompositingReasonMaskWithCompositedDescendants | CompositingReasonFilterWithCompositedDescendants | CompositingReasonBlendingWithCompositedDescendants | CompositingReasonIsolateCompositedDescendants | CompositingReasonPreserve3DWith3DDescendants | // preserve-3d has to create
    // a backing store to ensure
    // that 3d-transformed
    // elements intersect.
    CompositingReasonBackdropFilter | CompositingReasonPositionFixedWithCompositedDescendants;

const uint64_t CompositingReasonComboSquashableReasons = CompositingReasonOverlap | CompositingReasonAssumedOverlap | CompositingReasonOverflowScrollingParent;
...
const uint64_t CompositingReasonTransformWithCompositedDescendants       = UINT64_C(1) << 32;
const uint64_t CompositingReasonOpacityWithCompositedDescendants         = UINT64_C(1) << 33;
const uint64_t CompositingReasonMaskWithCompositedDescendants            = UINT64_C(1) << 34;
const uint64_t CompositingReasonReflectionWithCompositedDescendants      = UINT64_C(1) << 35;
const uint64_t CompositingReasonFilterWithCompositedDescendants          = UINT64_C(1) << 36;
const uint64_t CompositingReasonBlendingWithCompositedDescendants        = UINT64_C(1) << 37;
const uint64_t CompositingReasonClipsCompositingDescendants              = UINT64_C(1) << 38;
const uint64_t CompositingReasonPerspectiveWith3DDescendants             = UINT64_C(1) << 39;
