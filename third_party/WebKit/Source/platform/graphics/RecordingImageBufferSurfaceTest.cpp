...
protected:
    ...
    {
        std::unique_ptr<MockSurfaceFactory> surfaceFactory = WTF::makeUnique<MockSurfaceFactory>();
        m_surfaceFactory = surfaceFactory.get();
        std::unique_ptr<RecordingImageBufferSurface> testSurface = WTF::wrapUnique(new RecordingImageBufferSurface(
        ...
        m_fakeImageBufferClient = WTF::wrapUnique(new FakeImageBufferClient(m_imageBuffer.get()));
