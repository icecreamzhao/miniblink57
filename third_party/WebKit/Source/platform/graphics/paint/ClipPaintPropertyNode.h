...
public:
    ...
    {
        return m_parent == o.m_parent && m_localTransformSpace == o.m_localTransformSpace && m_clipRect == o.m_clipRect && m_directCompositingReasons == o.m_directCompositingReasons;
    }
#endif
