...
public:
    ...
    void createAndAppend(Args&&... args)
    {
        ...
        DisplayItemClass& displayItem = m_newDisplayItemList.allocateAndConstruct<DisplayItemClass>(
...
#ifndef NDEBUG
    void showDebugDataWithPictures() const
    {
        showDebugDataInternal(true);
    }
#endif
...
private:
    ...
    void ensureNewDisplayItemListInitialCapacity()
    {
        if (m_newDisplayItemList.isEmpty()) {
            ...
            m_newDisplayItemList = DisplayItemList(m_currentPaintArtifact.getDisplayItemList().isEmpty()
    ...
    {
        return m_underInvalidationCheckingEnd - m_underInvalidationCheckingBegin > 0;
    }
