...
{
    return a.beginIndex == b.beginIndex && a.endIndex == b.endIndex && a.id == b.id && a.properties == b.properties && a.bounds == b.bounds && a.knownToBeOpaque == b.knownToBeOpaque && a.rasterInvalidationRects == b.rasterInvalidationRects;
}
