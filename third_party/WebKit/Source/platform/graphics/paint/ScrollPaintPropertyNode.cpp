...
{
    FloatSize scrollOffset = m_scrollOffsetTranslation->matrix().to2DTranslation();
    std::string mainThreadScrollingReasonsAsText = MainThreadScrollingReason::mainThreadScrollingReasonsAsText(
