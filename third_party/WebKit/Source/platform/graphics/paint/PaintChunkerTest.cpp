...
namespace {
    ...
    TEST_F(PaintChunkerTest, SingleNonEmptyRange)
    {
        ...
        EXPECT_THAT(chunks, ElementsAre(PaintChunk(0, 2, nullptr, defaultPaintChunkProperties())));
    }
    ...
    TEST_F(PaintChunkerTest, SamePropertiesTwiceCombineIntoOneChunk)
    {
        ...
        EXPECT_THAT(chunks, ElementsAre(PaintChunk(0, 3, nullptr, defaultPaintChunkProperties())));
    }
    ...
    TEST_F(PaintChunkerTest, BuildMultipleChunksWithSinglePropertyChanging)
    {
        ...
        EXPECT_THAT(chunks, ElementsAre(PaintChunk(0, 2, nullptr, defaultPaintChunkProperties()), PaintChunk(2, 3, nullptr, simpleTransform), PaintChunk(3, 4, nullptr, anotherTransform)));
    }
    ...
    TEST_F(PaintChunkerTest, BuildMultipleChunksWithDifferentPropertyChanges)
    {
        ...
        PaintChunkProperties simpleTransformAndEffectWithUpdatedTransform = defaultPaintChunkProperties();
    ...
    TEST_F(PaintChunkerTest, ChangingPropertiesWithoutItems)
    {
        ...
        EXPECT_THAT(chunks, ElementsAre(PaintChunk(0, 1, nullptr, defaultPaintChunkProperties()), PaintChunk(1, 2, nullptr, secondTransform)));
    }
