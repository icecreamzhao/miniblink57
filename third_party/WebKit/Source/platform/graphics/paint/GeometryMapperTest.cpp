    ...
    do {                                                                                   \
        ...
        EXPECT_RECT_EQ(expectedTransformedRect,                                            \
            geometryMapper->sourceToDestinationRect(                                       \
                inputRect, localPropertyTreeState.transform(),                             \
                ancestorPropertyTreeState.transform()));                                   \
        if (ancestorPropertyTreeState.transform() != localPropertyTreeState.transform()) { \
            EXPECT_EQ(                                                                     \
                expectedTransformToAncestor,                                               \
...
{
    RefPtr<TransformPaintPropertyNode> transform = TransformPaintPropertyNode::create(rootPropertyTreeState().transform(),
...
TEST_F(GeometryMapperTest, TranslationTransform)
{
    ...
    EXPECT_RECT_EQ(input, geometryMapper->ancestorToLocalRect(output, rootPropertyTreeState().transform(), localState.transform()));
}
...
TEST_F(GeometryMapperTest, NestedTransforms)
{
    ...
    RefPtr<TransformPaintPropertyNode> transform1 = TransformPaintPropertyNode::create(rootPropertyTreeState().transform(),
        rotateTransform, FloatPoint3D());

    TransformationMatrix scaleTransform;
    scaleTransform.scale(2);
    RefPtr<TransformPaintPropertyNode> transform2 = TransformPaintPropertyNode::create(transform1, scaleTransform,
        FloatPoint3D());
...
TEST_F(GeometryMapperTest, NestedTransformsScaleAndTranslation)
{
    ...
    RefPtr<TransformPaintPropertyNode> transform2 = TransformPaintPropertyNode::create(transform1, translateTransform,
        FloatPoint3D());
...
TEST_F(GeometryMapperTest, SiblingTransforms)
{
    ...
    RefPtr<TransformPaintPropertyNode> transform2 = TransformPaintPropertyNode::create(rootPropertyTreeState().transform(),
...
TEST_F(GeometryMapperTest, LowestCommonAncestor)
{
    ...
    RefPtr<TransformPaintPropertyNode> child1 = TransformPaintPropertyNode::create(rootPropertyTreeState().transform(),
        matrix, FloatPoint3D());
    RefPtr<TransformPaintPropertyNode> child2 = TransformPaintPropertyNode::create(rootPropertyTreeState().transform(),
        matrix, FloatPoint3D());
