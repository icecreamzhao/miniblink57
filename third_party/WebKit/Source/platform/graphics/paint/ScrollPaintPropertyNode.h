...
public:
    ...
    {
        return m_mainThreadScrollingReasons & MainThreadScrollingReason::kThreadedScrollingDisabled;
    }
    ...
    {
        RefPtr<ScrollPaintPropertyNode> cloned = adoptRef(new ScrollPaintPropertyNode(
    ...
    {
        return m_parent == o.m_parent && m_scrollOffsetTranslation == o.m_scrollOffsetTranslation && m_clip == o.m_clip && m_bounds == o.m_bounds && m_userScrollableHorizontal == o.m_userScrollableHorizontal && m_userScrollableVertical == o.m_userScrollableVertical && m_mainThreadScrollingReasons == o.m_mainThreadScrollingReasons;
    }
#endif
