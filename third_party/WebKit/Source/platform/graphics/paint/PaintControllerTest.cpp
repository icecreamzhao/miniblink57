...
public:
    PaintControllerTest()
        ...
        , ScopedPaintUnderInvalidationCheckingForTest(GetParam() & UnderInvalidationChecking)
...
TEST_P(PaintControllerTest, UpdateClip)
{
...

    {
        if (RuntimeEnabledFeatures::slimmingPaintV2Enabled()) {
            ...
            properties.propertyTreeState.setClip(clip.get());
...

    {
        if (RuntimeEnabledFeatures::slimmingPaintV2Enabled()) {
            ...
            PaintChunkProperties properties = defaultPaintChunkProperties();
            properties.propertyTreeState.setClip(clip2.get());
...
TEST_P(PaintControllerTest, CachedDisplayItems)
{
    ...
    const SkPicture* firstPicture = static_cast<const DrawingDisplayItem&>(
        getPaintController().getDisplayItemList()[0])
                                        .picture();
    const SkPicture* secondPicture = static_cast<const DrawingDisplayItem&>(
...
TEST_P(PaintControllerTest, CachedNestedSubsequenceUpdate)
{
    ...
    PaintChunkProperties container1BackgroundProperties = defaultPaintChunkProperties();
    PaintChunkProperties content1Properties = defaultPaintChunkProperties();
    PaintChunkProperties container1ForegroundProperties = defaultPaintChunkProperties();
    PaintChunkProperties container2BackgroundProperties = defaultPaintChunkProperties();
...
TEST_P(PaintControllerTest, SkipCache)
{
    ...
    EXPECT_DISPLAY_LIST(getPaintController().getDisplayItemList(), 3,
        ...
        TestDisplayItem(content, foregroundDrawingType));
    sk_sp<const SkPicture> picture1 = sk_ref_sp(static_cast<const DrawingDisplayItem&>(
        getPaintController().getDisplayItemList()[1])
                                                    .picture());
    sk_sp<const SkPicture> picture2 = sk_ref_sp(static_cast<const DrawingDisplayItem&>(
...
TEST_P(PaintControllerTest, PartialSkipCache)
{
    ...
    EXPECT_DISPLAY_LIST(getPaintController().getDisplayItemList(), 3,
        ...
        TestDisplayItem(content, foregroundDrawingType),
        TestDisplayItem(content, foregroundDrawingType));
    sk_sp<const SkPicture> picture0 = sk_ref_sp(static_cast<const DrawingDisplayItem&>(
        getPaintController().getDisplayItemList()[0])
                                                    .picture());
    sk_sp<const SkPicture> picture1 = sk_ref_sp(static_cast<const DrawingDisplayItem&>(
        getPaintController().getDisplayItemList()[1])
