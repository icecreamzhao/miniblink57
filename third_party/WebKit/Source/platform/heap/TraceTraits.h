...
struct TraceCollectionIfEnabled {
    ...
    {
        static_assert(WTF::IsTraceableInCollectionTrait<Traits>::value || weakHandlingFlag == WTF::WeakHandlingInCollections,
...
struct TraceInCollectionTrait<NoWeakHandlingInCollections,
    ...
    static bool trace(VisitorDispatcher visitor, void* self)
    {
        ...
        //   as a valid object.
        static_assert(!IsTraceableInCollectionTrait<Traits>::value || Traits::canClearUnusedSlotsWithMemset || std::is_polymorphic<T>::value,
...
struct TraceInCollectionTrait<
    ...
    blink::HeapHashTableBacking<HashTable<
        ...
        blink::HeapAllocator>>,
    void> {
    using Node = ListHashSetNode<NodeContents,
        blink::HeapListHashSetAllocator<T, inlineCapacity>>;
...
struct TraceInCollectionTrait<
    ...
    Traits> {
    using Node = ListHashSetNode<Value,
        blink::HeapListHashSetAllocator<Value, inlineCapacity>>;
