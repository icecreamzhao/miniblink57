...
template <typename T,
    TracenessMemberConfiguration tracenessConfiguration = TracenessMemberConfiguration::Traced>
class MemberBase {
...
public:
    ...
    template <typename U>
    MemberBase(const MemberBase<U>& other)
        : m_raw(other)
    {
        saveCreationThreadState();
        checkPointer();
...
public:
    ...
    Member(WTF::HashTableDeletedValueType x)
        : Parent(x)
    {
    }
...
public:
    SameThreadCheckedMember()
        : Parent()
    {
        saveCreationThreadState();
    }
    SameThreadCheckedMember(std::nullptr_t)
        : Parent(nullptr)
    {
        saveCreationThreadState();
    }

    SameThreadCheckedMember(T* raw)
        : Parent(raw)
    {
        saveCreationThreadState();
        checkPointer();
    ...
    SameThreadCheckedMember(WTF::HashTableDeletedValueType x)
        : Parent(x)
    {
        saveCreationThreadState();
        checkPointer();
    ...
    template <typename U>
    SameThreadCheckedMember(const Persistent<U>& other)
        : Parent(other)
    {
        saveCreationThreadState();
        checkPointer();
...
public:
    ...
    WeakMember(WTF::HashTableDeletedValueType x)
        : Parent(x)
    {
    }

    template <typename U>
    WeakMember(const Persistent<U>& other)
        : Parent(other)
    {
    }

    template <typename U>
    WeakMember(const Member<U>& other)
        : Parent(other)
    {
    }
...
public:
    ...
    UntracedMember(std::nullptr_t)
        : Parent(nullptr)
    {
    }

    UntracedMember(T* raw)
        : Parent(raw)
    {
    }

    template <typename U>
    UntracedMember(const Persistent<U>& other)
        : Parent(other)
    {
    }

    template <typename U>
    UntracedMember(const Member<U>& other)
        : Parent(other)
    {
    }

    UntracedMember(WTF::HashTableDeletedValueType x)
        : Parent(x)
    {
    }
