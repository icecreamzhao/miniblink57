...
public:
    ...
    PersistentBase(const PersistentBase& other)
        : m_raw(other)
    {
        saveCreationThreadHeap();
        initialize();
    ...
    template <typename U>
    PersistentBase(const Member<U>& other)
        : m_raw(other)
    {
        saveCreationThreadHeap();
        initialize();
...
private:
    ...
    void initialize()
    {
        ...
        TraceCallback traceCallback = TraceMethodDelegate<PersistentBase,
    ...
    {
        using Base = PersistentBase<typename std::remove_const<T>::type,
...
public:
    ...
    Persistent(WTF::HashTableDeletedValueType x)
        : Parent(x)
    {
    }
...
public:
    ...
    WeakPersistent(std::nullptr_t)
        : Parent(nullptr)
    {
    }
    WeakPersistent(T* raw)
        : Parent(raw)
    {
    }
    WeakPersistent(T& raw)
    ...
    WeakPersistent(const WeakPersistent& other)
        : Parent(other)
    {
    }
    template <typename U>
    WeakPersistent(const WeakPersistent<U>& other)
        : Parent(other)
    {
    }
    template <typename U>
    WeakPersistent(const Member<U>& other)
        : Parent(other)
    {
    }
...
public:
    ...
    CrossThreadPersistent(std::nullptr_t)
        : Parent(nullptr)
    {
    }
    CrossThreadPersistent(T* raw)
        : Parent(raw)
    {
    }
    CrossThreadPersistent(T& raw)
    ...
    CrossThreadPersistent(const CrossThreadPersistent& other)
        : Parent(other)
    {
    }
    template <typename U>
    ...
    template <typename U>
    CrossThreadPersistent(const Member<U>& other)
        : Parent(other)
    {
    }
    CrossThreadPersistent(WTF::HashTableDeletedValueType x)
        : Parent(x)
    {
    }
...
public:
    ...
    CrossThreadWeakPersistent(std::nullptr_t)
        : Parent(nullptr)
    {
    }
    CrossThreadWeakPersistent(T* raw)
        : Parent(raw)
    {
    }
    CrossThreadWeakPersistent(T& raw)
    ...
    template <typename U>
    CrossThreadWeakPersistent(const Member<U>& other)
        : Parent(other)
    {
    }
