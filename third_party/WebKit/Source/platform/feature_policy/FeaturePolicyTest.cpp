...
TEST_F(FeaturePolicyTest, PolicyParsedCorrectly)
{
    ...
    // Empty policy.
    WebParsedFeaturePolicy parsedPolicy = FeaturePolicy::parseFeaturePolicy("{}", m_originA.get(), &messages);
...
TEST_F(FeaturePolicyTest, TestInitialPolicy)
{
    ...
    std::unique_ptr<FeaturePolicy> policy1 = createFromParentPolicy(nullptr, m_originA);
...
TEST_F(FeaturePolicyTest, TestInitialSameOriginChildPolicy)
{
    ...
    std::unique_ptr<FeaturePolicy> policy1 = createFromParentPolicy(nullptr, m_originA);
    std::unique_ptr<FeaturePolicy> policy2 = createFromParentPolicy(policy1.get(), m_originA);
...
TEST_F(FeaturePolicyTest, TestInitialCrossOriginChildPolicy)
{
    ...
    std::unique_ptr<FeaturePolicy> policy1 = createFromParentPolicy(nullptr, m_originA);
    std::unique_ptr<FeaturePolicy> policy2 = createFromParentPolicy(policy1.get(), m_originB);
    EXPECT_TRUE(policy2->isFeatureEnabled(kDefaultOnFeature));
...
TEST_F(FeaturePolicyTest, TestFrameSelfInheritance)
{
    ...
    EXPECT_EQ(0UL, messages.size());
    std::unique_ptr<FeaturePolicy> policy2 = createFromParentPolicy(policy1.get(), m_originA);
    std::unique_ptr<FeaturePolicy> policy3 = createFromParentPolicy(policy2.get(), m_originA);
    std::unique_ptr<FeaturePolicy> policy4 = createFromParentPolicy(policy1.get(), m_originB);
    std::unique_ptr<FeaturePolicy> policy5 = createFromParentPolicy(policy4.get(), m_originB);
    EXPECT_TRUE(policy2->isFeatureEnabled(kDefaultSelfFeature));
...
TEST_F(FeaturePolicyTest, TestSelectiveFrameInheritance)
{
    ...
    EXPECT_EQ(0UL, messages.size());
    std::unique_ptr<FeaturePolicy> policy2 = createFromParentPolicy(policy1.get(), m_originB);
    std::unique_ptr<FeaturePolicy> policy3 = createFromParentPolicy(policy1.get(), m_originC);
    std::unique_ptr<FeaturePolicy> policy4 = createFromParentPolicy(policy3.get(), m_originB);
    EXPECT_TRUE(policy2->isFeatureEnabled(kDefaultSelfFeature));
    EXPECT_FALSE(policy3->isFeatureEnabled(kDefaultSelfFeature));
    EXPECT_FALSE(policy4->isFeatureEnabled(kDefaultSelfFeature));
}
...
TEST_F(FeaturePolicyTest, TestChildPolicyCanBlockChildren)
{
    ...
    EXPECT_EQ(0UL, messages.size());
    std::unique_ptr<FeaturePolicy> policy3 = createFromParentPolicy(policy2.get(), m_originC);
    EXPECT_TRUE(policy2->isFeatureEnabled(kDefaultOnFeature));
...
TEST_F(FeaturePolicyTest, TestDefaultOnEnablesForAllAncestors)
{
    ...
    EXPECT_EQ(0UL, messages.size());
    std::unique_ptr<FeaturePolicy> policy2 = createFromParentPolicy(policy1.get(), m_originB);
    std::unique_ptr<FeaturePolicy> policy3 = createFromParentPolicy(policy2.get(), m_originB);
    std::unique_ptr<FeaturePolicy> policy4 = createFromParentPolicy(policy2.get(), m_originC);
    EXPECT_FALSE(policy1->isFeatureEnabled(kDefaultOnFeature));
    EXPECT_TRUE(policy2->isFeatureEnabled(kDefaultOnFeature));
...
TEST_F(FeaturePolicyTest, TestEnabledFrameCanDelegateByDefault)
{
    ...
    std::unique_ptr<FeaturePolicy> policy2 = createFromParentPolicy(policy1.get(), m_originB);
    std::unique_ptr<FeaturePolicy> policy3 = createFromParentPolicy(policy2.get(), m_originC);
    std::unique_ptr<FeaturePolicy> policy4 = createFromParentPolicy(policy1.get(), m_originC);
    EXPECT_TRUE(policy1->isFeatureEnabled(kDefaultOnFeature));
    EXPECT_TRUE(policy2->isFeatureEnabled(kDefaultOnFeature));
    EXPECT_TRUE(policy3->isFeatureEnabled(kDefaultOnFeature));
