...
TEST(WebProcessMemoryDumpTest, IntegrationTest)
{
    ...
    blink::WebMemoryAllocatorDumpGuid guid = base::trace_event::MemoryAllocatorDumpGuid("id_1").ToUint64();
    ...
    auto allocator_dumps_edges = wpmd1->process_memory_dump()->allocator_dumps_edges();
    ...
    auto discardable_memory = discardable_memory_allocator.AllocateLockedDiscardableMemory(1024);
