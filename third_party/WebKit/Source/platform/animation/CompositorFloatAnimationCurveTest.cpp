...
TEST(WebFloatAnimationCurveTest, EaseTimingFunction)
{
    ...
    curve->addKeyframe(CompositorFloatKeyframe(
        0, 0, *CubicBezierTimingFunction::preset(CubicBezierTimingFunction::EaseType::EASE)));
    curve->addKeyframe(
        CompositorFloatKeyframe(1, 1, *LinearTimingFunction::shared()));
...
TEST(WebFloatAnimationCurveTest, EaseInTimingFunction)
{
    std::unique_ptr<CompositorFloatAnimationCurve> curve = CompositorFloatAnimationCurve::create();
    curve->addKeyframe(CompositorFloatKeyframe(
        0, 0, *CubicBezierTimingFunction::preset(CubicBezierTimingFunction::EaseType::EASE_IN)));
    curve->addKeyframe(
        CompositorFloatKeyframe(1, 1, *LinearTimingFunction::shared()));
...
TEST(WebFloatAnimationCurveTest, EaseOutTimingFunction)
{
    std::unique_ptr<CompositorFloatAnimationCurve> curve = CompositorFloatAnimationCurve::create();
    curve->addKeyframe(CompositorFloatKeyframe(
        0, 0, *CubicBezierTimingFunction::preset(CubicBezierTimingFunction::EaseType::EASE_OUT)));
    curve->addKeyframe(
        CompositorFloatKeyframe(1, 1, *LinearTimingFunction::shared()));
...
TEST(WebFloatAnimationCurveTest, EaseInOutTimingFunction)
{
    std::unique_ptr<CompositorFloatAnimationCurve> curve = CompositorFloatAnimationCurve::create();
    curve->addKeyframe(CompositorFloatKeyframe(
        0, 0, *CubicBezierTimingFunction::preset(CubicBezierTimingFunction::EaseType::EASE_IN_OUT)));
    curve->addKeyframe(
        CompositorFloatKeyframe(1, 1, *LinearTimingFunction::shared()));
