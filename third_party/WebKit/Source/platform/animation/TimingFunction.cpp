...
String CubicBezierTimingFunction::toString() const
{
    ...
    case CubicBezierTimingFunction::EaseType::CUSTOM:
        return "cubic-bezier(" + String::numberToStringECMAScript(this->x1()) + ", " + String::numberToStringECMAScript(this->y1()) + ", " + String::numberToStringECMAScript(this->x2()) + ", " + String::numberToStringECMAScript(this->y2()) + ")";
    default:
        NOTREACHED();
        return "";
    }
