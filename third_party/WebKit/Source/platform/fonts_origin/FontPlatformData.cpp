...
bool FontPlatformData::operator==(const FontPlatformData& a) const
{
    ...
    return typefacesEqual && m_textSize == a.m_textSize && m_isHashTableDeletedValue == a.m_isHashTableDeletedValue && m_syntheticBold == a.m_syntheticBold && m_syntheticItalic == a.m_syntheticItalic
#if OS(LINUX) || OS(ANDROID)
        && m_style == a.m_style
#endif
