    ...
    , m_isVerticalOffset(fontDescription.isVerticalAnyUpright())
{
    ...
    m_expansionOpportunityCount = Character::expansionOpportunityCount(run, isAfterExpansion);
    ...
    float& offset)
{
    ...
    bool treatAsSpace = (Character::treatAsSpace(character) || (m_normalizeSpace && Character::isNormalizedCanvasSpaceCharacter(character))) && (character != '\t' || !m_allowTabs);
