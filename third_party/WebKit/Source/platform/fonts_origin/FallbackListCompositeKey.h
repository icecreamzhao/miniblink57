...
public:
    ...
    {
        return m_hash == other.m_hash && m_computedSize == other.m_computedSize && m_letterSpacing == other.m_letterSpacing && m_wordSpacing == other.m_wordSpacing && m_bitmapFields == other.m_bitmapFields && m_auxiliaryBitmapFields == other.m_auxiliaryBitmapFields && m_fontCacheKeys == other.m_fontCacheKeys;
    }
