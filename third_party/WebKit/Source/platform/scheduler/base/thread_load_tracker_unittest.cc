...
namespace scheduler {
    ...
    TEST(ThreadLoadTrackerTest, RecordTasks)
    {
        ...
        EXPECT_THAT(result, ElementsAre(std::make_pair(SecondsToTime(11), 0), std::make_pair(SecondsToTime(12), 0.1), std::make_pair(SecondsToTime(13), 0.1), std::make_pair(SecondsToTime(14), 0.2), std::make_pair(SecondsToTime(15), 0.5), std::make_pair(SecondsToTime(16), 1.0), std::make_pair(SecondsToTime(17), 0.5)));
    }
    ...
    TEST(ThreadLoadTrackerTest, PauseAndResume)
    {
        ...
        EXPECT_THAT(result, ElementsAre(std::make_pair(SecondsToTime(21), 0.1), std::make_pair(SecondsToTime(22), 0.1), std::make_pair(SecondsToTime(23), 0), std::make_pair(SecondsToTime(27), 0.1)));
    }
    ...
    TEST(ThreadLoadTrackerTest, DisabledByDefault)
    {
        ...
        EXPECT_THAT(result, ElementsAre(std::make_pair(SecondsToTime(27), 0), std::make_pair(SecondsToTime(28), 0), std::make_pair(SecondsToTime(29), 1)));
    }
