...
TEST_F(RenderWidgetSignalsTest, RenderWidgetSchedulingStateLifeCycle)
{
    ...
    std::unique_ptr<RenderWidgetSchedulingState> widget1_state = render_widget_signals_->NewRenderWidgetSchedulingState();
...
TEST_F(RenderWidgetSignalsTest, MultipleRenderWidgetsBecomeHiddenThenVisible)
{
    ...
    std::unique_ptr<RenderWidgetSchedulingState> widget3_state = render_widget_signals_->NewRenderWidgetSchedulingState();
    Mock::VerifyAndClearExpectations(mock_observer_.get());
...
TEST_F(RenderWidgetSignalsTest, TouchHandlerAddedAndRemoved_VisibleWidget)
{
    ...
    std::unique_ptr<RenderWidgetSchedulingState> widget_state = render_widget_signals_->NewRenderWidgetSchedulingState();
    Mock::VerifyAndClearExpectations(mock_observer_.get());
