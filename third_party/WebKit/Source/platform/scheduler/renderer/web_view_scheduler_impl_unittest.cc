...
namespace scheduler {
    ...
    public:
        ...
        void SetUp() override
        {
            ...
            mock_task_runner_ = make_scoped_refptr(new cc::OrderedSimpleTaskRunner(clock_.get(), true));
            ...
            web_frame_scheduler_ = web_view_scheduler_->createWebFrameSchedulerImpl(nullptr);
        }
    ...
    TEST_F(WebViewSchedulerImplTest, GracePeriodAppliesToNewBackgroundFrames)
    {
        ...
        std::unique_ptr<WebFrameSchedulerImpl> web_frame_scheduler = web_view_scheduler_->createWebFrameSchedulerImpl(nullptr);
        blink::WebTaskRunner* timer_task_runner = web_frame_scheduler->timerTaskRunner().get();
    ...
    TEST_F(WebViewSchedulerImplTest, RepeatingTimers_OneBackgroundOneForeground)
    {
        ...
        std::unique_ptr<WebFrameSchedulerImpl> web_frame_scheduler2 = web_view_scheduler2->createWebFrameSchedulerImpl(nullptr);
    ...
    TEST_F(WebViewSchedulerImplTest, VirtualTime_TimerFastForwarding)
    {
        ...
        size_t initial_virtual_time_ms = web_frame_scheduler_->timerTaskRunner()
        ...
        EXPECT_THAT(real_times, ElementsAre(initial_real_time, initial_real_time, initial_real_time));
        EXPECT_THAT(virtual_times_ms, ElementsAre(initial_virtual_time_ms + 2, initial_virtual_time_ms + 20, initial_virtual_time_ms + 200));
    }
    ...
    {
        for (int i = 0; i < 10; i++) {
            WebFrameSchedulerImpl* web_frame_scheduler = web_view_scheduler_->createWebFrameSchedulerImpl(nullptr).release();
            web_frame_scheduler->timerTaskRunner()->postDelayedTask(
    ...
    TEST_F(WebViewSchedulerImplTest, DeleteThrottledQueue_InTask)
    {
        ...
        WebFrameSchedulerImpl* web_frame_scheduler = web_view_scheduler_->createWebFrameSchedulerImpl(nullptr).release();
        RefPtr<blink::WebTaskRunner> timer_task_runner = web_frame_scheduler->timerTaskRunner();
    ...
    namespace {
        ...
        using ScopedExpensiveBackgroundTimerThrottlingForTest = ScopedRuntimeEnabledFeatureForTest<
    ...
    TEST_F(WebViewSchedulerImplTest, BackgroundThrottlingGracePeriod)
    {
        ...
        mock_task_runner_->RunUntilTime(base::TimeTicks() + base::TimeDelta::FromMilliseconds(2500));
        ...
        mock_task_runner_->RunUntilTime(base::TimeTicks() + base::TimeDelta::FromMilliseconds(3500));
        ...
        mock_task_runner_->RunUntilTime(base::TimeTicks() + base::TimeDelta::FromMilliseconds(11500));
    ...
    TEST_F(WebViewSchedulerImplTest, OpenWebSocketExemptsFromBudgetThrottling)
    {
        ...
        std::unique_ptr<WebFrameSchedulerImpl> web_frame_scheduler1 = web_view_scheduler->createWebFrameSchedulerImpl(nullptr);
        std::unique_ptr<WebFrameSchedulerImpl> web_frame_scheduler2 = web_view_scheduler->createWebFrameSchedulerImpl(nullptr);

        web_view_scheduler->setPageVisible(false);

        // Wait for 20s to avoid initial throttling delay.
        mock_task_runner_->RunUntilTime(base::TimeTicks() + base::TimeDelta::FromMilliseconds(20500));
        ...
        mock_task_runner_->RunUntilTime(base::TimeTicks() + base::TimeDelta::FromMilliseconds(55500));
        ...
        mock_task_runner_->RunUntilTime(base::TimeTicks() + base::TimeDelta::FromMilliseconds(58500));
        ...
        mock_task_runner_->RunUntilTime(base::TimeTicks() + base::TimeDelta::FromMilliseconds(59500));
        ...
        mock_task_runner_->RunUntilTime(base::TimeTicks() + base::TimeDelta::FromMilliseconds(70500));
