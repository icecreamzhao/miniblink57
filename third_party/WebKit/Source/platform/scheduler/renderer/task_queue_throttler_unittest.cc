...
namespace scheduler {
    ...
    namespace {
        ...
        {
            internal::TaskQueueImpl* task_queue_impl = reinterpret_cast<internal::TaskQueueImpl*>(task_queue);
            if (!task_queue_impl->IsQueueEnabled())
                return true;
            return task_queue_impl->GetFenceForTest() == static_cast<internal::EnqueueOrder>(internal::EnqueueOrderValues::BLOCKING_FENCE);
        }
    }
    ...
    TEST_F(TaskQueueThrottlerTest, WakeUpForNonDelayedTask)
    {
        ...
        EXPECT_THAT(run_times,
            ElementsAre(base::TimeTicks() + base::TimeDelta::FromMilliseconds(1000.0)));
    }
    ...
    TEST_F(TaskQueueThrottlerTest, WakeUpForDelayedTask)
    {
        ...
        mock_task_runner_->RunUntilIdle();
        EXPECT_THAT(run_times,
            ElementsAre(base::TimeTicks() + base::TimeDelta::FromMilliseconds(2000.0)));
    }
    ...
    {
        TaskQueueThrottler::TimeBudgetPool* pool = task_queue_throttler_->CreateTimeBudgetPool("test", base::nullopt,
            base::nullopt);
    ...
    TEST_F(TaskQueueThrottlerTest, EnableAndDisableTimeBudgetPool)
    {
        ...
        EXPECT_THAT(run_times, ElementsAre(base::TimeTicks() + base::TimeDelta::FromMilliseconds(1000)));
        run_times.clear();
        ...
        EXPECT_THAT(run_times, ElementsAre(base::TimeTicks() + base::TimeDelta::FromMilliseconds(2000)));
        run_times.clear();
        ...
        EXPECT_THAT(run_times, ElementsAre(base::TimeTicks() + base::TimeDelta::FromMilliseconds(4000)));
        run_times.clear();
    ...
    TEST_F(TaskQueueThrottlerTest, TwoQueuesTimeBudgetThrottling)
    {
        ...
        scoped_refptr<TaskQueue> second_queue = scheduler_->NewTimerTaskRunner(TaskQueue::QueueType::TEST);
    ...
    TEST_F(TaskQueueThrottlerTest, MaxThrottlingDuration)
    {
        ...
        TaskQueueThrottler::TimeBudgetPool* pool = task_queue_throttler_->CreateTimeBudgetPool(
    ...
    TEST_F(TaskQueueThrottlerTest, EnableAndDisableThrottling)
    {
        ...
        mock_task_runner_->RunUntilTime(base::TimeTicks() + base::TimeDelta::FromMilliseconds(300));

        // Disable throttling - task should run immediately.
        task_queue_throttler_->DisableThrottling();

        mock_task_runner_->RunUntilTime(base::TimeTicks() + base::TimeDelta::FromMilliseconds(500));

        EXPECT_THAT(run_times, ElementsAre(base::TimeTicks() + base::TimeDelta::FromMilliseconds(300)));
        run_times.clear();
        ...
        mock_task_runner_->RunUntilTime(base::TimeTicks() + base::TimeDelta::FromMilliseconds(1300));
        ...
        mock_task_runner_->RunUntilTime(base::TimeTicks() + base::TimeDelta::FromMilliseconds(1400));
    ...
    TEST_F(TaskQueueThrottlerTest, EnableAndDisableThrottlingAndTimeBudgets)
    {
        ...
        mock_task_runner_->RunUntilTime(base::TimeTicks() + base::TimeDelta::FromMilliseconds(100));
