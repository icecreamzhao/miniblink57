...
#include "base/device/base/synchronization/shared_memory_seqlock_buffer.h"
...
namespace scheduler {
    ...
    private:
        ...
        enum class ExpensiveTaskPolicy { RUN,
            BLOCK,
            THROTTLE };
        ...
        struct TaskQueuePolicy {
            ...
            {
                return is_enabled == other.is_enabled && priority == other.priority && time_domain_type == other.time_domain_type;
            }
        ...
        struct Policy {
            ...
            {
                return compositor_queue_policy == other.compositor_queue_policy && loading_queue_policy == other.loading_queue_policy && timer_queue_policy == other.timer_queue_policy && default_queue_policy == other.default_queue_policy && rail_mode == other.rail_mode && should_disable_throttling == other.should_disable_throttling;
            }
        ...
        using TaskQueueVoterMap = std::map<scoped_refptr<TaskQueue>,
            std::unique_ptr<TaskQueue::QueueEnabledVoter>>;
        ...
        using SeqLockQueueingTimeEstimator = device::SharedMemorySeqLockBuffer<QueueingTimeEstimator>;
