...
namespace scheduler {
    ...
    public:
        ...
        {
            base::TimeDelta non_idle_time = base::TimeDelta::FromMilliseconds(compositor_time);
        ...
        {
            base::TimeDelta non_idle_time1 = base::TimeDelta::FromMilliseconds(compositor_time1);
            base::TimeDelta non_idle_time2 = base::TimeDelta::FromMilliseconds(compositor_time2);
            base::PendingTask task(FROM_HERE, base::Closure());
            estimator_->WillProcessTask(task);
