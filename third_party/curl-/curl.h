...
#if defined(WIN32) && !defined(_WIN32_WCE) && !defined(__GNUC__) && !defined(__CYGWIN__) || defined(__MINGW32__)
...
/* HP-UX systems version 9, 10 and 11 lack sys/select.h and so does oldish
   ...
   require it! */
#if defined(_AIX) || defined(__NOVELL_LIBC__) || defined(__NetBSD__) || defined(__minix) || defined(__SYMBIAN32__) || defined(__INTEGRITY)
