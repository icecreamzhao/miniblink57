...
protected:
    ...
    void SetUp() override
    {
        ...
        const std::string vertexShaderSource = SHADER_SOURCE(#version 300 es\n
        ...
        const std::string fragmentShaderSource = SHADER_SOURCE(#version 300 es\n
...
public:
    ...
    {
        EGLWindow* eglWindow = new EGLWindow(param.majorVersion, param.minorVersion, param.eglParameters);
    ...
    {
        const std::string testVertexShaderSource = SHADER_SOURCE(#version 300 es\n
                                                                     precision highp float;
        ...
        const std::string testFragmentShaderSource = SHADER_SOURCE(#version 300 es \n
                                                                       precision highp float;
...
TEST_P(ProgramBinariesAcrossPlatforms, CreateAndReloadBinary)
{
    ...
    if (firstRenderer.eglParameters.deviceType != EGL_PLATFORM_ANGLE_DEVICE_TYPE_WARP_ANGLE && secondRenderer.eglParameters.deviceType == EGL_PLATFORM_ANGLE_DEVICE_TYPE_WARP_ANGLE) {
