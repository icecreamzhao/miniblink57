...
protected:
    ...
    void SetUp() override
    {
        ...
        const std::string vsSource = "precision highp float;\n"
        ...
        EGLImageKHR* outSourceImage)
    {
        ...
        EGLImageKHR image = eglCreateImageKHR(window->getDisplay(), window->getContext(), EGL_GL_TEXTURE_2D_KHR,
        ...
        EGLImageKHR* outSourceImage)
    {
        ...
        // Create an image from the source texture
        EGLWindow* window = getEGLWindow();
        EGLImageKHR image = eglCreateImageKHR(window->getDisplay(), window->getContext(), imageTarget,
            reinterpretHelper<EGLClientBuffer>(source), nullptr);
        ...
        EGLImageKHR* outSourceImage)
    {
        ...
        EGLImageKHR image = eglCreateImageKHR(window->getDisplay(), window->getContext(), EGL_GL_TEXTURE_3D_KHR,
        ...
        EGLImageKHR* outSourceImage)
    {
        ...
        EGLWindow* window = getEGLWindow();
        EGLImageKHR image = eglCreateImageKHR(window->getDisplay(), window->getContext(), EGL_GL_RENDERBUFFER_KHR,
            reinterpretHelper<EGLClientBuffer>(source), nullptr);
...
{
    EGLWindow* window = getEGLWindow();
    if (!extensionEnabled("OES_EGL_image") || !eglDisplayExtensionEnabled(window->getDisplay(), "EGL_KHR_image_base") || !eglDisplayExtensionEnabled(window->getDisplay(), "EGL_KHR_gl_texture_2D_image")) {
...
{
    EGLWindow* window = getEGLWindow();
    if (!extensionEnabled("OES_EGL_image") || !eglDisplayExtensionEnabled(window->getDisplay(), "EGL_KHR_image_base")) {
    ...
    if (eglDisplayExtensionEnabled(window->getDisplay(), "EGL_KHR_gl_texture_3D_image") && getClientVersion() >= 3) {
...
{
    EGLWindow* window = getEGLWindow();
    if (!extensionEnabled("OES_EGL_image") || !eglDisplayExtensionEnabled(window->getDisplay(), "EGL_KHR_image_base") || !eglDisplayExtensionEnabled(window->getDisplay(), "EGL_KHR_gl_texture_cubemap_image")) {
        std::cout << "Test skipped because OES_EGL_image, EGL_KHR_image_base or "
...
{
    EGLWindow* window = getEGLWindow();
    if (!extensionEnabled("OES_EGL_image") || !eglDisplayExtensionEnabled(window->getDisplay(), "EGL_KHR_image_base") || !eglDisplayExtensionEnabled(window->getDisplay(), "EGL_KHR_gl_texture_3D_image")) {
        std::cout << "Test skipped because OES_EGL_image, EGL_KHR_image_base or "
...
{
    EGLWindow* window = getEGLWindow();
    if (!extensionEnabled("OES_EGL_image") || !eglDisplayExtensionEnabled(window->getDisplay(), "EGL_KHR_image_base") || !eglDisplayExtensionEnabled(window->getDisplay(), "EGL_KHR_gl_renderbuffer_image")) {
        std::cout << "Test skipped because OES_EGL_image, EGL_KHR_image_base or "
