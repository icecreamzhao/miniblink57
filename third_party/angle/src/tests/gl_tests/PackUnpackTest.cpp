...
protected:
    ...
    void SetUp() override
    {
        ...
        const std::string vs = SHADER_SOURCE(#version 300 es\n
        ...
        const std::string sNormFS = SHADER_SOURCE(#version 300 es\n
                                                      precision mediump float;
        ...
        // Fragment Shader source
        const std::string halfFS = SHADER_SOURCE(#version 300 es\n
                                                     precision mediump float;
                                                 uniform mediump vec2 v;
                                                 layout(location = 0) out mediump vec4 fragColor;
