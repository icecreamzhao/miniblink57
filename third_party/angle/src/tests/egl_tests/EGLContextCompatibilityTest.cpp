...
protected:
    bool areConfigsCompatible(EGLConfig c1, EGLConfig c2, EGLint surfaceBit)
    {
        ...
        return colorBufferType1 == colorBufferType2 && red1 == red2 && green1 == green2 && blue1 == blue2 && alpha1 == alpha2 && depth1 == depth2 && stencil1 == stencil2 && (surfaceType1 & surfaceBit) != 0 && (surfaceType2 & surfaceBit) != 0;
    }
