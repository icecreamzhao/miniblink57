...
protected:
    ...
    void CreateD3D11Device()
    {
        ...
        HRESULT hr = mD3D11CreateDevice(nullptr, D3D_DRIVER_TYPE_HARDWARE, 0, 0, nullptr, 0,
    ...
    void CreateD3D11FL9_3Device()
    {
        ...
        HRESULT hr = mD3D11CreateDevice(nullptr, D3D_DRIVER_TYPE_HARDWARE, 0, 0, &fl93, 1, D3D11_SDK_VERSION,
...
TEST_F(EGLDeviceCreationTest, BasicD3D11DeviceViaFuncPointer)
{
    ...
    PFNEGLCREATEDEVICEANGLEPROC createDeviceANGLE = (PFNEGLCREATEDEVICEANGLEPROC)eglGetProcAddress("eglCreateDeviceANGLE");
    PFNEGLRELEASEDEVICEANGLEPROC releaseDeviceANGLE = (PFNEGLRELEASEDEVICEANGLEPROC)eglGetProcAddress("eglReleaseDeviceANGLE");

    EGLDeviceEXT eglDevice = createDeviceANGLE(EGL_D3D11_DEVICE_ANGLE, reinterpret_cast<void*>(mDevice), nullptr);
    ASSERT_NE(EGL_NO_DEVICE_EXT, eglDevice);
    ASSERT_EGL_SUCCESS();
