...
public:
    CollectVertexVariablesTest()
        : CollectVariablesTest(GL_VERTEX_SHADER)
    {
    }
};
...
public:
    CollectFragmentVariablesTest()
        : CollectVariablesTest(GL_FRAGMENT_SHADER)
    {
    }
};
...
{
    const std::string& shaderString = "attribute vec4 position;\n"
                                      "void main() {\n"
...
{
    const std::string& fragColorShader = "precision mediump float;\n"
                                         "void main() {\n"
...
{
    const std::string& fragDataShader = "#extension GL_EXT_draw_buffers : require\n"
                                        "precision mediump float;\n"
                                        "void main() {\n"
...
{
    const std::string& fragDepthShader = "#extension GL_EXT_frag_depth : require\n"
                                         "precision mediump float;\n"
                                         "void main() {\n"
                                         "   gl_FragDepthEXT = 0.7;"
                                         "}\n";
...
{
    const std::string& fragDepthHighShader = "#version 300 es\n"
                                             "precision mediump float;\n"
                                             "void main() {\n"
                                             "   gl_FragDepth = 0.7;"
                                             "}\n";
