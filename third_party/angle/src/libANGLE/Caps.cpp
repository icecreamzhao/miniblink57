...
static bool DetermineHalfFloatTextureFilteringSupport(const TextureCapsMap& textureCaps)
{
    ...
    return DetermineHalfFloatTextureSupport(textureCaps) && GetFormatSupport(textureCaps, requiredFormats, true, true, false);
}
...
static bool DetermineFloatTextureFilteringSupport(const TextureCapsMap& textureCaps)
{
    ...
    return DetermineFloatTextureSupport(textureCaps) && GetFormatSupport(textureCaps, requiredFormats, true, true, false);
}
...
static bool DetermineSRGBTextureSupport(const TextureCapsMap& textureCaps)
{
    ...
    return GetFormatSupport(textureCaps, requiredFilterFormats, true, true, false) && GetFormatSupport(textureCaps, requiredRenderFormats, true, false, true);
}
