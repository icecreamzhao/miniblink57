...
void VS_Passthrough2D(in float2 inPosition
                      : POSITION, in float2 inTexCoord
                      : TEXCOORD0,
                      out float4 outPosition
                      : SV_POSITION, out float2 outTexCoord
                      : TEXCOORD0)
{
...
float PS_PassthroughDepth2D(in float4 inPosition
                            : SV_POSITION, in float2 inTexCoord
                            : TEXCOORD0)
    : SV_DEPTH
{
...
float4 PS_PassthroughRGBA2D(in float4 inPosition
                            : SV_POSITION, in float2 inTexCoord
                            : TEXCOORD0)
    : SV_TARGET0
{
...
uint4 PS_PassthroughRGBA2DUI(in float4 inPosition
                             : SV_POSITION, in float2 inTexCoord
                             : TEXCOORD0)
    : SV_TARGET0
{
...
int4 PS_PassthroughRGBA2DI(in float4 inPosition
                           : SV_POSITION, in float2 inTexCoord
                           : TEXCOORD0)
    : SV_TARGET0
{
...
float4 PS_PassthroughRGB2D(in float4 inPosition
                           : SV_POSITION, in float2 inTexCoord
                           : TEXCOORD0)
    : SV_TARGET0
{
...
uint4 PS_PassthroughRGB2DUI(in float4 inPosition
                            : SV_POSITION, in float2 inTexCoord
                            : TEXCOORD0)
    : SV_TARGET0
{
...
int4 PS_PassthroughRGB2DI(in float4 inPosition
                          : SV_POSITION, in float2 inTexCoord
                          : TEXCOORD0)
    : SV_TARGET0
{
...
float4 PS_PassthroughRG2D(in float4 inPosition
                          : SV_POSITION, in float2 inTexCoord
                          : TEXCOORD0)
    : SV_TARGET0
{
...
uint4 PS_PassthroughRG2DUI(in float4 inPosition
                           : SV_POSITION, in float2 inTexCoord
                           : TEXCOORD0)
    : SV_TARGET0
{
...
int4 PS_PassthroughRG2DI(in float4 inPosition
                         : SV_POSITION, in float2 inTexCoord
                         : TEXCOORD0)
    : SV_TARGET0
{
...
float4 PS_PassthroughR2D(in float4 inPosition
                         : SV_POSITION, in float2 inTexCoord
                         : TEXCOORD0)
    : SV_TARGET0
{
...
uint4 PS_PassthroughR2DUI(in float4 inPosition
                          : SV_POSITION, in float2 inTexCoord
                          : TEXCOORD0)
    : SV_TARGET0
{
...
int4 PS_PassthroughR2DI(in float4 inPosition
                        : SV_POSITION, in float2 inTexCoord
                        : TEXCOORD0)
    : SV_TARGET0
{
...
float4 PS_PassthroughLum2D(in float4 inPosition
                           : SV_POSITION, in float2 inTexCoord
                           : TEXCOORD0)
    : SV_TARGET0
{
...
float4 PS_PassthroughLumAlpha2D(in float4 inPosition
                                : SV_POSITION, in float2 inTexCoord
                                : TEXCOORD0)
    : SV_TARGET0
{
