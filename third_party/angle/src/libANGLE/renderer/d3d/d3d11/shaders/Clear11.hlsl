...
void VS_ClearFloat(in float3 inPosition
                   : POSITION, in float4 inColor
                   : COLOR,
                   out float4 outPosition
                   : SV_POSITION, out float4 outColor
                   : COLOR)
{
...
PS_OutputFloat PS_ClearFloat(in float4 inPosition
                             : SV_POSITION, in float4 inColor
                             : COLOR)
{
...
PS_OutputFloat_FL9 PS_ClearFloat_FL9(in float4 inPosition
                                     : SV_POSITION, in float4 inColor
                                     : COLOR)
{
...
void VS_ClearUint(in float3 inPosition
                  : POSITION, in uint4 inColor
                  : COLOR,
                  out float4 outPosition
                  : SV_POSITION, out uint4 outColor
                  : COLOR)
{
    outPosition = float4(inPosition, 1.0f);
    outColor = inColor;
...
PS_OutputUint PS_ClearUint(in float4 inPosition
                           : SV_POSITION, in uint4 inColor
                           : COLOR)
{
...
void VS_ClearSint(in float3 inPosition
                  : POSITION, in int4 inColor
                  : COLOR,
                  out float4 outPosition
                  : SV_POSITION, out int4 outColor
                  : COLOR)
{
    outPosition = float4(inPosition, 1.0f);
    outColor = inColor;
...
PS_OutputSint PS_ClearSint(in float4 inPosition
                           : SV_POSITION, in int4 inColor
                           : COLOR)
{
