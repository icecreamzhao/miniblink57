...
egl::Error DXGISwapChainWindowSurfaceWGL::createSwapChain()
{
    ...
    mRenderbufferBufferHandle = mFunctionsWGL->dxRegisterObjectNV(mDeviceHandle, colorBuffer, mColorRenderbufferID,
    ...
    if (mDepthBufferFormat != GL_NONE) {
        ...
        const gl::InternalFormat& depthStencilFormatInfo = gl::GetInternalFormatInfo(mDepthBufferFormat);
