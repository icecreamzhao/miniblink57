...
EGLDisplay EGLAPIENTRY GetPlatformDisplayEXT(EGLenum platform, void* native_display, const EGLint* attrib_list)
{
    ...
    if (platform == EGL_PLATFORM_ANGLE_ANGLE) {
        ...
        if (deviceType == EGL_PLATFORM_ANGLE_DEVICE_TYPE_WARP_ANGLE && platformType != EGL_PLATFORM_ANGLE_TYPE_D3D11_ANGLE) {
            SetGlobalError(
                Error(EGL_BAD_ATTRIBUTE,
        ...
        if (deviceTypeSpecified && platformType != EGL_PLATFORM_ANGLE_TYPE_D3D9_ANGLE && platformType != EGL_PLATFORM_ANGLE_TYPE_D3D11_ANGLE) {
            SetGlobalError(
                Error(EGL_BAD_ATTRIBUTE,
