...
#define _MD_INIT_CONTEXT(_thread, _sp, _main, status) \
    {                                                 \
        ...
        CONTEXT(_thread)                              \
        [2] = (unsigned char*)((_sp)-128);            \
        CONTEXT(_thread)                              \
        [0] = (int)_main;                             \
        *status = PR_TRUE;                            \
    }
#define _MD_GET_SP(_thread) CONTEXT(_thread) \
[2]
#endif
#ifdef __sparc__
#define _MD_INIT_CONTEXT(_thread, _sp, _main, status) \
