...
typedef void(JRI_CALLBACK* JRICollectionStartProc)(JRIRuntimeInstance* runtime);
...
typedef void (*JRI_GetClassFieldInfo_t)(JRIReflectionEnv* env, struct java_lang_Class* clazz,
...
typedef void (*JRI_GetClassMethodInfo_t)(JRIReflectionEnv* env, struct java_lang_Class* clazz,
...
typedef jbool (*JRI_GetFrameInfo_t)(JRIDebuggerEnv* env, jsize frameIndex,
    jref* methodClass, jsize* methodIndex,
    jsize* pc, jsize* varsCount);

typedef void (*JRI_GetVarInfo_t)(JRIDebuggerEnv* env, jsize frameIndex, jsize varIndex,
    char** name, char** signature,
    jbool* isArgument, jsize* startScope, jsize* endScope);

#define JRIVarNotInScope ((JRIFieldID)-1)

typedef void (*JRI_GetSourceInfo_t)(JRIDebuggerEnv* env, jsize frameIndex,
...
typedef void (*JRI_CompileClass_t)(JRICompilerEnv* env,
...
typedef jref (*JRI_CompileExpr_t)(JRIExprEnv* env,
