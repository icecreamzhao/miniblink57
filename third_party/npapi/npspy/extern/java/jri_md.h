 ...
 */
#define jlong_CMP(a, op, b) (((int32)(a).hi op(int32)(b).hi) || (((a).hi == (b).hi) && ((a).lo op(b).lo)))
#define jlong_UCMP(a, op, b) (((a).hi op(b).hi) || (((a).hi == (b).hi) && ((a).lo op(b).lo)))
