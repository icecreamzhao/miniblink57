...
#define HAVE_OPENSSL_PEM_H

/* Define to 1 if you have the <openssl/pkcs12.h> header file. */
/* #undef HAVE_OPENSSL_PKCS12_H */
#define HAVE_OPENSSL_PKCS12_H
...
/* #undef USE_OPENSSL */
//#define USE_OPENSSL // at command line
